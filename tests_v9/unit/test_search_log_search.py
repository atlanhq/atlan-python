...
"""
Unit tests for search log search using v9 (msgspec) request models.

Ported from tests/unit/test_search_log_search.py — uses v9 SearchLogRequest
while keeping legacy SearchLogClient and SearchLogResults (returned by client).
"""
