...
"""
Unit tests for audit search using v9 (msgspec) request models.

Ported from tests/unit/test_audit_search.py — uses v9 AuditSearchRequest/DSL/Bool/Term
while keeping legacy AuditClient and AuditSearchResults (returned by client).
"""
