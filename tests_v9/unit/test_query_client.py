...
"""
Unit tests for query client — ported from tests/unit/test_query_client.py.

Uses v9 QueryRequest/QueryResponse (msgspec) where available. The QueryClient
itself is legacy; tests verify that v9 request models work with the client.
"""
