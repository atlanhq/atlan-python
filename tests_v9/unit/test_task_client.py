...
"""
Unit tests for task client — ported from tests/unit/test_task_client.py.

Uses v9 TaskSearchRequest, FluentTasks, and AtlanTask (msgspec.Struct).
The legacy TaskClient is used since the client layer is not migrated.
"""
