...
"""Unit tests for APIField model in pyatlan_v9."""

import pytest

from pyatlan_v9.model import APIField
from pyatlan_v9.model.enums import APIQueryParamTypeEnum
...
def test_creator_with_missing_parameters_raise_value_error(
    ...
    """Test creator validates parent context constraints."""
...
def test_creator_parent_object():
    """Test creator when APIField belongs to an APIObject."""
...
def test_creator_parent_query():
    """Test creator when APIField belongs to an APIQuery."""
    sut = APIField.creator(
        name=API_FIELD_NAME,
...
def test_overload_creator_parent_object():
    """Test creator with object-parent optional field metadata."""
    sut = APIField.creator(
        name=API_FIELD_NAME,
        parent_api_object_qualified_name=API_FIELD_PARENT_OBJECT_QUALIFIED_NAME,
        parent_api_query_qualified_name=None,
...
def test_overload_creator_parent_query():
    """Test creator with query-parent optional field metadata."""
    sut = APIField.creator(
        name=API_FIELD_NAME,
        parent_api_object_qualified_name=None,
        parent_api_query_qualified_name=API_FIELD_PARENT_QUERY_QUALIFIED_NAME,
...
def test_updater():
    """Test updater creates APIField for modification."""
