...
"""Unit tests for QuickSightDashboard model in pyatlan_v9."""

import pytest

from pyatlan_v9.models import QuickSightDashboard
...
def test_updater_with_invalid_parameter_raises_value_error(
    ...
    with pytest.raises(ValueError, match=message):
        QuickSightDashboard.updater(qualified_name=qualified_name, name=name)


def test_updater():
    """Test updater creates a QuickSightDashboard for modification."""
    sut = QuickSightDashboard.updater(
