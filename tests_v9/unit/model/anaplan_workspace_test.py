...
"""Unit tests for AnaplanWorkspace model in pyatlan_v9."""

import pytest

from pyatlan_v9.models import AnaplanWorkspace
...
def test_updater_with_invalid_parameter_raises_value_error(
    ...
    with pytest.raises(ValueError, match=message):
        AnaplanWorkspace.updater(qualified_name=qualified_name, name=name)


def test_updater():
    """Test updater creates AnaplanWorkspace for modification."""
    sut = AnaplanWorkspace.updater(
