...
"""Unit tests for APIObject model in pyatlan_v9."""

import pytest

from pyatlan_v9.models import APIObject
...
def test_overload_creator():
    """Test creator accepts optional api_field_count."""
    sut = APIObject.creator(
...
def test_updater():
    """Test updater creates APIObject for modification."""
