...
"""Unit tests for AnaplanLineItem model in pyatlan_v9."""

import pytest

from pyatlan_v9.models import AnaplanLineItem
...
def test_updater_with_invalid_parameter_raises_value_error(
    ...
    with pytest.raises(ValueError, match=message):
        AnaplanLineItem.updater(qualified_name=qualified_name, name=name)


def test_updater():
    """Test updater creates AnaplanLineItem for modification."""
    sut = AnaplanLineItem.updater(
