...
"""Unit tests for APIQuery model in pyatlan_v9."""

import pytest

from pyatlan_v9.models import APIQuery
...
def test_overload_creator():
    """Test creator accepts optional APIQuery output settings."""
    sut = APIQuery.creator(
        name=API_QUERY_NAME,
...
def test_updater():
    """Test updater creates APIQuery for modification."""
