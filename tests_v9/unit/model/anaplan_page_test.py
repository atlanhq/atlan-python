...
"""Unit tests for AnaplanPage model in pyatlan_v9."""
...
def test_updater_with_invalid_parameter_raises_value_error(
    ...
    with pytest.raises(ValueError, match=message):
        AnaplanPage.updater(qualified_name=qualified_name, name=name)


def test_updater():
    """Test updater creates AnaplanPage for modification."""
    sut = AnaplanPage.updater(
