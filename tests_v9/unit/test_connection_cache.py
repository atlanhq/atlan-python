...
"""
Unit tests for connection cache — ported from tests/unit/test_connection_cache.py.

Uses legacy ConnectionCache/ConnectionName (plain Python classes) and v9
Connection (msgspec.Struct) as test data. The cache layer itself has no Pydantic
dependency — this test verifies cache lookup/caching behaviour.
"""
