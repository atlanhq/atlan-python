...
from pyatlan_v9.errors import AtlanError, ErrorCode, NotFoundError
from pyatlan_v9.model.aio.custom_metadata import (
    AsyncCustomMetadataDict,
    AsyncCustomMetadataProxy,
    AsyncCustomMetadataRequest,
)
from pyatlan_v9.model.assets import Asset
from pyatlan_v9.model.enums import AtlanCustomAttributePrimitiveType
...
class TestAsyncCustomMetadataRequest:
    ...
    async def test_create(
        ...
        assert request.to_dict() == {ATTR_FIRST_NAME_ID: "Jane"}
