...
from pyatlan_v9.model.fields.atlan_fields import CustomMetadataField
...
from tests_v9.integration.admin_test import create_group, delete_group
from tests_v9.integration.client import TestId, delete_asset
from tests_v9.integration.glossary_test import create_glossary, create_term
from tests_v9.integration.utils import (
...
def create_custom_metadata(
    ...
    r = client.typedef.creator(cm_def)
...
def create_enum(client: AtlanClient, name: str, values: List[str]) -> EnumDef:
    ...
    r = client.typedef.creator(enum_def)
...
def cm_raci(
    ...
    TEST_MULTI_VALUE_USING_SETTER = AttributeDef.creator(
        client=client,
