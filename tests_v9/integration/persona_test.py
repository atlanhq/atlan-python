...
from tests_v9.integration.glossary_test import create_glossary
from tests_v9.integration.utils import find_personas_by_name_with_retry
...
def persona(
    ...
    to_create = Persona.creator(name=MODULE_NAME)
...
class PolicyInfo(msgspec.Struct, rename="camel"):
