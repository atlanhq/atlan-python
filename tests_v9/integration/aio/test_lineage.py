...
from pyatlan_v9.model.lineage import FluentLineage
from pyatlan_v9.model.search import DSL, Bool, IndexSearchRequest, Prefix, Term
...
async def cp_lineage_start(
    ...
    assert connection.qualified_name
    to_create = ColumnProcess.creator(
