...
existing_integration_test_files = [file for file in accumulated_durations.keys() if file.startswith(integration_test_dir)]
new_integration_test_files = [file for file in os.listdir(integration_test_dir) if file.endswith('_test.py') and file not in accumulated_durations]
...
for test_file in new_integration_test_files:
    ...
    if full_test_file_path not in accumulated_durations and test_file not in ignore_list:
