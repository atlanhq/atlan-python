...
class V9AsyncOAuthClient:
    ...
    obtained through the oauth_client property of AsyncAtlanClient.
    """
    ...
    async def get(
        ...
        """
        Retrieves OAuth clients defined in Atlan with async pagination support.
        ...
        response = AsyncOAuthClientListResponse(
