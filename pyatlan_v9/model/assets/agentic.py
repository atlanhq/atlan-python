...
"""
Agentic asset model with flattened inheritance.

This module provides:
- Agentic: Flat asset class (easy to use)
- AgenticAttributes: Nested attributes struct (extends AssetAttributes)
- AgenticNested: Nested API format struct
"""
...
class Agentic(Asset):
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _agentic_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> Agentic:
        """
        ...
        if serde is None:
            serde = get_serde()
        return _agentic_from_nested_bytes(json_data, serde)
...
class AgenticAttributes(AssetAttributes):
    """Agentic-specific attributes for nested API format."""
...
class AgenticRelationshipAttributes(AssetRelationshipAttributes):
    """Agentic-specific relationship attributes for nested API format."""
...
class AgenticNested(AssetNested):
    """Agentic in nested API format for high-performance serialization."""

    attributes: Union[AgenticAttributes, UnsetType] = UNSET
    relationship_attributes: Union[AgenticRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[AgenticRelationshipAttributes, UnsetType] = (
        UNSET
    )
    remove_relationship_attributes: Union[AgenticRelationshipAttributes, UnsetType] = (
        UNSET
    )
...
def _populate_agentic_attrs(attrs: AgenticAttributes, obj: Agentic) -> None:
...
def _extract_agentic_attrs(attrs: AgenticAttributes) -> dict:
...
def _agentic_to_nested(agentic: Agentic) -> AgenticNested:
    """Convert flat Agentic to nested format."""
    attrs = AgenticAttributes()
    _populate_agentic_attrs(attrs, agentic)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        agentic, _AGENTIC_REL_FIELDS, AgenticRelationshipAttributes
    )
    return AgenticNested(
        guid=agentic.guid,
        type_name=agentic.type_name,
        status=agentic.status,
        version=agentic.version,
        create_time=agentic.create_time,
        update_time=agentic.update_time,
        created_by=agentic.created_by,
        updated_by=agentic.updated_by,
        classifications=agentic.classifications,
        classification_names=agentic.classification_names,
        meanings=agentic.meanings,
        labels=agentic.labels,
        business_attributes=agentic.business_attributes,
        custom_attributes=agentic.custom_attributes,
        pending_tasks=agentic.pending_tasks,
        proxy=agentic.proxy,
...
def _agentic_from_nested(nested: AgenticNested) -> Agentic:
    """Convert nested format to flat Agentic."""
    attrs = nested.attributes if nested.attributes is not UNSET else AgenticAttributes()
    ...
    kwargs.update(_extract_agentic_attrs(attrs))
    kwargs.update(merged_rels)
    return Agentic(**kwargs)


def _agentic_to_nested_bytes(agentic: Agentic, serde: Serde) -> bytes:
    """Convert flat Agentic to nested JSON bytes."""
    return serde.encode(_agentic_to_nested(agentic))


def _agentic_from_nested_bytes(data: bytes, serde: Serde) -> Agentic:
    """Convert nested JSON bytes to flat Agentic."""
    nested = serde.decode(data, AgenticNested)
    return _agentic_from_nested(nested)
...
Agentic.ANOMALO_CHECKS = RelationField("anomaloChecks")
Agentic.APPLICATION = RelationField("application")
Agentic.APPLICATION_FIELD = RelationField("applicationField")
Agentic.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
Agentic.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
Agentic.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
Agentic.OUTPUT_PORT_DATA_PRODUCTS = RelationField("outputPortDataProducts")
Agentic.INPUT_PORT_DATA_PRODUCTS = RelationField("inputPortDataProducts")
Agentic.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
Agentic.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
Agentic.METRICS = RelationField("metrics")
Agentic.DQ_BASE_DATASET_RULES = RelationField("dqBaseDatasetRules")
Agentic.DQ_REFERENCE_DATASET_RULES = RelationField("dqReferenceDatasetRules")
Agentic.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
...
Agentic.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
Agentic.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
Agentic.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
Agentic.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
Agentic.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
Agentic.FILES = RelationField("files")
Agentic.LINKS = RelationField("links")
Agentic.README = RelationField("readme")
Agentic.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
Agentic.SODA_CHECKS = RelationField("sodaChecks")
Agentic.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
Agentic.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
