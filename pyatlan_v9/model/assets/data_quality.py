...
from .data_quality_related import RelatedDataQuality, RelatedDataQualityRule, RelatedMetric
...
class DataQualityNested(AssetNested):
    ...
    attributes: DataQualityAttributes | UnsetType = UNSET
    relationship_attributes: DataQualityRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: DataQualityRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: DataQualityRelationshipAttributes | UnsetType = UNSET
