...
from .sap_related import RelatedSapErpAbapProgram, RelatedSapErpComponent, RelatedSapErpTransactionCode
...
class SapErpTransactionCode(Asset):
    ...
    sap_erp_abap_program: RelatedSapErpAbapProgram | None | UnsetType = UNSET
    ...
    def validate(self, for_creation: bool = False) -> None:
        ...
        if errors:
            raise ValueError(f"SapErpTransactionCode validation failed: {errors}")

    def minimize(self) -> "SapErpTransactionCode":
        self.validate()
        return SapErpTransactionCode(qualified_name=self.qualified_name, name=self.name)

    def relate(self) -> "RelatedSapErpTransactionCode":
        if self.guid is not UNSET:
            return RelatedSapErpTransactionCode(guid=self.guid)
        return RelatedSapErpTransactionCode(qualified_name=self.qualified_name)
...
class SapErpTransactionCodeNested(AssetNested):
    ...
    attributes: SapErpTransactionCodeAttributes | UnsetType = UNSET
    relationship_attributes: SapErpTransactionCodeRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: SapErpTransactionCodeRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: SapErpTransactionCodeRelationshipAttributes | UnsetType = UNSET
