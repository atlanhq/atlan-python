...
def _sql_insight_filter_from_nested(nested: SqlInsightFilterNested) -> SqlInsightFilter:
    ...
    kwargs.update(_extract_sql_insight_filter_attrs(attrs))
    kwargs.update(merged_rels)
    return SqlInsightFilter(**kwargs)
...
SqlInsightFilter.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
SqlInsightFilter.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
