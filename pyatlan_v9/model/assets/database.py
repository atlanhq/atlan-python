...
class DatabaseNested(AssetNested):
    ...
    attributes: DatabaseAttributes | UnsetType = UNSET
    relationship_attributes: DatabaseRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: DatabaseRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: DatabaseRelationshipAttributes | UnsetType = UNSET
