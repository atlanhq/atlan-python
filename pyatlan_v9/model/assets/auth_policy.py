...
def _auth_policy_from_nested(nested: AuthPolicyNested) -> AuthPolicy:
    ...
    kwargs.update(_extract_auth_policy_attrs(attrs))
...
AuthPolicy.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
AuthPolicy.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
