...
class DremioVirtualDatasetNested(AssetNested):
    ...
    relationship_attributes: DremioVirtualDatasetRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: DremioVirtualDatasetRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: DremioVirtualDatasetRelationshipAttributes | UnsetType = UNSET
