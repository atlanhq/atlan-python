...
def _thoughtspot_view_from_nested(nested: ThoughtspotViewNested) -> ThoughtspotView:
    ...
    kwargs.update(_extract_thoughtspot_view_attrs(attrs))
    kwargs.update(merged_rels)
    return ThoughtspotView(**kwargs)
...
ThoughtspotView.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
ThoughtspotView.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
