...
def _snowflake_semantic_logical_table_from_nested(
    ...
    return SnowflakeSemanticLogicalTable(**kwargs)
...
SnowflakeSemanticLogicalTable.SQL_COALESCE_LAST_RUN_STATUS = KeywordField(
    "sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus"
)
SnowflakeSemanticLogicalTable.SQL_COALESCE_NODE_STATUS = KeywordField(
    "sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus"
)
SnowflakeSemanticLogicalTable.SQL_COALESCE_LAST_RUN_AT = NumericField(
    "sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt"
)
SnowflakeSemanticLogicalTable.SQL_COALESCE_NODE_TYPE = KeywordField(
    "sqlCoalesceNodeType", "sqlCoalesceNodeType"
)
SnowflakeSemanticLogicalTable.SQL_COALESCE_ENVIRONMENT_ID = KeywordField(
    "sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId"
)
SnowflakeSemanticLogicalTable.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField(
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName.text",
)
SnowflakeSemanticLogicalTable.SQL_COALESCE_PROJECT_ID = KeywordField(
    "sqlCoalesceProjectId", "sqlCoalesceProjectId"
)
SnowflakeSemanticLogicalTable.SQL_COALESCE_PROJECT_NAME = KeywordTextField(
    "sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text"
)
SnowflakeSemanticLogicalTable.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
...
SnowflakeSemanticLogicalTable.CONTEXT_REPOSITORIES = RelationField(
    "contextRepositories"
)
...
SnowflakeSemanticLogicalTable.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = (
    RelationField("gcpDataplexAspectTypeMetadataEntities")
)
SnowflakeSemanticLogicalTable.MEANINGS = RelationField("meanings")
SnowflakeSemanticLogicalTable.KNOWLEDGE_LINKED_FILES = RelationField(
