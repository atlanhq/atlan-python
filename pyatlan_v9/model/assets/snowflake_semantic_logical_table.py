...
class SnowflakeSemanticLogicalTable(Asset):
    ...
    snowflake_semantic_view: RelatedSnowflakeSemanticView | None | UnsetType = UNSET
    """Semantic view containing the logical table."""

    snowflake_semantic_facts: list[RelatedSnowflakeSemanticFact] | None | UnsetType = (
        UNSET
    )
    ...
    snowflake_base_table: RelatedSQL | None | UnsetType = UNSET
...
class SnowflakeSemanticLogicalTableNested(AssetNested):
    ...
    attributes: SnowflakeSemanticLogicalTableAttributes | UnsetType = UNSET
