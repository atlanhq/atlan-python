...
def _bi_process_from_nested(nested: BIProcessNested) -> BIProcess:
    ...
    kwargs.update(_extract_bi_process_attrs(attrs))
    kwargs.update(merged_rels)
    return BIProcess(**kwargs)
...
BIProcess.PROCESS_DERIVATION = KeywordField("processDerivation", "processDerivation")
...
BIProcess.BIGQUERY_ROUTINES = RelationField("bigqueryRoutines")
...
BIProcess.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
