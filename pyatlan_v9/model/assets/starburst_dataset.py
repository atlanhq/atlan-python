...
def _starburst_dataset_from_nested(nested: StarburstDatasetNested) -> StarburstDataset:
    ...
    kwargs.update(_extract_starburst_dataset_attrs(attrs))
    kwargs.update(merged_rels)
    return StarburstDataset(**kwargs)
...
StarburstDataset.SQL_COALESCE_LAST_RUN_STATUS = KeywordField(
    "sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus"
)
StarburstDataset.SQL_COALESCE_NODE_STATUS = KeywordField(
    "sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus"
)
StarburstDataset.SQL_COALESCE_LAST_RUN_AT = NumericField(
    "sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt"
)
StarburstDataset.SQL_COALESCE_NODE_TYPE = KeywordField(
    "sqlCoalesceNodeType", "sqlCoalesceNodeType"
)
StarburstDataset.SQL_COALESCE_ENVIRONMENT_ID = KeywordField(
    "sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId"
)
StarburstDataset.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField(
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName.text",
)
StarburstDataset.SQL_COALESCE_PROJECT_ID = KeywordField(
    "sqlCoalesceProjectId", "sqlCoalesceProjectId"
)
StarburstDataset.SQL_COALESCE_PROJECT_NAME = KeywordTextField(
    "sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text"
)
StarburstDataset.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
...
StarburstDataset.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
