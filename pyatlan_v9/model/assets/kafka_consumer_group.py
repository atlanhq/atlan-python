...
class KafkaConsumerGroupNested(AssetNested):
    ...
    relationship_attributes: Union[KafkaConsumerGroupRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[KafkaConsumerGroupRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[KafkaConsumerGroupRelationshipAttributes, UnsetType] = UNSET
...
def _populate_kafka_consumer_group_attrs(attrs: KafkaConsumerGroupAttributes, obj: KafkaConsumerGroup) -> None:
    ...
    attrs.kafka_consumer_group_assigned_partitions = obj.kafka_consumer_group_assigned_partitions
...
def _extract_kafka_consumer_group_attrs(attrs: KafkaConsumerGroupAttributes) -> dict:
    ...
    result["kafka_consumer_group_assigned_partitions"] = attrs.kafka_consumer_group_assigned_partitions
...
KafkaConsumerGroup.KAFKA_CONSUMER_GROUP_STATE = KeywordField("kafkaConsumerGroupState", "kafkaConsumerGroupState")
KafkaConsumerGroup.KAFKA_CONSUMER_GROUP_ASSIGNED_PARTITIONS = KeywordField("kafkaConsumerGroupAssignedPartitions", "kafkaConsumerGroupAssignedPartitions")
KafkaConsumerGroup.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
KafkaConsumerGroup.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
KafkaConsumerGroup.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
