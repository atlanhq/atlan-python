...
def _api_query_from_nested(nested: APIQueryNested) -> APIQuery:
    ...
    kwargs.update(_extract_api_query_attrs(attrs))
...
APIQuery.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
APIQuery.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
APIQuery.MEANINGS = RelationField("meanings")
APIQuery.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
