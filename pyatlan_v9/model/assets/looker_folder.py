...
class LookerFolder(Asset):
    ...
    dashboards: list[RelatedLookerDashboard] | None | UnsetType = UNSET
    ...
    looker_sub_folders: list[RelatedLookerFolder] | None | UnsetType = UNSET
    """Subfolders that exist within this folder."""

    looker_parent_folder: RelatedLookerFolder | None | UnsetType = UNSET
