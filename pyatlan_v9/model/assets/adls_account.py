...
class ADLSAccountNested(AssetNested):
    ...
    append_relationship_attributes: ADLSAccountRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: ADLSAccountRelationshipAttributes | UnsetType = UNSET
