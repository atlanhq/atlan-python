...
def _model_entity_association_from_nested(
    ...
    kwargs.update(_extract_model_entity_association_attrs(attrs))
    kwargs.update(merged_rels)
    return ModelEntityAssociation(**kwargs)
...
ModelEntityAssociation.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
