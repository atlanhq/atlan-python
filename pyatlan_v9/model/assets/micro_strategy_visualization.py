...
class MicroStrategyVisualization(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this MicroStrategyVisualization instance.
    ...
    def minimize(self) -> "MicroStrategyVisualization":
        """
        Return a minimal copy of this MicroStrategyVisualization with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new MicroStrategyVisualization with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new MicroStrategyVisualization instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedMicroStrategyVisualization":
        """
        Create a :class:`RelatedMicroStrategyVisualization` reference from this instance.
        ...
        Returns:
            A RelatedMicroStrategyVisualization reference to this asset.
        """
...
def _micro_strategy_visualization_to_nested(
    ...
    return MicroStrategyVisualizationNested(
        ...
        depth=micro_strategy_visualization.depth,
        immediate_upstream=micro_strategy_visualization.immediate_upstream,
        immediate_downstream=micro_strategy_visualization.immediate_downstream,
        attributes=attrs,
...
MicroStrategyVisualization.CATALOG_DATASET_GUID = KeywordField(
...
MicroStrategyVisualization.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
MicroStrategyVisualization.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
MicroStrategyVisualization.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
MicroStrategyVisualization.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
