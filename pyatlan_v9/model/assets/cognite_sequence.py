...
def _cognite_sequence_from_nested(nested: CogniteSequenceNested) -> CogniteSequence:
    ...
    kwargs.update(_extract_cognite_sequence_attrs(attrs))
    kwargs.update(merged_rels)
    return CogniteSequence(**kwargs)
...
CogniteSequence.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
CogniteSequence.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
