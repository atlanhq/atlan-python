...
CogniteSequence.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
CogniteSequence.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
CogniteSequence.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
