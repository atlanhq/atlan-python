...
def _superset_dataset_from_nested(nested: SupersetDatasetNested) -> SupersetDataset:
    ...
    kwargs.update(_extract_superset_dataset_attrs(attrs))
...
SupersetDataset.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
SupersetDataset.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
