...
def _s3_from_nested(nested: S3Nested) -> S3:
    ...
    kwargs.update(_extract_s3_attrs(attrs))
...
S3.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
S3.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
S3.MEANINGS = RelationField("meanings")
S3.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
