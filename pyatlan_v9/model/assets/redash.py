...
class Redash(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Redash instance.
    ...
    def minimize(self) -> "Redash":
        """
        Return a minimal copy of this Redash with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Redash with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Redash instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedRedash":
        """
        Create a :class:`RelatedRedash` reference from this instance.
        ...
        Returns:
            A RelatedRedash reference to this asset.
        """
...
def _redash_to_nested(redash: Redash) -> RedashNested:
    ...
    return RedashNested(
        ...
        depth=redash.depth,
        immediate_upstream=redash.immediate_upstream,
        immediate_downstream=redash.immediate_downstream,
        attributes=attrs,
...
def _redash_from_nested(nested: RedashNested) -> Redash:
    ...
    kwargs.update(_extract_redash_attrs(attrs))
    kwargs.update(merged_rels)
    return Redash(**kwargs)
...
Redash.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Redash.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Redash.MEANINGS = RelationField("meanings")
Redash.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
