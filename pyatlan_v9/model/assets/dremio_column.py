...
class DremioColumnNested(AssetNested):
    ...
    append_relationship_attributes: DremioColumnRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: DremioColumnRelationshipAttributes | UnsetType = UNSET
