...
def _semantic_field_from_nested(nested: SemanticFieldNested) -> SemanticField:
    ...
    kwargs.update(_extract_semantic_field_attrs(attrs))
    kwargs.update(merged_rels)
    return SemanticField(**kwargs)
...
SemanticField.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
SemanticField.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
