...
class TableauMetric(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this TableauMetric instance.
    ...
    def minimize(self) -> "TableauMetric":
        """
        Return a minimal copy of this TableauMetric with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new TableauMetric with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new TableauMetric instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedTableauMetric":
        """
        Create a :class:`RelatedTableauMetric` reference from this instance.
        ...
        Returns:
            A RelatedTableauMetric reference to this asset.
        """
...
def _tableau_metric_from_nested(nested: TableauMetricNested) -> TableauMetric:
    ...
    kwargs.update(_extract_tableau_metric_attrs(attrs))
    kwargs.update(merged_rels)
    return TableauMetric(**kwargs)
...
TableauMetric.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
