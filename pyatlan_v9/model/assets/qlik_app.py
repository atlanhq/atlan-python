...
def _qlik_app_from_nested(nested: QlikAppNested) -> QlikApp:
    ...
    kwargs.update(_extract_qlik_app_attrs(attrs))
    kwargs.update(merged_rels)
    return QlikApp(**kwargs)
...
QlikApp.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
QlikApp.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
QlikApp.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
QlikApp.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
