...
def _context_artifact_from_nested(nested: ContextArtifactNested) -> ContextArtifact:
    ...
    kwargs.update(_extract_context_artifact_attrs(attrs))
    kwargs.update(merged_rels)
    return ContextArtifact(**kwargs)
...
ContextArtifact.AGENTIC_SOURCE = KeywordField("agenticSource", "agenticSource")
