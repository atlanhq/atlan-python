...
def _sage_maker_unified_studio_subscribed_asset_from_nested(
    ...
    kwargs.update(_extract_sage_maker_unified_studio_subscribed_asset_attrs(attrs))
    kwargs.update(merged_rels)
    return SageMakerUnifiedStudioSubscribedAsset(**kwargs)
...
SageMakerUnifiedStudioSubscribedAsset.CONTEXT_REPOSITORIES = RelationField(
    "contextRepositories"
)
