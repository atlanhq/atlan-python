...
class AnaplanSystemDimension(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this AnaplanSystemDimension instance.
    ...
    def minimize(self) -> "AnaplanSystemDimension":
        """
        Return a minimal copy of this AnaplanSystemDimension with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new AnaplanSystemDimension with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new AnaplanSystemDimension instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedAnaplanSystemDimension":
        """
        Create a :class:`RelatedAnaplanSystemDimension` reference from this instance.
        ...
        Returns:
            A RelatedAnaplanSystemDimension reference to this asset.
        """
...
def _anaplan_system_dimension_from_nested(
    ...
    kwargs.update(_extract_anaplan_system_dimension_attrs(attrs))
    kwargs.update(merged_rels)
    return AnaplanSystemDimension(**kwargs)
...
AnaplanSystemDimension.CATALOG_DATASET_GUID = KeywordField(
...
AnaplanSystemDimension.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
AnaplanSystemDimension.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
AnaplanSystemDimension.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
AnaplanSystemDimension.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
AnaplanSystemDimension.MEANINGS = RelationField("meanings")
AnaplanSystemDimension.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
