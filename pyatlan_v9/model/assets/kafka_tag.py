...
class KafkaTagNested(AssetNested):
    ...
    append_relationship_attributes: Union[KafkaTagRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[KafkaTagRelationshipAttributes, UnsetType] = UNSET
...
def _kafka_tag_from_nested(nested: KafkaTagNested) -> KafkaTag:
    ...
    attrs = nested.attributes if nested.attributes is not UNSET else KafkaTagAttributes()
...
KafkaTag.TAG_ALLOWED_VALUES = KeywordTextField("tagAllowedValues", "tagAllowedValues", "tagAllowedValues.text")
KafkaTag.MAPPED_CLASSIFICATION_NAME = KeywordField("mappedClassificationName", "mappedClassificationName")
...
KafkaTag.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
