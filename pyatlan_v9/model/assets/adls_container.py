...
class ADLSContainer(Asset):
    ...
    adls_container_url: str | None | UnsetType = UNSET
    """URL of this container."""

    adls_container_lease_state: str | None | UnsetType = UNSET
    """Lease state of this container."""

    adls_container_lease_status: str | None | UnsetType = UNSET
    """Lease status of this container."""

    adls_container_encryption_scope: str | None | UnsetType = UNSET
    """Encryption scope of this container."""

    adls_container_version_level_immutability_support: bool | None | UnsetType = UNSET
    """Whether this container supports version-level immutability (true) or not (false)."""

    adls_object_count: int | None | UnsetType = UNSET
    ...
    adls_account: RelatedADLSAccount | None | UnsetType = UNSET
    """Account in which this container exists."""

    adls_objects: list[RelatedADLSObject] | None | UnsetType = UNSET
...
class ADLSContainerNested(AssetNested):
    ...
    attributes: ADLSContainerAttributes | UnsetType = UNSET
    relationship_attributes: ADLSContainerRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: ADLSContainerRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: ADLSContainerRelationshipAttributes | UnsetType = UNSET
