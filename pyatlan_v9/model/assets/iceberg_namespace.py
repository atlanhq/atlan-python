...
def _iceberg_namespace_from_nested(nested: IcebergNamespaceNested) -> IcebergNamespace:
    ...
    kwargs.update(_extract_iceberg_namespace_attrs(attrs))
    kwargs.update(merged_rels)
    return IcebergNamespace(**kwargs)
...
IcebergNamespace.SQL_COALESCE_LAST_RUN_STATUS = KeywordField(
    "sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus"
)
IcebergNamespace.SQL_COALESCE_NODE_STATUS = KeywordField(
    "sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus"
)
IcebergNamespace.SQL_COALESCE_LAST_RUN_AT = NumericField(
    "sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt"
)
IcebergNamespace.SQL_COALESCE_NODE_TYPE = KeywordField(
    "sqlCoalesceNodeType", "sqlCoalesceNodeType"
)
IcebergNamespace.SQL_COALESCE_ENVIRONMENT_ID = KeywordField(
    "sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId"
)
IcebergNamespace.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField(
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName.text",
)
IcebergNamespace.SQL_COALESCE_PROJECT_ID = KeywordField(
    "sqlCoalesceProjectId", "sqlCoalesceProjectId"
)
IcebergNamespace.SQL_COALESCE_PROJECT_NAME = KeywordTextField(
    "sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text"
)
IcebergNamespace.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
...
IcebergNamespace.BIGQUERY_ROUTINES = RelationField("bigqueryRoutines")
IcebergNamespace.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
