...
class IcebergNamespace(Asset):
    ...
    schema_external_location: str | None | UnsetType = UNSET
    ...
    iceberg_sub_namespaces: list[RelatedIcebergNamespace] | None | UnsetType = UNSET
    """Child namespaces nested within the parent Iceberg Namespace."""

    iceberg_parent_namespace: RelatedIcebergNamespace | None | UnsetType = UNSET
...
class IcebergNamespaceNested(AssetNested):
    ...
    attributes: IcebergNamespaceAttributes | UnsetType = UNSET
    relationship_attributes: IcebergNamespaceRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: IcebergNamespaceRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: IcebergNamespaceRelationshipAttributes | UnsetType = UNSET
