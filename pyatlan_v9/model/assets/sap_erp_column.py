...
class SapErpColumn(Asset):
    ...
    sap_erp_table: RelatedSapErpTable | None | UnsetType = UNSET
    """SAP ERP table in which this column exists."""

    sap_erp_view: RelatedSapErpView | None | UnsetType = UNSET
