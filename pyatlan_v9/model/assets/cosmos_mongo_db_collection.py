...
def _cosmos_mongo_db_collection_from_nested(
    ...
    kwargs.update(_extract_cosmos_mongo_db_collection_attrs(attrs))
    kwargs.update(merged_rels)
    return CosmosMongoDBCollection(**kwargs)
...
CosmosMongoDBCollection.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
...
CosmosMongoDBCollection.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
