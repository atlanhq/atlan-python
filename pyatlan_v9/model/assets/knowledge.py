...
from .knowledge_related import RelatedKnowledge, RelatedKnowledgeFile
...
def _knowledge_from_nested(nested: KnowledgeNested) -> Knowledge:
    ...
    kwargs.update(_extract_knowledge_attrs(attrs))
...
Knowledge.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
