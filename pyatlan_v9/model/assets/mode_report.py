...
class ModeReport(Asset):
    ...
    mode_queries: list[RelatedModeQuery] | None | UnsetType = UNSET
    """Queries that exist within this report."""

    mode_collections: list[RelatedModeCollection] | None | UnsetType = UNSET
...
class ModeReportNested(AssetNested):
    ...
    attributes: ModeReportAttributes | UnsetType = UNSET
