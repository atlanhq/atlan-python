...
from .sap_related import RelatedSapErpColumn, RelatedSapErpComponent, RelatedSapErpTable
...
class SapErpTable(Asset):
    ...
    SAP_ERP_TABLE_TYPE: ClassVar[Any] = None
    SAP_ERP_TABLE_DELIVERY_CLASS: ClassVar[Any] = None
    ...
    sap_erp_table_type: str | None | UnsetType = UNSET
    """Type of the SAP ERP table."""

    sap_erp_table_delivery_class: str | None | UnsetType = UNSET
    ...
    def validate(self, for_creation: bool = False) -> None:
        ...
        if errors:
            raise ValueError(f"SapErpTable validation failed: {errors}")

    def minimize(self) -> "SapErpTable":
        self.validate()
        return SapErpTable(qualified_name=self.qualified_name, name=self.name)

    def relate(self) -> "RelatedSapErpTable":
        if self.guid is not UNSET:
            return RelatedSapErpTable(guid=self.guid)
        return RelatedSapErpTable(qualified_name=self.qualified_name)
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _sap_erp_table_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> SapErpTable:
        """
...
class SapErpTableNested(AssetNested):
    ...
    attributes: SapErpTableAttributes | UnsetType = UNSET
    relationship_attributes: SapErpTableRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: SapErpTableRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: SapErpTableRelationshipAttributes | UnsetType = UNSET

# =============================================================================
# CONVERSION HELPERS & CONSTANTS
# =============================================================================

_SAP_ERP_TABLE_REL_FIELDS: list[str] = [
    *_ASSET_REL_FIELDS,
...
def _populate_sap_erp_table_attrs(attrs: SapErpTableAttributes, obj: SapErpTable) -> None:
    ...
    attrs.sap_erp_table_delivery_class = obj.sap_erp_table_delivery_class
...
def _extract_sap_erp_table_attrs(attrs: SapErpTableAttributes) -> dict:
    ...
    result["sap_erp_table_type"] = attrs.sap_erp_table_type
    result["sap_erp_table_delivery_class"] = attrs.sap_erp_table_delivery_class
...
def _sap_erp_table_to_nested(sap_erp_table: SapErpTable) -> SapErpTableNested:
    ...
    _populate_sap_erp_table_attrs(attrs, sap_erp_table)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        sap_erp_table, _SAP_ERP_TABLE_REL_FIELDS, SapErpTableRelationshipAttributes
    )
...
SapErpTable.SAP_COMPONENT_NAME = KeywordField("sapComponentName", "sapComponentName")
...
SapErpTable.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
SapErpTable.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
SapErpTable.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
SapErpTable.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
SapErpTable.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
SapErpTable.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
SapErpTable.FILES = RelationField("files")
SapErpTable.LINKS = RelationField("links")
...
SapErpTable.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")