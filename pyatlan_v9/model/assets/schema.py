...
def _schema__from_nested(nested: SchemaNested) -> Schema:
    ...
    kwargs.update(_extract_schema__attrs(attrs))
...
Schema.SQL_AI_INSIGHTS_LAST_ANALYZED_AT = NumericField(
    "sqlAiInsightsLastAnalyzedAt", "sqlAiInsightsLastAnalyzedAt"
)
Schema.SQL_AI_INSIGHTS_POPULAR_BUSINESS_QUESTION_COUNT = NumericField(
    "sqlAiInsightsPopularBusinessQuestionCount",
    "sqlAiInsightsPopularBusinessQuestionCount",
)
Schema.SQL_AI_INSIGHTS_POPULAR_JOIN_COUNT = NumericField(
    "sqlAiInsightsPopularJoinCount", "sqlAiInsightsPopularJoinCount"
)
Schema.SQL_AI_INSIGHTS_POPULAR_FILTER_COUNT = NumericField(
...
Schema.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
...
Schema.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
