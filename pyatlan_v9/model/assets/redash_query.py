...
RedashQuery.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
RedashQuery.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
RedashQuery.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
