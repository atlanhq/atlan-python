...
def _workflow_from_nested(nested: WorkflowNested) -> Workflow:
    ...
    kwargs.update(_extract_workflow_attrs(attrs))
...
Workflow.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Workflow.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
