...
def _metric_from_nested(nested: MetricNested) -> Metric:
    ...
    kwargs.update(_extract_metric_attrs(attrs))
...
Metric.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Metric.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
