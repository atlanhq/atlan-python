...
def _no_sql_from_nested(nested: NoSQLNested) -> NoSQL:
    ...
    kwargs.update(_extract_no_sql_attrs(attrs))
...
NoSQL.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
NoSQL.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
