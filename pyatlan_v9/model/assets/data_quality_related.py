...
class RelatedDataQualityRule(RelatedDataQuality):
    ...
    dq_rule_base_dataset_qualified_name: str | None | UnsetType = UNSET
    """Base dataset qualified name that attached to this rule."""

    dq_rule_base_column_qualified_name: str | None | UnsetType = UNSET
    """Base column qualified name that attached to this rule."""

    dq_rule_reference_dataset_qualified_names: list[str] | None | UnsetType = UNSET
    """List of unique reference dataset's qualified names related to this rule."""

    dq_rule_reference_column_qualified_names: list[str] | None | UnsetType = UNSET
    """List of unique reference column's qualified names related to this rule."""

    dq_rule_source_sync_status: str | None | UnsetType = UNSET
    """Latest sync status of the rule to the source."""

    dq_rule_source_sync_error_code: str | None | UnsetType = UNSET
    """Error code in the case of state being "failure"."""

    dq_rule_source_sync_error_message: str | None | UnsetType = UNSET
    """Error message in the case of state being "error"."""

    dq_rule_source_sync_raw_error: str | None | UnsetType = UNSET
    """Raw error message from the source."""

    dq_rule_source_synced_at: int | None | UnsetType = UNSET
    """Time (epoch) at which the rule synced to the source."""

    dq_rule_latest_result: str | None | UnsetType = UNSET
    """Latest result of the rule."""

    dq_rule_latest_result_computed_at: int | None | UnsetType = UNSET
    """Time (epoch) at which the latest rule result was evaluated."""

    dq_rule_latest_result_fetched_at: int | None | UnsetType = UNSET
    """Time (epoch) at which the latest rule result was fetched."""

    dq_rule_latest_metric_value: str | None | UnsetType = UNSET
    """Last result metrics value of the rule."""

    dq_rule_latest_metric_value_computed_at: int | None | UnsetType = UNSET
    """Time (epoch) at which the latest metric value was evaluated in the source."""

    dq_rule_dimension: str | None | UnsetType = UNSET
    """Dimension of the data quality rule."""

    dq_rule_template_name: str | None | UnsetType = UNSET
    """Name of the rule template corresponding to the rule."""

    dq_rule_status: str | None | UnsetType = UNSET
    """Status of the rule."""

    dq_rule_alert_priority: str | None | UnsetType = UNSET
