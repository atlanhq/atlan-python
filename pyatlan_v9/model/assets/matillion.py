...
class MatillionNested(AssetNested):
    ...
    append_relationship_attributes: Union[MatillionRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[MatillionRelationshipAttributes, UnsetType] = UNSET
...
Matillion.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
Matillion.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
