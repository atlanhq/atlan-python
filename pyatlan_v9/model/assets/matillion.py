...
class Matillion(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Matillion instance.
    ...
    def minimize(self) -> "Matillion":
        """
        Return a minimal copy of this Matillion with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Matillion with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Matillion instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedMatillion":
        """
        Create a :class:`RelatedMatillion` reference from this instance.
        ...
        Returns:
            A RelatedMatillion reference to this asset.
        """
...
def _matillion_from_nested(nested: MatillionNested) -> Matillion:
    ...
    kwargs.update(_extract_matillion_attrs(attrs))
    kwargs.update(merged_rels)
    return Matillion(**kwargs)
...
Matillion.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
