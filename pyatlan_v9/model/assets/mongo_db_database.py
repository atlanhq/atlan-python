...
_MONGO_DB_DATABASE_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
def _mongo_db_database_from_nested(nested: MongoDBDatabaseNested) -> MongoDBDatabase:
    ...
    kwargs.update(_extract_mongo_db_database_attrs(attrs))
    kwargs.update(merged_rels)
    return MongoDBDatabase(**kwargs)
...
MongoDBDatabase.SQL_IS_IMPORTED_VIA_DATA_SHARE = BooleanField(
    "sqlIsImportedViaDataShare", "sqlIsImportedViaDataShare"
)
MongoDBDatabase.SQL_ORIGIN_ACCOUNT_GUID = KeywordField(
...
MongoDBDatabase.SQL_HAS_AI_INSIGHTS = BooleanField(
    "sqlHasAiInsights", "sqlHasAiInsights"
)
MongoDBDatabase.SQL_AI_INSIGHTS_LAST_ANALYZED_AT = NumericField(
    "sqlAiInsightsLastAnalyzedAt", "sqlAiInsightsLastAnalyzedAt"
)
MongoDBDatabase.SQL_AI_INSIGHTS_POPULAR_BUSINESS_QUESTION_COUNT = NumericField(
    "sqlAiInsightsPopularBusinessQuestionCount",
    "sqlAiInsightsPopularBusinessQuestionCount",
)
MongoDBDatabase.SQL_AI_INSIGHTS_POPULAR_JOIN_COUNT = NumericField(
    "sqlAiInsightsPopularJoinCount", "sqlAiInsightsPopularJoinCount"
)
MongoDBDatabase.SQL_AI_INSIGHTS_POPULAR_FILTER_COUNT = NumericField(
    "sqlAiInsightsPopularFilterCount", "sqlAiInsightsPopularFilterCount"
)
MongoDBDatabase.SQL_AI_INSIGHTS_RELATIONSHIP_COUNT = NumericField(
    "sqlAiInsightsRelationshipCount", "sqlAiInsightsRelationshipCount"
)
MongoDBDatabase.SQL_COALESCE_LAST_RUN_STATUS = KeywordField(
    "sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus"
)
MongoDBDatabase.SQL_COALESCE_NODE_STATUS = KeywordField(
    "sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus"
)
MongoDBDatabase.SQL_COALESCE_LAST_RUN_AT = NumericField(
    "sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt"
)
MongoDBDatabase.SQL_COALESCE_NODE_TYPE = KeywordField(
    "sqlCoalesceNodeType", "sqlCoalesceNodeType"
)
MongoDBDatabase.SQL_COALESCE_ENVIRONMENT_ID = KeywordField(
    "sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId"
)
MongoDBDatabase.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField(
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName.text",
)
MongoDBDatabase.SQL_COALESCE_PROJECT_ID = KeywordField(
    "sqlCoalesceProjectId", "sqlCoalesceProjectId"
)
MongoDBDatabase.SQL_COALESCE_PROJECT_NAME = KeywordTextField(
    "sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text"
)
MongoDBDatabase.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
...
MongoDBDatabase.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
MongoDBDatabase.DBT_MODELS = RelationField("dbtModels")
MongoDBDatabase.SQL_DBT_MODELS = RelationField("sqlDbtModels")
MongoDBDatabase.DBT_TESTS = RelationField("dbtTests")
MongoDBDatabase.DBT_SOURCES = RelationField("dbtSources")
...
MongoDBDatabase.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
MongoDBDatabase.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
MongoDBDatabase.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
MongoDBDatabase.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
MongoDBDatabase.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
MongoDBDatabase.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
MongoDBDatabase.FILES = RelationField("files")
...
MongoDBDatabase.SODA_CHECKS = RelationField("sodaChecks")
MongoDBDatabase.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
MongoDBDatabase.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
MongoDBDatabase.SQL_INSIGHT_OUTGOING_JOINS = RelationField("sqlInsightOutgoingJoins")
MongoDBDatabase.SQL_INSIGHT_INCOMING_JOINS = RelationField("sqlInsightIncomingJoins")
MongoDBDatabase.SQL_INSIGHT_BUSINESS_QUESTIONS = RelationField(
