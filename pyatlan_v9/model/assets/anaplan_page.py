...
def _anaplan_page_from_nested(nested: AnaplanPageNested) -> AnaplanPage:
    ...
    kwargs.update(_extract_anaplan_page_attrs(attrs))
    kwargs.update(merged_rels)
    return AnaplanPage(**kwargs)
...
AnaplanPage.CATALOG_DATASET_GUID = KeywordField(
...
AnaplanPage.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
AnaplanPage.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
AnaplanPage.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
