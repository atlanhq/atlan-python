...
class AnaplanPageNested(AssetNested):
    ...
    append_relationship_attributes: Union[AnaplanPageRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[AnaplanPageRelationshipAttributes, UnsetType] = UNSET
...
AnaplanPage.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
AnaplanPage.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
AnaplanPage.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
AnaplanPage.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
