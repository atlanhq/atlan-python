...
def _populate_quick_sight_dataset_field_attrs(
    attrs: QuickSightDatasetFieldAttributes, obj: QuickSightDatasetField
) -> None:
...
def _quick_sight_dataset_field_from_nested(
    ...
    kwargs.update(_extract_quick_sight_dataset_field_attrs(attrs))
...
QuickSightDatasetField.QUICK_SIGHT_SHEET_ID = KeywordField(
...
QuickSightDatasetField.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
QuickSightDatasetField.MODEL_IMPLEMENTED_ENTITIES = RelationField(
    "modelImplementedEntities"
)
QuickSightDatasetField.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField(
...
QuickSightDatasetField.USER_DEF_RELATIONSHIP_FROM = RelationField(
...
QuickSightDatasetField.SCHEMA_REGISTRY_SUBJECTS = RelationField(
