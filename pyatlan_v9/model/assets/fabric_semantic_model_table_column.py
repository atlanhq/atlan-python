...
def _fabric_semantic_model_table_column_from_nested(
    ...
    kwargs.update(_extract_fabric_semantic_model_table_column_attrs(attrs))
    kwargs.update(merged_rels)
    return FabricSemanticModelTableColumn(**kwargs)
...
FabricSemanticModelTableColumn.CONTEXT_REPOSITORIES = RelationField(
    "contextRepositories"
)
