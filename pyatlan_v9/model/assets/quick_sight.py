...
class QuickSight(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this QuickSight instance.
    ...
    def minimize(self) -> "QuickSight":
        """
        Return a minimal copy of this QuickSight with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new QuickSight with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new QuickSight instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedQuickSight":
        """
        Create a :class:`RelatedQuickSight` reference from this instance.
        ...
        Returns:
            A RelatedQuickSight reference to this asset.
        """
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _quick_sight_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> QuickSight:
        """
...
_QUICK_SIGHT_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
def _quick_sight_to_nested(quick_sight: QuickSight) -> QuickSightNested:
    ...
    _populate_quick_sight_attrs(attrs, quick_sight)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        quick_sight, _QUICK_SIGHT_REL_FIELDS, QuickSightRelationshipAttributes
    )
...
def _quick_sight_from_nested(nested: QuickSightNested) -> QuickSight:
    ...
    kwargs.update(_extract_quick_sight_attrs(attrs))
    kwargs.update(merged_rels)
    return QuickSight(**kwargs)
...
QuickSight.APPLICATION = RelationField("application")
QuickSight.APPLICATION_FIELD = RelationField("applicationField")
QuickSight.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
QuickSight.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
QuickSight.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
QuickSight.OUTPUT_PORT_DATA_PRODUCTS = RelationField("outputPortDataProducts")
QuickSight.INPUT_PORT_DATA_PRODUCTS = RelationField("inputPortDataProducts")
QuickSight.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
QuickSight.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
QuickSight.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
QuickSight.MC_MONITORS = RelationField("mcMonitors")
QuickSight.MC_INCIDENTS = RelationField("mcIncidents")
QuickSight.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
QuickSight.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
QuickSight.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
QuickSight.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
QuickSight.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
QuickSight.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
QuickSight.FILES = RelationField("files")
QuickSight.LINKS = RelationField("links")
QuickSight.README = RelationField("readme")
QuickSight.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
QuickSight.SODA_CHECKS = RelationField("sodaChecks")
QuickSight.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
QuickSight.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
