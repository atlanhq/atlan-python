...
def _tableau_worksheet_field_from_nested(
    ...
    kwargs.update(_extract_tableau_worksheet_field_attrs(attrs))
    kwargs.update(merged_rels)
    return TableauWorksheetField(**kwargs)
...
TableauWorksheetField.TABLEAU_SOURCE_READ_COUNTS = KeywordField(
...
TableauWorksheetField.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
TableauWorksheetField.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
