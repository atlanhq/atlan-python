...
class SapErpFioriAppNested(AssetNested):
    ...
    relationship_attributes: Union[SapErpFioriAppRelationshipAttributes, UnsetType] = (
        UNSET
    )
    append_relationship_attributes: Union[
        SapErpFioriAppRelationshipAttributes, UnsetType
    ] = UNSET
...
def _populate_sap_erp_fiori_app_attrs(
    attrs: SapErpFioriAppAttributes, obj: SapErpFioriApp
) -> None:
...
def _sap_erp_fiori_app_to_nested(
    sap_erp_fiori_app: SapErpFioriApp,
) -> SapErpFioriAppNested:
...
def _sap_erp_fiori_app_from_nested(nested: SapErpFioriAppNested) -> SapErpFioriApp:
    ...
    kwargs.update(_extract_sap_erp_fiori_app_attrs(attrs))
    kwargs.update(merged_rels)
    return SapErpFioriApp(**kwargs)


def _sap_erp_fiori_app_to_nested_bytes(
    sap_erp_fiori_app: SapErpFioriApp, serde: Serde
) -> bytes:
...
SapErpFioriApp.CATALOG_DATASET_GUID = KeywordField(
...
SapErpFioriApp.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
SapErpFioriApp.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField(
...
SapErpFioriApp.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
SapErpFioriApp.MEANINGS = RelationField("meanings")
SapErpFioriApp.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
