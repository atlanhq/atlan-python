...
class TableauNested(AssetNested):
    ...
    append_relationship_attributes: Union[TableauRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[TableauRelationshipAttributes, UnsetType] = UNSET
...
Tableau.TABLEAU_SOURCE_READ_COUNTS = KeywordField("tableauSourceReadCounts", "tableauSourceReadCounts")
...
Tableau.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
