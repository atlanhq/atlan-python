...
def _anaplan_view_from_nested(nested: AnaplanViewNested) -> AnaplanView:
    ...
    kwargs.update(_extract_anaplan_view_attrs(attrs))
    kwargs.update(merged_rels)
    return AnaplanView(**kwargs)
...
AnaplanView.CATALOG_DATASET_GUID = KeywordField(
...
AnaplanView.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
AnaplanView.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
AnaplanView.MEANINGS = RelationField("meanings")
AnaplanView.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
