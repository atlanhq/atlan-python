...
def _sql_insight_join_from_nested(nested: SqlInsightJoinNested) -> SqlInsightJoin:
    ...
    kwargs.update(_extract_sql_insight_join_attrs(attrs))
    kwargs.update(merged_rels)
    return SqlInsightJoin(**kwargs)
...
SqlInsightJoin.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
