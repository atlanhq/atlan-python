...
class SnowflakeAIModelContext(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this SnowflakeAIModelContext instance.
        ...
        if errors:
            raise ValueError(f"SnowflakeAIModelContext validation failed: {errors}")

    def minimize(self) -> "SnowflakeAIModelContext":
        """
        Return a minimal copy of this SnowflakeAIModelContext with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new SnowflakeAIModelContext with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new SnowflakeAIModelContext instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedSnowflakeAIModelContext":
        """
        Create a :class:`RelatedSnowflakeAIModelContext` reference from this instance.
        ...
        Returns:
            A RelatedSnowflakeAIModelContext reference to this asset.
        """
        if self.guid is not UNSET:
            return RelatedSnowflakeAIModelContext(guid=self.guid)
        return RelatedSnowflakeAIModelContext(qualified_name=self.qualified_name)
...
def _snowflake_ai_model_context_from_nested(
    ...
    kwargs.update(_extract_snowflake_ai_model_context_attrs(attrs))
    kwargs.update(merged_rels)
    return SnowflakeAIModelContext(**kwargs)
...
SnowflakeAIModelContext.SQL_HAS_AI_INSIGHTS = BooleanField(
    "sqlHasAiInsights", "sqlHasAiInsights"
)
SnowflakeAIModelContext.SQL_AI_INSIGHTS_LAST_ANALYZED_AT = NumericField(
    "sqlAiInsightsLastAnalyzedAt", "sqlAiInsightsLastAnalyzedAt"
)
SnowflakeAIModelContext.SQL_AI_INSIGHTS_POPULAR_BUSINESS_QUESTION_COUNT = NumericField(
    "sqlAiInsightsPopularBusinessQuestionCount",
    "sqlAiInsightsPopularBusinessQuestionCount",
)
SnowflakeAIModelContext.SQL_AI_INSIGHTS_POPULAR_JOIN_COUNT = NumericField(
    "sqlAiInsightsPopularJoinCount", "sqlAiInsightsPopularJoinCount"
)
SnowflakeAIModelContext.SQL_AI_INSIGHTS_POPULAR_FILTER_COUNT = NumericField(
    "sqlAiInsightsPopularFilterCount", "sqlAiInsightsPopularFilterCount"
)
SnowflakeAIModelContext.SQL_AI_INSIGHTS_RELATIONSHIP_COUNT = NumericField(
    "sqlAiInsightsRelationshipCount", "sqlAiInsightsRelationshipCount"
)
SnowflakeAIModelContext.SQL_COALESCE_LAST_RUN_STATUS = KeywordField(
    "sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus"
)
SnowflakeAIModelContext.SQL_COALESCE_NODE_STATUS = KeywordField(
    "sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus"
)
SnowflakeAIModelContext.SQL_COALESCE_LAST_RUN_AT = NumericField(
    "sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt"
)
SnowflakeAIModelContext.SQL_COALESCE_NODE_TYPE = KeywordField(
    "sqlCoalesceNodeType", "sqlCoalesceNodeType"
)
SnowflakeAIModelContext.SQL_COALESCE_ENVIRONMENT_ID = KeywordField(
    "sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId"
)
SnowflakeAIModelContext.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField(
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName.text",
)
SnowflakeAIModelContext.SQL_COALESCE_PROJECT_ID = KeywordField(
    "sqlCoalesceProjectId", "sqlCoalesceProjectId"
)
SnowflakeAIModelContext.SQL_COALESCE_PROJECT_NAME = KeywordTextField(
    "sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text"
)
SnowflakeAIModelContext.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
    "sqlShareQualifiedNames", "sqlShareQualifiedNames"
)
SnowflakeAIModelContext.CATALOG_DATASET_GUID = KeywordField(
...
SnowflakeAIModelContext.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
SnowflakeAIModelContext.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
SnowflakeAIModelContext.MEANINGS = RelationField("meanings")
SnowflakeAIModelContext.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
...
SnowflakeAIModelContext.SQL_INSIGHT_OUTGOING_JOINS = RelationField(
    "sqlInsightOutgoingJoins"
)
SnowflakeAIModelContext.SQL_INSIGHT_INCOMING_JOINS = RelationField(
    "sqlInsightIncomingJoins"
)
SnowflakeAIModelContext.SQL_INSIGHT_BUSINESS_QUESTIONS = RelationField(
