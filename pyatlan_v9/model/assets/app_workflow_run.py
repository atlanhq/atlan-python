...
class AppWorkflowRunNested(AssetNested):
    ...
    append_relationship_attributes: AppWorkflowRunRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: AppWorkflowRunRelationshipAttributes | UnsetType = (
        UNSET
    )
