...
def _data_product_from_nested(nested: DataProductNested) -> DataProduct:
    ...
    kwargs.update(_extract_data_product_attrs(attrs))
...
DataProduct.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
DataProduct.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
