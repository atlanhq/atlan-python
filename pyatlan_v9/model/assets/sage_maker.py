...
class SageMakerNested(AssetNested):
    ...
    append_relationship_attributes: Union[SageMakerRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[SageMakerRelationshipAttributes, UnsetType] = UNSET
...
SageMaker.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
SageMaker.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
