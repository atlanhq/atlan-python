...
class SalesforceReport(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this SalesforceReport instance.
    ...
    def minimize(self) -> "SalesforceReport":
        """
        Return a minimal copy of this SalesforceReport with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new SalesforceReport with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new SalesforceReport instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedSalesforceReport":
        """
        Create a :class:`RelatedSalesforceReport` reference from this instance.
        ...
        Returns:
            A RelatedSalesforceReport reference to this asset.
        """
...
def _salesforce_report_to_nested(
    ...
    return SalesforceReportNested(
        ...
        depth=salesforce_report.depth,
        immediate_upstream=salesforce_report.immediate_upstream,
        immediate_downstream=salesforce_report.immediate_downstream,
        attributes=attrs,
...
SalesforceReport.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
SalesforceReport.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
