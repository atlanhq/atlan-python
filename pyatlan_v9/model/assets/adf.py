...
class ADF(Asset):
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _adf_to_nested_bytes(self, serde)
...
def _adf_to_nested(adf: ADF) -> ADFNested:
    ...
    attrs = ADFAttributes()
    _populate_adf_attrs(attrs, adf)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        adf, _ADF_REL_FIELDS, ADFRelationshipAttributes
    )
    return ADFNested(
        guid=adf.guid,
...
ADF.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
ADF.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
ADF.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
ADF.MC_MONITORS = RelationField("mcMonitors")
ADF.MC_INCIDENTS = RelationField("mcIncidents")
ADF.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
ADF.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
ADF.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
ADF.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
ADF.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
ADF.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
ADF.FILES = RelationField("files")
ADF.LINKS = RelationField("links")
ADF.README = RelationField("readme")
