...
def _quick_sight_folder_from_nested(nested: QuickSightFolderNested) -> QuickSightFolder:
    ...
    kwargs.update(_extract_quick_sight_folder_attrs(attrs))
...
QuickSightFolder.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
QuickSightFolder.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
