...
def _cognos_from_nested(nested: CognosNested) -> Cognos:
    ...
    kwargs.update(_extract_cognos_attrs(attrs))
    kwargs.update(merged_rels)
    return Cognos(**kwargs)
...
Cognos.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Cognos.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Cognos.MEANINGS = RelationField("meanings")
Cognos.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
