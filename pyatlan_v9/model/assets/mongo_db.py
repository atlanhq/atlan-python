...
class MongoDB(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this MongoDB instance.
    ...
    def minimize(self) -> "MongoDB":
        """
        Return a minimal copy of this MongoDB with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new MongoDB with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new MongoDB instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedMongoDB":
        """
        Create a :class:`RelatedMongoDB` reference from this instance.
        ...
        Returns:
            A RelatedMongoDB reference to this asset.
        """
...
class MongoDBNested(AssetNested):
    ...
    attributes: Union[MongoDBAttributes, UnsetType] = UNSET
    relationship_attributes: Union[MongoDBRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[MongoDBRelationshipAttributes, UnsetType] = (
        UNSET
    )
    remove_relationship_attributes: Union[MongoDBRelationshipAttributes, UnsetType] = (
        UNSET
    )
...
def _mongo_db_from_nested(nested: MongoDBNested) -> MongoDB:
    ...
    kwargs.update(_extract_mongo_db_attrs(attrs))
...
MongoDB.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
MongoDB.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
MongoDB.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
MongoDB.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
MongoDB.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
MongoDB.MEANINGS = RelationField("meanings")
MongoDB.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
