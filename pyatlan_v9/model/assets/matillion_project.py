...
class MatillionProject(Asset):
    ...
    MATILLION_VERSIONS: ClassVar[Any] = None
    MATILLION_ENVIRONMENTS: ClassVar[Any] = None
    MATILLION_PROJECT_JOB_COUNT: ClassVar[Any] = None
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this MatillionProject instance.
    ...
    def minimize(self) -> "MatillionProject":
        """
        Return a minimal copy of this MatillionProject with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new MatillionProject with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new MatillionProject instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedMatillionProject":
        """
        Create a :class:`RelatedMatillionProject` reference from this instance.
        ...
        Returns:
            A RelatedMatillionProject reference to this asset.
        """
...
_MATILLION_PROJECT_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
def _populate_matillion_project_attrs(
    ...
    attrs.matillion_environments = obj.matillion_environments
    attrs.matillion_project_job_count = obj.matillion_project_job_count
...
def _extract_matillion_project_attrs(attrs: MatillionProjectAttributes) -> dict:
    ...
    result["matillion_versions"] = attrs.matillion_versions
    result["matillion_environments"] = attrs.matillion_environments
    result["matillion_project_job_count"] = attrs.matillion_project_job_count
...
def _matillion_project_to_nested(
    ...
    return MatillionProjectNested(
        ...
        depth=matillion_project.depth,
        immediate_upstream=matillion_project.immediate_upstream,
        immediate_downstream=matillion_project.immediate_downstream,
        attributes=attrs,
...
def _matillion_project_from_nested(nested: MatillionProjectNested) -> MatillionProject:
    ...
    kwargs.update(_extract_matillion_project_attrs(attrs))
    kwargs.update(merged_rels)
    return MatillionProject(**kwargs)
...
MatillionProject.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
MatillionProject.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
...
MatillionProject.MC_INCIDENTS = RelationField("mcIncidents")
MatillionProject.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
MatillionProject.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
MatillionProject.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
MatillionProject.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
MatillionProject.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
MatillionProject.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
MatillionProject.FILES = RelationField("files")
MatillionProject.LINKS = RelationField("links")
MatillionProject.README = RelationField("readme")
MatillionProject.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
MatillionProject.SODA_CHECKS = RelationField("sodaChecks")
MatillionProject.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
MatillionProject.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
