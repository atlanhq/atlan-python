...
class DataStudioAsset(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this DataStudioAsset instance.
    ...
    def minimize(self) -> "DataStudioAsset":
        """
        Return a minimal copy of this DataStudioAsset with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new DataStudioAsset with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new DataStudioAsset instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedDataStudioAsset":
        """
        Create a :class:`RelatedDataStudioAsset` reference from this instance.
        ...
        Returns:
            A RelatedDataStudioAsset reference to this asset.
        """
...
def _data_studio_asset_from_nested(nested: DataStudioAssetNested) -> DataStudioAsset:
    ...
    kwargs.update(_extract_data_studio_asset_attrs(attrs))
...
DataStudioAsset.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
DataStudioAsset.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
DataStudioAsset.MEANINGS = RelationField("meanings")
DataStudioAsset.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
