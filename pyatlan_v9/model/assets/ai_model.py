...
def _ai_model_from_nested(nested: AIModelNested) -> AIModel:
    ...
    kwargs.update(_extract_ai_model_attrs(attrs))
...
AIModel.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
AIModel.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
