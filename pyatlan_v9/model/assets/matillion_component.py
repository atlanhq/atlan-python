...
class MatillionComponent(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this MatillionComponent instance.
    ...
    def minimize(self) -> "MatillionComponent":
        """
        Return a minimal copy of this MatillionComponent with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new MatillionComponent with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new MatillionComponent instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedMatillionComponent":
        """
        Create a :class:`RelatedMatillionComponent` reference from this instance.
        ...
        Returns:
            A RelatedMatillionComponent reference to this asset.
        """
...
def _matillion_component_from_nested(
    ...
    kwargs.update(_extract_matillion_component_attrs(attrs))
    kwargs.update(merged_rels)
    return MatillionComponent(**kwargs)
...
MatillionComponent.CATALOG_DATASET_GUID = KeywordField(
...
MatillionComponent.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
MatillionComponent.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
MatillionComponent.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
MatillionComponent.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
