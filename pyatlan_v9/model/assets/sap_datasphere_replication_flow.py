...
class SapDatasphereReplicationFlowNested(AssetNested):
    ...
    relationship_attributes: Union[
        SapDatasphereReplicationFlowRelationshipAttributes, UnsetType
    ] = UNSET
...
def _populate_sap_datasphere_replication_flow_attrs(
    attrs: SapDatasphereReplicationFlowAttributes, obj: SapDatasphereReplicationFlow
) -> None:
...
def _extract_sap_datasphere_replication_flow_attrs(
...
def _sap_datasphere_replication_flow_to_nested(
    sap_datasphere_replication_flow: SapDatasphereReplicationFlow,
) -> SapDatasphereReplicationFlowNested:
    """Convert flat SapDatasphereReplicationFlow to nested format."""
    attrs = SapDatasphereReplicationFlowAttributes()
    _populate_sap_datasphere_replication_flow_attrs(
        attrs, sap_datasphere_replication_flow
    )
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        sap_datasphere_replication_flow,
...
def _sap_datasphere_replication_flow_from_nested(
    nested: SapDatasphereReplicationFlowNested,
) -> SapDatasphereReplicationFlow:
    """Convert nested format to flat SapDatasphereReplicationFlow."""
    attrs = (
        nested.attributes
        if nested.attributes is not UNSET
        else SapDatasphereReplicationFlowAttributes()
    )
    ...
    return SapDatasphereReplicationFlow(**kwargs)


def _sap_datasphere_replication_flow_to_nested_bytes(
    sap_datasphere_replication_flow: SapDatasphereReplicationFlow, serde: Serde
) -> bytes:
    """Convert flat SapDatasphereReplicationFlow to nested JSON bytes."""
    return serde.encode(
        _sap_datasphere_replication_flow_to_nested(sap_datasphere_replication_flow)
    )


def _sap_datasphere_replication_flow_from_nested_bytes(
...
SapDatasphereReplicationFlow.FLOW_FINISHED_AT = NumericField(
    "flowFinishedAt", "flowFinishedAt"
)
SapDatasphereReplicationFlow.FLOW_STATUS = KeywordField("flowStatus", "flowStatus")
SapDatasphereReplicationFlow.FLOW_SCHEDULE = KeywordField(
    "flowSchedule", "flowSchedule"
)
SapDatasphereReplicationFlow.FLOW_PROJECT_NAME = KeywordTextField(
    "flowProjectName", "flowProjectName", "flowProjectName.text"
)
SapDatasphereReplicationFlow.FLOW_PROJECT_QUALIFIED_NAME = KeywordField(
    "flowProjectQualifiedName", "flowProjectQualifiedName"
)
SapDatasphereReplicationFlow.FLOW_FOLDER_NAME = KeywordTextField(
    "flowFolderName", "flowFolderName", "flowFolderName.text"
)
SapDatasphereReplicationFlow.FLOW_FOLDER_QUALIFIED_NAME = KeywordField(
    "flowFolderQualifiedName", "flowFolderQualifiedName"
)
SapDatasphereReplicationFlow.FLOW_REUSABLE_UNIT_NAME = KeywordTextField(
    "flowReusableUnitName", "flowReusableUnitName", "flowReusableUnitName.text"
)
SapDatasphereReplicationFlow.FLOW_REUSABLE_UNIT_QUALIFIED_NAME = KeywordField(
...
SapDatasphereReplicationFlow.FLOW_ERROR_MESSAGE = KeywordField(
    "flowErrorMessage", "flowErrorMessage"
)
SapDatasphereReplicationFlow.FLOW_INPUT_PARAMETERS = KeywordField(
    "flowInputParameters", "flowInputParameters"
)
SapDatasphereReplicationFlow.INPUT_TO_AIRFLOW_TASKS = RelationField(
    "inputToAirflowTasks"
)
SapDatasphereReplicationFlow.OUTPUT_FROM_AIRFLOW_TASKS = RelationField(
...
SapDatasphereReplicationFlow.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
    "dataContractLatestCertified"
)
SapDatasphereReplicationFlow.OUTPUT_PORT_DATA_PRODUCTS = RelationField(
    "outputPortDataProducts"
)
SapDatasphereReplicationFlow.INPUT_PORT_DATA_PRODUCTS = RelationField(
    "inputPortDataProducts"
)
SapDatasphereReplicationFlow.MODEL_IMPLEMENTED_ENTITIES = RelationField(
    "modelImplementedEntities"
)
SapDatasphereReplicationFlow.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField(
...
SapDatasphereReplicationFlow.DQ_REFERENCE_DATASET_RULES = RelationField(
...
SapDatasphereReplicationFlow.FLOW_CONTROLLED_OPERATIONS = RelationField(
    "flowControlledOperations"
)
SapDatasphereReplicationFlow.FLOW_CONTROLLED_BY = RelationField("flowControlledBy")
SapDatasphereReplicationFlow.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
...
SapDatasphereReplicationFlow.PARTIAL_CHILD_OBJECTS = RelationField(
    "partialChildObjects"
)
SapDatasphereReplicationFlow.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
SapDatasphereReplicationFlow.OUTPUT_FROM_PROCESSES = RelationField(
    "outputFromProcesses"
)
SapDatasphereReplicationFlow.USER_DEF_RELATIONSHIP_TO = RelationField(
    "userDefRelationshipTo"
)
SapDatasphereReplicationFlow.USER_DEF_RELATIONSHIP_FROM = RelationField(
...
SapDatasphereReplicationFlow.SAP_DATASPHERE_SCHEMA = RelationField(
    "sapDatasphereSchema"
)
SapDatasphereReplicationFlow.SCHEMA_REGISTRY_SUBJECTS = RelationField(
...
SapDatasphereReplicationFlow.OUTPUT_FROM_SPARK_JOBS = RelationField(
    "outputFromSparkJobs"
)
