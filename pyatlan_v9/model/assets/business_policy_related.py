...
class RelatedBusinessPolicyException(RelatedBusinessPolicy):
    ...
    business_policy_exception_filter_dsl: str | None | UnsetType = msgspec.field(default=UNSET, name="businessPolicyExceptionFilterDSL")
...
class RelatedBusinessPolicyIncident(RelatedBusinessPolicy):
    ...
    business_policy_incident_related_policy_guids: list[str] | None | UnsetType = msgspec.field(default=UNSET, name="businessPolicyIncidentRelatedPolicyGUIDs")
    """policy ids related to this incident"""

    business_policy_incident_filter_dsl: str | None | UnsetType = msgspec.field(default=UNSET, name="businessPolicyIncidentFilterDSL")
