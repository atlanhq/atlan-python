...
class Catalog(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Catalog instance.
    ...
    def minimize(self) -> "Catalog":
        """
        Return a minimal copy of this Catalog with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Catalog with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Catalog instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedCatalog":
        """
        Create a :class:`RelatedCatalog` reference from this instance.
        ...
        Returns:
            A RelatedCatalog reference to this asset.
        """
...
def _catalog_to_nested(catalog: Catalog) -> CatalogNested:
    ...
    return CatalogNested(
        ...
        depth=catalog.depth,
        immediate_upstream=catalog.immediate_upstream,
        immediate_downstream=catalog.immediate_downstream,
        attributes=attrs,
...
Catalog.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
Catalog.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
Catalog.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
Catalog.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
