...
class SAP(Asset):
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _sap_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> SAP:
        """
...
def _sap_to_nested(sap: SAP) -> SAPNested:
    ...
    attrs = SAPAttributes()
    _populate_sap_attrs(attrs, sap)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        sap, _SAP_REL_FIELDS, SAPRelationshipAttributes
    )
    return SAPNested(
        guid=sap.guid,
...
SAP.SAP_TECHNICAL_NAME = KeywordField("sapTechnicalName", "sapTechnicalName")
SAP.SAP_LOGICAL_NAME = KeywordField("sapLogicalName", "sapLogicalName")
SAP.SAP_PACKAGE_NAME = KeywordField("sapPackageName", "sapPackageName")
SAP.SAP_COMPONENT_NAME = KeywordField("sapComponentName", "sapComponentName")
SAP.SAP_DATA_TYPE = KeywordField("sapDataType", "sapDataType")
SAP.SAP_FIELD_COUNT = NumericField("sapFieldCount", "sapFieldCount")
SAP.SAP_FIELD_ORDER = NumericField("sapFieldOrder", "sapFieldOrder")
SAP.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
SAP.INPUT_TO_AIRFLOW_TASKS = RelationField("inputToAirflowTasks")
SAP.OUTPUT_FROM_AIRFLOW_TASKS = RelationField("outputFromAirflowTasks")
SAP.ANOMALO_CHECKS = RelationField("anomaloChecks")
SAP.APPLICATION = RelationField("application")
SAP.APPLICATION_FIELD = RelationField("applicationField")
SAP.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
SAP.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
SAP.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
SAP.OUTPUT_PORT_DATA_PRODUCTS = RelationField("outputPortDataProducts")
SAP.INPUT_PORT_DATA_PRODUCTS = RelationField("inputPortDataProducts")
SAP.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
SAP.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
SAP.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
SAP.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
SAP.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
SAP.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
SAP.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
SAP.FILES = RelationField("files")
SAP.LINKS = RelationField("links")
SAP.README = RelationField("readme")
SAP.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
SAP.SODA_CHECKS = RelationField("sodaChecks")
SAP.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
SAP.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
