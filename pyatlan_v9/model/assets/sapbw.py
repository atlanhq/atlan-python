...
class SAPBW(Asset):
    ...
    type_name: Union[str, UnsetType] = "SAPBW"
...
class SAPBWNested(AssetNested):
    ...
    append_relationship_attributes: Union[SAPBWRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[SAPBWRelationshipAttributes, UnsetType] = UNSET
...
SAPBW.SAP_BW_PARENT_QUALIFIED_NAME = KeywordField("sapBwParentQualifiedName", "sapBwParentQualifiedName")
SAPBW.SAP_BW_INFO_OBJECT_NAME = KeywordField("sapBwInfoObjectName", "sapBwInfoObjectName")
SAPBW.SAP_BW_INFO_OBJECT_QUALIFIED_NAME = KeywordField("sapBwInfoObjectQualifiedName", "sapBwInfoObjectQualifiedName")
...
SAPBW.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
