...
def _power_bi_column_from_nested(nested: PowerBIColumnNested) -> PowerBIColumn:
    ...
    kwargs.update(_extract_power_bi_column_attrs(attrs))
    kwargs.update(merged_rels)
    return PowerBIColumn(**kwargs)
...
PowerBIColumn.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
PowerBIColumn.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
