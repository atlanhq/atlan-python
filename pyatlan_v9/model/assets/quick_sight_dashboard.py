...
from .quick_sight_related import RelatedQuickSightDashboard, RelatedQuickSightDashboardVisual, RelatedQuickSightFolder
...
class QuickSightDashboard(Asset):
    ...
    quick_sight_dashboard_visuals: list[RelatedQuickSightDashboardVisual] | None | UnsetType = UNSET
    """Visuals that exist within this dashboard."""

    quick_sight_dashboard_folders: list[RelatedQuickSightFolder] | None | UnsetType = UNSET
    """"""
...
class QuickSightDashboardNested(AssetNested):
    ...
    attributes: QuickSightDashboardAttributes | UnsetType = UNSET
    relationship_attributes: QuickSightDashboardRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: QuickSightDashboardRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: QuickSightDashboardRelationshipAttributes | UnsetType = UNSET
