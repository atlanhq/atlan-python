...
def _dataverse_attribute_from_nested(
    ...
    kwargs.update(_extract_dataverse_attribute_attrs(attrs))
...
DataverseAttribute.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
DataverseAttribute.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
