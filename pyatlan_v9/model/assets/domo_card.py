...
def _domo_card_from_nested(nested: DomoCardNested) -> DomoCard:
    ...
    kwargs.update(_extract_domo_card_attrs(attrs))
    kwargs.update(merged_rels)
    return DomoCard(**kwargs)
...
DomoCard.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
DomoCard.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
DomoCard.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
