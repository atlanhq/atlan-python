...
class LookerField(Asset):
    ...
    explore: RelatedLookerExplore | None | UnsetType = UNSET
    """Explore in which this field exists."""

    project: RelatedLookerProject | None | UnsetType = UNSET
    """Project in which this field exists."""

    view: RelatedLookerView | None | UnsetType = UNSET
    """View in which this field exists."""

    tile: RelatedLookerTile | None | UnsetType = UNSET
    """Tile in which this field is used."""

    look: RelatedLookerLook | None | UnsetType = UNSET
