...
def _api_spec_from_nested(nested: APISpecNested) -> APISpec:
    ...
    kwargs.update(_extract_api_spec_attrs(attrs))
...
APISpec.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
APISpec.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
