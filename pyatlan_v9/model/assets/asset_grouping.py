...
class AssetGroupingNested(AssetNested):
    ...
    relationship_attributes: Union[AssetGroupingRelationshipAttributes, UnsetType] = (
        UNSET
    )
    append_relationship_attributes: Union[
        AssetGroupingRelationshipAttributes, UnsetType
    ] = UNSET
...
def _asset_grouping_to_nested(asset_grouping: AssetGrouping) -> AssetGroupingNested:
    ...
    return AssetGroupingNested(
        ...
        depth=asset_grouping.depth,
        immediate_upstream=asset_grouping.immediate_upstream,
        immediate_downstream=asset_grouping.immediate_downstream,
        attributes=attrs,
...
AssetGrouping.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
AssetGrouping.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
AssetGrouping.MEANINGS = RelationField("meanings")
AssetGrouping.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
