...
class Collection(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Collection instance.
    ...
    def minimize(self) -> "Collection":
        """
        Return a minimal copy of this Collection with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Collection with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Collection instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedCollection":
        """
        Create a :class:`RelatedCollection` reference from this instance.
        ...
        Returns:
            A RelatedCollection reference to this asset.
        """
...
def _collection_from_nested(nested: CollectionNested) -> Collection:
    ...
    kwargs.update(_extract_collection_attrs(attrs))
...
Collection.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
Collection.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
Collection.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
Collection.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
