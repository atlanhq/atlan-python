...
class DomoDashboardNested(AssetNested):
    ...
    append_relationship_attributes: DomoDashboardRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: DomoDashboardRelationshipAttributes | UnsetType = (
        UNSET
    )
