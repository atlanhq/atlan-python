...
class DomoDashboard(Asset):
    ...
    domo_dashboard_children: list[RelatedDomoDashboard] | None | UnsetType = UNSET
    """Child Domo Dashboards that are contained by this parent Domo Dashboard."""

    domo_dashboard_parent: RelatedDomoDashboard | None | UnsetType = UNSET
...
class DomoDashboardNested(AssetNested):
    ...
    attributes: DomoDashboardAttributes | UnsetType = UNSET
    relationship_attributes: DomoDashboardRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: DomoDashboardRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: DomoDashboardRelationshipAttributes | UnsetType = UNSET
