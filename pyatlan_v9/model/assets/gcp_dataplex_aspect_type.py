...
def _gcp_dataplex_aspect_type_from_nested(
    ...
    kwargs.update(_extract_gcp_dataplex_aspect_type_attrs(attrs))
    kwargs.update(merged_rels)
    return GCPDataplexAspectType(**kwargs)
...
GCPDataplexAspectType.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
