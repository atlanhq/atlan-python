...
class SchemaRegistry(Asset):
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _schema_registry_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> SchemaRegistry:
        """
...
class SchemaRegistryNested(AssetNested):
    ...
    relationship_attributes: Union[SchemaRegistryRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[SchemaRegistryRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[SchemaRegistryRelationshipAttributes, UnsetType] = UNSET

# =============================================================================
# CONVERSION HELPERS & CONSTANTS
# =============================================================================

_SCHEMA_REGISTRY_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
SchemaRegistry.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
SchemaRegistry.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
SchemaRegistry.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
SchemaRegistry.MEANINGS = RelationField("meanings")
SchemaRegistry.MC_MONITORS = RelationField("mcMonitors")
SchemaRegistry.MC_INCIDENTS = RelationField("mcIncidents")
SchemaRegistry.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
SchemaRegistry.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
SchemaRegistry.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
SchemaRegistry.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
SchemaRegistry.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
SchemaRegistry.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
SchemaRegistry.FILES = RelationField("files")
SchemaRegistry.LINKS = RelationField("links")
SchemaRegistry.README = RelationField("readme")
SchemaRegistry.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
SchemaRegistry.SODA_CHECKS = RelationField("sodaChecks")
SchemaRegistry.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
SchemaRegistry.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")