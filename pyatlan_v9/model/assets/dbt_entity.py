...
class DbtEntity(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this DbtEntity instance.
    ...
    def minimize(self) -> "DbtEntity":
        """
        Return a minimal copy of this DbtEntity with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new DbtEntity with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new DbtEntity instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedDbtEntity":
        """
        Create a :class:`RelatedDbtEntity` reference from this instance.
        ...
        Returns:
            A RelatedDbtEntity reference to this asset.
        """
...
def _dbt_entity_to_nested(dbt_entity: DbtEntity) -> DbtEntityNested:
    ...
    return DbtEntityNested(
        ...
        depth=dbt_entity.depth,
        immediate_upstream=dbt_entity.immediate_upstream,
        immediate_downstream=dbt_entity.immediate_downstream,
        attributes=attrs,
...
def _dbt_entity_from_nested(nested: DbtEntityNested) -> DbtEntity:
    ...
    kwargs.update(_extract_dbt_entity_attrs(attrs))
    kwargs.update(merged_rels)
    return DbtEntity(**kwargs)
...
DbtEntity.SEMANTIC_SAMPLE_VALUES = TextField(
    "semanticSampleValues", "semanticSampleValues"
)
DbtEntity.SEMANTIC_ACCESS_MODIFIER = KeywordField(
    "semanticAccessModifier", "semanticAccessModifier"
)
DbtEntity.SEMANTIC_DATA_TYPE = KeywordField("semanticDataType", "semanticDataType")
DbtEntity.SEMANTIC_LABELS = KeywordField("semanticLabels", "semanticLabels")
...
DbtEntity.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
DbtEntity.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
DbtEntity.MEANINGS = RelationField("meanings")
DbtEntity.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
