...
def _tableau_workbook_from_nested(nested: TableauWorkbookNested) -> TableauWorkbook:
    ...
    kwargs.update(_extract_tableau_workbook_attrs(attrs))
    kwargs.update(merged_rels)
    return TableauWorkbook(**kwargs)
...
TableauWorkbook.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
TableauWorkbook.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
