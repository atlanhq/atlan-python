...
def _domo_from_nested(nested: DomoNested) -> Domo:
    ...
    kwargs.update(_extract_domo_attrs(attrs))
...
Domo.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
Domo.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Domo.MEANINGS = RelationField("meanings")
Domo.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
