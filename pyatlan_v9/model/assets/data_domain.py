...
class DataDomain(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this DataDomain instance.
    ...
    def minimize(self) -> "DataDomain":
        """
        Return a minimal copy of this DataDomain with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new DataDomain with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new DataDomain instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedDataDomain":
        """
        Create a :class:`RelatedDataDomain` reference from this instance.
        ...
        Returns:
            A RelatedDataDomain reference to this asset.
        """
...
def _data_domain_from_nested(nested: DataDomainNested) -> DataDomain:
    ...
    kwargs.update(_extract_data_domain_attrs(attrs))
...
DataDomain.CATALOG_DATASET_GUID = KeywordField(
...
DataDomain.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
DataDomain.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
DataDomain.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
DataDomain.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
DataDomain.MEANINGS = RelationField("meanings")
DataDomain.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
