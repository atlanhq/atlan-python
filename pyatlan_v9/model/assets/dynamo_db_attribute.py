...
def _dynamo_db_attribute_from_nested(
    ...
    kwargs.update(_extract_dynamo_db_attribute_attrs(attrs))
    kwargs.update(merged_rels)
    return DynamoDBAttribute(**kwargs)
...
DynamoDBAttribute.SQL_COALESCE_LAST_RUN_STATUS = KeywordField(
    "sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus"
)
DynamoDBAttribute.SQL_COALESCE_NODE_STATUS = KeywordField(
    "sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus"
)
DynamoDBAttribute.SQL_COALESCE_LAST_RUN_AT = NumericField(
    "sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt"
)
DynamoDBAttribute.SQL_COALESCE_NODE_TYPE = KeywordField(
    "sqlCoalesceNodeType", "sqlCoalesceNodeType"
)
DynamoDBAttribute.SQL_COALESCE_ENVIRONMENT_ID = KeywordField(
    "sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId"
)
DynamoDBAttribute.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField(
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName.text",
)
DynamoDBAttribute.SQL_COALESCE_PROJECT_ID = KeywordField(
    "sqlCoalesceProjectId", "sqlCoalesceProjectId"
)
DynamoDBAttribute.SQL_COALESCE_PROJECT_NAME = KeywordTextField(
    "sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text"
)
DynamoDBAttribute.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
...
DynamoDBAttribute.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
