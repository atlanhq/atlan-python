...
class SSRSFieldNested(AssetNested):
    ...
    append_relationship_attributes: Union[
        SSRSFieldRelationshipAttributes, UnsetType
    ] = UNSET
...
def _ssrs_field_from_nested(nested: SSRSFieldNested) -> SSRSField:
    ...
    attrs = (
        nested.attributes if nested.attributes is not UNSET else SSRSFieldAttributes()
    )
    ...
    kwargs.update(_extract_ssrs_field_attrs(attrs))
    kwargs.update(merged_rels)
    return SSRSField(**kwargs)
...
SSRSField.CATALOG_DATASET_GUID = KeywordField(
...
SSRSField.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
