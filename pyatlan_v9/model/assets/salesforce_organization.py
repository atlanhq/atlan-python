...
def _salesforce_organization_from_nested(
    ...
    kwargs.update(_extract_salesforce_organization_attrs(attrs))
    kwargs.update(merged_rels)
    return SalesforceOrganization(**kwargs)
...
SalesforceOrganization.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
