...
class AdfDataflowNested(AssetNested):
    ...
    attributes: AdfDataflowAttributes | UnsetType = UNSET
    relationship_attributes: AdfDataflowRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: AdfDataflowRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: AdfDataflowRelationshipAttributes | UnsetType = UNSET
