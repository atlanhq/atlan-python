...
from .anaplan_related import RelatedAnaplanDimension, RelatedAnaplanList, RelatedAnaplanModel, RelatedAnaplanModule, RelatedAnaplanPage, RelatedAnaplanWorkspace
...
class AnaplanModelNested(AssetNested):
    ...
    append_relationship_attributes: AnaplanModelRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: AnaplanModelRelationshipAttributes | UnsetType = UNSET
