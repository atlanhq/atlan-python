...
def _flow_control_operation_from_nested(
    ...
    kwargs.update(_extract_flow_control_operation_attrs(attrs))
    kwargs.update(merged_rels)
    return FlowControlOperation(**kwargs)
...
FlowControlOperation.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
FlowControlOperation.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
