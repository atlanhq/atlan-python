...
def _api_path_from_nested(nested: APIPathNested) -> APIPath:
    ...
    kwargs.update(_extract_api_path_attrs(attrs))
...
APIPath.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
APIPath.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
APIPath.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
APIPath.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
APIPath.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
