...
class DatabricksGenieAgent(Asset):
    ...
    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> DatabricksGenieAgent:
        """
...
class DatabricksGenieAgentNested(AssetNested):
    ...
    relationship_attributes: Union[DatabricksGenieAgentRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[DatabricksGenieAgentRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[DatabricksGenieAgentRelationshipAttributes, UnsetType] = UNSET
...
def _populate_databricks_genie_agent_attrs(attrs: DatabricksGenieAgentAttributes, obj: DatabricksGenieAgent) -> None:
...
def _extract_databricks_genie_agent_attrs(attrs: DatabricksGenieAgentAttributes) -> dict:
...
def _databricks_genie_agent_to_nested(databricks_genie_agent: DatabricksGenieAgent) -> DatabricksGenieAgentNested:
    ...
    replace_rels, append_rels, remove_rels = categorize_relationships(
        databricks_genie_agent, _DATABRICKS_GENIE_AGENT_REL_FIELDS, DatabricksGenieAgentRelationshipAttributes
    )
...
def _databricks_genie_agent_from_nested(nested: DatabricksGenieAgentNested) -> DatabricksGenieAgent:
    """Convert nested format to flat DatabricksGenieAgent."""
    attrs = nested.attributes if nested.attributes is not UNSET else DatabricksGenieAgentAttributes()
...
def _databricks_genie_agent_to_nested_bytes(databricks_genie_agent: DatabricksGenieAgent, serde: Serde) -> bytes:
...
def _databricks_genie_agent_from_nested_bytes(data: bytes, serde: Serde) -> DatabricksGenieAgent:
...
DatabricksGenieAgent.DATABRICKS_WORKSPACE_ID = KeywordField("databricksWorkspaceId", "databricksWorkspaceId")
DatabricksGenieAgent.DATABRICKS_WAREHOUSE_ID = KeywordField("databricksWarehouseId", "databricksWarehouseId")
DatabricksGenieAgent.DATABRICKS_PARENT_PATH = KeywordField("databricksParentPath", "databricksParentPath")
...
DatabricksGenieAgent.QUERY_COUNT_UPDATED_AT = NumericField("queryCountUpdatedAt", "queryCountUpdatedAt")
DatabricksGenieAgent.DATABASE_NAME = KeywordField("databaseName", "databaseName")
DatabricksGenieAgent.DATABASE_QUALIFIED_NAME = KeywordField("databaseQualifiedName", "databaseQualifiedName")
DatabricksGenieAgent.SCHEMA_NAME = KeywordField("schemaName", "schemaName")
DatabricksGenieAgent.SCHEMA_QUALIFIED_NAME = KeywordField("schemaQualifiedName", "schemaQualifiedName")
DatabricksGenieAgent.TABLE_NAME = KeywordField("tableName", "tableName")
DatabricksGenieAgent.TABLE_QUALIFIED_NAME = KeywordField("tableQualifiedName", "tableQualifiedName")
DatabricksGenieAgent.VIEW_NAME = KeywordField("viewName", "viewName")
DatabricksGenieAgent.VIEW_QUALIFIED_NAME = KeywordField("viewQualifiedName", "viewQualifiedName")
DatabricksGenieAgent.CALCULATION_VIEW_NAME = KeywordField("calculationViewName", "calculationViewName")
DatabricksGenieAgent.CALCULATION_VIEW_QUALIFIED_NAME = KeywordField("calculationViewQualifiedName", "calculationViewQualifiedName")
...
DatabricksGenieAgent.SQL_AI_MODEL_CONTEXT_QUALIFIED_NAME = KeywordField("sqlAIModelContextQualifiedName", "sqlAIModelContextQualifiedName")
DatabricksGenieAgent.SQL_IS_SECURE = BooleanField("sqlIsSecure", "sqlIsSecure")
DatabricksGenieAgent.SQL_HAS_AI_INSIGHTS = BooleanField("sqlHasAiInsights", "sqlHasAiInsights")
DatabricksGenieAgent.SQL_AI_INSIGHTS_LAST_ANALYZED_AT = NumericField("sqlAiInsightsLastAnalyzedAt", "sqlAiInsightsLastAnalyzedAt")
DatabricksGenieAgent.SQL_AI_INSIGHTS_POPULAR_BUSINESS_QUESTION_COUNT = NumericField("sqlAiInsightsPopularBusinessQuestionCount", "sqlAiInsightsPopularBusinessQuestionCount")
DatabricksGenieAgent.SQL_AI_INSIGHTS_POPULAR_JOIN_COUNT = NumericField("sqlAiInsightsPopularJoinCount", "sqlAiInsightsPopularJoinCount")
DatabricksGenieAgent.SQL_AI_INSIGHTS_POPULAR_FILTER_COUNT = NumericField("sqlAiInsightsPopularFilterCount", "sqlAiInsightsPopularFilterCount")
DatabricksGenieAgent.SQL_AI_INSIGHTS_RELATIONSHIP_COUNT = NumericField("sqlAiInsightsRelationshipCount", "sqlAiInsightsRelationshipCount")
DatabricksGenieAgent.SQL_COALESCE_LAST_RUN_STATUS = KeywordField("sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus")
DatabricksGenieAgent.SQL_COALESCE_NODE_STATUS = KeywordField("sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus")
DatabricksGenieAgent.SQL_COALESCE_LAST_RUN_AT = NumericField("sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt")
DatabricksGenieAgent.SQL_COALESCE_NODE_TYPE = KeywordField("sqlCoalesceNodeType", "sqlCoalesceNodeType")
DatabricksGenieAgent.SQL_COALESCE_ENVIRONMENT_ID = KeywordField("sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId")
DatabricksGenieAgent.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField("sqlCoalesceEnvironmentName", "sqlCoalesceEnvironmentName", "sqlCoalesceEnvironmentName.text")
DatabricksGenieAgent.SQL_COALESCE_PROJECT_ID = KeywordField("sqlCoalesceProjectId", "sqlCoalesceProjectId")
DatabricksGenieAgent.SQL_COALESCE_PROJECT_NAME = KeywordTextField("sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text")
DatabricksGenieAgent.SQL_SHARE_QUALIFIED_NAMES = KeywordField("sqlShareQualifiedNames", "sqlShareQualifiedNames")
DatabricksGenieAgent.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
DatabricksGenieAgent.AGENT_SYSTEM_PROMPT = TextField("agentSystemPrompt", "agentSystemPrompt")
DatabricksGenieAgent.AGENT_LLM_CONFIG = KeywordField("agentLlmConfig", "agentLlmConfig")
DatabricksGenieAgent.AGENT_MCP_SERVERS = KeywordField("agentMcpServers", "agentMcpServers")
DatabricksGenieAgent.AGENT_SCHEDULES = TextField("agentSchedules", "agentSchedules")
DatabricksGenieAgent.AGENT_SKILL_NAMES = KeywordField("agentSkillNames", "agentSkillNames")
DatabricksGenieAgent.AGENT_SKILL_QUALIFIED_NAMES = KeywordField("agentSkillQualifiedNames", "agentSkillQualifiedNames")
...
DatabricksGenieAgent.CONTEXT_SOURCE_REPOSITORY = RelationField("contextSourceRepository")
...
DatabricksGenieAgent.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
DatabricksGenieAgent.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
DatabricksGenieAgent.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
DatabricksGenieAgent.DQ_REFERENCE_DATASET_RULES = RelationField("dqReferenceDatasetRules")
...
DatabricksGenieAgent.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
...
DatabricksGenieAgent.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
...
DatabricksGenieAgent.SNOWFLAKE_SEMANTIC_LOGICAL_TABLES = RelationField("snowflakeSemanticLogicalTables")
...
DatabricksGenieAgent.SQL_INSIGHT_OUTGOING_JOINS = RelationField("sqlInsightOutgoingJoins")
DatabricksGenieAgent.SQL_INSIGHT_INCOMING_JOINS = RelationField("sqlInsightIncomingJoins")
DatabricksGenieAgent.SQL_INSIGHT_BUSINESS_QUESTIONS = RelationField("sqlInsightBusinessQuestions")