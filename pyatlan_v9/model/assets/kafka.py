...
def _kafka_from_nested(nested: KafkaNested) -> Kafka:
    ...
    kwargs.update(_extract_kafka_attrs(attrs))
...
Kafka.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
Kafka.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
Kafka.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
Kafka.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
Kafka.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Kafka.MEANINGS = RelationField("meanings")
Kafka.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
