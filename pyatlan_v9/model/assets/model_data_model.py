...
class ModelDataModelNested(AssetNested):
    ...
    append_relationship_attributes: ModelDataModelRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: ModelDataModelRelationshipAttributes | UnsetType = (
        UNSET
    )
