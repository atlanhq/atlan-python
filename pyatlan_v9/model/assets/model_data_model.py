...
def _model_data_model_from_nested(nested: ModelDataModelNested) -> ModelDataModel:
    ...
    kwargs.update(_extract_model_data_model_attrs(attrs))
    kwargs.update(merged_rels)
    return ModelDataModel(**kwargs)
...
ModelDataModel.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
ModelDataModel.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
