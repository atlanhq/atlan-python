...
def _mongo_db_collection_from_nested(
    ...
    kwargs.update(_extract_mongo_db_collection_attrs(attrs))
    kwargs.update(merged_rels)
    return MongoDBCollection(**kwargs)
...
MongoDBCollection.CATALOG_DATASET_GUID = KeywordField(
...
MongoDBCollection.SQL_HAS_AI_INSIGHTS = BooleanField(
    "sqlHasAiInsights", "sqlHasAiInsights"
)
MongoDBCollection.SQL_AI_INSIGHTS_LAST_ANALYZED_AT = NumericField(
    "sqlAiInsightsLastAnalyzedAt", "sqlAiInsightsLastAnalyzedAt"
)
MongoDBCollection.SQL_AI_INSIGHTS_POPULAR_BUSINESS_QUESTION_COUNT = NumericField(
    "sqlAiInsightsPopularBusinessQuestionCount",
    "sqlAiInsightsPopularBusinessQuestionCount",
)
MongoDBCollection.SQL_AI_INSIGHTS_POPULAR_JOIN_COUNT = NumericField(
    "sqlAiInsightsPopularJoinCount", "sqlAiInsightsPopularJoinCount"
)
MongoDBCollection.SQL_AI_INSIGHTS_POPULAR_FILTER_COUNT = NumericField(
    "sqlAiInsightsPopularFilterCount", "sqlAiInsightsPopularFilterCount"
)
MongoDBCollection.SQL_AI_INSIGHTS_RELATIONSHIP_COUNT = NumericField(
    "sqlAiInsightsRelationshipCount", "sqlAiInsightsRelationshipCount"
)
MongoDBCollection.SQL_COALESCE_LAST_RUN_STATUS = KeywordField(
    "sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus"
)
MongoDBCollection.SQL_COALESCE_NODE_STATUS = KeywordField(
    "sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus"
)
MongoDBCollection.SQL_COALESCE_LAST_RUN_AT = NumericField(
    "sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt"
)
MongoDBCollection.SQL_COALESCE_NODE_TYPE = KeywordField(
    "sqlCoalesceNodeType", "sqlCoalesceNodeType"
)
MongoDBCollection.SQL_COALESCE_ENVIRONMENT_ID = KeywordField(
    "sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId"
)
MongoDBCollection.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField(
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName.text",
)
MongoDBCollection.SQL_COALESCE_PROJECT_ID = KeywordField(
    "sqlCoalesceProjectId", "sqlCoalesceProjectId"
)
MongoDBCollection.SQL_COALESCE_PROJECT_NAME = KeywordTextField(
    "sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text"
)
MongoDBCollection.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
...
MongoDBCollection.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
MongoDBCollection.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
MongoDBCollection.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
MongoDBCollection.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
...
MongoDBCollection.SQL_INSIGHT_BUSINESS_QUESTIONS = RelationField(
