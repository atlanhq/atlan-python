...
def _sisense_datamodel_from_nested(nested: SisenseDatamodelNested) -> SisenseDatamodel:
    ...
    kwargs.update(_extract_sisense_datamodel_attrs(attrs))
    kwargs.update(merged_rels)
    return SisenseDatamodel(**kwargs)
...
SisenseDatamodel.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
