...
def _tag_from_nested(nested: TagNested) -> Tag:
    ...
    kwargs.update(_extract_tag_attrs(attrs))
...
Tag.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Tag.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
