...
def _snowflake_semantic_dimension_from_nested(
    ...
    kwargs.update(_extract_snowflake_semantic_dimension_attrs(attrs))
    kwargs.update(merged_rels)
    return SnowflakeSemanticDimension(**kwargs)
...
SnowflakeSemanticDimension.SQL_HAS_AI_INSIGHTS = BooleanField(
    "sqlHasAiInsights", "sqlHasAiInsights"
)
SnowflakeSemanticDimension.SQL_AI_INSIGHTS_LAST_ANALYZED_AT = NumericField(
    "sqlAiInsightsLastAnalyzedAt", "sqlAiInsightsLastAnalyzedAt"
)
SnowflakeSemanticDimension.SQL_AI_INSIGHTS_POPULAR_BUSINESS_QUESTION_COUNT = (
    NumericField(
        "sqlAiInsightsPopularBusinessQuestionCount",
        "sqlAiInsightsPopularBusinessQuestionCount",
    )
)
SnowflakeSemanticDimension.SQL_AI_INSIGHTS_POPULAR_JOIN_COUNT = NumericField(
    "sqlAiInsightsPopularJoinCount", "sqlAiInsightsPopularJoinCount"
)
SnowflakeSemanticDimension.SQL_AI_INSIGHTS_POPULAR_FILTER_COUNT = NumericField(
    "sqlAiInsightsPopularFilterCount", "sqlAiInsightsPopularFilterCount"
)
SnowflakeSemanticDimension.SQL_AI_INSIGHTS_RELATIONSHIP_COUNT = NumericField(
    "sqlAiInsightsRelationshipCount", "sqlAiInsightsRelationshipCount"
)
SnowflakeSemanticDimension.SQL_COALESCE_LAST_RUN_STATUS = KeywordField(
    "sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus"
)
SnowflakeSemanticDimension.SQL_COALESCE_NODE_STATUS = KeywordField(
    "sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus"
)
SnowflakeSemanticDimension.SQL_COALESCE_LAST_RUN_AT = NumericField(
    "sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt"
)
SnowflakeSemanticDimension.SQL_COALESCE_NODE_TYPE = KeywordField(
    "sqlCoalesceNodeType", "sqlCoalesceNodeType"
)
SnowflakeSemanticDimension.SQL_COALESCE_ENVIRONMENT_ID = KeywordField(
    "sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId"
)
SnowflakeSemanticDimension.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField(
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName.text",
)
SnowflakeSemanticDimension.SQL_COALESCE_PROJECT_ID = KeywordField(
    "sqlCoalesceProjectId", "sqlCoalesceProjectId"
)
SnowflakeSemanticDimension.SQL_COALESCE_PROJECT_NAME = KeywordTextField(
    "sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text"
)
SnowflakeSemanticDimension.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
    "sqlShareQualifiedNames", "sqlShareQualifiedNames"
)
SnowflakeSemanticDimension.CATALOG_DATASET_GUID = KeywordField(
...
SnowflakeSemanticDimension.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
SnowflakeSemanticDimension.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
SnowflakeSemanticDimension.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
SnowflakeSemanticDimension.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
SnowflakeSemanticDimension.MEANINGS = RelationField("meanings")
SnowflakeSemanticDimension.KNOWLEDGE_LINKED_FILES = RelationField(
...
SnowflakeSemanticDimension.SQL_INSIGHT_OUTGOING_JOINS = RelationField(
    "sqlInsightOutgoingJoins"
)
SnowflakeSemanticDimension.SQL_INSIGHT_INCOMING_JOINS = RelationField(
    "sqlInsightIncomingJoins"
)
SnowflakeSemanticDimension.SQL_INSIGHT_BUSINESS_QUESTIONS = RelationField(
