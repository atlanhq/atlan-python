...
def _process_from_nested(nested: ProcessNested) -> Process:
    ...
    kwargs.update(_extract_process_attrs(attrs))
...
Process.PROCESS_DERIVATION = KeywordField("processDerivation", "processDerivation")
...
Process.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
