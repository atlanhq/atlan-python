...
class DbtMetric(Asset):
    ...
    dbt_metric_filter_columns: list[RelatedColumn] | None | UnsetType = UNSET
...
class DbtMetricNested(AssetNested):
    ...
    attributes: DbtMetricAttributes | UnsetType = UNSET
    relationship_attributes: DbtMetricRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: DbtMetricRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: DbtMetricRelationshipAttributes | UnsetType = UNSET
