...
def _ai_model_version_from_nested(nested: AIModelVersionNested) -> AIModelVersion:
    ...
    kwargs.update(_extract_ai_model_version_attrs(attrs))
    kwargs.update(merged_rels)
    return AIModelVersion(**kwargs)
...
AIModelVersion.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
AIModelVersion.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
