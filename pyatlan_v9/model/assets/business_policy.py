...
def _business_policy_from_nested(nested: BusinessPolicyNested) -> BusinessPolicy:
    ...
    kwargs.update(_extract_business_policy_attrs(attrs))
    kwargs.update(merged_rels)
    return BusinessPolicy(**kwargs)
...
BusinessPolicy.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
BusinessPolicy.MEANINGS = RelationField("meanings")
BusinessPolicy.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
