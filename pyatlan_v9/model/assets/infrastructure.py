...
class Infrastructure(Referenceable):
    ...
    # Override type_name with Infrastructure-specific default
    ...
    def to_json(self, nested: bool = True, serde: Serde | None = None) -> str:
        ...
        if serde is None:
            serde = get_serde()
        if nested:
            return _infrastructure_to_nested_bytes(self, serde).decode("utf-8")
        else:
...
def _infrastructure_to_nested(infrastructure: Infrastructure) -> InfrastructureNested:
    ...
    attrs = InfrastructureAttributes(
        ...
        display_name=infrastructure.display_name,
        description=infrastructure.description,
        asset_source_readme=infrastructure.asset_source_readme,
        user_description=infrastructure.user_description,
        tenant_id=infrastructure.tenant_id,
        certificate_status=infrastructure.certificate_status,
        certificate_status_message=infrastructure.certificate_status_message,
        certificate_updated_by=infrastructure.certificate_updated_by,
        certificate_updated_at=infrastructure.certificate_updated_at,
        announcement_title=infrastructure.announcement_title,
        announcement_message=infrastructure.announcement_message,
        announcement_type=infrastructure.announcement_type,
        announcement_updated_at=infrastructure.announcement_updated_at,
        announcement_updated_by=infrastructure.announcement_updated_by,
        owner_users=infrastructure.owner_users,
        owner_groups=infrastructure.owner_groups,
        admin_users=infrastructure.admin_users,
        admin_groups=infrastructure.admin_groups,
        viewer_users=infrastructure.viewer_users,
        viewer_groups=infrastructure.viewer_groups,
        connector_name=infrastructure.connector_name,
        connection_name=infrastructure.connection_name,
        connection_qualified_name=infrastructure.connection_qualified_name,
        has_lineage=infrastructure.has_lineage,
        is_discoverable=infrastructure.is_discoverable,
        is_editable=infrastructure.is_editable,
        sub_type=infrastructure.sub_type,
        view_score=infrastructure.view_score,
        popularity_score=infrastructure.popularity_score,
        source_owners=infrastructure.source_owners,
        asset_source_id=infrastructure.asset_source_id,
        source_created_by=infrastructure.source_created_by,
        source_created_at=infrastructure.source_created_at,
        source_updated_at=infrastructure.source_updated_at,
        source_updated_by=infrastructure.source_updated_by,
        source_url=infrastructure.source_url,
        source_embed_url=infrastructure.source_embed_url,
        last_sync_workflow_name=infrastructure.last_sync_workflow_name,
        last_sync_run_at=infrastructure.last_sync_run_at,
        last_sync_run=infrastructure.last_sync_run,
        admin_roles=infrastructure.admin_roles,
        source_read_count=infrastructure.source_read_count,
        source_read_user_count=infrastructure.source_read_user_count,
        source_last_read_at=infrastructure.source_last_read_at,
        last_row_changed_at=infrastructure.last_row_changed_at,
        source_total_cost=infrastructure.source_total_cost,
        source_cost_unit=infrastructure.source_cost_unit,
        source_read_query_cost=infrastructure.source_read_query_cost,
        source_read_recent_user_list=infrastructure.source_read_recent_user_list,
        source_read_recent_user_record_list=infrastructure.source_read_recent_user_record_list,
        source_read_top_user_list=infrastructure.source_read_top_user_list,
        source_read_top_user_record_list=infrastructure.source_read_top_user_record_list,
        source_read_popular_query_record_list=infrastructure.source_read_popular_query_record_list,
        source_read_expensive_query_record_list=infrastructure.source_read_expensive_query_record_list,
        source_read_slow_query_record_list=infrastructure.source_read_slow_query_record_list,
        source_query_compute_cost_list=infrastructure.source_query_compute_cost_list,
        source_query_compute_cost_record_list=infrastructure.source_query_compute_cost_record_list,
        dbt_qualified_name=infrastructure.dbt_qualified_name,
        asset_dbt_workflow_last_updated=infrastructure.asset_dbt_workflow_last_updated,
        asset_dbt_alias=infrastructure.asset_dbt_alias,
        asset_dbt_meta=infrastructure.asset_dbt_meta,
        asset_dbt_unique_id=infrastructure.asset_dbt_unique_id,
        asset_dbt_account_name=infrastructure.asset_dbt_account_name,
        asset_dbt_project_name=infrastructure.asset_dbt_project_name,
        asset_dbt_package_name=infrastructure.asset_dbt_package_name,
        asset_dbt_job_name=infrastructure.asset_dbt_job_name,
        asset_dbt_job_schedule=infrastructure.asset_dbt_job_schedule,
        asset_dbt_job_status=infrastructure.asset_dbt_job_status,
        asset_dbt_test_status=infrastructure.asset_dbt_test_status,
        asset_dbt_job_schedule_cron_humanized=infrastructure.asset_dbt_job_schedule_cron_humanized,
        asset_dbt_job_last_run=infrastructure.asset_dbt_job_last_run,
        asset_dbt_job_last_run_url=infrastructure.asset_dbt_job_last_run_url,
        asset_dbt_job_last_run_created_at=infrastructure.asset_dbt_job_last_run_created_at,
        asset_dbt_job_last_run_updated_at=infrastructure.asset_dbt_job_last_run_updated_at,
        asset_dbt_job_last_run_dequed_at=infrastructure.asset_dbt_job_last_run_dequed_at,
        asset_dbt_job_last_run_started_at=infrastructure.asset_dbt_job_last_run_started_at,
        asset_dbt_job_last_run_total_duration=infrastructure.asset_dbt_job_last_run_total_duration,
        asset_dbt_job_last_run_total_duration_humanized=infrastructure.asset_dbt_job_last_run_total_duration_humanized,
        asset_dbt_job_last_run_queued_duration=infrastructure.asset_dbt_job_last_run_queued_duration,
        asset_dbt_job_last_run_queued_duration_humanized=infrastructure.asset_dbt_job_last_run_queued_duration_humanized,
        asset_dbt_job_last_run_run_duration=infrastructure.asset_dbt_job_last_run_run_duration,
        asset_dbt_job_last_run_run_duration_humanized=infrastructure.asset_dbt_job_last_run_run_duration_humanized,
        asset_dbt_job_last_run_git_branch=infrastructure.asset_dbt_job_last_run_git_branch,
        asset_dbt_job_last_run_git_sha=infrastructure.asset_dbt_job_last_run_git_sha,
        asset_dbt_job_last_run_status_message=infrastructure.asset_dbt_job_last_run_status_message,
        asset_dbt_job_last_run_owner_thread_id=infrastructure.asset_dbt_job_last_run_owner_thread_id,
        asset_dbt_job_last_run_executed_by_thread_id=infrastructure.asset_dbt_job_last_run_executed_by_thread_id,
        asset_dbt_job_last_run_artifacts_saved=infrastructure.asset_dbt_job_last_run_artifacts_saved,
        asset_dbt_job_last_run_artifact_s3_path=infrastructure.asset_dbt_job_last_run_artifact_s3_path,
        asset_dbt_job_last_run_has_docs_generated=infrastructure.asset_dbt_job_last_run_has_docs_generated,
        asset_dbt_job_last_run_has_sources_generated=infrastructure.asset_dbt_job_last_run_has_sources_generated,
        asset_dbt_job_last_run_notifications_sent=infrastructure.asset_dbt_job_last_run_notifications_sent,
        asset_dbt_job_next_run=infrastructure.asset_dbt_job_next_run,
        asset_dbt_job_next_run_humanized=infrastructure.asset_dbt_job_next_run_humanized,
        asset_dbt_environment_name=infrastructure.asset_dbt_environment_name,
        asset_dbt_environment_dbt_version=infrastructure.asset_dbt_environment_dbt_version,
        asset_dbt_tags=infrastructure.asset_dbt_tags,
        asset_dbt_semantic_layer_proxy_url=infrastructure.asset_dbt_semantic_layer_proxy_url,
        asset_dbt_source_freshness_criteria=infrastructure.asset_dbt_source_freshness_criteria,
        sample_data_url=infrastructure.sample_data_url,
        asset_tags=infrastructure.asset_tags,
        asset_mc_incident_names=infrastructure.asset_mc_incident_names,
        asset_mc_incident_qualified_names=infrastructure.asset_mc_incident_qualified_names,
        asset_mc_alert_qualified_names=infrastructure.asset_mc_alert_qualified_names,
        asset_mc_monitor_names=infrastructure.asset_mc_monitor_names,
        asset_mc_monitor_qualified_names=infrastructure.asset_mc_monitor_qualified_names,
        asset_mc_monitor_statuses=infrastructure.asset_mc_monitor_statuses,
        asset_mc_monitor_types=infrastructure.asset_mc_monitor_types,
        asset_mc_monitor_schedule_types=infrastructure.asset_mc_monitor_schedule_types,
        asset_mc_incident_types=infrastructure.asset_mc_incident_types,
        asset_mc_incident_sub_types=infrastructure.asset_mc_incident_sub_types,
        asset_mc_incident_severities=infrastructure.asset_mc_incident_severities,
        asset_mc_incident_priorities=infrastructure.asset_mc_incident_priorities,
        asset_mc_incident_states=infrastructure.asset_mc_incident_states,
        asset_mc_is_monitored=infrastructure.asset_mc_is_monitored,
        asset_mc_last_sync_run_at=infrastructure.asset_mc_last_sync_run_at,
        starred_by=infrastructure.starred_by,
        starred_details_list=infrastructure.starred_details_list,
        starred_count=infrastructure.starred_count,
        asset_anomalo_dq_status=infrastructure.asset_anomalo_dq_status,
        asset_anomalo_check_count=infrastructure.asset_anomalo_check_count,
        asset_anomalo_failed_check_count=infrastructure.asset_anomalo_failed_check_count,
        asset_anomalo_check_statuses=infrastructure.asset_anomalo_check_statuses,
        asset_anomalo_last_check_run_at=infrastructure.asset_anomalo_last_check_run_at,
        asset_anomalo_applied_check_types=infrastructure.asset_anomalo_applied_check_types,
        asset_anomalo_failed_check_types=infrastructure.asset_anomalo_failed_check_types,
        asset_anomalo_source_url=infrastructure.asset_anomalo_source_url,
        asset_soda_dq_status=infrastructure.asset_soda_dq_status,
        asset_soda_check_count=infrastructure.asset_soda_check_count,
        asset_soda_last_sync_run_at=infrastructure.asset_soda_last_sync_run_at,
        asset_soda_last_scan_at=infrastructure.asset_soda_last_scan_at,
        asset_soda_check_statuses=infrastructure.asset_soda_check_statuses,
        asset_soda_source_url=infrastructure.asset_soda_source_url,
        asset_icon=infrastructure.asset_icon,
        asset_external_dq_metadata_details=infrastructure.asset_external_dq_metadata_details,
        is_partial=infrastructure.is_partial,
        is_ai_generated=infrastructure.is_ai_generated,
        asset_cover_image=infrastructure.asset_cover_image,
        asset_theme_hex=infrastructure.asset_theme_hex,
        lexicographical_sort_order=infrastructure.lexicographical_sort_order,
        has_contract=infrastructure.has_contract,
        asset_redirect_gui_ds=infrastructure.asset_redirect_gui_ds,
        asset_policy_gui_ds=infrastructure.asset_policy_gui_ds,
        asset_policies_count=infrastructure.asset_policies_count,
        domain_gui_ds=infrastructure.domain_gui_ds,
        non_compliant_asset_policy_gui_ds=infrastructure.non_compliant_asset_policy_gui_ds,
        product_gui_ds=infrastructure.product_gui_ds,
        output_product_gui_ds=infrastructure.output_product_gui_ds,
        application_qualified_name=infrastructure.application_qualified_name,
        application_field_qualified_name=infrastructure.application_field_qualified_name,
        asset_user_defined_type=infrastructure.asset_user_defined_type,
        asset_internal_popularity_score=infrastructure.asset_internal_popularity_score,
        asset_dq_schedule_type=infrastructure.asset_dq_schedule_type,
        asset_dq_schedule_crontab=infrastructure.asset_dq_schedule_crontab,
        asset_dq_schedule_time_zone=infrastructure.asset_dq_schedule_time_zone,
        asset_dq_schedule_source_sync_status=infrastructure.asset_dq_schedule_source_sync_status,
        asset_dq_schedule_source_synced_at=infrastructure.asset_dq_schedule_source_synced_at,
        asset_dq_schedule_source_sync_error_message=infrastructure.asset_dq_schedule_source_sync_error_message,
        asset_dq_schedule_source_sync_error_code=infrastructure.asset_dq_schedule_source_sync_error_code,
        asset_dq_schedule_source_sync_raw_error=infrastructure.asset_dq_schedule_source_sync_raw_error,
        asset_dq_rule_attached_dimensions=infrastructure.asset_dq_rule_attached_dimensions,
        asset_dq_rule_failed_dimensions=infrastructure.asset_dq_rule_failed_dimensions,
        asset_dq_rule_passed_dimensions=infrastructure.asset_dq_rule_passed_dimensions,
        asset_dq_rule_attached_rule_types=infrastructure.asset_dq_rule_attached_rule_types,
        asset_dq_rule_failed_rule_types=infrastructure.asset_dq_rule_failed_rule_types,
        asset_dq_rule_passed_rule_types=infrastructure.asset_dq_rule_passed_rule_types,
        asset_dq_rule_result_tags=infrastructure.asset_dq_rule_result_tags,
        asset_dq_rule_last_run_at=infrastructure.asset_dq_rule_last_run_at,
        asset_dq_rule_total_count=infrastructure.asset_dq_rule_total_count,
        asset_dq_rule_failed_count=infrastructure.asset_dq_rule_failed_count,
        asset_dq_rule_passed_count=infrastructure.asset_dq_rule_passed_count,
        asset_dq_result=infrastructure.asset_dq_result,
        asset_dq_freshness_value=infrastructure.asset_dq_freshness_value,
        asset_dq_freshness_expectation=infrastructure.asset_dq_freshness_expectation,
        asset_dq_row_scope_filter_column_qualified_name=infrastructure.asset_dq_row_scope_filter_column_qualified_name,
        asset_space_qualified_name=infrastructure.asset_space_qualified_name,
        asset_space_name=infrastructure.asset_space_name,
        asset_smus_metadata_form_names=infrastructure.asset_smus_metadata_form_names,
        asset_smus_metadata_form_key_value_details=infrastructure.asset_smus_metadata_form_key_value_details,
        asset_smus_metadata_form_details=infrastructure.asset_smus_metadata_form_details,
    )
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    rel_fields: list[str] = []
    replace_rels, append_rels, remove_rels = categorize_relationships(
        infrastructure, rel_fields, InfrastructureRelationshipAttributes
    )
