...
def _infrastructure_from_nested(nested: InfrastructureNested) -> Infrastructure:
    ...
    kwargs.update(_extract_infrastructure_attrs(attrs))
...
Infrastructure.ASSET_MANAGED_BY = KeywordField("assetManagedBy", "assetManagedBy")
...
Infrastructure.ASSET_SUMMARY_PROVIDER = KeywordField(
    "assetSummaryProvider", "assetSummaryProvider"
)
Infrastructure.ASSET_SUMMARY = KeywordField("assetSummary", "assetSummary")
Infrastructure.ASSET_SUMMARY_FILTER_TOKENS = KeywordTextField(
...
Infrastructure.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
