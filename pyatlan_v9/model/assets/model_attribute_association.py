...
def _model_attribute_association_from_nested(
    ...
    kwargs.update(_extract_model_attribute_association_attrs(attrs))
    kwargs.update(merged_rels)
    return ModelAttributeAssociation(**kwargs)
...
ModelAttributeAssociation.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
