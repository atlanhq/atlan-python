...
class CogniteTimeSeriesNested(AssetNested):
    ...
    attributes: CogniteTimeSeriesAttributes | UnsetType = UNSET
    relationship_attributes: CogniteTimeSeriesRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: CogniteTimeSeriesRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: CogniteTimeSeriesRelationshipAttributes | UnsetType = UNSET

# =============================================================================
# CONVERSION HELPERS & CONSTANTS
# =============================================================================

_COGNITE_TIME_SERIES_REL_FIELDS: list[str] = [
    *_ASSET_REL_FIELDS,
...
CogniteTimeSeries.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
CogniteTimeSeries.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
CogniteTimeSeries.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
CogniteTimeSeries.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
CogniteTimeSeries.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
CogniteTimeSeries.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
CogniteTimeSeries.FILES = RelationField("files")
CogniteTimeSeries.LINKS = RelationField("links")
CogniteTimeSeries.README = RelationField("readme")
CogniteTimeSeries.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
CogniteTimeSeries.SODA_CHECKS = RelationField("sodaChecks")
CogniteTimeSeries.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
CogniteTimeSeries.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")