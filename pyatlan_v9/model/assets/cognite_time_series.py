...
def _cognite_time_series_from_nested(
    ...
    kwargs.update(_extract_cognite_time_series_attrs(attrs))
    kwargs.update(merged_rels)
    return CogniteTimeSeries(**kwargs)
...
CogniteTimeSeries.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
