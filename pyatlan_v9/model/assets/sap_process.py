...
class SAPProcessNested(AssetNested):
    ...
    append_relationship_attributes: Union[
        SAPProcessRelationshipAttributes, UnsetType
    ] = UNSET
...
def _sap_process_from_nested(nested: SAPProcessNested) -> SAPProcess:
    ...
    attrs = (
        nested.attributes if nested.attributes is not UNSET else SAPProcessAttributes()
    )
    ...
    kwargs.update(_extract_sap_process_attrs(attrs))
    kwargs.update(merged_rels)
    return SAPProcess(**kwargs)
...
SAPProcess.BIGQUERY_ROUTINES = RelationField("bigqueryRoutines")
...
SAPProcess.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
SAPProcess.MEANINGS = RelationField("meanings")
SAPProcess.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
