...
def _cognos_datasource_from_nested(nested: CognosDatasourceNested) -> CognosDatasource:
    ...
    kwargs.update(_extract_cognos_datasource_attrs(attrs))
    kwargs.update(merged_rels)
    return CognosDatasource(**kwargs)
...
CognosDatasource.CATALOG_DATASET_GUID = KeywordField(
...
CognosDatasource.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
