...
class CognosDatasetNested(AssetNested):
    ...
    append_relationship_attributes: CognosDatasetRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: CognosDatasetRelationshipAttributes | UnsetType = (
        UNSET
    )
