...
def _cognos_dataset_from_nested(nested: CognosDatasetNested) -> CognosDataset:
    ...
    kwargs.update(_extract_cognos_dataset_attrs(attrs))
    kwargs.update(merged_rels)
    return CognosDataset(**kwargs)
...
CognosDataset.CATALOG_DATASET_GUID = KeywordField(
...
CognosDataset.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
CognosDataset.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
CognosDataset.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
CognosDataset.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
