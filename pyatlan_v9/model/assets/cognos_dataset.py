...
from .cognos_related import RelatedCognosColumn, RelatedCognosDataset, RelatedCognosFolder
...
class CognosDatasetNested(AssetNested):
    ...
    attributes: CognosDatasetAttributes | UnsetType = UNSET
    relationship_attributes: CognosDatasetRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: CognosDatasetRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: CognosDatasetRelationshipAttributes | UnsetType = UNSET
