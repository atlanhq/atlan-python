...
class Salesforce(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Salesforce instance.
    ...
    def minimize(self) -> "Salesforce":
        """
        Return a minimal copy of this Salesforce with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Salesforce with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Salesforce instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedSalesforce":
        """
        Create a :class:`RelatedSalesforce` reference from this instance.
        ...
        Returns:
            A RelatedSalesforce reference to this asset.
        """
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _salesforce_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> Salesforce:
        """
...
_SALESFORCE_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
def _salesforce_to_nested(salesforce: Salesforce) -> SalesforceNested:
    ...
    _populate_salesforce_attrs(attrs, salesforce)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        salesforce, _SALESFORCE_REL_FIELDS, SalesforceRelationshipAttributes
    )
...
def _salesforce_from_nested(nested: SalesforceNested) -> Salesforce:
    ...
    kwargs.update(_extract_salesforce_attrs(attrs))
...
Salesforce.APPLICATION = RelationField("application")
Salesforce.APPLICATION_FIELD = RelationField("applicationField")
Salesforce.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
Salesforce.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
Salesforce.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
Salesforce.OUTPUT_PORT_DATA_PRODUCTS = RelationField("outputPortDataProducts")
Salesforce.INPUT_PORT_DATA_PRODUCTS = RelationField("inputPortDataProducts")
Salesforce.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
Salesforce.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
Salesforce.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
Salesforce.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
Salesforce.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
Salesforce.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
Salesforce.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
Salesforce.FILES = RelationField("files")
Salesforce.LINKS = RelationField("links")
Salesforce.README = RelationField("readme")
Salesforce.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
Salesforce.SODA_CHECKS = RelationField("sodaChecks")
Salesforce.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
Salesforce.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
