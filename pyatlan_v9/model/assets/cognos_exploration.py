...
def _cognos_exploration_from_nested(
    ...
    kwargs.update(_extract_cognos_exploration_attrs(attrs))
    kwargs.update(merged_rels)
    return CognosExploration(**kwargs)
...
CognosExploration.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
CognosExploration.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
