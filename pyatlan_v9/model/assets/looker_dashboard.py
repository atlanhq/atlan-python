...
class LookerDashboard(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this LookerDashboard instance.
    ...
    def minimize(self) -> "LookerDashboard":
        """
        Return a minimal copy of this LookerDashboard with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new LookerDashboard with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new LookerDashboard instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedLookerDashboard":
        """
        Create a :class:`RelatedLookerDashboard` reference from this instance.
        ...
        Returns:
            A RelatedLookerDashboard reference to this asset.
        """
...
def _looker_dashboard_from_nested(nested: LookerDashboardNested) -> LookerDashboard:
    ...
    kwargs.update(_extract_looker_dashboard_attrs(attrs))
    kwargs.update(merged_rels)
    return LookerDashboard(**kwargs)
...
LookerDashboard.CATALOG_DATASET_GUID = KeywordField(
...
LookerDashboard.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
LookerDashboard.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
LookerDashboard.MEANINGS = RelationField("meanings")
LookerDashboard.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
