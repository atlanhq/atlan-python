...
def _azure_service_bus_schema_from_nested(
    ...
    kwargs.update(_extract_azure_service_bus_schema_attrs(attrs))
    kwargs.update(merged_rels)
    return AzureServiceBusSchema(**kwargs)
...
AzureServiceBusSchema.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
