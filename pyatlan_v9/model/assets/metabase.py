...
class Metabase(Asset):
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _metabase_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> Metabase:
        """
...
def _metabase_to_nested(metabase: Metabase) -> MetabaseNested:
    ...
    _populate_metabase_attrs(attrs, metabase)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        metabase, _METABASE_REL_FIELDS, MetabaseRelationshipAttributes
    )
...
def _metabase_from_nested(nested: MetabaseNested) -> Metabase:
    ...
    kwargs.update(_extract_metabase_attrs(attrs))
    kwargs.update(merged_rels)
    return Metabase(**kwargs)
...
Metabase.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Metabase.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
Metabase.METRICS = RelationField("metrics")
Metabase.DQ_BASE_DATASET_RULES = RelationField("dqBaseDatasetRules")
Metabase.DQ_REFERENCE_DATASET_RULES = RelationField("dqReferenceDatasetRules")
Metabase.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Metabase.MEANINGS = RelationField("meanings")
Metabase.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
Metabase.MC_MONITORS = RelationField("mcMonitors")
Metabase.MC_INCIDENTS = RelationField("mcIncidents")
Metabase.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
Metabase.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
Metabase.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
Metabase.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
Metabase.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
Metabase.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
Metabase.FILES = RelationField("files")
Metabase.LINKS = RelationField("links")
Metabase.README = RelationField("readme")
Metabase.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
Metabase.SODA_CHECKS = RelationField("sodaChecks")
Metabase.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
Metabase.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
