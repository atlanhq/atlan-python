...
def _dbt_source_from_nested(nested: DbtSourceNested) -> DbtSource:
    ...
    kwargs.update(_extract_dbt_source_attrs(attrs))
    kwargs.update(merged_rels)
    return DbtSource(**kwargs)
...
DbtSource.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
DbtSource.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
DbtSource.MEANINGS = RelationField("meanings")
DbtSource.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
