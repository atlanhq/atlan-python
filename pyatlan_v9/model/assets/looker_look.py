...
from .looker_related import RelatedLookerDashboard, RelatedLookerField, RelatedLookerFolder, RelatedLookerModel, RelatedLookerQuery, RelatedLookerTile
...
class LookerLookNested(AssetNested):
    ...
    append_relationship_attributes: Union[LookerLookRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[LookerLookRelationshipAttributes, UnsetType] = UNSET
...
LookerLook.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
LookerLook.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
