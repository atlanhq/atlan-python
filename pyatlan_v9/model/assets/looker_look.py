...
class LookerLook(Asset):
    ...
    folder: RelatedLookerFolder | None | UnsetType = UNSET
    """Folder in which this Look exists."""

    dashboard: RelatedLookerDashboard | None | UnsetType = UNSET
    """Dashboard in which this Look is used."""

    model: RelatedLookerModel | None | UnsetType = UNSET
    """Model in which this Look exists."""

    tile: RelatedLookerTile | None | UnsetType = UNSET
    """Tiles that exist within this Look."""

    query: RelatedLookerQuery | None | UnsetType = UNSET
    """Deprecated."""
...
class LookerLookNested(AssetNested):
    ...
    attributes: LookerLookAttributes | UnsetType = UNSET
