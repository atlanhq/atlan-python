...
def _tableau_worksheet_from_nested(nested: TableauWorksheetNested) -> TableauWorksheet:
    ...
    kwargs.update(_extract_tableau_worksheet_attrs(attrs))
    kwargs.update(merged_rels)
    return TableauWorksheet(**kwargs)
...
TableauWorksheet.TABLEAU_SOURCE_READ_COUNTS = KeywordField(
...
TableauWorksheet.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
TableauWorksheet.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
