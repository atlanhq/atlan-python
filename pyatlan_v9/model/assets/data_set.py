...
class DataSet(Referenceable):
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _data_set_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> DataSet:
        """
...
class DataSetNested(ReferenceableNested):
    ...
    attributes: DataSetAttributes | UnsetType = UNSET
    relationship_attributes: DataSetRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: DataSetRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: DataSetRelationshipAttributes | UnsetType = UNSET

# =============================================================================
# CONVERSION HELPERS & CONSTANTS
# =============================================================================

_DATA_SET_REL_FIELDS: list[str] = [
    *_REFERENCEABLE_REL_FIELDS,
    "anomalo_checks",
    "application",
    "application_field",
...
def _data_set_to_nested(data_set: DataSet) -> DataSetNested:
    ...
    _populate_data_set_attrs(attrs, data_set)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        data_set, _DATA_SET_REL_FIELDS, DataSetRelationshipAttributes
    )
...
DataSet.ADMIN_GROUPS = KeywordField("adminGroups", "adminGroups")
...
DataSet.SUB_TYPE = KeywordField("subType", "subType")
DataSet.VIEW_SCORE = NumericField("viewScore", "viewScore")
DataSet.POPULARITY_SCORE = NumericField("popularityScore", "popularityScore")
DataSet.SOURCE_OWNERS = KeywordField("sourceOwners", "sourceOwners")
DataSet.ASSET_SOURCE_ID = KeywordField("assetSourceId", "assetSourceId")
DataSet.SOURCE_CREATED_BY = KeywordField("sourceCreatedBy", "sourceCreatedBy")
DataSet.SOURCE_CREATED_AT = NumericField("sourceCreatedAt", "sourceCreatedAt")
DataSet.SOURCE_UPDATED_AT = NumericField("sourceUpdatedAt", "sourceUpdatedAt")
...
DataSet.INPUT_PORT_DATA_PRODUCTS = RelationField("inputPortDataProducts")
DataSet.METRICS = RelationField("metrics")
DataSet.DQ_BASE_DATASET_RULES = RelationField("dqBaseDatasetRules")
DataSet.DQ_REFERENCE_DATASET_RULES = RelationField("dqReferenceDatasetRules")
...
DataSet.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
DataSet.FILES = RelationField("files")
DataSet.LINKS = RelationField("links")
DataSet.README = RelationField("readme")
DataSet.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
DataSet.SODA_CHECKS = RelationField("sodaChecks")