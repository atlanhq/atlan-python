...
DataSet.ASSET_MANAGED_BY = KeywordField("assetManagedBy", "assetManagedBy")
...
DataSet.ASSET_EXTERNAL_DQ_TEST_ENTITIES = KeywordField(
    "assetExternalDQTestEntities", "assetExternalDQTestEntities"
)
DataSet.ASSET_EXTERNAL_DQ_TEST_LATEST_SCORES = NumericField(
    "assetExternalDQTestLatestScores", "assetExternalDQTestLatestScores"
)
DataSet.ASSET_EXTERNAL_DQ_TEST_AVG_SCORES = NumericField(
    "assetExternalDQTestAvgScores", "assetExternalDQTestAvgScores"
)
DataSet.ASSET_EXTERNAL_DQ_TEST_MIN_SCORES = NumericField(
...
DataSet.ASSET_IMMUTA_REQUEST_URL = KeywordField(
    "assetImmutaRequestUrl", "assetImmutaRequestUrl"
)
DataSet.ASSET_IMMUTA_REQUEST_TYPE = KeywordField(
...
DataSet.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
