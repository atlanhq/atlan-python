...
def _adf_activity_from_nested(nested: AdfActivityNested) -> AdfActivity:
    ...
    kwargs.update(_extract_adf_activity_attrs(attrs))
    kwargs.update(merged_rels)
    return AdfActivity(**kwargs)
...
AdfActivity.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
AdfActivity.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
