...
def _looker_from_nested(nested: LookerNested) -> Looker:
    ...
    kwargs.update(_extract_looker_attrs(attrs))
...
Looker.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Looker.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Looker.MEANINGS = RelationField("meanings")
Looker.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
