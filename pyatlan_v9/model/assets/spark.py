...
class Spark(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Spark instance.
    ...
    def minimize(self) -> "Spark":
        """
        Return a minimal copy of this Spark with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Spark with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Spark instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedSpark":
        """
        Create a :class:`RelatedSpark` reference from this instance.
        ...
        Returns:
            A RelatedSpark reference to this asset.
        """
...
def _spark_from_nested(nested: SparkNested) -> Spark:
    ...
    kwargs.update(_extract_spark_attrs(attrs))
...
Spark.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
