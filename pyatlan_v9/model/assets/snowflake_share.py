...
"""
SnowflakeShare asset model with flattened inheritance.

This module provides:
- SnowflakeShare: Flat asset class (easy to use)
- SnowflakeShareAttributes: Nested attributes struct (extends AssetAttributes)
- SnowflakeShareNested: Nested API format struct
"""
...
from .snowflake_related import RelatedSnowflakeListing, RelatedSnowflakeSemanticLogicalTable
...
class SnowflakeShare(Asset):
    ...
    SNOWFLAKE_LISTING: ClassVar[Any] = None
    ...
    snowflake_listing: Union[RelatedSnowflakeListing, None, UnsetType] = UNSET
    """Snowflake listing this share is published under."""
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _snowflake_share_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> SnowflakeShare:
        """
        ...
        Returns:
            SnowflakeShare instance
        """
        if isinstance(json_data, str):
            json_data = json_data.encode("utf-8")
        if serde is None:
            serde = get_serde()
        return _snowflake_share_from_nested_bytes(json_data, serde)
...
class SnowflakeShareRelationshipAttributes(AssetRelationshipAttributes):
    """SnowflakeShare-specific relationship attributes for nested API format."""
...
class SnowflakeShareNested(AssetNested):
    """SnowflakeShare in nested API format for high-performance serialization."""

    attributes: Union[SnowflakeShareAttributes, UnsetType] = UNSET
    relationship_attributes: Union[SnowflakeShareRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[SnowflakeShareRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[SnowflakeShareRelationshipAttributes, UnsetType] = UNSET

# =============================================================================
# CONVERSION HELPERS & CONSTANTS
# =============================================================================

_SNOWFLAKE_SHARE_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
def _populate_snowflake_share_attrs(attrs: SnowflakeShareAttributes, obj: SnowflakeShare) -> None:
...
def _snowflake_share_to_nested(snowflake_share: SnowflakeShare) -> SnowflakeShareNested:
    """Convert flat SnowflakeShare to nested format."""
    attrs = SnowflakeShareAttributes()
    _populate_snowflake_share_attrs(attrs, snowflake_share)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        snowflake_share, _SNOWFLAKE_SHARE_REL_FIELDS, SnowflakeShareRelationshipAttributes
    )
    return SnowflakeShareNested(
        guid=snowflake_share.guid,
        type_name=snowflake_share.type_name,
        status=snowflake_share.status,
        version=snowflake_share.version,
        create_time=snowflake_share.create_time,
        update_time=snowflake_share.update_time,
        created_by=snowflake_share.created_by,
        updated_by=snowflake_share.updated_by,
        classifications=snowflake_share.classifications,
        classification_names=snowflake_share.classification_names,
        meanings=snowflake_share.meanings,
        labels=snowflake_share.labels,
        business_attributes=snowflake_share.business_attributes,
        custom_attributes=snowflake_share.custom_attributes,
        pending_tasks=snowflake_share.pending_tasks,
        proxy=snowflake_share.proxy,
...
def _snowflake_share_from_nested(nested: SnowflakeShareNested) -> SnowflakeShare:
    """Convert nested format to flat SnowflakeShare."""
    attrs = nested.attributes if nested.attributes is not UNSET else SnowflakeShareAttributes()
    # Merge relationships from all three buckets
    merged_rels = merge_relationships(
        nested.relationship_attributes,
        nested.append_relationship_attributes,
        nested.remove_relationship_attributes,
        _SNOWFLAKE_SHARE_REL_FIELDS,
        SnowflakeShareRelationshipAttributes
    )
    return SnowflakeShare(
        guid=nested.guid,
...
def _snowflake_share_to_nested_bytes(snowflake_share: SnowflakeShare, serde: Serde) -> bytes:
    """Convert flat SnowflakeShare to nested JSON bytes."""
    return serde.encode(_snowflake_share_to_nested(snowflake_share))


def _snowflake_share_from_nested_bytes(data: bytes, serde: Serde) -> SnowflakeShare:
    """Convert nested JSON bytes to flat SnowflakeShare."""
    nested = serde.decode(data, SnowflakeShareNested)
    return _snowflake_share_from_nested(nested)
...
SnowflakeShare.SNOWFLAKE_OWNER_ACCOUNT = KeywordField("snowflakeOwnerAccount", "snowflakeOwnerAccount")
SnowflakeShare.SNOWFLAKE_TARGET_ACCOUNTS = KeywordField("snowflakeTargetAccounts", "snowflakeTargetAccounts")
SnowflakeShare.SNOWFLAKE_LISTING_GLOBAL_NAME = KeywordField("snowflakeListingGlobalName", "snowflakeListingGlobalName")
SnowflakeShare.SNOWFLAKE_SECURE_OBJECT = BooleanField("snowflakeSecureObject", "snowflakeSecureObject")
...
SnowflakeShare.QUERY_USER_MAP = KeywordField("queryUserMap", "queryUserMap")
SnowflakeShare.QUERY_COUNT_UPDATED_AT = NumericField("queryCountUpdatedAt", "queryCountUpdatedAt")
SnowflakeShare.DATABASE_NAME = KeywordField("databaseName", "databaseName")
SnowflakeShare.DATABASE_QUALIFIED_NAME = KeywordField("databaseQualifiedName", "databaseQualifiedName")
SnowflakeShare.SCHEMA_NAME = KeywordField("schemaName", "schemaName")
SnowflakeShare.SCHEMA_QUALIFIED_NAME = KeywordField("schemaQualifiedName", "schemaQualifiedName")
SnowflakeShare.TABLE_NAME = KeywordField("tableName", "tableName")
SnowflakeShare.TABLE_QUALIFIED_NAME = KeywordField("tableQualifiedName", "tableQualifiedName")
SnowflakeShare.VIEW_NAME = KeywordField("viewName", "viewName")
SnowflakeShare.VIEW_QUALIFIED_NAME = KeywordField("viewQualifiedName", "viewQualifiedName")
SnowflakeShare.CALCULATION_VIEW_NAME = KeywordField("calculationViewName", "calculationViewName")
SnowflakeShare.CALCULATION_VIEW_QUALIFIED_NAME = KeywordField("calculationViewQualifiedName", "calculationViewQualifiedName")
SnowflakeShare.IS_PROFILED = BooleanField("isProfiled", "isProfiled")
SnowflakeShare.LAST_PROFILED_AT = NumericField("lastProfiledAt", "lastProfiledAt")
SnowflakeShare.SQL_AI_MODEL_CONTEXT_QUALIFIED_NAME = KeywordField("sqlAIModelContextQualifiedName", "sqlAIModelContextQualifiedName")
SnowflakeShare.SQL_IS_SECURE = BooleanField("sqlIsSecure", "sqlIsSecure")
SnowflakeShare.SQL_HAS_AI_INSIGHTS = BooleanField("sqlHasAiInsights", "sqlHasAiInsights")
SnowflakeShare.SQL_AI_INSIGHTS_LAST_ANALYZED_AT = NumericField("sqlAiInsightsLastAnalyzedAt", "sqlAiInsightsLastAnalyzedAt")
SnowflakeShare.SQL_AI_INSIGHTS_POPULAR_BUSINESS_QUESTION_COUNT = NumericField("sqlAiInsightsPopularBusinessQuestionCount", "sqlAiInsightsPopularBusinessQuestionCount")
SnowflakeShare.SQL_AI_INSIGHTS_POPULAR_JOIN_COUNT = NumericField("sqlAiInsightsPopularJoinCount", "sqlAiInsightsPopularJoinCount")
SnowflakeShare.SQL_AI_INSIGHTS_POPULAR_FILTER_COUNT = NumericField("sqlAiInsightsPopularFilterCount", "sqlAiInsightsPopularFilterCount")
SnowflakeShare.SQL_AI_INSIGHTS_RELATIONSHIP_COUNT = NumericField("sqlAiInsightsRelationshipCount", "sqlAiInsightsRelationshipCount")
SnowflakeShare.SQL_COALESCE_LAST_RUN_STATUS = KeywordField("sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus")
SnowflakeShare.SQL_COALESCE_NODE_STATUS = KeywordField("sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus")
SnowflakeShare.SQL_COALESCE_LAST_RUN_AT = NumericField("sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt")
SnowflakeShare.SQL_COALESCE_NODE_TYPE = KeywordField("sqlCoalesceNodeType", "sqlCoalesceNodeType")
SnowflakeShare.SQL_COALESCE_ENVIRONMENT_ID = KeywordField("sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId")
SnowflakeShare.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField("sqlCoalesceEnvironmentName", "sqlCoalesceEnvironmentName", "sqlCoalesceEnvironmentName.text")
SnowflakeShare.SQL_COALESCE_PROJECT_ID = KeywordField("sqlCoalesceProjectId", "sqlCoalesceProjectId")
SnowflakeShare.SQL_COALESCE_PROJECT_NAME = KeywordTextField("sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text")
SnowflakeShare.SQL_SHARE_QUALIFIED_NAMES = KeywordField("sqlShareQualifiedNames", "sqlShareQualifiedNames")
SnowflakeShare.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
SnowflakeShare.INPUT_TO_AIRFLOW_TASKS = RelationField("inputToAirflowTasks")
SnowflakeShare.OUTPUT_FROM_AIRFLOW_TASKS = RelationField("outputFromAirflowTasks")
SnowflakeShare.ANOMALO_CHECKS = RelationField("anomaloChecks")
SnowflakeShare.APPLICATION = RelationField("application")
SnowflakeShare.APPLICATION_FIELD = RelationField("applicationField")
SnowflakeShare.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
SnowflakeShare.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
SnowflakeShare.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
SnowflakeShare.OUTPUT_PORT_DATA_PRODUCTS = RelationField("outputPortDataProducts")
SnowflakeShare.INPUT_PORT_DATA_PRODUCTS = RelationField("inputPortDataProducts")
SnowflakeShare.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
SnowflakeShare.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
SnowflakeShare.METRICS = RelationField("metrics")
SnowflakeShare.DQ_BASE_DATASET_RULES = RelationField("dqBaseDatasetRules")
SnowflakeShare.DQ_REFERENCE_DATASET_RULES = RelationField("dqReferenceDatasetRules")
SnowflakeShare.DBT_MODELS = RelationField("dbtModels")
SnowflakeShare.SQL_DBT_MODELS = RelationField("sqlDbtModels")
SnowflakeShare.DBT_TESTS = RelationField("dbtTests")
SnowflakeShare.DBT_SOURCES = RelationField("dbtSources")
SnowflakeShare.SQL_DBT_SOURCES = RelationField("sqlDBTSources")
SnowflakeShare.DBT_SEED_ASSETS = RelationField("dbtSeedAssets")
SnowflakeShare.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
...
SnowflakeShare.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
SnowflakeShare.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
SnowflakeShare.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
SnowflakeShare.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
SnowflakeShare.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
SnowflakeShare.FILES = RelationField("files")
SnowflakeShare.LINKS = RelationField("links")
SnowflakeShare.README = RelationField("readme")
SnowflakeShare.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
SnowflakeShare.SNOWFLAKE_SEMANTIC_LOGICAL_TABLES = RelationField("snowflakeSemanticLogicalTables")
SnowflakeShare.SNOWFLAKE_LISTING = RelationField("snowflakeListing")
SnowflakeShare.SODA_CHECKS = RelationField("sodaChecks")
SnowflakeShare.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
SnowflakeShare.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
SnowflakeShare.SQL_INSIGHT_OUTGOING_JOINS = RelationField("sqlInsightOutgoingJoins")
SnowflakeShare.SQL_INSIGHT_INCOMING_JOINS = RelationField("sqlInsightIncomingJoins")
SnowflakeShare.SQL_INSIGHT_BUSINESS_QUESTIONS = RelationField("sqlInsightBusinessQuestions")