...
class KnowledgeFileNested(AssetNested):
    ...
    relationship_attributes: Union[KnowledgeFileRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[KnowledgeFileRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[KnowledgeFileRelationshipAttributes, UnsetType] = UNSET
...
def _populate_knowledge_file_attrs(attrs: KnowledgeFileAttributes, obj: KnowledgeFile) -> None:
...
def _knowledge_file_from_nested(nested: KnowledgeFileNested) -> KnowledgeFile:
    ...
    attrs = nested.attributes if nested.attributes is not UNSET else KnowledgeFileAttributes()
...
def _knowledge_file_to_nested_bytes(knowledge_file: KnowledgeFile, serde: Serde) -> bytes:
...
KnowledgeFile.KNOWLEDGE_CONTENT_HASH = KeywordField("knowledgeContentHash", "knowledgeContentHash")
KnowledgeFile.KNOWLEDGE_FOLDER_NAMES = KeywordField("knowledgeFolderNames", "knowledgeFolderNames")
KnowledgeFile.KNOWLEDGE_CONTENT_VERSION_ID = KeywordField("knowledgeContentVersionId", "knowledgeContentVersionId")
KnowledgeFile.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
KnowledgeFile.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
KnowledgeFile.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
