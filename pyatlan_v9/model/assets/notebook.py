...
class Notebook(Asset):
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _notebook_to_nested_bytes(self, serde)
...
class NotebookNested(AssetNested):
    ...
    attributes: NotebookAttributes | UnsetType = UNSET
    relationship_attributes: NotebookRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: NotebookRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: NotebookRelationshipAttributes | UnsetType = UNSET
...
def _notebook_to_nested(notebook: Notebook) -> NotebookNested:
    ...
    _populate_notebook_attrs(attrs, notebook)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        notebook, _NOTEBOOK_REL_FIELDS, NotebookRelationshipAttributes
    )
...
Notebook.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
Notebook.METRICS = RelationField("metrics")
Notebook.DQ_BASE_DATASET_RULES = RelationField("dqBaseDatasetRules")
Notebook.DQ_REFERENCE_DATASET_RULES = RelationField("dqReferenceDatasetRules")
Notebook.MEANINGS = RelationField("meanings")
Notebook.MC_MONITORS = RelationField("mcMonitors")
Notebook.MC_INCIDENTS = RelationField("mcIncidents")
Notebook.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
Notebook.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
Notebook.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
Notebook.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
Notebook.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
Notebook.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
Notebook.FILES = RelationField("files")
Notebook.LINKS = RelationField("links")
Notebook.README = RelationField("readme")
Notebook.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
Notebook.SODA_CHECKS = RelationField("sodaChecks")
Notebook.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
Notebook.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
