...
def _notebook_from_nested(nested: NotebookNested) -> Notebook:
    ...
    kwargs.update(_extract_notebook_attrs(attrs))
...
Notebook.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Notebook.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Notebook.MEANINGS = RelationField("meanings")
Notebook.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
