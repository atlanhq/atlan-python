...
def _cognos_module_from_nested(nested: CognosModuleNested) -> CognosModule:
    ...
    kwargs.update(_extract_cognos_module_attrs(attrs))
    kwargs.update(merged_rels)
    return CognosModule(**kwargs)
...
CognosModule.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
CognosModule.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
CognosModule.MEANINGS = RelationField("meanings")
CognosModule.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
