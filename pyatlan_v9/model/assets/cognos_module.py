...
class CognosModuleNested(AssetNested):
    ...
    append_relationship_attributes: CognosModuleRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: CognosModuleRelationshipAttributes | UnsetType = (
        UNSET
    )
