...
class MetabaseCollection(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this MetabaseCollection instance.
    ...
    def minimize(self) -> "MetabaseCollection":
        """
        Return a minimal copy of this MetabaseCollection with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new MetabaseCollection with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new MetabaseCollection instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedMetabaseCollection":
        """
        Create a :class:`RelatedMetabaseCollection` reference from this instance.
        ...
        Returns:
            A RelatedMetabaseCollection reference to this asset.
        """
...
def _metabase_collection_from_nested(
    ...
    kwargs.update(_extract_metabase_collection_attrs(attrs))
    kwargs.update(merged_rels)
    return MetabaseCollection(**kwargs)
...
MetabaseCollection.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
