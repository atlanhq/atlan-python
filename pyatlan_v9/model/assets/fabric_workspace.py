...
def _fabric_workspace_from_nested(nested: FabricWorkspaceNested) -> FabricWorkspace:
    ...
    kwargs.update(_extract_fabric_workspace_attrs(attrs))
    kwargs.update(merged_rels)
    return FabricWorkspace(**kwargs)
...
FabricWorkspace.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
FabricWorkspace.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
