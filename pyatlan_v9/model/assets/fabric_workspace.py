...
class FabricWorkspace(Asset):
    ...
    fabric_databases: list[RelatedDatabase] | None | UnsetType = UNSET
    """Individual databases contained in the workspace."""

    fabric_dashboards: list[RelatedFabricDashboard] | None | UnsetType = UNSET
    """Individual dashboards contained in the workspace."""

    fabric_dataflows: list[RelatedFabricDataflow] | None | UnsetType = UNSET
    """Individual dataflows contained in the workspace."""

    fabric_data_pipelines: list[RelatedFabricDataPipeline] | None | UnsetType = UNSET
    """Individual data pipelines contained in the workspace."""

    fabric_reports: list[RelatedFabricReport] | None | UnsetType = UNSET
    """Individual reports contained in the workspace."""

    fabric_semantic_models: list[RelatedFabricSemanticModel] | None | UnsetType = UNSET
