...
class MicroStrategyAttribute(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this MicroStrategyAttribute instance.
    ...
    def minimize(self) -> "MicroStrategyAttribute":
        """
        Return a minimal copy of this MicroStrategyAttribute with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new MicroStrategyAttribute with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new MicroStrategyAttribute instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedMicroStrategyAttribute":
        """
        Create a :class:`RelatedMicroStrategyAttribute` reference from this instance.
        ...
        Returns:
            A RelatedMicroStrategyAttribute reference to this asset.
        """
...
def _micro_strategy_attribute_from_nested(
    ...
    kwargs.update(_extract_micro_strategy_attribute_attrs(attrs))
    kwargs.update(merged_rels)
    return MicroStrategyAttribute(**kwargs)
...
MicroStrategyAttribute.CATALOG_DATASET_GUID = KeywordField(
...
MicroStrategyAttribute.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
MicroStrategyAttribute.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
MicroStrategyAttribute.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
