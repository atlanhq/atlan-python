...
def _persona_from_nested(nested: PersonaNested) -> Persona:
    ...
    kwargs.update(_extract_persona_attrs(attrs))
...
Persona.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Persona.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
