...
class PresetChart(Asset):
    ...
    PRESET_CHART_DESCRIPTION_MARKDOWN: ClassVar[Any] = None
    PRESET_CHART_FORM_DATA: ClassVar[Any] = None
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _preset_chart_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> PresetChart:
        """
...
_PRESET_CHART_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
def _populate_preset_chart_attrs(
    ...
    attrs.preset_chart_form_data = obj.preset_chart_form_data
...
def _preset_chart_to_nested(preset_chart: PresetChart) -> PresetChartNested:
    ...
    attrs = PresetChartAttributes()
    _populate_preset_chart_attrs(attrs, preset_chart)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        preset_chart, _PRESET_CHART_REL_FIELDS, PresetChartRelationshipAttributes
    )
...
def _preset_chart_from_nested(nested: PresetChartNested) -> PresetChart:
    ...
    kwargs.update(_extract_preset_chart_attrs(attrs))
...
PresetChart.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
PresetChart.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
PresetChart.MC_MONITORS = RelationField("mcMonitors")
PresetChart.MC_INCIDENTS = RelationField("mcIncidents")
PresetChart.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
PresetChart.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
PresetChart.PRESET_DASHBOARD = RelationField("presetDashboard")
PresetChart.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
PresetChart.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
PresetChart.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
PresetChart.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
PresetChart.FILES = RelationField("files")
PresetChart.LINKS = RelationField("links")
PresetChart.README = RelationField("readme")
PresetChart.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
PresetChart.SODA_CHECKS = RelationField("sodaChecks")
PresetChart.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
PresetChart.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
