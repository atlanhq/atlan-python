...
def _sapbw_transformation_from_nested(
    ...
    kwargs.update(_extract_sapbw_transformation_attrs(attrs))
    kwargs.update(merged_rels)
    return SAPBWTransformation(**kwargs)
...
SAPBWTransformation.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
