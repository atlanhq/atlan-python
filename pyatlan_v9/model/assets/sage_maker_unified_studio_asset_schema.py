...
def _sage_maker_unified_studio_asset_schema_from_nested(
    ...
    kwargs.update(_extract_sage_maker_unified_studio_asset_schema_attrs(attrs))
    kwargs.update(merged_rels)
    return SageMakerUnifiedStudioAssetSchema(**kwargs)
...
SageMakerUnifiedStudioAssetSchema.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = (
    RelationField("gcpDataplexAspectTypeMetadataEntities")
)
SageMakerUnifiedStudioAssetSchema.MEANINGS = RelationField("meanings")
SageMakerUnifiedStudioAssetSchema.KNOWLEDGE_LINKED_FILES = RelationField(
