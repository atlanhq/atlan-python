...
class SageMakerFeature(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        ...
        if for_creation:
            ...
            if self.sage_maker_feature_group_name is UNSET:
                errors.append("sage_maker_feature_group_name is required for creation")
            if self.sage_maker_feature_group_qualified_name is UNSET:
                errors.append(
                    "sage_maker_feature_group_qualified_name is required for creation"
                )
        if errors:
...
def _sage_maker_feature_from_nested(nested: SageMakerFeatureNested) -> SageMakerFeature:
    ...
    kwargs.update(_extract_sage_maker_feature_attrs(attrs))
    kwargs.update(merged_rels)
    return SageMakerFeature(**kwargs)
...
SageMakerFeature.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
SageMakerFeature.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
SageMakerFeature.MEANINGS = RelationField("meanings")
SageMakerFeature.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
