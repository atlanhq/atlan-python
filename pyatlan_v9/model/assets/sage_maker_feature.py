...
class SageMakerFeature(Asset):
    ...
    sage_maker_feature_group: Union[RelatedSageMakerFeatureGroup, None, UnsetType] = UNSET
    ...
    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> SageMakerFeature:
        """
...
class SageMakerFeatureNested(AssetNested):
    ...
    relationship_attributes: Union[SageMakerFeatureRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[SageMakerFeatureRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[SageMakerFeatureRelationshipAttributes, UnsetType] = UNSET
...
def _populate_sage_maker_feature_attrs(attrs: SageMakerFeatureAttributes, obj: SageMakerFeature) -> None:
...
def _sage_maker_feature_to_nested(sage_maker_feature: SageMakerFeature) -> SageMakerFeatureNested:
    ...
    replace_rels, append_rels, remove_rels = categorize_relationships(
        sage_maker_feature, _SAGE_MAKER_FEATURE_REL_FIELDS, SageMakerFeatureRelationshipAttributes
    )
...
def _sage_maker_feature_from_nested(nested: SageMakerFeatureNested) -> SageMakerFeature:
    ...
    attrs = nested.attributes if nested.attributes is not UNSET else SageMakerFeatureAttributes()
...
def _sage_maker_feature_to_nested_bytes(sage_maker_feature: SageMakerFeature, serde: Serde) -> bytes:
    """Convert flat SageMakerFeature to nested JSON bytes."""
    return serde.encode(_sage_maker_feature_to_nested(sage_maker_feature))


def _sage_maker_feature_from_nested_bytes(data: bytes, serde: Serde) -> SageMakerFeature:
...
SageMakerFeature.SAGE_MAKER_GROUP_NAME = KeywordField("sageMakerGroupName", "sageMakerGroupName")
SageMakerFeature.SAGE_MAKER_GROUP_QUALIFIED_NAME = KeywordField("sageMakerGroupQualifiedName", "sageMakerGroupQualifiedName")
SageMakerFeature.SAGE_MAKER_DATA_TYPE = KeywordField("sageMakerDataType", "sageMakerDataType")
SageMakerFeature.SAGE_MAKER_IS_RECORD_IDENTIFIER = BooleanField("sageMakerIsRecordIdentifier", "sageMakerIsRecordIdentifier")
SageMakerFeature.SAGE_MAKER_S3_URI = KeywordField("sageMakerS3Uri", "sageMakerS3Uri")
SageMakerFeature.ETHICAL_AI_PRIVACY_CONFIG = KeywordField("ethicalAIPrivacyConfig", "ethicalAIPrivacyConfig")
SageMakerFeature.ETHICAL_AI_FAIRNESS_CONFIG = KeywordField("ethicalAIFairnessConfig", "ethicalAIFairnessConfig")
SageMakerFeature.ETHICAL_AI_BIAS_MITIGATION_CONFIG = KeywordField("ethicalAIBiasMitigationConfig", "ethicalAIBiasMitigationConfig")
SageMakerFeature.ETHICAL_AI_RELIABILITY_AND_SAFETY_CONFIG = KeywordField("ethicalAIReliabilityAndSafetyConfig", "ethicalAIReliabilityAndSafetyConfig")
SageMakerFeature.ETHICAL_AI_TRANSPARENCY_CONFIG = KeywordField("ethicalAITransparencyConfig", "ethicalAITransparencyConfig")
SageMakerFeature.ETHICAL_AI_ACCOUNTABILITY_CONFIG = KeywordField("ethicalAIAccountabilityConfig", "ethicalAIAccountabilityConfig")
SageMakerFeature.ETHICAL_AI_ENVIRONMENTAL_CONSCIOUSNESS_CONFIG = KeywordField("ethicalAIEnvironmentalConsciousnessConfig", "ethicalAIEnvironmentalConsciousnessConfig")
SageMakerFeature.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
SageMakerFeature.AWS_OWNER_NAME = KeywordTextField("awsOwnerName", "awsOwnerName", "awsOwnerName.text")
SageMakerFeature.AWS_OWNER_ID = KeywordField("awsOwnerId", "awsOwnerId")
SageMakerFeature.AWS_TAGS = KeywordField("awsTags", "awsTags")
SageMakerFeature.CLOUD_UNIFORM_RESOURCE_NAME = KeywordField("cloudUniformResourceName", "cloudUniformResourceName")
...
SageMakerFeature.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
SageMakerFeature.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
SageMakerFeature.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
