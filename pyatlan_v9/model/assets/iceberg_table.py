...
class IcebergTable(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this IcebergTable instance.
    ...
    def minimize(self) -> "IcebergTable":
        """
        Return a minimal copy of this IcebergTable with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new IcebergTable with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new IcebergTable instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedIcebergTable":
        """
        Create a :class:`RelatedIcebergTable` reference from this instance.
        ...
        Returns:
            A RelatedIcebergTable reference to this asset.
        """
...
def _iceberg_table_to_nested(iceberg_table: IcebergTable) -> IcebergTableNested:
    ...
    return IcebergTableNested(
        ...
        depth=iceberg_table.depth,
        immediate_upstream=iceberg_table.immediate_upstream,
        immediate_downstream=iceberg_table.immediate_downstream,
        attributes=attrs,
...
def _iceberg_table_from_nested(nested: IcebergTableNested) -> IcebergTable:
    ...
    kwargs.update(_extract_iceberg_table_attrs(attrs))
    kwargs.update(merged_rels)
    return IcebergTable(**kwargs)
...
IcebergTable.SQL_HAS_AI_INSIGHTS = BooleanField("sqlHasAiInsights", "sqlHasAiInsights")
IcebergTable.SQL_AI_INSIGHTS_LAST_ANALYZED_AT = NumericField(
    "sqlAiInsightsLastAnalyzedAt", "sqlAiInsightsLastAnalyzedAt"
)
IcebergTable.SQL_AI_INSIGHTS_POPULAR_BUSINESS_QUESTION_COUNT = NumericField(
    "sqlAiInsightsPopularBusinessQuestionCount",
    "sqlAiInsightsPopularBusinessQuestionCount",
)
IcebergTable.SQL_AI_INSIGHTS_POPULAR_JOIN_COUNT = NumericField(
    "sqlAiInsightsPopularJoinCount", "sqlAiInsightsPopularJoinCount"
)
IcebergTable.SQL_AI_INSIGHTS_POPULAR_FILTER_COUNT = NumericField(
    "sqlAiInsightsPopularFilterCount", "sqlAiInsightsPopularFilterCount"
)
IcebergTable.SQL_AI_INSIGHTS_RELATIONSHIP_COUNT = NumericField(
    "sqlAiInsightsRelationshipCount", "sqlAiInsightsRelationshipCount"
)
IcebergTable.SQL_COALESCE_LAST_RUN_STATUS = KeywordField(
    "sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus"
)
IcebergTable.SQL_COALESCE_NODE_STATUS = KeywordField(
    "sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus"
)
IcebergTable.SQL_COALESCE_LAST_RUN_AT = NumericField(
    "sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt"
)
IcebergTable.SQL_COALESCE_NODE_TYPE = KeywordField(
    "sqlCoalesceNodeType", "sqlCoalesceNodeType"
)
IcebergTable.SQL_COALESCE_ENVIRONMENT_ID = KeywordField(
    "sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId"
)
IcebergTable.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField(
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName.text",
)
IcebergTable.SQL_COALESCE_PROJECT_ID = KeywordField(
    "sqlCoalesceProjectId", "sqlCoalesceProjectId"
)
IcebergTable.SQL_COALESCE_PROJECT_NAME = KeywordTextField(
    "sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text"
)
IcebergTable.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
    "sqlShareQualifiedNames", "sqlShareQualifiedNames"
)
IcebergTable.CATALOG_DATASET_GUID = KeywordField(
...
IcebergTable.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
IcebergTable.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
IcebergTable.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
IcebergTable.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
IcebergTable.MEANINGS = RelationField("meanings")
IcebergTable.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
...
IcebergTable.SQL_INSIGHT_OUTGOING_JOINS = RelationField("sqlInsightOutgoingJoins")
IcebergTable.SQL_INSIGHT_INCOMING_JOINS = RelationField("sqlInsightIncomingJoins")
IcebergTable.SQL_INSIGHT_BUSINESS_QUESTIONS = RelationField(
