...
def _databricks_external_location_to_nested(
    ...
    return DatabricksExternalLocationNested(
        ...
        depth=databricks_external_location.depth,
        immediate_upstream=databricks_external_location.immediate_upstream,
        immediate_downstream=databricks_external_location.immediate_downstream,
        attributes=attrs,
...
def _databricks_external_location_from_nested(
    ...
    kwargs.update(_extract_databricks_external_location_attrs(attrs))
    kwargs.update(merged_rels)
    return DatabricksExternalLocation(**kwargs)
