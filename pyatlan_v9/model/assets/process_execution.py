...
class ProcessExecution(Referenceable):
    ...
    asset_external_dq_score_value: Union[float, None, UnsetType] = msgspec.field(default=UNSET, name="assetExternalDQScoreValue")
    """Single asset-level DQ score (0–100). Populated natively by tools that provide one."""

    asset_external_dq_test_entities: Union[List[str], None, UnsetType] = msgspec.field(default=UNSET, name="assetExternalDQTestEntities")
    """Ordered list of DQ test/scan names on this asset. Positionally aligned with the score metrics."""

    asset_external_dq_test_latest_scores: Union[List[float], None, UnsetType] = msgspec.field(default=UNSET, name="assetExternalDQTestLatestScores")
    """List of scores of the most recent run for each DQ test."""

    asset_external_dq_test_avg_scores: Union[List[float], None, UnsetType] = msgspec.field(default=UNSET, name="assetExternalDQTestAvgScores")
    """List of mean scores across all runs for each DQ test."""

    asset_external_dq_test_min_scores: Union[List[float], None, UnsetType] = msgspec.field(default=UNSET, name="assetExternalDQTestMinScores")
...
class ProcessExecutionNested(ReferenceableNested):
    ...
    attributes: Union[ProcessExecutionAttributes, UnsetType] = UNSET
    relationship_attributes: Union[ProcessExecutionRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[ProcessExecutionRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[ProcessExecutionRelationshipAttributes, UnsetType] = UNSET
...
def _populate_process_execution_attrs(attrs: ProcessExecutionAttributes, obj: ProcessExecution) -> None:
    ...
    attrs.asset_external_dq_test_latest_scores = obj.asset_external_dq_test_latest_scores
...
def _extract_process_execution_attrs(attrs: ProcessExecutionAttributes) -> dict:
    ...
    result["asset_external_dq_test_latest_scores"] = attrs.asset_external_dq_test_latest_scores
    result["asset_external_dq_test_avg_scores"] = attrs.asset_external_dq_test_avg_scores
    result["asset_external_dq_test_min_scores"] = attrs.asset_external_dq_test_min_scores
...
ProcessExecution.ASSET_ANNOUNCEMENT_EXPIRED_AT = NumericField("assetAnnouncementExpiredAt", "assetAnnouncementExpiredAt")
...
ProcessExecution.ASSET_SUMMARY_V2_PROVIDER = KeywordField("assetSummaryV2Provider", "assetSummaryV2Provider")
ProcessExecution.ASSET_SUMMARY_V2 = KeywordField("assetSummaryV2", "assetSummaryV2")
ProcessExecution.ASSET_SUMMARY_V2_FILTER_TOKENS = KeywordField("assetSummaryV2FilterTokens", "assetSummaryV2FilterTokens")
ProcessExecution.ASSET_EXTERNAL_DQ_SCORE_VALUE = NumericField("assetExternalDQScoreValue", "assetExternalDQScoreValue")
ProcessExecution.ASSET_EXTERNAL_DQ_TEST_ENTITIES = KeywordField("assetExternalDQTestEntities", "assetExternalDQTestEntities")
ProcessExecution.ASSET_EXTERNAL_DQ_TEST_LATEST_SCORES = NumericField("assetExternalDQTestLatestScores", "assetExternalDQTestLatestScores")
ProcessExecution.ASSET_EXTERNAL_DQ_TEST_AVG_SCORES = NumericField("assetExternalDQTestAvgScores", "assetExternalDQTestAvgScores")
ProcessExecution.ASSET_EXTERNAL_DQ_TEST_MIN_SCORES = NumericField("assetExternalDQTestMinScores", "assetExternalDQTestMinScores")
...
ProcessExecution.ASSET_IMMUTA_REQUEST_URL = KeywordField("assetImmutaRequestUrl", "assetImmutaRequestUrl")
ProcessExecution.ASSET_IMMUTA_REQUEST_TYPE = KeywordField("assetImmutaRequestType", "assetImmutaRequestType")
...
ProcessExecution.ASSET_AI_ALIAS = TextField("assetAiAlias", "assetAiAlias")
ProcessExecution.ASSET_HAS_AI_README = BooleanField("assetHasAiReadme", "assetHasAiReadme")
...
ProcessExecution.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
ProcessExecution.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
ProcessExecution.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
