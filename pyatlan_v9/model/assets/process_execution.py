...
class ProcessExecution(Referenceable):
    ...
    # Override type_name with ProcessExecution-specific default
    ...
    def to_json(self, nested: bool = True, serde: Serde | None = None) -> str:
        ...
        if serde is None:
            serde = get_serde()
        if nested:
            return _process_execution_to_nested_bytes(self, serde).decode("utf-8")
        else:
...
def _process_execution_to_nested(
    ...
    attrs = ProcessExecutionAttributes(
        ...
        display_name=process_execution.display_name,
        description=process_execution.description,
        asset_source_readme=process_execution.asset_source_readme,
        user_description=process_execution.user_description,
        tenant_id=process_execution.tenant_id,
        certificate_status=process_execution.certificate_status,
        certificate_status_message=process_execution.certificate_status_message,
        certificate_updated_by=process_execution.certificate_updated_by,
        certificate_updated_at=process_execution.certificate_updated_at,
        announcement_title=process_execution.announcement_title,
        announcement_message=process_execution.announcement_message,
        announcement_type=process_execution.announcement_type,
        announcement_updated_at=process_execution.announcement_updated_at,
        announcement_updated_by=process_execution.announcement_updated_by,
        owner_users=process_execution.owner_users,
        owner_groups=process_execution.owner_groups,
        admin_users=process_execution.admin_users,
        admin_groups=process_execution.admin_groups,
        viewer_users=process_execution.viewer_users,
        viewer_groups=process_execution.viewer_groups,
        connector_name=process_execution.connector_name,
        connection_name=process_execution.connection_name,
        connection_qualified_name=process_execution.connection_qualified_name,
        has_lineage=process_execution.has_lineage,
        is_discoverable=process_execution.is_discoverable,
        is_editable=process_execution.is_editable,
        sub_type=process_execution.sub_type,
        view_score=process_execution.view_score,
        popularity_score=process_execution.popularity_score,
        source_owners=process_execution.source_owners,
        asset_source_id=process_execution.asset_source_id,
        source_created_by=process_execution.source_created_by,
        source_created_at=process_execution.source_created_at,
        source_updated_at=process_execution.source_updated_at,
        source_updated_by=process_execution.source_updated_by,
        source_url=process_execution.source_url,
        source_embed_url=process_execution.source_embed_url,
        last_sync_workflow_name=process_execution.last_sync_workflow_name,
        last_sync_run_at=process_execution.last_sync_run_at,
        last_sync_run=process_execution.last_sync_run,
        admin_roles=process_execution.admin_roles,
        source_read_count=process_execution.source_read_count,
        source_read_user_count=process_execution.source_read_user_count,
        source_last_read_at=process_execution.source_last_read_at,
        last_row_changed_at=process_execution.last_row_changed_at,
        source_total_cost=process_execution.source_total_cost,
        source_cost_unit=process_execution.source_cost_unit,
        source_read_query_cost=process_execution.source_read_query_cost,
        source_read_recent_user_list=process_execution.source_read_recent_user_list,
        source_read_recent_user_record_list=process_execution.source_read_recent_user_record_list,
        source_read_top_user_list=process_execution.source_read_top_user_list,
        source_read_top_user_record_list=process_execution.source_read_top_user_record_list,
        source_read_popular_query_record_list=process_execution.source_read_popular_query_record_list,
        source_read_expensive_query_record_list=process_execution.source_read_expensive_query_record_list,
        source_read_slow_query_record_list=process_execution.source_read_slow_query_record_list,
        source_query_compute_cost_list=process_execution.source_query_compute_cost_list,
        source_query_compute_cost_record_list=process_execution.source_query_compute_cost_record_list,
        dbt_qualified_name=process_execution.dbt_qualified_name,
        asset_dbt_workflow_last_updated=process_execution.asset_dbt_workflow_last_updated,
        asset_dbt_alias=process_execution.asset_dbt_alias,
        asset_dbt_meta=process_execution.asset_dbt_meta,
        asset_dbt_unique_id=process_execution.asset_dbt_unique_id,
        asset_dbt_account_name=process_execution.asset_dbt_account_name,
        asset_dbt_project_name=process_execution.asset_dbt_project_name,
        asset_dbt_package_name=process_execution.asset_dbt_package_name,
        asset_dbt_job_name=process_execution.asset_dbt_job_name,
        asset_dbt_job_schedule=process_execution.asset_dbt_job_schedule,
        asset_dbt_job_status=process_execution.asset_dbt_job_status,
        asset_dbt_test_status=process_execution.asset_dbt_test_status,
        asset_dbt_job_schedule_cron_humanized=process_execution.asset_dbt_job_schedule_cron_humanized,
        asset_dbt_job_last_run=process_execution.asset_dbt_job_last_run,
        asset_dbt_job_last_run_url=process_execution.asset_dbt_job_last_run_url,
        asset_dbt_job_last_run_created_at=process_execution.asset_dbt_job_last_run_created_at,
        asset_dbt_job_last_run_updated_at=process_execution.asset_dbt_job_last_run_updated_at,
        asset_dbt_job_last_run_dequed_at=process_execution.asset_dbt_job_last_run_dequed_at,
        asset_dbt_job_last_run_started_at=process_execution.asset_dbt_job_last_run_started_at,
        asset_dbt_job_last_run_total_duration=process_execution.asset_dbt_job_last_run_total_duration,
        asset_dbt_job_last_run_total_duration_humanized=process_execution.asset_dbt_job_last_run_total_duration_humanized,
        asset_dbt_job_last_run_queued_duration=process_execution.asset_dbt_job_last_run_queued_duration,
        asset_dbt_job_last_run_queued_duration_humanized=process_execution.asset_dbt_job_last_run_queued_duration_humanized,
        asset_dbt_job_last_run_run_duration=process_execution.asset_dbt_job_last_run_run_duration,
        asset_dbt_job_last_run_run_duration_humanized=process_execution.asset_dbt_job_last_run_run_duration_humanized,
        asset_dbt_job_last_run_git_branch=process_execution.asset_dbt_job_last_run_git_branch,
        asset_dbt_job_last_run_git_sha=process_execution.asset_dbt_job_last_run_git_sha,
        asset_dbt_job_last_run_status_message=process_execution.asset_dbt_job_last_run_status_message,
        asset_dbt_job_last_run_owner_thread_id=process_execution.asset_dbt_job_last_run_owner_thread_id,
        asset_dbt_job_last_run_executed_by_thread_id=process_execution.asset_dbt_job_last_run_executed_by_thread_id,
        asset_dbt_job_last_run_artifacts_saved=process_execution.asset_dbt_job_last_run_artifacts_saved,
        asset_dbt_job_last_run_artifact_s3_path=process_execution.asset_dbt_job_last_run_artifact_s3_path,
        asset_dbt_job_last_run_has_docs_generated=process_execution.asset_dbt_job_last_run_has_docs_generated,
        asset_dbt_job_last_run_has_sources_generated=process_execution.asset_dbt_job_last_run_has_sources_generated,
        asset_dbt_job_last_run_notifications_sent=process_execution.asset_dbt_job_last_run_notifications_sent,
        asset_dbt_job_next_run=process_execution.asset_dbt_job_next_run,
        asset_dbt_job_next_run_humanized=process_execution.asset_dbt_job_next_run_humanized,
        asset_dbt_environment_name=process_execution.asset_dbt_environment_name,
        asset_dbt_environment_dbt_version=process_execution.asset_dbt_environment_dbt_version,
        asset_dbt_tags=process_execution.asset_dbt_tags,
        asset_dbt_semantic_layer_proxy_url=process_execution.asset_dbt_semantic_layer_proxy_url,
        asset_dbt_source_freshness_criteria=process_execution.asset_dbt_source_freshness_criteria,
        sample_data_url=process_execution.sample_data_url,
        asset_tags=process_execution.asset_tags,
        asset_mc_incident_names=process_execution.asset_mc_incident_names,
        asset_mc_incident_qualified_names=process_execution.asset_mc_incident_qualified_names,
        asset_mc_alert_qualified_names=process_execution.asset_mc_alert_qualified_names,
        asset_mc_monitor_names=process_execution.asset_mc_monitor_names,
        asset_mc_monitor_qualified_names=process_execution.asset_mc_monitor_qualified_names,
        asset_mc_monitor_statuses=process_execution.asset_mc_monitor_statuses,
        asset_mc_monitor_types=process_execution.asset_mc_monitor_types,
        asset_mc_monitor_schedule_types=process_execution.asset_mc_monitor_schedule_types,
        asset_mc_incident_types=process_execution.asset_mc_incident_types,
        asset_mc_incident_sub_types=process_execution.asset_mc_incident_sub_types,
        asset_mc_incident_severities=process_execution.asset_mc_incident_severities,
        asset_mc_incident_priorities=process_execution.asset_mc_incident_priorities,
        asset_mc_incident_states=process_execution.asset_mc_incident_states,
        asset_mc_is_monitored=process_execution.asset_mc_is_monitored,
        asset_mc_last_sync_run_at=process_execution.asset_mc_last_sync_run_at,
        starred_by=process_execution.starred_by,
        starred_details_list=process_execution.starred_details_list,
        starred_count=process_execution.starred_count,
        asset_anomalo_dq_status=process_execution.asset_anomalo_dq_status,
        asset_anomalo_check_count=process_execution.asset_anomalo_check_count,
        asset_anomalo_failed_check_count=process_execution.asset_anomalo_failed_check_count,
        asset_anomalo_check_statuses=process_execution.asset_anomalo_check_statuses,
        asset_anomalo_last_check_run_at=process_execution.asset_anomalo_last_check_run_at,
        asset_anomalo_applied_check_types=process_execution.asset_anomalo_applied_check_types,
        asset_anomalo_failed_check_types=process_execution.asset_anomalo_failed_check_types,
        asset_anomalo_source_url=process_execution.asset_anomalo_source_url,
        asset_soda_dq_status=process_execution.asset_soda_dq_status,
        asset_soda_check_count=process_execution.asset_soda_check_count,
        asset_soda_last_sync_run_at=process_execution.asset_soda_last_sync_run_at,
        asset_soda_last_scan_at=process_execution.asset_soda_last_scan_at,
        asset_soda_check_statuses=process_execution.asset_soda_check_statuses,
        asset_soda_source_url=process_execution.asset_soda_source_url,
        asset_icon=process_execution.asset_icon,
        asset_external_dq_metadata_details=process_execution.asset_external_dq_metadata_details,
        is_partial=process_execution.is_partial,
        is_ai_generated=process_execution.is_ai_generated,
        asset_cover_image=process_execution.asset_cover_image,
        asset_theme_hex=process_execution.asset_theme_hex,
        lexicographical_sort_order=process_execution.lexicographical_sort_order,
        has_contract=process_execution.has_contract,
        asset_redirect_gui_ds=process_execution.asset_redirect_gui_ds,
        asset_policy_gui_ds=process_execution.asset_policy_gui_ds,
        asset_policies_count=process_execution.asset_policies_count,
        domain_gui_ds=process_execution.domain_gui_ds,
        non_compliant_asset_policy_gui_ds=process_execution.non_compliant_asset_policy_gui_ds,
        product_gui_ds=process_execution.product_gui_ds,
        output_product_gui_ds=process_execution.output_product_gui_ds,
        application_qualified_name=process_execution.application_qualified_name,
        application_field_qualified_name=process_execution.application_field_qualified_name,
        asset_user_defined_type=process_execution.asset_user_defined_type,
        asset_internal_popularity_score=process_execution.asset_internal_popularity_score,
        asset_dq_schedule_type=process_execution.asset_dq_schedule_type,
        asset_dq_schedule_crontab=process_execution.asset_dq_schedule_crontab,
        asset_dq_schedule_time_zone=process_execution.asset_dq_schedule_time_zone,
        asset_dq_schedule_source_sync_status=process_execution.asset_dq_schedule_source_sync_status,
        asset_dq_schedule_source_synced_at=process_execution.asset_dq_schedule_source_synced_at,
        asset_dq_schedule_source_sync_error_message=process_execution.asset_dq_schedule_source_sync_error_message,
        asset_dq_schedule_source_sync_error_code=process_execution.asset_dq_schedule_source_sync_error_code,
        asset_dq_schedule_source_sync_raw_error=process_execution.asset_dq_schedule_source_sync_raw_error,
        asset_dq_rule_attached_dimensions=process_execution.asset_dq_rule_attached_dimensions,
        asset_dq_rule_failed_dimensions=process_execution.asset_dq_rule_failed_dimensions,
        asset_dq_rule_passed_dimensions=process_execution.asset_dq_rule_passed_dimensions,
        asset_dq_rule_attached_rule_types=process_execution.asset_dq_rule_attached_rule_types,
        asset_dq_rule_failed_rule_types=process_execution.asset_dq_rule_failed_rule_types,
        asset_dq_rule_passed_rule_types=process_execution.asset_dq_rule_passed_rule_types,
        asset_dq_rule_result_tags=process_execution.asset_dq_rule_result_tags,
        asset_dq_rule_last_run_at=process_execution.asset_dq_rule_last_run_at,
        asset_dq_rule_total_count=process_execution.asset_dq_rule_total_count,
        asset_dq_rule_failed_count=process_execution.asset_dq_rule_failed_count,
        asset_dq_rule_passed_count=process_execution.asset_dq_rule_passed_count,
        asset_dq_result=process_execution.asset_dq_result,
        asset_dq_freshness_value=process_execution.asset_dq_freshness_value,
        asset_dq_freshness_expectation=process_execution.asset_dq_freshness_expectation,
        asset_dq_row_scope_filter_column_qualified_name=process_execution.asset_dq_row_scope_filter_column_qualified_name,
        asset_space_qualified_name=process_execution.asset_space_qualified_name,
        asset_space_name=process_execution.asset_space_name,
        asset_smus_metadata_form_names=process_execution.asset_smus_metadata_form_names,
        asset_smus_metadata_form_key_value_details=process_execution.asset_smus_metadata_form_key_value_details,
        asset_smus_metadata_form_details=process_execution.asset_smus_metadata_form_details,
    )
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    rel_fields: list[str] = []
    replace_rels, append_rels, remove_rels = categorize_relationships(
        process_execution, rel_fields, ProcessExecutionRelationshipAttributes
    )
