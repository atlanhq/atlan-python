...
class AtlanAppDeployment(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this AtlanAppDeployment instance.
    ...
    def minimize(self) -> "AtlanAppDeployment":
        """
        Return a minimal copy of this AtlanAppDeployment with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new AtlanAppDeployment with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new AtlanAppDeployment instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedAtlanAppDeployment":
        """
        Create a :class:`RelatedAtlanAppDeployment` reference from this instance.
        ...
        Returns:
            A RelatedAtlanAppDeployment reference to this asset.
        """
...
def _atlan_app_deployment_from_nested(
    ...
    kwargs.update(_extract_atlan_app_deployment_attrs(attrs))
    kwargs.update(merged_rels)
    return AtlanAppDeployment(**kwargs)
...
AtlanAppDeployment.CATALOG_DATASET_GUID = KeywordField(
...
AtlanAppDeployment.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
AtlanAppDeployment.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
AtlanAppDeployment.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
AtlanAppDeployment.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
