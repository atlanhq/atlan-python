...
from .flow_related import RelatedFlowControlOperation, RelatedFlowDatasetOperation, RelatedFlowReusableUnit
...
class FlowDatasetOperation(Asset):
    ...
    flow_reusable_unit: RelatedFlowReusableUnit | None | UnsetType = UNSET
...
class FlowDatasetOperationNested(AssetNested):
    ...
    attributes: FlowDatasetOperationAttributes | UnsetType = UNSET
    relationship_attributes: FlowDatasetOperationRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: FlowDatasetOperationRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: FlowDatasetOperationRelationshipAttributes | UnsetType = UNSET

# =============================================================================
# CONVERSION HELPERS & CONSTANTS
# =============================================================================

_FLOW_DATASET_OPERATION_REL_FIELDS: list[str] = [
    *_ASSET_REL_FIELDS,
    "adf_activity",
    "airflow_tasks",
    "anomalo_checks",
...
FlowDatasetOperation.FLOW_STARTED_AT = NumericField("flowStartedAt", "flowStartedAt")
...
FlowDatasetOperation.POWER_BI_DATAFLOW = RelationField("powerBIDataflow")
FlowDatasetOperation.INPUTS = RelationField("inputs")
...
FlowDatasetOperation.SQL_PROCEDURES = RelationField("sqlProcedures")
FlowDatasetOperation.SQL_FUNCTIONS = RelationField("sqlFunctions")
FlowDatasetOperation.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
FlowDatasetOperation.SODA_CHECKS = RelationField("sodaChecks")
FlowDatasetOperation.SPARK_JOBS = RelationField("sparkJobs")