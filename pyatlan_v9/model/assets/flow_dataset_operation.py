...
def _flow_dataset_operation_from_nested(
    ...
    kwargs.update(_extract_flow_dataset_operation_attrs(attrs))
    kwargs.update(merged_rels)
    return FlowDatasetOperation(**kwargs)
...
FlowDatasetOperation.BIGQUERY_ROUTINES = RelationField("bigqueryRoutines")
FlowDatasetOperation.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
