...
def _semantic_measure_from_nested(nested: SemanticMeasureNested) -> SemanticMeasure:
    ...
    kwargs.update(_extract_semantic_measure_attrs(attrs))
    kwargs.update(merged_rels)
    return SemanticMeasure(**kwargs)
...
SemanticMeasure.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
SemanticMeasure.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
SemanticMeasure.MEANINGS = RelationField("meanings")
SemanticMeasure.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
