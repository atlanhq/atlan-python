...
def _sap_erp_view_from_nested(nested: SapErpViewNested) -> SapErpView:
    ...
    kwargs.update(_extract_sap_erp_view_attrs(attrs))
    kwargs.update(merged_rels)
    return SapErpView(**kwargs)
...
SapErpView.CATALOG_DATASET_GUID = KeywordField(
...
SapErpView.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
SapErpView.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
