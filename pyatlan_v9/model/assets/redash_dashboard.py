...
class RedashDashboard(Asset):
    ...
    REDASH_DASHBOARD_WIDGET_COUNT: ClassVar[Any] = None
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this RedashDashboard instance.
    ...
    def minimize(self) -> "RedashDashboard":
        """
        Return a minimal copy of this RedashDashboard with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new RedashDashboard with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new RedashDashboard instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedRedashDashboard":
        """
        Create a :class:`RelatedRedashDashboard` reference from this instance.
        ...
        Returns:
            A RelatedRedashDashboard reference to this asset.
        """
...
_REDASH_DASHBOARD_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
def _extract_redash_dashboard_attrs(attrs: RedashDashboardAttributes) -> dict:
    ...
    result["redash_dashboard_widget_count"] = attrs.redash_dashboard_widget_count
...
def _redash_dashboard_from_nested(nested: RedashDashboardNested) -> RedashDashboard:
    ...
    kwargs.update(_extract_redash_dashboard_attrs(attrs))
    kwargs.update(merged_rels)
    return RedashDashboard(**kwargs)
...
RedashDashboard.CATALOG_DATASET_GUID = KeywordField(
...
RedashDashboard.APPLICATION = RelationField("application")
RedashDashboard.APPLICATION_FIELD = RelationField("applicationField")
RedashDashboard.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
RedashDashboard.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
RedashDashboard.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
RedashDashboard.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
RedashDashboard.MEANINGS = RelationField("meanings")
RedashDashboard.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
RedashDashboard.MC_MONITORS = RelationField("mcMonitors")
RedashDashboard.MC_INCIDENTS = RelationField("mcIncidents")
RedashDashboard.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
RedashDashboard.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
RedashDashboard.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
RedashDashboard.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
RedashDashboard.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
RedashDashboard.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
RedashDashboard.FILES = RelationField("files")
RedashDashboard.LINKS = RelationField("links")
RedashDashboard.README = RelationField("readme")
RedashDashboard.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
RedashDashboard.SODA_CHECKS = RelationField("sodaChecks")
RedashDashboard.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
RedashDashboard.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
