...
def _cognite3d_model_from_nested(nested: Cognite3DModelNested) -> Cognite3DModel:
    ...
    kwargs.update(_extract_cognite3d_model_attrs(attrs))
    kwargs.update(merged_rels)
    return Cognite3DModel(**kwargs)
...
Cognite3DModel.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Cognite3DModel.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
