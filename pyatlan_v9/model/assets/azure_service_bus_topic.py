...
def _azure_service_bus_topic_from_nested(
    ...
    kwargs.update(_extract_azure_service_bus_topic_attrs(attrs))
    kwargs.update(merged_rels)
    return AzureServiceBusTopic(**kwargs)
...
AzureServiceBusTopic.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
AzureServiceBusTopic.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
