...
def _cube_field_from_nested(nested: CubeFieldNested) -> CubeField:
    ...
    kwargs.update(_extract_cube_field_attrs(attrs))
    kwargs.update(merged_rels)
    return CubeField(**kwargs)
...
CubeField.CATALOG_DATASET_GUID = KeywordField(
...
CubeField.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
CubeField.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
CubeField.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
CubeField.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
CubeField.MEANINGS = RelationField("meanings")
CubeField.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
