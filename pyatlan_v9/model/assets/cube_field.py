...
class CubeField(Asset):
    ...
    cube_hierarchy: RelatedCubeHierarchy | None | UnsetType = UNSET
    """Hierarchy containing the field."""

    cube_nested_fields: list[RelatedCubeField] | None | UnsetType = UNSET
    """Individual fields contained in the parent field."""

    cube_parent_field: RelatedCubeField | None | UnsetType = UNSET
...
class CubeFieldNested(AssetNested):
    ...
    attributes: CubeFieldAttributes | UnsetType = UNSET
