...
class IncidentNested(ReferenceableNested):
    ...
    append_relationship_attributes: Union[IncidentRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[IncidentRelationshipAttributes, UnsetType] = UNSET
...
Incident.ASSET_ANNOUNCEMENT_EXPIRED_AT = NumericField("assetAnnouncementExpiredAt", "assetAnnouncementExpiredAt")
...
Incident.ASSET_SUMMARY_V2_PROVIDER = KeywordField("assetSummaryV2Provider", "assetSummaryV2Provider")
Incident.ASSET_SUMMARY_V2 = KeywordField("assetSummaryV2", "assetSummaryV2")
Incident.ASSET_SUMMARY_V2_FILTER_TOKENS = KeywordField("assetSummaryV2FilterTokens", "assetSummaryV2FilterTokens")
Incident.ASSET_EXTERNAL_DQ_SCORE_VALUE = NumericField("assetExternalDQScoreValue", "assetExternalDQScoreValue")
Incident.ASSET_EXTERNAL_DQ_TEST_ENTITIES = KeywordField("assetExternalDQTestEntities", "assetExternalDQTestEntities")
Incident.ASSET_EXTERNAL_DQ_TEST_LATEST_SCORES = NumericField("assetExternalDQTestLatestScores", "assetExternalDQTestLatestScores")
Incident.ASSET_EXTERNAL_DQ_TEST_AVG_SCORES = NumericField("assetExternalDQTestAvgScores", "assetExternalDQTestAvgScores")
Incident.ASSET_EXTERNAL_DQ_TEST_MIN_SCORES = NumericField("assetExternalDQTestMinScores", "assetExternalDQTestMinScores")
...
Incident.ASSET_IMMUTA_REQUEST_URL = KeywordField("assetImmutaRequestUrl", "assetImmutaRequestUrl")
Incident.ASSET_IMMUTA_REQUEST_TYPE = KeywordField("assetImmutaRequestType", "assetImmutaRequestType")
...
Incident.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
