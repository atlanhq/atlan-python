...
class CustomEntity(Asset):
    ...
    custom_child_entities: list[RelatedCustomEntity] | None | UnsetType = UNSET
    """Custom entities contained within the parent entity."""

    custom_parent_entity: RelatedCustomEntity | None | UnsetType = UNSET
    """Custom entity in which the child entities are contained."""

    custom_related_to_entities: list[RelatedCustomEntity] | None | UnsetType = UNSET
    """Target custom entity indicating where the relationship is directed."""

    custom_related_from_entities: list[RelatedCustomEntity] | None | UnsetType = UNSET
