...
def _adf_pipeline_from_nested(nested: AdfPipelineNested) -> AdfPipeline:
    ...
    kwargs.update(_extract_adf_pipeline_attrs(attrs))
    kwargs.update(merged_rels)
    return AdfPipeline(**kwargs)
...
AdfPipeline.CATALOG_DATASET_GUID = KeywordField(
...
AdfPipeline.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
AdfPipeline.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
AdfPipeline.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
AdfPipeline.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
AdfPipeline.MEANINGS = RelationField("meanings")
AdfPipeline.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
