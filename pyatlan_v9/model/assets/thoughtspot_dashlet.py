...
def _thoughtspot_dashlet_from_nested(
    ...
    kwargs.update(_extract_thoughtspot_dashlet_attrs(attrs))
    kwargs.update(merged_rels)
    return ThoughtspotDashlet(**kwargs)
...
ThoughtspotDashlet.CATALOG_DATASET_GUID = KeywordField(
...
ThoughtspotDashlet.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
ThoughtspotDashlet.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
