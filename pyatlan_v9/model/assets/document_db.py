...
def _document_db_from_nested(nested: DocumentDBNested) -> DocumentDB:
    ...
    kwargs.update(_extract_document_db_attrs(attrs))
    kwargs.update(merged_rels)
    return DocumentDB(**kwargs)
...
DocumentDB.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
DocumentDB.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
