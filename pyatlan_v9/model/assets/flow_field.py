...
def _flow_field_from_nested(nested: FlowFieldNested) -> FlowField:
    ...
    kwargs.update(_extract_flow_field_attrs(attrs))
    kwargs.update(merged_rels)
    return FlowField(**kwargs)
...
FlowField.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
FlowField.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
FlowField.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
FlowField.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
