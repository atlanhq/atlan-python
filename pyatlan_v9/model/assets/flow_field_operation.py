...
def _flow_field_operation_from_nested(
    ...
    kwargs.update(_extract_flow_field_operation_attrs(attrs))
    kwargs.update(merged_rels)
    return FlowFieldOperation(**kwargs)
...
FlowFieldOperation.PROCESS_DERIVATION = KeywordField(
...
FlowFieldOperation.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
FlowFieldOperation.MEANINGS = RelationField("meanings")
FlowFieldOperation.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
