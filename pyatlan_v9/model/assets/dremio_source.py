...
class DremioSourceNested(AssetNested):
    ...
    append_relationship_attributes: DremioSourceRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: DremioSourceRelationshipAttributes | UnsetType = (
        UNSET
    )
