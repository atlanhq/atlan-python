...
class FlowDatasetNested(AssetNested):
    ...
    append_relationship_attributes: Union[FlowDatasetRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[FlowDatasetRelationshipAttributes, UnsetType] = UNSET
...
FlowDataset.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
FlowDataset.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
FlowDataset.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
