...
class FlowDataset(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this FlowDataset instance.
    ...
    def minimize(self) -> "FlowDataset":
        """
        Return a minimal copy of this FlowDataset with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new FlowDataset with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new FlowDataset instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedFlowDataset":
        """
        Create a :class:`RelatedFlowDataset` reference from this instance.
        ...
        Returns:
            A RelatedFlowDataset reference to this asset.
        """
...
def _flow_dataset_from_nested(nested: FlowDatasetNested) -> FlowDataset:
    ...
    kwargs.update(_extract_flow_dataset_attrs(attrs))
    kwargs.update(merged_rels)
    return FlowDataset(**kwargs)
...
FlowDataset.CATALOG_DATASET_GUID = KeywordField(
...
FlowDataset.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
FlowDataset.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
