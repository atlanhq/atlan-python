...
class ObjectStore(Asset):
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _object_store_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> ObjectStore:
        """
...
_OBJECT_STORE_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
def _object_store_to_nested(object_store: ObjectStore) -> ObjectStoreNested:
    ...
    _populate_object_store_attrs(attrs, object_store)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        object_store, _OBJECT_STORE_REL_FIELDS, ObjectStoreRelationshipAttributes
    )
...
def _object_store_from_nested(nested: ObjectStoreNested) -> ObjectStore:
    ...
    kwargs.update(_extract_object_store_attrs(attrs))
...
ObjectStore.CATALOG_DATASET_GUID = KeywordField(
    "catalogDatasetGuid", "catalogDatasetGuid"
)
ObjectStore.INPUT_TO_AIRFLOW_TASKS = RelationField("inputToAirflowTasks")
ObjectStore.OUTPUT_FROM_AIRFLOW_TASKS = RelationField("outputFromAirflowTasks")
ObjectStore.ANOMALO_CHECKS = RelationField("anomaloChecks")
ObjectStore.APPLICATION = RelationField("application")
ObjectStore.APPLICATION_FIELD = RelationField("applicationField")
ObjectStore.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
ObjectStore.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
ObjectStore.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
    "dataContractLatestCertified"
)
ObjectStore.OUTPUT_PORT_DATA_PRODUCTS = RelationField("outputPortDataProducts")
ObjectStore.INPUT_PORT_DATA_PRODUCTS = RelationField("inputPortDataProducts")
ObjectStore.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
ObjectStore.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
ObjectStore.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
ObjectStore.MC_MONITORS = RelationField("mcMonitors")
ObjectStore.MC_INCIDENTS = RelationField("mcIncidents")
ObjectStore.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
ObjectStore.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
ObjectStore.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
ObjectStore.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
ObjectStore.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
ObjectStore.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
ObjectStore.FILES = RelationField("files")
ObjectStore.LINKS = RelationField("links")
ObjectStore.README = RelationField("readme")
ObjectStore.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
ObjectStore.SODA_CHECKS = RelationField("sodaChecks")
ObjectStore.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
ObjectStore.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
