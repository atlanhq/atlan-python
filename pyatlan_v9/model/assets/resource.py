...
class Resource(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Resource instance.
    ...
    def minimize(self) -> "Resource":
        """
        Return a minimal copy of this Resource with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Resource with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Resource instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedResource":
        """
        Create a :class:`RelatedResource` reference from this instance.
        ...
        Returns:
            A RelatedResource reference to this asset.
        """
...
def _resource_from_nested(nested: ResourceNested) -> Resource:
    ...
    kwargs.update(_extract_resource_attrs(attrs))
...
Resource.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
Resource.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
Resource.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
Resource.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
Resource.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Resource.MEANINGS = RelationField("meanings")
Resource.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
