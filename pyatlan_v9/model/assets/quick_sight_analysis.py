...
def _quick_sight_analysis_from_nested(
    ...
    kwargs.update(_extract_quick_sight_analysis_attrs(attrs))
...
QuickSightAnalysis.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
QuickSightAnalysis.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
QuickSightAnalysis.MEANINGS = RelationField("meanings")
QuickSightAnalysis.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
