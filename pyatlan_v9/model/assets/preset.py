...
class Preset(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Preset instance.
    ...
    def minimize(self) -> "Preset":
        """
        Return a minimal copy of this Preset with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Preset with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Preset instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedPreset":
        """
        Create a :class:`RelatedPreset` reference from this instance.
        ...
        Returns:
            A RelatedPreset reference to this asset.
        """
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _preset_to_nested_bytes(self, serde)
...
def _preset_to_nested(preset: Preset) -> PresetNested:
    ...
    _populate_preset_attrs(attrs, preset)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        preset, _PRESET_REL_FIELDS, PresetRelationshipAttributes
    )
    return PresetNested(
        guid=preset.guid,
...
def _preset_from_nested(nested: PresetNested) -> Preset:
    ...
    kwargs.update(_extract_preset_attrs(attrs))
...
Preset.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
Preset.APPLICATION = RelationField("application")
Preset.APPLICATION_FIELD = RelationField("applicationField")
Preset.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
Preset.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
Preset.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
Preset.OUTPUT_PORT_DATA_PRODUCTS = RelationField("outputPortDataProducts")
Preset.INPUT_PORT_DATA_PRODUCTS = RelationField("inputPortDataProducts")
Preset.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
Preset.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
Preset.METRICS = RelationField("metrics")
Preset.DQ_BASE_DATASET_RULES = RelationField("dqBaseDatasetRules")
Preset.DQ_REFERENCE_DATASET_RULES = RelationField("dqReferenceDatasetRules")
Preset.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Preset.MEANINGS = RelationField("meanings")
Preset.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
Preset.MC_MONITORS = RelationField("mcMonitors")
Preset.MC_INCIDENTS = RelationField("mcIncidents")
Preset.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
Preset.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
Preset.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
Preset.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
Preset.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
Preset.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
Preset.FILES = RelationField("files")
Preset.LINKS = RelationField("links")
Preset.README = RelationField("readme")
Preset.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
Preset.SODA_CHECKS = RelationField("sodaChecks")
Preset.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
Preset.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
