...
class Fabric(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Fabric instance.
    ...
    def minimize(self) -> "Fabric":
        """
        Return a minimal copy of this Fabric with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Fabric with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Fabric instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedFabric":
        """
        Create a :class:`RelatedFabric` reference from this instance.
        ...
        Returns:
            A RelatedFabric reference to this asset.
        """
...
def _fabric_to_nested(fabric: Fabric) -> FabricNested:
    ...
    return FabricNested(
        ...
        depth=fabric.depth,
        immediate_upstream=fabric.immediate_upstream,
        immediate_downstream=fabric.immediate_downstream,
        attributes=attrs,
...
Fabric.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Fabric.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Fabric.MEANINGS = RelationField("meanings")
Fabric.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
