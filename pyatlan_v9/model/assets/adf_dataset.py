...
class AdfDataset(Asset):
    ...
    adf_activities: list[RelatedAdfActivity] | None | UnsetType = UNSET
    """ADF Dataset that is associated with these ADF activities."""

    adf_dataflows: list[RelatedAdfDataflow] | None | UnsetType = UNSET
    """ADF Datasets that are associated with this ADF Dataflows."""

    adf_linkedservice: RelatedAdfLinkedservice | None | UnsetType = UNSET
    """ADF datasets that are associated with this ADF Linkedservice."""

    adf_pipelines: list[RelatedAdfPipeline] | None | UnsetType = UNSET
...
class AdfDatasetNested(AssetNested):
    ...
    attributes: AdfDatasetAttributes | UnsetType = UNSET
