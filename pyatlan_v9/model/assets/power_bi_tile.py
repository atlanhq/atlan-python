...
class PowerBITile(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this PowerBITile instance.
    ...
    def minimize(self) -> "PowerBITile":
        """
        Return a minimal copy of this PowerBITile with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new PowerBITile with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new PowerBITile instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedPowerBITile":
        """
        Create a :class:`RelatedPowerBITile` reference from this instance.
        ...
        Returns:
            A RelatedPowerBITile reference to this asset.
        """
...
class PowerBITileNested(AssetNested):
    ...
    append_relationship_attributes: Union[
        PowerBITileRelationshipAttributes, UnsetType
    ] = UNSET
...
def _power_bi_tile_to_nested(power_bi_tile: PowerBITile) -> PowerBITileNested:
    ...
    return PowerBITileNested(
        ...
        depth=power_bi_tile.depth,
        immediate_upstream=power_bi_tile.immediate_upstream,
        immediate_downstream=power_bi_tile.immediate_downstream,
        attributes=attrs,
...
def _power_bi_tile_from_nested(nested: PowerBITileNested) -> PowerBITile:
    ...
    kwargs.update(_extract_power_bi_tile_attrs(attrs))
    kwargs.update(merged_rels)
    return PowerBITile(**kwargs)
...
PowerBITile.CATALOG_DATASET_GUID = KeywordField(
...
PowerBITile.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
PowerBITile.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
PowerBITile.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
PowerBITile.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
PowerBITile.MEANINGS = RelationField("meanings")
PowerBITile.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
