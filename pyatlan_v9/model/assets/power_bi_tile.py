...
class PowerBITile(Asset):
    ...
    # Override type_name with PowerBITile-specific default
    ...
    def to_json(self, nested: bool = True, serde: Serde | None = None) -> str:
        ...
        if serde is None:
            serde = get_serde()
        if nested:
            return _power_bi_tile_to_nested_bytes(self, serde).decode("utf-8")
        else:
...
def _power_bi_tile_to_nested(power_bi_tile: PowerBITile) -> PowerBITileNested:
    ...
    attrs = PowerBITileAttributes(
        workspace_qualified_name=power_bi_tile.workspace_qualified_name,
        dashboard_qualified_name=power_bi_tile.dashboard_qualified_name,
        power_bi_is_hidden=power_bi_tile.power_bi_is_hidden,
        power_bi_table_qualified_name=power_bi_tile.power_bi_table_qualified_name,
        power_bi_format_string=power_bi_tile.power_bi_format_string,
        power_bi_endorsement=power_bi_tile.power_bi_endorsement,
    )
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    rel_fields: list[str] = ["dashboard", "report", "dataset"]
    replace_rels, append_rels, remove_rels = categorize_relationships(
        power_bi_tile, rel_fields, PowerBITileRelationshipAttributes
    )
...
def _power_bi_tile_from_nested(nested: PowerBITileNested) -> PowerBITile:
    ...
    return PowerBITile(
        ...
        dashboard_qualified_name=attrs.dashboard_qualified_name,
