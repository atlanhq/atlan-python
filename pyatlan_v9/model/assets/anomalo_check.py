...
class AnomaloCheck(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this AnomaloCheck instance.
    ...
    def minimize(self) -> "AnomaloCheck":
        """
        Return a minimal copy of this AnomaloCheck with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new AnomaloCheck with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new AnomaloCheck instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedAnomaloCheck":
        """
        Create a :class:`RelatedAnomaloCheck` reference from this instance.
        ...
        Returns:
            A RelatedAnomaloCheck reference to this asset.
        """
...
def _anomalo_check_to_nested(anomalo_check: AnomaloCheck) -> AnomaloCheckNested:
    ...
    return AnomaloCheckNested(
        ...
        depth=anomalo_check.depth,
        immediate_upstream=anomalo_check.immediate_upstream,
        immediate_downstream=anomalo_check.immediate_downstream,
        attributes=attrs,
...
AnomaloCheck.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
AnomaloCheck.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
AnomaloCheck.MEANINGS = RelationField("meanings")
AnomaloCheck.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
