...
def _dbt_seed_from_nested(nested: DbtSeedNested) -> DbtSeed:
    ...
    kwargs.update(_extract_dbt_seed_attrs(attrs))
    kwargs.update(merged_rels)
    return DbtSeed(**kwargs)
...
DbtSeed.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
DbtSeed.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
DbtSeed.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
DbtSeed.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
DbtSeed.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
