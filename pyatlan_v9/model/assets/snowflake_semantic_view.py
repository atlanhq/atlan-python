...
def _snowflake_semantic_view_from_nested(
    ...
    kwargs.update(_extract_snowflake_semantic_view_attrs(attrs))
    kwargs.update(merged_rels)
    return SnowflakeSemanticView(**kwargs)
...
SnowflakeSemanticView.SQL_COALESCE_LAST_RUN_STATUS = KeywordField(
    "sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus"
)
SnowflakeSemanticView.SQL_COALESCE_NODE_STATUS = KeywordField(
    "sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus"
)
SnowflakeSemanticView.SQL_COALESCE_LAST_RUN_AT = NumericField(
    "sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt"
)
SnowflakeSemanticView.SQL_COALESCE_NODE_TYPE = KeywordField(
    "sqlCoalesceNodeType", "sqlCoalesceNodeType"
)
SnowflakeSemanticView.SQL_COALESCE_ENVIRONMENT_ID = KeywordField(
    "sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId"
)
SnowflakeSemanticView.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField(
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName.text",
)
SnowflakeSemanticView.SQL_COALESCE_PROJECT_ID = KeywordField(
    "sqlCoalesceProjectId", "sqlCoalesceProjectId"
)
SnowflakeSemanticView.SQL_COALESCE_PROJECT_NAME = KeywordTextField(
    "sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text"
)
SnowflakeSemanticView.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
...
SnowflakeSemanticView.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
