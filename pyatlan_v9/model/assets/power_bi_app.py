...
def _power_bi_app_from_nested(nested: PowerBIAppNested) -> PowerBIApp:
    ...
    kwargs.update(_extract_power_bi_app_attrs(attrs))
    kwargs.update(merged_rels)
    return PowerBIApp(**kwargs)
...
PowerBIApp.CATALOG_DATASET_GUID = KeywordField(
...
PowerBIApp.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
PowerBIApp.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
PowerBIApp.MEANINGS = RelationField("meanings")
PowerBIApp.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
