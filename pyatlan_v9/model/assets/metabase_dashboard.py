...
def _metabase_dashboard_from_nested(
    ...
    kwargs.update(_extract_metabase_dashboard_attrs(attrs))
    kwargs.update(merged_rels)
    return MetabaseDashboard(**kwargs)
...
MetabaseDashboard.CATALOG_DATASET_GUID = KeywordField(
...
MetabaseDashboard.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
MetabaseDashboard.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
MetabaseDashboard.MEANINGS = RelationField("meanings")
MetabaseDashboard.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
