...
def _s3_bucket_from_nested(nested: S3BucketNested) -> S3Bucket:
    ...
    kwargs.update(_extract_s3_bucket_attrs(attrs))
...
S3Bucket.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
S3Bucket.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
