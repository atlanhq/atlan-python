...
class S3Bucket(Asset):
    ...
    objects: list[RelatedS3Object] | None | UnsetType = UNSET
    """S3 objects within this bucket."""

    s3_prefixes: list[RelatedS3Prefix] | None | UnsetType = UNSET
...
class S3BucketNested(AssetNested):
    ...
    attributes: S3BucketAttributes | UnsetType = UNSET
    relationship_attributes: S3BucketRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: S3BucketRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: S3BucketRelationshipAttributes | UnsetType = UNSET
