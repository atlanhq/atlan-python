...
class Custom(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Custom instance.
    ...
    def minimize(self) -> "Custom":
        """
        Return a minimal copy of this Custom with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Custom with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Custom instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedCustom":
        """
        Create a :class:`RelatedCustom` reference from this instance.
        ...
        Returns:
            A RelatedCustom reference to this asset.
        """
...
def _custom_to_nested(custom: Custom) -> CustomNested:
    ...
    return CustomNested(
        ...
        depth=custom.depth,
        immediate_upstream=custom.immediate_upstream,
        immediate_downstream=custom.immediate_downstream,
        attributes=attrs,
...
Custom.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
Custom.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Custom.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Custom.MEANINGS = RelationField("meanings")
Custom.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
