...
class S3Prefix(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this S3Prefix instance.
    ...
    def minimize(self) -> "S3Prefix":
        """
        Return a minimal copy of this S3Prefix with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new S3Prefix with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new S3Prefix instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedS3Prefix":
        """
        Create a :class:`RelatedS3Prefix` reference from this instance.
        ...
        Returns:
            A RelatedS3Prefix reference to this asset.
        """
...
def _s3_prefix_from_nested(nested: S3PrefixNested) -> S3Prefix:
    ...
    kwargs.update(_extract_s3_prefix_attrs(attrs))
    kwargs.update(merged_rels)
    return S3Prefix(**kwargs)
