...
class ModelEntity(Asset):
    ...
    model_entity_mapped_from_entities: list[RelatedModelEntity] | None | UnsetType = (
        UNSET
    )
...
class ModelEntityNested(AssetNested):
    ...
    append_relationship_attributes: ModelEntityRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: ModelEntityRelationshipAttributes | UnsetType = (
        UNSET
    )
