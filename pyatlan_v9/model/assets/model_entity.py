...
class ModelEntity(Asset):
    ...
    model_versions: list[RelatedModelVersion] | None | UnsetType = UNSET
    """Data model version(s) in which this entity exists."""

    model_entity_mapped_to_entities: list[RelatedModelEntity] | None | UnsetType = UNSET
    """Entities to which this entity is mapped."""

    model_entity_mapped_from_entities: list[RelatedModelEntity] | None | UnsetType = UNSET
    """Entities from which this entity is mapped."""

    model_entity_implemented_by_assets: list[RelatedCatalog] | None | UnsetType = UNSET
    """Assets that implement this entity."""

    model_implemented_entities: list[RelatedModelEntity] | None | UnsetType = UNSET
    """Entities implemented by this asset."""

    model_entity_specialization_entities: list[RelatedModelEntity] | None | UnsetType = UNSET
    """Specialized entities derived from the general entity."""

    model_entity_generalization_entity: RelatedModelEntity | None | UnsetType = UNSET
    """General entity, representing shared characteristics of specialized entities."""

    model_entity_related_from_entities: list[RelatedModelEntityAssociation] | None | UnsetType = UNSET
    """Association from which this entity is related."""

    model_entity_related_to_entities: list[RelatedModelEntityAssociation] | None | UnsetType = UNSET
    """Association to which this entity is related."""

    model_entity_attributes: list[RelatedModelAttribute] | None | UnsetType = UNSET
...
class ModelEntityNested(AssetNested):
    ...
    attributes: ModelEntityAttributes | UnsetType = UNSET
    relationship_attributes: ModelEntityRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: ModelEntityRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: ModelEntityRelationshipAttributes | UnsetType = UNSET
