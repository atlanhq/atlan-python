...
class ModelEntity(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        ...
        if for_creation:
            ...
            if self.model_versions is UNSET:
                errors.append("model_versions is required for creation")
        if errors:
...
def _model_entity_from_nested(nested: ModelEntityNested) -> ModelEntity:
    ...
    kwargs.update(_extract_model_entity_attrs(attrs))
    kwargs.update(merged_rels)
    return ModelEntity(**kwargs)
...
ModelEntity.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
ModelEntity.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
ModelEntity.MEANINGS = RelationField("meanings")
ModelEntity.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
