...
class MatillionJobNested(AssetNested):
    ...
    append_relationship_attributes: MatillionJobRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: MatillionJobRelationshipAttributes | UnsetType = (
        UNSET
    )
