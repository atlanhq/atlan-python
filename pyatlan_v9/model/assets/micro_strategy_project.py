...
def _micro_strategy_project_from_nested(
    ...
    kwargs.update(_extract_micro_strategy_project_attrs(attrs))
    kwargs.update(merged_rels)
    return MicroStrategyProject(**kwargs)
...
MicroStrategyProject.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
