...
def _dbt_column_process_from_nested(nested: DbtColumnProcessNested) -> DbtColumnProcess:
    ...
    kwargs.update(_extract_dbt_column_process_attrs(attrs))
    kwargs.update(merged_rels)
    return DbtColumnProcess(**kwargs)
...
DbtColumnProcess.CATALOG_DATASET_GUID = KeywordField(
...
DbtColumnProcess.PROCESS_DERIVATION = KeywordField(
...
DbtColumnProcess.BIGQUERY_ROUTINES = RelationField("bigqueryRoutines")
DbtColumnProcess.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
DbtColumnProcess.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
DbtColumnProcess.MEANINGS = RelationField("meanings")
DbtColumnProcess.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
