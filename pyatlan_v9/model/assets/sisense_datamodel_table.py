...
def _sisense_datamodel_table_from_nested(
    ...
    kwargs.update(_extract_sisense_datamodel_table_attrs(attrs))
    kwargs.update(merged_rels)
    return SisenseDatamodelTable(**kwargs)
...
SisenseDatamodelTable.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
