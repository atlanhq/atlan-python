...
class ReadmeTemplate(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this ReadmeTemplate instance.
    ...
    def minimize(self) -> "ReadmeTemplate":
        """
        Return a minimal copy of this ReadmeTemplate with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new ReadmeTemplate with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new ReadmeTemplate instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedReadmeTemplate":
        """
        Create a :class:`RelatedReadmeTemplate` reference from this instance.
        ...
        Returns:
            A RelatedReadmeTemplate reference to this asset.
        """
...
def _readme_template_to_nested(readme_template: ReadmeTemplate) -> ReadmeTemplateNested:
    ...
    return ReadmeTemplateNested(
        ...
        depth=readme_template.depth,
        immediate_upstream=readme_template.immediate_upstream,
        immediate_downstream=readme_template.immediate_downstream,
        attributes=attrs,
...
ReadmeTemplate.CATALOG_DATASET_GUID = KeywordField(
...
ReadmeTemplate.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
ReadmeTemplate.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
ReadmeTemplate.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
ReadmeTemplate.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
ReadmeTemplate.MEANINGS = RelationField("meanings")
ReadmeTemplate.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
