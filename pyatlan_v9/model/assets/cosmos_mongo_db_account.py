...
def _cosmos_mongo_db_account_from_nested(
    ...
    return CosmosMongoDBAccount(**kwargs)
...
CosmosMongoDBAccount.CATALOG_DATASET_GUID = KeywordField(
...
CosmosMongoDBAccount.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
