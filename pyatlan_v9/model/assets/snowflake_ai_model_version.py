...
def _snowflake_ai_model_version_from_nested(
    ...
    kwargs.update(_extract_snowflake_ai_model_version_attrs(attrs))
    kwargs.update(merged_rels)
    return SnowflakeAIModelVersion(**kwargs)
...
SnowflakeAIModelVersion.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
SnowflakeAIModelVersion.MEANINGS = RelationField("meanings")
SnowflakeAIModelVersion.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
