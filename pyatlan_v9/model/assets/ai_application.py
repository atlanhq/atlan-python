...
AIApplication.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
AIApplication.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
AIApplication.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
