...
class IcebergCatalogNested(AssetNested):
    ...
    append_relationship_attributes: IcebergCatalogRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: IcebergCatalogRelationshipAttributes | UnsetType = (
        UNSET
    )
