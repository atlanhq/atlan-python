...
def _bigquery_routine_from_nested(nested: BigqueryRoutineNested) -> BigqueryRoutine:
    ...
    kwargs.update(_extract_bigquery_routine_attrs(attrs))
    kwargs.update(merged_rels)
    return BigqueryRoutine(**kwargs)
...
BigqueryRoutine.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
...
BigqueryRoutine.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
