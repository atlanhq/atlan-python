...
from .unstructured_related import RelatedUnstructuredContainer, RelatedUnstructuredFolder
...
class UnstructuredObject(Asset):
    ...
    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> UnstructuredObject:
        """
...
class UnstructuredObjectNested(AssetNested):
    ...
    relationship_attributes: Union[UnstructuredObjectRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[UnstructuredObjectRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[UnstructuredObjectRelationshipAttributes, UnsetType] = UNSET
...
def _populate_unstructured_object_attrs(attrs: UnstructuredObjectAttributes, obj: UnstructuredObject) -> None:
    ...
    attrs.unstructured_object_content_language = obj.unstructured_object_content_language
...
def _extract_unstructured_object_attrs(attrs: UnstructuredObjectAttributes) -> dict:
    ...
    result["unstructured_object_content_language"] = attrs.unstructured_object_content_language
...
def _unstructured_object_to_nested(unstructured_object: UnstructuredObject) -> UnstructuredObjectNested:
    ...
    replace_rels, append_rels, remove_rels = categorize_relationships(
        unstructured_object, _UNSTRUCTURED_OBJECT_REL_FIELDS, UnstructuredObjectRelationshipAttributes
    )
...
def _unstructured_object_from_nested(nested: UnstructuredObjectNested) -> UnstructuredObject:
    """Convert nested format to flat UnstructuredObject."""
    attrs = nested.attributes if nested.attributes is not UNSET else UnstructuredObjectAttributes()
...
def _unstructured_object_to_nested_bytes(unstructured_object: UnstructuredObject, serde: Serde) -> bytes:
...
def _unstructured_object_from_nested_bytes(data: bytes, serde: Serde) -> UnstructuredObject:
...
UnstructuredObject.UNSTRUCTURED_OBJECT_KEY = KeywordField("unstructuredObjectKey", "unstructuredObjectKey")
UnstructuredObject.UNSTRUCTURED_OBJECT_SIZE = NumericField("unstructuredObjectSize", "unstructuredObjectSize")
UnstructuredObject.UNSTRUCTURED_OBJECT_EXTENSION = KeywordField("unstructuredObjectExtension", "unstructuredObjectExtension")
UnstructuredObject.UNSTRUCTURED_OBJECT_MIME_TYPE = KeywordField("unstructuredObjectMimeType", "unstructuredObjectMimeType")
UnstructuredObject.UNSTRUCTURED_OBJECT_CONTENT_LANGUAGE = KeywordField("unstructuredObjectContentLanguage", "unstructuredObjectContentLanguage")
UnstructuredObject.UNSTRUCTURED_CONTAINER_NAME = KeywordField("unstructuredContainerName", "unstructuredContainerName")
UnstructuredObject.UNSTRUCTURED_CONTAINER_QUALIFIED_NAME = KeywordField("unstructuredContainerQualifiedName", "unstructuredContainerQualifiedName")
UnstructuredObject.UNSTRUCTURED_PARENT_FOLDER_QUALIFIED_NAME = KeywordField("unstructuredParentFolderQualifiedName", "unstructuredParentFolderQualifiedName")
UnstructuredObject.UNSTRUCTURED_FOLDER_HIERARCHY = KeywordField("unstructuredFolderHierarchy", "unstructuredFolderHierarchy")
UnstructuredObject.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
UnstructuredObject.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
UnstructuredObject.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
UnstructuredObject.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
UnstructuredObject.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
...
UnstructuredObject.UNSTRUCTURED_PARENT_FOLDER = RelationField("unstructuredParentFolder")