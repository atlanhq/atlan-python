...
def _unstructured_object_from_nested(
    ...
    kwargs.update(_extract_unstructured_object_attrs(attrs))
    kwargs.update(merged_rels)
    return UnstructuredObject(**kwargs)
...
UnstructuredObject.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
