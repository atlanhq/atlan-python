...
class FabricVisual(Asset):
    ...
    FABRIC_PAGE_QUALIFIED_NAME: ClassVar[Any] = None
    FABRIC_PAGE_NAME: ClassVar[Any] = None
    FABRIC_VISUAL_TYPE: ClassVar[Any] = None
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this FabricVisual instance.
    ...
    def minimize(self) -> "FabricVisual":
        """
        Return a minimal copy of this FabricVisual with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new FabricVisual with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new FabricVisual instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedFabricVisual":
        """
        Create a :class:`RelatedFabricVisual` reference from this instance.
        ...
        Returns:
            A RelatedFabricVisual reference to this asset.
        """
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _fabric_visual_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> FabricVisual:
        """
...
_FABRIC_VISUAL_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
def _populate_fabric_visual_attrs(
    ...
    attrs.fabric_page_name = obj.fabric_page_name
    attrs.fabric_visual_type = obj.fabric_visual_type
...
def _extract_fabric_visual_attrs(attrs: FabricVisualAttributes) -> dict:
    ...
    result["fabric_page_qualified_name"] = attrs.fabric_page_qualified_name
    result["fabric_page_name"] = attrs.fabric_page_name
    result["fabric_visual_type"] = attrs.fabric_visual_type
...
def _fabric_visual_to_nested(fabric_visual: FabricVisual) -> FabricVisualNested:
    ...
    _populate_fabric_visual_attrs(attrs, fabric_visual)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        fabric_visual, _FABRIC_VISUAL_REL_FIELDS, FabricVisualRelationshipAttributes
    )
...
FabricVisual.CATALOG_DATASET_GUID = KeywordField(
    "catalogDatasetGuid", "catalogDatasetGuid"
)
FabricVisual.INPUT_TO_AIRFLOW_TASKS = RelationField("inputToAirflowTasks")
FabricVisual.OUTPUT_FROM_AIRFLOW_TASKS = RelationField("outputFromAirflowTasks")
FabricVisual.ANOMALO_CHECKS = RelationField("anomaloChecks")
FabricVisual.APPLICATION = RelationField("application")
FabricVisual.APPLICATION_FIELD = RelationField("applicationField")
FabricVisual.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
FabricVisual.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
FabricVisual.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
    "dataContractLatestCertified"
)
FabricVisual.OUTPUT_PORT_DATA_PRODUCTS = RelationField("outputPortDataProducts")
FabricVisual.INPUT_PORT_DATA_PRODUCTS = RelationField("inputPortDataProducts")
FabricVisual.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
FabricVisual.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
FabricVisual.METRICS = RelationField("metrics")
...
FabricVisual.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
FabricVisual.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
FabricVisual.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
FabricVisual.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
FabricVisual.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
FabricVisual.FILES = RelationField("files")
FabricVisual.LINKS = RelationField("links")
FabricVisual.README = RelationField("readme")
FabricVisual.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
FabricVisual.SODA_CHECKS = RelationField("sodaChecks")
FabricVisual.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
FabricVisual.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
