...
def _adls_from_nested(nested: ADLSNested) -> ADLS:
    ...
    kwargs.update(_extract_adls_attrs(attrs))
...
ADLS.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
ADLS.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
ADLS.MEANINGS = RelationField("meanings")
ADLS.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
