...
def _semantic_dimension_from_nested(
    ...
    kwargs.update(_extract_semantic_dimension_attrs(attrs))
    kwargs.update(merged_rels)
    return SemanticDimension(**kwargs)
...
SemanticDimension.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
SemanticDimension.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
SemanticDimension.MEANINGS = RelationField("meanings")
SemanticDimension.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
