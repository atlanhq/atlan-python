...
class SAPBWInfoArea(Asset):
    ...
    sap_bw_composite_providers: Union[
        List[RelatedSAPBWCompositeProvider], None, UnsetType
    ] = UNSET
...
class SAPBWInfoAreaNested(AssetNested):
    ...
    relationship_attributes: Union[SAPBWInfoAreaRelationshipAttributes, UnsetType] = (
        UNSET
    )
    append_relationship_attributes: Union[
        SAPBWInfoAreaRelationshipAttributes, UnsetType
    ] = UNSET
...
def _populate_sapbw_info_area_attrs(
    attrs: SAPBWInfoAreaAttributes, obj: SAPBWInfoArea
) -> None:
...
def _sapbw_info_area_from_nested(nested: SAPBWInfoAreaNested) -> SAPBWInfoArea:
    ...
    kwargs.update(_extract_sapbw_info_area_attrs(attrs))
    kwargs.update(merged_rels)
    return SAPBWInfoArea(**kwargs)


def _sapbw_info_area_to_nested_bytes(
    sapbw_info_area: SAPBWInfoArea, serde: Serde
) -> bytes:
...
SAPBWInfoArea.SAP_BW_OBJECT_STATUS = KeywordField(
    "sapBwObjectStatus", "sapBwObjectStatus"
)
SAPBWInfoArea.SAP_BW_PARENT_NAME = KeywordField("sapBwParentName", "sapBwParentName")
SAPBWInfoArea.SAP_BW_PARENT_QUALIFIED_NAME = KeywordField(
    "sapBwParentQualifiedName", "sapBwParentQualifiedName"
)
SAPBWInfoArea.SAP_BW_INFO_OBJECT_NAME = KeywordField(
    "sapBwInfoObjectName", "sapBwInfoObjectName"
)
SAPBWInfoArea.SAP_BW_INFO_OBJECT_QUALIFIED_NAME = KeywordField(
...
SAPBWInfoArea.CATALOG_DATASET_GUID = KeywordField(
...
SAPBWInfoArea.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
SAPBWInfoArea.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
