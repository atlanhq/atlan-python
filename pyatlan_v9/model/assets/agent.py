...
class AgentNested(AssetNested):
    ...
    append_relationship_attributes: Union[AgentRelationshipAttributes, UnsetType] = (
        UNSET
    )
    remove_relationship_attributes: Union[AgentRelationshipAttributes, UnsetType] = (
        UNSET
    )
...
def _agent_from_nested(nested: AgentNested) -> Agent:
    ...
    kwargs.update(_extract_agent_attrs(attrs))
...
Agent.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
