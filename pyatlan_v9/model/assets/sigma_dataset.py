...
class SigmaDatasetNested(AssetNested):
    ...
    append_relationship_attributes: SigmaDatasetRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: SigmaDatasetRelationshipAttributes | UnsetType = (
        UNSET
    )
