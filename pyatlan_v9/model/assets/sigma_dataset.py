...
class SigmaDataset(Asset):
    ...
    SIGMA_DATASET_COLUMNS: ClassVar[Any] = None
    ...
    sigma_dataset_columns: list[RelatedSigmaDatasetColumn] | None | UnsetType = UNSET
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _sigma_dataset_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> SigmaDataset:
        """
...
class SigmaDatasetNested(AssetNested):
    ...
    attributes: SigmaDatasetAttributes | UnsetType = UNSET
    relationship_attributes: SigmaDatasetRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: SigmaDatasetRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: SigmaDatasetRelationshipAttributes | UnsetType = UNSET

# =============================================================================
# CONVERSION HELPERS & CONSTANTS
# =============================================================================

_SIGMA_DATASET_REL_FIELDS: list[str] = [
    *_ASSET_REL_FIELDS,
...
def _sigma_dataset_to_nested(sigma_dataset: SigmaDataset) -> SigmaDatasetNested:
    ...
    _populate_sigma_dataset_attrs(attrs, sigma_dataset)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        sigma_dataset, _SIGMA_DATASET_REL_FIELDS, SigmaDatasetRelationshipAttributes
    )
...
SigmaDataset.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
SigmaDataset.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
SigmaDataset.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
SigmaDataset.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
SigmaDataset.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
SigmaDataset.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
SigmaDataset.FILES = RelationField("files")
SigmaDataset.LINKS = RelationField("links")
SigmaDataset.README = RelationField("readme")
SigmaDataset.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
SigmaDataset.SIGMA_DATASET_COLUMNS = RelationField("sigmaDatasetColumns")
SigmaDataset.SODA_CHECKS = RelationField("sodaChecks")
SigmaDataset.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
SigmaDataset.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")