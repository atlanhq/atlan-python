...
class FabricActivity(Asset):
    ...
    FABRIC_DATA_PIPELINE_QUALIFIED_NAME: ClassVar[Any] = None
    FABRIC_ACTIVITY_TYPE: ClassVar[Any] = None
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _fabric_activity_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> FabricActivity:
        """
...
_FABRIC_ACTIVITY_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
def _populate_fabric_activity_attrs(
    ...
    attrs.fabric_activity_type = obj.fabric_activity_type
...
def _fabric_activity_from_nested(nested: FabricActivityNested) -> FabricActivity:
    ...
    kwargs.update(_extract_fabric_activity_attrs(attrs))
    kwargs.update(merged_rels)
    return FabricActivity(**kwargs)
...
FabricActivity.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
FabricActivity.MC_MONITORS = RelationField("mcMonitors")
FabricActivity.MC_INCIDENTS = RelationField("mcIncidents")
FabricActivity.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
FabricActivity.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
FabricActivity.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
FabricActivity.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
FabricActivity.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
FabricActivity.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
FabricActivity.FILES = RelationField("files")
FabricActivity.LINKS = RelationField("links")
FabricActivity.README = RelationField("readme")
FabricActivity.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
FabricActivity.SODA_CHECKS = RelationField("sodaChecks")
FabricActivity.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
FabricActivity.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
