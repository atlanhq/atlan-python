...
class CognosReportNested(AssetNested):
    ...
    relationship_attributes: Union[CognosReportRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[CognosReportRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[CognosReportRelationshipAttributes, UnsetType] = UNSET
...
CognosReport.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
CognosReport.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
CognosReport.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
