...
class CognosReport(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this CognosReport instance.
    ...
    def minimize(self) -> "CognosReport":
        """
        Return a minimal copy of this CognosReport with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new CognosReport with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new CognosReport instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedCognosReport":
        """
        Create a :class:`RelatedCognosReport` reference from this instance.
        ...
        Returns:
            A RelatedCognosReport reference to this asset.
        """
...
def _cognos_report_to_nested(cognos_report: CognosReport) -> CognosReportNested:
    ...
    return CognosReportNested(
        ...
        depth=cognos_report.depth,
        immediate_upstream=cognos_report.immediate_upstream,
        immediate_downstream=cognos_report.immediate_downstream,
        attributes=attrs,
...
def _cognos_report_from_nested(nested: CognosReportNested) -> CognosReport:
    ...
    kwargs.update(_extract_cognos_report_attrs(attrs))
    kwargs.update(merged_rels)
    return CognosReport(**kwargs)
...
CognosReport.CATALOG_DATASET_GUID = KeywordField(
...
CognosReport.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
CognosReport.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
CognosReport.DATA_CONTRACT_LATEST_CERTIFIED = RelationField(
...
CognosReport.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
CognosReport.MEANINGS = RelationField("meanings")
CognosReport.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
