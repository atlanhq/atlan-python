...
def _power_bi_datasource_from_nested(
    ...
    kwargs.update(_extract_power_bi_datasource_attrs(attrs))
    kwargs.update(merged_rels)
    return PowerBIDatasource(**kwargs)
...
PowerBIDatasource.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
PowerBIDatasource.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
PowerBIDatasource.MEANINGS = RelationField("meanings")
PowerBIDatasource.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
