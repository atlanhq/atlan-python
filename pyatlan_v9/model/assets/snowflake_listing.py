...
def _snowflake_listing_from_nested(nested: SnowflakeListingNested) -> SnowflakeListing:
    ...
    kwargs.update(_extract_snowflake_listing_attrs(attrs))
    kwargs.update(merged_rels)
    return SnowflakeListing(**kwargs)
...
SnowflakeListing.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
