...
from .snowflake_related import RelatedSnowflakeSemanticLogicalTable, RelatedSnowflakeShare
...
class SnowflakeListing(Asset):
    ...
    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> SnowflakeListing:
        """
...
class SnowflakeListingNested(AssetNested):
    ...
    relationship_attributes: Union[SnowflakeListingRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[SnowflakeListingRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[SnowflakeListingRelationshipAttributes, UnsetType] = UNSET
...
def _populate_snowflake_listing_attrs(attrs: SnowflakeListingAttributes, obj: SnowflakeListing) -> None:
...
def _extract_snowflake_listing_attrs(attrs: SnowflakeListingAttributes) -> dict:
    ...
    result["snowflake_uniform_listing_locator"] = attrs.snowflake_uniform_listing_locator
...
def _snowflake_listing_to_nested(snowflake_listing: SnowflakeListing) -> SnowflakeListingNested:
    ...
    replace_rels, append_rels, remove_rels = categorize_relationships(
        snowflake_listing, _SNOWFLAKE_LISTING_REL_FIELDS, SnowflakeListingRelationshipAttributes
    )
...
def _snowflake_listing_from_nested(nested: SnowflakeListingNested) -> SnowflakeListing:
    ...
    attrs = nested.attributes if nested.attributes is not UNSET else SnowflakeListingAttributes()
...
def _snowflake_listing_to_nested_bytes(snowflake_listing: SnowflakeListing, serde: Serde) -> bytes:
...
SnowflakeListing.SNOWFLAKE_SUBTITLE = KeywordField("snowflakeSubtitle", "snowflakeSubtitle")
SnowflakeListing.SNOWFLAKE_UNIFORM_LISTING_LOCATOR = KeywordField("snowflakeUniformListingLocator", "snowflakeUniformListingLocator")
SnowflakeListing.SNOWFLAKE_STATE = KeywordField("snowflakeState", "snowflakeState")
SnowflakeListing.SNOWFLAKE_DISTRIBUTION = KeywordField("snowflakeDistribution", "snowflakeDistribution")
SnowflakeListing.SNOWFLAKE_IS_SHARE = BooleanField("snowflakeIsShare", "snowflakeIsShare")
SnowflakeListing.SNOWFLAKE_IS_APPLICATION = BooleanField("snowflakeIsApplication", "snowflakeIsApplication")
SnowflakeListing.SNOWFLAKE_APPLICATION_PACKAGE = KeywordField("snowflakeApplicationPackage", "snowflakeApplicationPackage")
SnowflakeListing.SNOWFLAKE_CATEGORIES = KeywordField("snowflakeCategories", "snowflakeCategories")
SnowflakeListing.SNOWFLAKE_DATA_ATTRIBUTES = KeywordField("snowflakeDataAttributes", "snowflakeDataAttributes")
SnowflakeListing.SNOWFLAKE_TERMS = KeywordField("snowflakeTerms", "snowflakeTerms")
SnowflakeListing.SNOWFLAKE_PROFILE = KeywordField("snowflakeProfile", "snowflakeProfile")
SnowflakeListing.SNOWFLAKE_SUPPORT_CONTACT = KeywordField("snowflakeSupportContact", "snowflakeSupportContact")
SnowflakeListing.SNOWFLAKE_RESHARING = KeywordField("snowflakeResharing", "snowflakeResharing")
SnowflakeListing.SNOWFLAKE_AUTO_FULFILLMENT = KeywordField("snowflakeAutoFulfillment", "snowflakeAutoFulfillment")
SnowflakeListing.SNOWFLAKE_TARGETS = KeywordField("snowflakeTargets", "snowflakeTargets")
...
SnowflakeListing.QUERY_COUNT_UPDATED_AT = NumericField("queryCountUpdatedAt", "queryCountUpdatedAt")
SnowflakeListing.DATABASE_NAME = KeywordField("databaseName", "databaseName")
SnowflakeListing.DATABASE_QUALIFIED_NAME = KeywordField("databaseQualifiedName", "databaseQualifiedName")
SnowflakeListing.SCHEMA_NAME = KeywordField("schemaName", "schemaName")
SnowflakeListing.SCHEMA_QUALIFIED_NAME = KeywordField("schemaQualifiedName", "schemaQualifiedName")
SnowflakeListing.TABLE_NAME = KeywordField("tableName", "tableName")
SnowflakeListing.TABLE_QUALIFIED_NAME = KeywordField("tableQualifiedName", "tableQualifiedName")
SnowflakeListing.VIEW_NAME = KeywordField("viewName", "viewName")
SnowflakeListing.VIEW_QUALIFIED_NAME = KeywordField("viewQualifiedName", "viewQualifiedName")
SnowflakeListing.CALCULATION_VIEW_NAME = KeywordField("calculationViewName", "calculationViewName")
SnowflakeListing.CALCULATION_VIEW_QUALIFIED_NAME = KeywordField("calculationViewQualifiedName", "calculationViewQualifiedName")
...
SnowflakeListing.SQL_AI_MODEL_CONTEXT_QUALIFIED_NAME = KeywordField("sqlAIModelContextQualifiedName", "sqlAIModelContextQualifiedName")
SnowflakeListing.SQL_IS_SECURE = BooleanField("sqlIsSecure", "sqlIsSecure")
SnowflakeListing.SQL_HAS_AI_INSIGHTS = BooleanField("sqlHasAiInsights", "sqlHasAiInsights")
SnowflakeListing.SQL_AI_INSIGHTS_LAST_ANALYZED_AT = NumericField("sqlAiInsightsLastAnalyzedAt", "sqlAiInsightsLastAnalyzedAt")
SnowflakeListing.SQL_AI_INSIGHTS_POPULAR_BUSINESS_QUESTION_COUNT = NumericField("sqlAiInsightsPopularBusinessQuestionCount", "sqlAiInsightsPopularBusinessQuestionCount")
SnowflakeListing.SQL_AI_INSIGHTS_POPULAR_JOIN_COUNT = NumericField("sqlAiInsightsPopularJoinCount", "sqlAiInsightsPopularJoinCount")
SnowflakeListing.SQL_AI_INSIGHTS_POPULAR_FILTER_COUNT = NumericField("sqlAiInsightsPopularFilterCount", "sqlAiInsightsPopularFilterCount")
SnowflakeListing.SQL_AI_INSIGHTS_RELATIONSHIP_COUNT = NumericField("sqlAiInsightsRelationshipCount", "sqlAiInsightsRelationshipCount")
SnowflakeListing.SQL_COALESCE_LAST_RUN_STATUS = KeywordField("sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus")
SnowflakeListing.SQL_COALESCE_NODE_STATUS = KeywordField("sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus")
SnowflakeListing.SQL_COALESCE_LAST_RUN_AT = NumericField("sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt")
SnowflakeListing.SQL_COALESCE_NODE_TYPE = KeywordField("sqlCoalesceNodeType", "sqlCoalesceNodeType")
SnowflakeListing.SQL_COALESCE_ENVIRONMENT_ID = KeywordField("sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId")
SnowflakeListing.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField("sqlCoalesceEnvironmentName", "sqlCoalesceEnvironmentName", "sqlCoalesceEnvironmentName.text")
SnowflakeListing.SQL_COALESCE_PROJECT_ID = KeywordField("sqlCoalesceProjectId", "sqlCoalesceProjectId")
SnowflakeListing.SQL_COALESCE_PROJECT_NAME = KeywordTextField("sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text")
SnowflakeListing.SQL_SHARE_QUALIFIED_NAMES = KeywordField("sqlShareQualifiedNames", "sqlShareQualifiedNames")
SnowflakeListing.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
SnowflakeListing.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
SnowflakeListing.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
...
SnowflakeListing.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
...
SnowflakeListing.SNOWFLAKE_SEMANTIC_LOGICAL_TABLES = RelationField("snowflakeSemanticLogicalTables")
...
SnowflakeListing.SQL_INSIGHT_BUSINESS_QUESTIONS = RelationField("sqlInsightBusinessQuestions")