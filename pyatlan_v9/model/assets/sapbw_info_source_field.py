...
def _sapbw_info_source_field_from_nested(
    ...
    kwargs.update(_extract_sapbw_info_source_field_attrs(attrs))
    kwargs.update(merged_rels)
    return SAPBWInfoSourceField(**kwargs)
...
SAPBWInfoSourceField.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
