...
def _tableau_site_from_nested(nested: TableauSiteNested) -> TableauSite:
    ...
    kwargs.update(_extract_tableau_site_attrs(attrs))
    kwargs.update(merged_rels)
    return TableauSite(**kwargs)
...
TableauSite.TABLEAU_SOURCE_READ_COUNTS = KeywordField(
    "tableauSourceReadCounts", "tableauSourceReadCounts"
)
TableauSite.CATALOG_DATASET_GUID = KeywordField(
...
TableauSite.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
TableauSite.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
TableauSite.MEANINGS = RelationField("meanings")
TableauSite.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
