...
def _fivetran_connector_from_nested(
    ...
    kwargs.update(_extract_fivetran_connector_attrs(attrs))
    kwargs.update(merged_rels)
    return FivetranConnector(**kwargs)
...
FivetranConnector.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
FivetranConnector.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
