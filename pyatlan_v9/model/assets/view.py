...
from .sql_related import RelatedColumn, RelatedQuery, RelatedSchema, RelatedView
...
class View(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this View instance.
        ...
        if errors:
            raise ValueError(f"View validation failed: {errors}")

    def minimize(self) -> "View":
        """
        Return a minimal copy of this View with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new View with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new View instance with only the minimum required fields.
        """
        self.validate()
        return View(qualified_name=self.qualified_name, name=self.name)

    def relate(self) -> "RelatedView":
        """
        Create a :class:`RelatedView` reference from this instance.
        ...
        Returns:
            A RelatedView reference to this asset.
        """
        if self.guid is not UNSET:
            return RelatedView(guid=self.guid)
        return RelatedView(qualified_name=self.qualified_name)
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _view_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> View:
        """
...
def _populate_view_attrs(attrs: ViewAttributes, obj: View) -> None:
    """Populate View-specific attributes on the attrs struct."""
...
def _extract_view_attrs(attrs: ViewAttributes) -> dict:
    """Extract all View attributes from the attrs struct into a flat dict."""
...
def _view_to_nested(view: View) -> ViewNested:
    """Convert flat View to nested format."""
    attrs = ViewAttributes()
    _populate_view_attrs(attrs, view)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        view, _VIEW_REL_FIELDS, ViewRelationshipAttributes
    )
    return ViewNested(
        guid=view.guid,
...
def _view_from_nested(nested: ViewNested) -> View:
    """Convert nested format to flat View."""
    ...
    kwargs.update(_extract_view_attrs(attrs))
...
View.COLUMN_COUNT = NumericField("columnCount", "columnCount")
View.ROW_COUNT = NumericField("rowCount", "rowCount")
View.SIZE_BYTES = NumericField("sizeBytes", "sizeBytes")
View.IS_QUERY_PREVIEW = BooleanField("isQueryPreview", "isQueryPreview")
View.QUERY_PREVIEW_CONFIG = KeywordField("queryPreviewConfig", "queryPreviewConfig")
View.ALIAS = KeywordField("alias", "alias")
View.IS_TEMPORARY = BooleanField("isTemporary", "isTemporary")
View.DEFINITION = KeywordField("definition", "definition")
View.QUERY_COUNT = NumericField("queryCount", "queryCount")
View.QUERY_USER_COUNT = NumericField("queryUserCount", "queryUserCount")
View.QUERY_USER_MAP = KeywordField("queryUserMap", "queryUserMap")
View.QUERY_COUNT_UPDATED_AT = NumericField("queryCountUpdatedAt", "queryCountUpdatedAt")
View.DATABASE_NAME = KeywordField("databaseName", "databaseName")
View.DATABASE_QUALIFIED_NAME = KeywordField(
    "databaseQualifiedName", "databaseQualifiedName"
)
View.SCHEMA_NAME = KeywordField("schemaName", "schemaName")
View.SCHEMA_QUALIFIED_NAME = KeywordField("schemaQualifiedName", "schemaQualifiedName")
View.TABLE_NAME = KeywordField("tableName", "tableName")
View.TABLE_QUALIFIED_NAME = KeywordField("tableQualifiedName", "tableQualifiedName")
View.VIEW_NAME = KeywordField("viewName", "viewName")
View.VIEW_QUALIFIED_NAME = KeywordField("viewQualifiedName", "viewQualifiedName")
View.CALCULATION_VIEW_NAME = KeywordField("calculationViewName", "calculationViewName")
View.CALCULATION_VIEW_QUALIFIED_NAME = KeywordField(
    "calculationViewQualifiedName", "calculationViewQualifiedName"
)
View.IS_PROFILED = BooleanField("isProfiled", "isProfiled")
View.LAST_PROFILED_AT = NumericField("lastProfiledAt", "lastProfiledAt")
View.SQL_AI_MODEL_CONTEXT_QUALIFIED_NAME = KeywordField(
    "sqlAIModelContextQualifiedName", "sqlAIModelContextQualifiedName"
)
View.SQL_IS_SECURE = BooleanField("sqlIsSecure", "sqlIsSecure")
View.SQL_HAS_AI_INSIGHTS = BooleanField("sqlHasAiInsights", "sqlHasAiInsights")
View.SQL_AI_INSIGHTS_LAST_ANALYZED_AT = NumericField(
    "sqlAiInsightsLastAnalyzedAt", "sqlAiInsightsLastAnalyzedAt"
)
View.SQL_AI_INSIGHTS_POPULAR_BUSINESS_QUESTION_COUNT = NumericField(
    "sqlAiInsightsPopularBusinessQuestionCount",
    "sqlAiInsightsPopularBusinessQuestionCount",
)
View.SQL_AI_INSIGHTS_POPULAR_JOIN_COUNT = NumericField(
    "sqlAiInsightsPopularJoinCount", "sqlAiInsightsPopularJoinCount"
)
View.SQL_AI_INSIGHTS_POPULAR_FILTER_COUNT = NumericField(
    "sqlAiInsightsPopularFilterCount", "sqlAiInsightsPopularFilterCount"
)
View.SQL_AI_INSIGHTS_RELATIONSHIP_COUNT = NumericField(
    "sqlAiInsightsRelationshipCount", "sqlAiInsightsRelationshipCount"
)
View.SQL_COALESCE_LAST_RUN_STATUS = KeywordField(
    "sqlCoalesceLastRunStatus", "sqlCoalesceLastRunStatus"
)
View.SQL_COALESCE_NODE_STATUS = KeywordField(
    "sqlCoalesceNodeStatus", "sqlCoalesceNodeStatus"
)
View.SQL_COALESCE_LAST_RUN_AT = NumericField(
    "sqlCoalesceLastRunAt", "sqlCoalesceLastRunAt"
)
View.SQL_COALESCE_NODE_TYPE = KeywordField("sqlCoalesceNodeType", "sqlCoalesceNodeType")
View.SQL_COALESCE_ENVIRONMENT_ID = KeywordField(
    "sqlCoalesceEnvironmentId", "sqlCoalesceEnvironmentId"
)
View.SQL_COALESCE_ENVIRONMENT_NAME = KeywordTextField(
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName",
    "sqlCoalesceEnvironmentName.text",
)
View.SQL_COALESCE_PROJECT_ID = KeywordField(
    "sqlCoalesceProjectId", "sqlCoalesceProjectId"
)
View.SQL_COALESCE_PROJECT_NAME = KeywordTextField(
    "sqlCoalesceProjectName", "sqlCoalesceProjectName", "sqlCoalesceProjectName.text"
)
View.SQL_SHARE_QUALIFIED_NAMES = KeywordField(
    "sqlShareQualifiedNames", "sqlShareQualifiedNames"
)
View.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
View.INPUT_TO_AIRFLOW_TASKS = RelationField("inputToAirflowTasks")
View.OUTPUT_FROM_AIRFLOW_TASKS = RelationField("outputFromAirflowTasks")
View.ANOMALO_CHECKS = RelationField("anomaloChecks")
View.APPLICATION = RelationField("application")
View.APPLICATION_FIELD = RelationField("applicationField")
View.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
View.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
View.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
View.OUTPUT_PORT_DATA_PRODUCTS = RelationField("outputPortDataProducts")
View.INPUT_PORT_DATA_PRODUCTS = RelationField("inputPortDataProducts")
View.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
View.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
View.METRICS = RelationField("metrics")
View.DQ_BASE_DATASET_RULES = RelationField("dqBaseDatasetRules")
View.DQ_REFERENCE_DATASET_RULES = RelationField("dqReferenceDatasetRules")
View.DBT_MODELS = RelationField("dbtModels")
View.SQL_DBT_MODELS = RelationField("sqlDbtModels")
View.DBT_TESTS = RelationField("dbtTests")
View.DBT_SOURCES = RelationField("dbtSources")
View.SQL_DBT_SOURCES = RelationField("sqlDBTSources")
View.DBT_SEED_ASSETS = RelationField("dbtSeedAssets")
View.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
View.MEANINGS = RelationField("meanings")
View.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
View.MC_MONITORS = RelationField("mcMonitors")
View.MC_INCIDENTS = RelationField("mcIncidents")
View.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
View.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
View.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
View.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
View.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
View.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
View.FILES = RelationField("files")
View.LINKS = RelationField("links")
View.README = RelationField("readme")
View.COLUMNS = RelationField("columns")
View.QUERIES = RelationField("queries")
View.ATLAN_SCHEMA = RelationField("atlanSchema")
View.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
View.SNOWFLAKE_SEMANTIC_LOGICAL_TABLES = RelationField("snowflakeSemanticLogicalTables")
View.SODA_CHECKS = RelationField("sodaChecks")
View.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
View.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
View.SQL_INSIGHT_OUTGOING_JOINS = RelationField("sqlInsightOutgoingJoins")
View.SQL_INSIGHT_INCOMING_JOINS = RelationField("sqlInsightIncomingJoins")
View.SQL_INSIGHT_BUSINESS_QUESTIONS = RelationField("sqlInsightBusinessQuestions")
