...
class Form(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Form instance.
    ...
    def minimize(self) -> "Form":
        """
        Return a minimal copy of this Form with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Form with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Form instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedForm":
        """
        Create a :class:`RelatedForm` reference from this instance.
        ...
        Returns:
            A RelatedForm reference to this asset.
        """
...
def _form_from_nested(nested: FormNested) -> Form:
    ...
    kwargs.update(_extract_form_attrs(attrs))
...
Form.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
Form.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
Form.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
