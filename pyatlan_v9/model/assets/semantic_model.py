...
def _semantic_model_from_nested(nested: SemanticModelNested) -> SemanticModel:
    ...
    kwargs.update(_extract_semantic_model_attrs(attrs))
    kwargs.update(merged_rels)
    return SemanticModel(**kwargs)
...
SemanticModel.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
SemanticModel.MEANINGS = RelationField("meanings")
SemanticModel.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
