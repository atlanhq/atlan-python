...
class SemanticModel(Asset):
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _semantic_model_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> SemanticModel:
        """
...
class SemanticModelNested(AssetNested):
    ...
    relationship_attributes: Union[SemanticModelRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[SemanticModelRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[SemanticModelRelationshipAttributes, UnsetType] = UNSET

# =============================================================================
# CONVERSION HELPERS & CONSTANTS
# =============================================================================

_SEMANTIC_MODEL_REL_FIELDS: List[str] = [
    *_ASSET_REL_FIELDS,
...
def _semantic_model_to_nested(semantic_model: SemanticModel) -> SemanticModelNested:
    ...
    _populate_semantic_model_attrs(attrs, semantic_model)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        semantic_model, _SEMANTIC_MODEL_REL_FIELDS, SemanticModelRelationshipAttributes
    )
...
SemanticModel.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
SemanticModel.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
SemanticModel.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
SemanticModel.METRICS = RelationField("metrics")
SemanticModel.DQ_BASE_DATASET_RULES = RelationField("dqBaseDatasetRules")
SemanticModel.DQ_REFERENCE_DATASET_RULES = RelationField("dqReferenceDatasetRules")
SemanticModel.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
SemanticModel.MEANINGS = RelationField("meanings")
SemanticModel.MC_MONITORS = RelationField("mcMonitors")
SemanticModel.MC_INCIDENTS = RelationField("mcIncidents")
SemanticModel.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
SemanticModel.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
SemanticModel.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
SemanticModel.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
SemanticModel.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
SemanticModel.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
SemanticModel.FILES = RelationField("files")
SemanticModel.LINKS = RelationField("links")
SemanticModel.README = RelationField("readme")
SemanticModel.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
SemanticModel.SEMANTIC_DIMENSIONS = RelationField("semanticDimensions")
SemanticModel.SEMANTIC_MEASURES = RelationField("semanticMeasures")
SemanticModel.SEMANTIC_ENTITIES = RelationField("semanticEntities")
SemanticModel.SODA_CHECKS = RelationField("sodaChecks")
SemanticModel.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
SemanticModel.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")