...
def _sap_erp_abap_program_from_nested(
    ...
    kwargs.update(_extract_sap_erp_abap_program_attrs(attrs))
    kwargs.update(merged_rels)
    return SapErpAbapProgram(**kwargs)
...
SapErpAbapProgram.CATALOG_DATASET_GUID = KeywordField(
...
SapErpAbapProgram.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
SapErpAbapProgram.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
