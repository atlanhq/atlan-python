...
class AnaplanModuleNested(AssetNested):
    ...
    relationship_attributes: Union[AnaplanModuleRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[AnaplanModuleRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[AnaplanModuleRelationshipAttributes, UnsetType] = UNSET
...
AnaplanModule.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
AnaplanModule.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
AnaplanModule.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
