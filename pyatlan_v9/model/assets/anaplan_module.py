...
class AnaplanModuleNested(AssetNested):
    ...
    append_relationship_attributes: AnaplanModuleRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: AnaplanModuleRelationshipAttributes | UnsetType = (
        UNSET
    )
