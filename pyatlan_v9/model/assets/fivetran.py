...
class Fivetran(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this Fivetran instance.
    ...
    def minimize(self) -> "Fivetran":
        """
        Return a minimal copy of this Fivetran with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new Fivetran with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new Fivetran instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedFivetran":
        """
        Create a :class:`RelatedFivetran` reference from this instance.
        ...
        Returns:
            A RelatedFivetran reference to this asset.
        """
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _fivetran_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> Fivetran:
        """
...
def _fivetran_to_nested(fivetran: Fivetran) -> FivetranNested:
    ...
    _populate_fivetran_attrs(attrs, fivetran)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        fivetran, _FIVETRAN_REL_FIELDS, FivetranRelationshipAttributes
    )
...
def _fivetran_from_nested(nested: FivetranNested) -> Fivetran:
    ...
    kwargs.update(_extract_fivetran_attrs(attrs))
    kwargs.update(merged_rels)
    return Fivetran(**kwargs)
...
Fivetran.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
Fivetran.APPLICATION = RelationField("application")
Fivetran.APPLICATION_FIELD = RelationField("applicationField")
Fivetran.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
Fivetran.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
Fivetran.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
Fivetran.OUTPUT_PORT_DATA_PRODUCTS = RelationField("outputPortDataProducts")
Fivetran.INPUT_PORT_DATA_PRODUCTS = RelationField("inputPortDataProducts")
Fivetran.MODEL_IMPLEMENTED_ENTITIES = RelationField("modelImplementedEntities")
Fivetran.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
Fivetran.METRICS = RelationField("metrics")
Fivetran.DQ_BASE_DATASET_RULES = RelationField("dqBaseDatasetRules")
Fivetran.DQ_REFERENCE_DATASET_RULES = RelationField("dqReferenceDatasetRules")
Fivetran.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Fivetran.MEANINGS = RelationField("meanings")
Fivetran.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
Fivetran.MC_MONITORS = RelationField("mcMonitors")
Fivetran.MC_INCIDENTS = RelationField("mcIncidents")
Fivetran.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
Fivetran.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
Fivetran.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
Fivetran.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
Fivetran.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
Fivetran.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
Fivetran.FILES = RelationField("files")
Fivetran.LINKS = RelationField("links")
Fivetran.README = RelationField("readme")
Fivetran.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
Fivetran.SODA_CHECKS = RelationField("sodaChecks")
Fivetran.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
Fivetran.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
