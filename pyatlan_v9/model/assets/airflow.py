...
class Airflow(Asset):
    ...
    def to_nested_bytes(self, serde: Serde | None = None) -> bytes:
        ...
        if serde is None:
            serde = get_serde()
        return _airflow_to_nested_bytes(self, serde)

    @staticmethod
    def from_json(json_data: str | bytes, serde: Serde | None = None) -> Airflow:
        """
...
def _airflow_to_nested(airflow: Airflow) -> AirflowNested:
    ...
    _populate_airflow_attrs(attrs, airflow)
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    replace_rels, append_rels, remove_rels = categorize_relationships(
        airflow, _AIRFLOW_REL_FIELDS, AirflowRelationshipAttributes
    )
...
def _airflow_from_nested(nested: AirflowNested) -> Airflow:
    ...
    kwargs.update(_extract_airflow_attrs(attrs))
    kwargs.update(merged_rels)
    return Airflow(**kwargs)
...
Airflow.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
Airflow.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
Airflow.MODEL_IMPLEMENTED_ATTRIBUTES = RelationField("modelImplementedAttributes")
Airflow.METRICS = RelationField("metrics")
Airflow.DQ_BASE_DATASET_RULES = RelationField("dqBaseDatasetRules")
Airflow.DQ_REFERENCE_DATASET_RULES = RelationField("dqReferenceDatasetRules")
Airflow.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
Airflow.MEANINGS = RelationField("meanings")
Airflow.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
Airflow.MC_MONITORS = RelationField("mcMonitors")
Airflow.MC_INCIDENTS = RelationField("mcIncidents")
Airflow.PARTIAL_CHILD_FIELDS = RelationField("partialChildFields")
Airflow.PARTIAL_CHILD_OBJECTS = RelationField("partialChildObjects")
Airflow.INPUT_TO_PROCESSES = RelationField("inputToProcesses")
Airflow.OUTPUT_FROM_PROCESSES = RelationField("outputFromProcesses")
Airflow.USER_DEF_RELATIONSHIP_TO = RelationField("userDefRelationshipTo")
Airflow.USER_DEF_RELATIONSHIP_FROM = RelationField("userDefRelationshipFrom")
Airflow.FILES = RelationField("files")
Airflow.LINKS = RelationField("links")
Airflow.README = RelationField("readme")
Airflow.SCHEMA_REGISTRY_SUBJECTS = RelationField("schemaRegistrySubjects")
Airflow.SODA_CHECKS = RelationField("sodaChecks")
Airflow.INPUT_TO_SPARK_JOBS = RelationField("inputToSparkJobs")
Airflow.OUTPUT_FROM_SPARK_JOBS = RelationField("outputFromSparkJobs")
Airflow.SPARK_ORCHESTRATED_ASSETS = RelationField("sparkOrchestratedAssets")
