...
def _gcs_from_nested(nested: GCSNested) -> GCS:
    ...
    kwargs.update(_extract_gcs_attrs(attrs))
...
GCS.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
GCS.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
GCS.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
GCS.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
GCS.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
GCS.MEANINGS = RelationField("meanings")
GCS.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
