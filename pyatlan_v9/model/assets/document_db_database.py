...
class DocumentDBDatabase(Asset):
    ...
    document_db_database_collection_count: int | None | UnsetType = msgspec.field(
    ...
    document_db_collections: list[RelatedDocumentDBCollection] | None | UnsetType = (
...
class DocumentDBDatabaseNested(AssetNested):
    ...
    relationship_attributes: DocumentDBDatabaseRelationshipAttributes | UnsetType = (
        UNSET
    )
