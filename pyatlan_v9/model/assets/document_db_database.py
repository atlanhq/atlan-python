...
class DocumentDBDatabase(Asset):
    ...
    document_db_database_collection_count: int | None | UnsetType = msgspec.field(default=UNSET, name="documentDBDatabaseCollectionCount")
    ...
    document_db_collections: list[RelatedDocumentDBCollection] | None | UnsetType = msgspec.field(default=UNSET, name="documentDBCollections")
...
class DocumentDBDatabaseNested(AssetNested):
    ...
    attributes: DocumentDBDatabaseAttributes | UnsetType = UNSET
    relationship_attributes: DocumentDBDatabaseRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: DocumentDBDatabaseRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: DocumentDBDatabaseRelationshipAttributes | UnsetType = UNSET
