...
class GCSObject(Asset):
    ...
    gcs_bucket: RelatedGCSBucket | None | UnsetType = UNSET
...
class GCSObjectNested(AssetNested):
    ...
    attributes: GCSObjectAttributes | UnsetType = UNSET
    relationship_attributes: GCSObjectRelationshipAttributes | UnsetType = UNSET
    append_relationship_attributes: GCSObjectRelationshipAttributes | UnsetType = UNSET
    remove_relationship_attributes: GCSObjectRelationshipAttributes | UnsetType = UNSET
