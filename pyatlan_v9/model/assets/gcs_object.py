...
def _gcs_object_from_nested(nested: GCSObjectNested) -> GCSObject:
    ...
    kwargs.update(_extract_gcs_object_attrs(attrs))
...
GCSObject.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
GCSObject.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
GCSObject.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
GCSObject.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
