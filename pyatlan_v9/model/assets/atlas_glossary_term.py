...
def _atlas_glossary_term_from_nested(
    ...
    kwargs.update(_extract_atlas_glossary_term_attrs(attrs))
...
AtlasGlossaryTerm.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
AtlasGlossaryTerm.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
