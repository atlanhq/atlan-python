...
class PowerBIMeasure(Asset):
    ...
    def validate(self, for_creation: bool = False) -> None:
        """
        Dry-run validation of this PowerBIMeasure instance.
    ...
    def minimize(self) -> "PowerBIMeasure":
        """
        Return a minimal copy of this PowerBIMeasure with only updater-required fields.

        Calls :meth:`validate` first to ensure the instance is valid, then
        returns a new PowerBIMeasure with only the fields needed for an update
        (qualified_name, name, and any type-specific additional fields).

        Returns:
            A new PowerBIMeasure instance with only the minimum required fields.
        """
        self.validate()
    ...
    def relate(self) -> "RelatedPowerBIMeasure":
        """
        Create a :class:`RelatedPowerBIMeasure` reference from this instance.
        ...
        Returns:
            A RelatedPowerBIMeasure reference to this asset.
        """
...
def _power_bi_measure_from_nested(nested: PowerBIMeasureNested) -> PowerBIMeasure:
    ...
    kwargs.update(_extract_power_bi_measure_attrs(attrs))
    kwargs.update(merged_rels)
    return PowerBIMeasure(**kwargs)
...
PowerBIMeasure.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
PowerBIMeasure.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
PowerBIMeasure.MEANINGS = RelationField("meanings")
PowerBIMeasure.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
