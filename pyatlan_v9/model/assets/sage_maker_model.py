...
class SageMakerModelNested(AssetNested):
    ...
    append_relationship_attributes: SageMakerModelRelationshipAttributes | UnsetType = (
        UNSET
    )
    remove_relationship_attributes: SageMakerModelRelationshipAttributes | UnsetType = (
        UNSET
    )
