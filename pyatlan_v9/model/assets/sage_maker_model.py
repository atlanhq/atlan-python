...
from .sage_maker_related import RelatedSageMakerModelDeployment, RelatedSageMakerModelGroup
...
class SageMakerModel(Asset):
    ...
    sage_maker_model_deployments: Union[List[RelatedSageMakerModelDeployment], None, UnsetType] = UNSET
...
class SageMakerModelNested(AssetNested):
    ...
    relationship_attributes: Union[SageMakerModelRelationshipAttributes, UnsetType] = UNSET
    append_relationship_attributes: Union[SageMakerModelRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[SageMakerModelRelationshipAttributes, UnsetType] = UNSET
...
SageMakerModel.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
SageMakerModel.AI_MODEL_QUALIFIED_NAME = KeywordField("aiModelQualifiedName", "aiModelQualifiedName")
SageMakerModel.AI_MODEL_VERSION_STAGE = KeywordField("aiModelVersionStage", "aiModelVersionStage")
SageMakerModel.AI_MODEL_VERSION_METRICS = KeywordField("aiModelVersionMetrics", "aiModelVersionMetrics")
...
SageMakerModel.DATA_CONTRACT_LATEST = RelationField("dataContractLatest")
SageMakerModel.DATA_CONTRACT_LATEST_CERTIFIED = RelationField("dataContractLatestCertified")
...
SageMakerModel.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
