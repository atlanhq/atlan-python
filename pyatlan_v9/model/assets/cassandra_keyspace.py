...
def _cassandra_keyspace_from_nested(
    ...
    kwargs.update(_extract_cassandra_keyspace_attrs(attrs))
    kwargs.update(merged_rels)
    return CassandraKeyspace(**kwargs)
...
CassandraKeyspace.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
CassandraKeyspace.MEANINGS = RelationField("meanings")
CassandraKeyspace.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
