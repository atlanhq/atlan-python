...
def _qlik_space_from_nested(nested: QlikSpaceNested) -> QlikSpace:
    ...
    kwargs.update(_extract_qlik_space_attrs(attrs))
    kwargs.update(merged_rels)
    return QlikSpace(**kwargs)
...
QlikSpace.CONTEXT_REPOSITORIES = RelationField("contextRepositories")
...
QlikSpace.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField(
    "gcpDataplexAspectTypeMetadataEntities"
)
QlikSpace.MEANINGS = RelationField("meanings")
QlikSpace.KNOWLEDGE_LINKED_FILES = RelationField("knowledgeLinkedFiles")
