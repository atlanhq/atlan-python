...
class QlikSpaceNested(AssetNested):
    ...
    append_relationship_attributes: Union[QlikSpaceRelationshipAttributes, UnsetType] = UNSET
    remove_relationship_attributes: Union[QlikSpaceRelationshipAttributes, UnsetType] = UNSET
...
QlikSpace.CATALOG_DATASET_GUID = KeywordField("catalogDatasetGuid", "catalogDatasetGuid")
...
QlikSpace.GCP_DATAPLEX_ASPECT_TYPE_METADATA_ENTITIES = RelationField("gcpDataplexAspectTypeMetadataEntities")
