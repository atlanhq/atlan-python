...
class QlikSpace(Asset):
    ...
    qlik_apps: list[RelatedQlikApp] | None | UnsetType = UNSET
    """Apps that exist within this space."""

    qlik_datasets: list[RelatedQlikDataset] | None | UnsetType = UNSET
...
class QlikSpaceNested(AssetNested):
    ...
    attributes: QlikSpaceAttributes | UnsetType = UNSET
