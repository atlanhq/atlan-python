...
class BI(Asset):
    ...
    # Override type_name with BI-specific default
    ...
    def to_json(self, nested: bool = True, serde: Serde | None = None) -> str:
        ...
        if serde is None:
            serde = get_serde()
        if nested:
            return _bi_to_nested_bytes(self, serde).decode("utf-8")
        else:
            return serde.encode(self).decode("utf-8")

    @staticmethod
    def from_json(json_data: Union[str, bytes], serde: Serde | None = None) -> "BI":
        """
...
def _bi_to_nested(bi: BI) -> BINested:
    ...
    replace_rels, append_rels, remove_rels = categorize_relationships(
        bi, rel_fields, BIRelationshipAttributes
    )
    return BINested(
        guid=bi.guid,
