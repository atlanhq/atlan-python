...
class Incident(Referenceable):
    ...
    # Override type_name with Incident-specific default
    ...
    def to_json(self, nested: bool = True, serde: Serde | None = None) -> str:
        ...
        if serde is None:
            serde = get_serde()
        if nested:
            return _incident_to_nested_bytes(self, serde).decode("utf-8")
        else:
...
def _incident_to_nested(incident: Incident) -> IncidentNested:
    ...
    attrs = IncidentAttributes(
        asset_severity=incident.asset_severity,
        name=incident.name,
        display_name=incident.display_name,
        description=incident.description,
        asset_source_readme=incident.asset_source_readme,
        user_description=incident.user_description,
        tenant_id=incident.tenant_id,
        certificate_status=incident.certificate_status,
        certificate_status_message=incident.certificate_status_message,
        certificate_updated_by=incident.certificate_updated_by,
        certificate_updated_at=incident.certificate_updated_at,
        announcement_title=incident.announcement_title,
        announcement_message=incident.announcement_message,
        announcement_type=incident.announcement_type,
        announcement_updated_at=incident.announcement_updated_at,
        announcement_updated_by=incident.announcement_updated_by,
        owner_users=incident.owner_users,
        owner_groups=incident.owner_groups,
        admin_users=incident.admin_users,
        admin_groups=incident.admin_groups,
        viewer_users=incident.viewer_users,
        viewer_groups=incident.viewer_groups,
        connector_name=incident.connector_name,
        connection_name=incident.connection_name,
        connection_qualified_name=incident.connection_qualified_name,
        has_lineage=incident.has_lineage,
        is_discoverable=incident.is_discoverable,
        is_editable=incident.is_editable,
        sub_type=incident.sub_type,
        view_score=incident.view_score,
        popularity_score=incident.popularity_score,
        source_owners=incident.source_owners,
        asset_source_id=incident.asset_source_id,
        source_created_by=incident.source_created_by,
        source_created_at=incident.source_created_at,
        source_updated_at=incident.source_updated_at,
        source_updated_by=incident.source_updated_by,
        source_url=incident.source_url,
        source_embed_url=incident.source_embed_url,
        last_sync_workflow_name=incident.last_sync_workflow_name,
        last_sync_run_at=incident.last_sync_run_at,
        last_sync_run=incident.last_sync_run,
        admin_roles=incident.admin_roles,
        source_read_count=incident.source_read_count,
        source_read_user_count=incident.source_read_user_count,
        source_last_read_at=incident.source_last_read_at,
        last_row_changed_at=incident.last_row_changed_at,
        source_total_cost=incident.source_total_cost,
        source_cost_unit=incident.source_cost_unit,
        source_read_query_cost=incident.source_read_query_cost,
        source_read_recent_user_list=incident.source_read_recent_user_list,
        source_read_recent_user_record_list=incident.source_read_recent_user_record_list,
        source_read_top_user_list=incident.source_read_top_user_list,
        source_read_top_user_record_list=incident.source_read_top_user_record_list,
        source_read_popular_query_record_list=incident.source_read_popular_query_record_list,
        source_read_expensive_query_record_list=incident.source_read_expensive_query_record_list,
        source_read_slow_query_record_list=incident.source_read_slow_query_record_list,
        source_query_compute_cost_list=incident.source_query_compute_cost_list,
        source_query_compute_cost_record_list=incident.source_query_compute_cost_record_list,
        dbt_qualified_name=incident.dbt_qualified_name,
        asset_dbt_workflow_last_updated=incident.asset_dbt_workflow_last_updated,
        asset_dbt_alias=incident.asset_dbt_alias,
        asset_dbt_meta=incident.asset_dbt_meta,
        asset_dbt_unique_id=incident.asset_dbt_unique_id,
        asset_dbt_account_name=incident.asset_dbt_account_name,
        asset_dbt_project_name=incident.asset_dbt_project_name,
        asset_dbt_package_name=incident.asset_dbt_package_name,
        asset_dbt_job_name=incident.asset_dbt_job_name,
        asset_dbt_job_schedule=incident.asset_dbt_job_schedule,
        asset_dbt_job_status=incident.asset_dbt_job_status,
        asset_dbt_test_status=incident.asset_dbt_test_status,
        asset_dbt_job_schedule_cron_humanized=incident.asset_dbt_job_schedule_cron_humanized,
        asset_dbt_job_last_run=incident.asset_dbt_job_last_run,
        asset_dbt_job_last_run_url=incident.asset_dbt_job_last_run_url,
        asset_dbt_job_last_run_created_at=incident.asset_dbt_job_last_run_created_at,
        asset_dbt_job_last_run_updated_at=incident.asset_dbt_job_last_run_updated_at,
        asset_dbt_job_last_run_dequed_at=incident.asset_dbt_job_last_run_dequed_at,
        asset_dbt_job_last_run_started_at=incident.asset_dbt_job_last_run_started_at,
        asset_dbt_job_last_run_total_duration=incident.asset_dbt_job_last_run_total_duration,
        asset_dbt_job_last_run_total_duration_humanized=incident.asset_dbt_job_last_run_total_duration_humanized,
        asset_dbt_job_last_run_queued_duration=incident.asset_dbt_job_last_run_queued_duration,
        asset_dbt_job_last_run_queued_duration_humanized=incident.asset_dbt_job_last_run_queued_duration_humanized,
        asset_dbt_job_last_run_run_duration=incident.asset_dbt_job_last_run_run_duration,
        asset_dbt_job_last_run_run_duration_humanized=incident.asset_dbt_job_last_run_run_duration_humanized,
        asset_dbt_job_last_run_git_branch=incident.asset_dbt_job_last_run_git_branch,
        asset_dbt_job_last_run_git_sha=incident.asset_dbt_job_last_run_git_sha,
        asset_dbt_job_last_run_status_message=incident.asset_dbt_job_last_run_status_message,
        asset_dbt_job_last_run_owner_thread_id=incident.asset_dbt_job_last_run_owner_thread_id,
        asset_dbt_job_last_run_executed_by_thread_id=incident.asset_dbt_job_last_run_executed_by_thread_id,
        asset_dbt_job_last_run_artifacts_saved=incident.asset_dbt_job_last_run_artifacts_saved,
        asset_dbt_job_last_run_artifact_s3_path=incident.asset_dbt_job_last_run_artifact_s3_path,
        asset_dbt_job_last_run_has_docs_generated=incident.asset_dbt_job_last_run_has_docs_generated,
        asset_dbt_job_last_run_has_sources_generated=incident.asset_dbt_job_last_run_has_sources_generated,
        asset_dbt_job_last_run_notifications_sent=incident.asset_dbt_job_last_run_notifications_sent,
        asset_dbt_job_next_run=incident.asset_dbt_job_next_run,
        asset_dbt_job_next_run_humanized=incident.asset_dbt_job_next_run_humanized,
        asset_dbt_environment_name=incident.asset_dbt_environment_name,
        asset_dbt_environment_dbt_version=incident.asset_dbt_environment_dbt_version,
        asset_dbt_tags=incident.asset_dbt_tags,
        asset_dbt_semantic_layer_proxy_url=incident.asset_dbt_semantic_layer_proxy_url,
        asset_dbt_source_freshness_criteria=incident.asset_dbt_source_freshness_criteria,
        sample_data_url=incident.sample_data_url,
        asset_tags=incident.asset_tags,
        asset_mc_incident_names=incident.asset_mc_incident_names,
        asset_mc_incident_qualified_names=incident.asset_mc_incident_qualified_names,
        asset_mc_alert_qualified_names=incident.asset_mc_alert_qualified_names,
        asset_mc_monitor_names=incident.asset_mc_monitor_names,
        asset_mc_monitor_qualified_names=incident.asset_mc_monitor_qualified_names,
        asset_mc_monitor_statuses=incident.asset_mc_monitor_statuses,
        asset_mc_monitor_types=incident.asset_mc_monitor_types,
        asset_mc_monitor_schedule_types=incident.asset_mc_monitor_schedule_types,
        asset_mc_incident_types=incident.asset_mc_incident_types,
        asset_mc_incident_sub_types=incident.asset_mc_incident_sub_types,
        asset_mc_incident_severities=incident.asset_mc_incident_severities,
        asset_mc_incident_priorities=incident.asset_mc_incident_priorities,
        asset_mc_incident_states=incident.asset_mc_incident_states,
        asset_mc_is_monitored=incident.asset_mc_is_monitored,
        asset_mc_last_sync_run_at=incident.asset_mc_last_sync_run_at,
        starred_by=incident.starred_by,
        starred_details_list=incident.starred_details_list,
        starred_count=incident.starred_count,
        asset_anomalo_dq_status=incident.asset_anomalo_dq_status,
        asset_anomalo_check_count=incident.asset_anomalo_check_count,
        asset_anomalo_failed_check_count=incident.asset_anomalo_failed_check_count,
        asset_anomalo_check_statuses=incident.asset_anomalo_check_statuses,
        asset_anomalo_last_check_run_at=incident.asset_anomalo_last_check_run_at,
        asset_anomalo_applied_check_types=incident.asset_anomalo_applied_check_types,
        asset_anomalo_failed_check_types=incident.asset_anomalo_failed_check_types,
        asset_anomalo_source_url=incident.asset_anomalo_source_url,
        asset_soda_dq_status=incident.asset_soda_dq_status,
        asset_soda_check_count=incident.asset_soda_check_count,
        asset_soda_last_sync_run_at=incident.asset_soda_last_sync_run_at,
        asset_soda_last_scan_at=incident.asset_soda_last_scan_at,
        asset_soda_check_statuses=incident.asset_soda_check_statuses,
        asset_soda_source_url=incident.asset_soda_source_url,
        asset_icon=incident.asset_icon,
        asset_external_dq_metadata_details=incident.asset_external_dq_metadata_details,
        is_partial=incident.is_partial,
        is_ai_generated=incident.is_ai_generated,
        asset_cover_image=incident.asset_cover_image,
        asset_theme_hex=incident.asset_theme_hex,
        lexicographical_sort_order=incident.lexicographical_sort_order,
        has_contract=incident.has_contract,
        asset_redirect_gui_ds=incident.asset_redirect_gui_ds,
        asset_policy_gui_ds=incident.asset_policy_gui_ds,
        asset_policies_count=incident.asset_policies_count,
        domain_gui_ds=incident.domain_gui_ds,
        non_compliant_asset_policy_gui_ds=incident.non_compliant_asset_policy_gui_ds,
        product_gui_ds=incident.product_gui_ds,
        output_product_gui_ds=incident.output_product_gui_ds,
        application_qualified_name=incident.application_qualified_name,
        application_field_qualified_name=incident.application_field_qualified_name,
        asset_user_defined_type=incident.asset_user_defined_type,
        asset_internal_popularity_score=incident.asset_internal_popularity_score,
        asset_dq_schedule_type=incident.asset_dq_schedule_type,
        asset_dq_schedule_crontab=incident.asset_dq_schedule_crontab,
        asset_dq_schedule_time_zone=incident.asset_dq_schedule_time_zone,
        asset_dq_schedule_source_sync_status=incident.asset_dq_schedule_source_sync_status,
        asset_dq_schedule_source_synced_at=incident.asset_dq_schedule_source_synced_at,
        asset_dq_schedule_source_sync_error_message=incident.asset_dq_schedule_source_sync_error_message,
        asset_dq_schedule_source_sync_error_code=incident.asset_dq_schedule_source_sync_error_code,
        asset_dq_schedule_source_sync_raw_error=incident.asset_dq_schedule_source_sync_raw_error,
        asset_dq_rule_attached_dimensions=incident.asset_dq_rule_attached_dimensions,
        asset_dq_rule_failed_dimensions=incident.asset_dq_rule_failed_dimensions,
        asset_dq_rule_passed_dimensions=incident.asset_dq_rule_passed_dimensions,
        asset_dq_rule_attached_rule_types=incident.asset_dq_rule_attached_rule_types,
        asset_dq_rule_failed_rule_types=incident.asset_dq_rule_failed_rule_types,
        asset_dq_rule_passed_rule_types=incident.asset_dq_rule_passed_rule_types,
        asset_dq_rule_result_tags=incident.asset_dq_rule_result_tags,
        asset_dq_rule_last_run_at=incident.asset_dq_rule_last_run_at,
        asset_dq_rule_total_count=incident.asset_dq_rule_total_count,
        asset_dq_rule_failed_count=incident.asset_dq_rule_failed_count,
        asset_dq_rule_passed_count=incident.asset_dq_rule_passed_count,
        asset_dq_result=incident.asset_dq_result,
        asset_dq_freshness_value=incident.asset_dq_freshness_value,
        asset_dq_freshness_expectation=incident.asset_dq_freshness_expectation,
        asset_dq_row_scope_filter_column_qualified_name=incident.asset_dq_row_scope_filter_column_qualified_name,
        asset_space_qualified_name=incident.asset_space_qualified_name,
        asset_space_name=incident.asset_space_name,
        asset_smus_metadata_form_names=incident.asset_smus_metadata_form_names,
        asset_smus_metadata_form_key_value_details=incident.asset_smus_metadata_form_key_value_details,
        asset_smus_metadata_form_details=incident.asset_smus_metadata_form_details,
    )
    # Categorize relationships by save semantic (REPLACE, APPEND, REMOVE)
    rel_fields: list[str] = []
    replace_rels, append_rels, remove_rels = categorize_relationships(
        incident, rel_fields, IncidentRelationshipAttributes
    )
...
def _incident_from_nested(nested: IncidentNested) -> Incident:
    ...
    return Incident(
        ...
        asset_severity=attrs.asset_severity,
        name=attrs.name,
