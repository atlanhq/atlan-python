...
class Catalog(Asset):
    ...
    # Override type_name with Catalog-specific default
    ...
    def to_json(self, nested: bool = True, serde: Serde | None = None) -> str:
        ...
        if serde is None:
            serde = get_serde()
        if nested:
            return _catalog_to_nested_bytes(self, serde).decode("utf-8")
        else:
...
def _catalog_to_nested(catalog: Catalog) -> CatalogNested:
    ...
    replace_rels, append_rels, remove_rels = categorize_relationships(
        catalog, rel_fields, CatalogRelationshipAttributes
    )
