...
from pyatlan.model.glossary import (
    AtlanGlossary,
    AtlanGlossaryCategory,
    AtlanGlossaryExtInfo,
    AtlanGlossaryTerm,
)
...
class GlossaryClient:
    ...
    GET_GLOSSARY_BY_GUID = API(
        GLOSSARY_URI + "/{glossary_guid}", HTTPMethod.GET, HTTPStatus.OK
    )
    GET_DETAILED_GLOSSARY = API(
        GLOSSARY_URI + "/{glossary_guid}/detailed", HTTPMethod.GET, HTTPStatus.OK
    )

    GET_GLOSSARY_TERM = API(GLOSSARY_TERM, HTTPMethod.GET, HTTPStatus.OK)
    GET_GLOSSARY_TERMS = API(
        GLOSSARY_URI + "/{glossary_guid}/terms", HTTPMethod.GET, HTTPStatus.OK
    )
    GET_GLOSSARY_TERMS_HEADERS = API(
        GLOSSARY_URI + "/{glossary_guid}/terms/headers", HTTPMethod.GET, HTTPStatus.OK
    )

    GET_GLOSSARY_CATEGORY = API(GLOSSARY_CATEGORY, HTTPMethod.GET, HTTPStatus.OK)
    GET_GLOSSARY_CATEGORIES = API(
        GLOSSARY_URI + "/{glossary_guid}/categories", HTTPMethod.GET, HTTPStatus.OK
    )
    GET_GLOSSARY_CATEGORIES_HEADERS = API(
        GLOSSARY_URI + "/{glossary_guid}/categories/headers",
        HTTPMethod.GET,
        HTTPStatus.OK,
    )

    GET_CATEGORY_TERMS = API(
        GLOSSARY_CATEGORY + "/{category_guid}/terms", HTTPMethod.GET, HTTPStatus.OK
    )
    GET_RELATED_TERMS = API(
        GLOSSARY_TERMS + "/{term_guid}/related", HTTPMethod.GET, HTTPStatus.OK
    )
    GET_RELATED_CATEGORIES = API(
        GLOSSARY_CATEGORY + "/{category_guid}/related", HTTPMethod.GET, HTTPStatus.OK
    )
    ...
    CREATE_GLOSSARY_CATEGORIES = API(
        GLOSSARY_CATEGORIES, HTTPMethod.POST, HTTPStatus.OK
    )

    UPDATE_GLOSSARY_BY_GUID = API(
        GLOSSARY_URI + "/{glossary_guid}", HTTPMethod.PUT, HTTPStatus.OK
    )
    UPDATE_PARTIAL_GLOSSARY = API(
        GLOSSARY_URI + "/{glossary_guid}/partial", HTTPMethod.PUT, HTTPStatus.OK
    )
    UPDATE_GLOSSARY_TERM = API(
        GLOSSARY_TERM + "/{term_guid}", HTTPMethod.PUT, HTTPStatus.OK
    )
    UPDATE_PARTIAL_TERM = API(
        GLOSSARY_TERM + "/{term_guid}/partial", HTTPMethod.PUT, HTTPStatus.OK
    )

    UPDATE_CATEGORY_BY_GUID = API(
        GLOSSARY_CATEGORY + "/{category_guid}", HTTPMethod.PUT, HTTPStatus.OK
    )
    UPDATE_PARTIAL_CATEGORY = API(
        GLOSSARY_CATEGORY + "/{category_guid}/partial", HTTPMethod.PUT, HTTPStatus.OK
    )

    DELETE_GLOSSARY_BY_GUID = API(
        GLOSSARY_URI + "/{glossary_guid}", HTTPMethod.DELETE, HTTPStatus.NO_CONTENT
    )
    DELETE_TERM_BY_GUID = API(
        GLOSSARY_TERM + "/{term_guid}", HTTPMethod.DELETE, HTTPStatus.NO_CONTENT
    )
    DELETE_CATEGORY_BY_GUID = API(
        GLOSSARY_CATEGORY + "/{category_guid}", HTTPMethod.DELETE, HTTPStatus.NO_CONTENT
    )
    ...
    ASSIGN_TERM_TO_ENTITIES = API(
        GLOSSARY_TERMS + "/{term_guid}/assignedEntities",
        HTTPMethod.POST,
    ...
    GET_IMPORT_GLOSSARY_TEMPLATE = API(
        GLOSSARY_URI + "/import/template",
        HTTPMethod.GET,
        HTTPStatus.OK,
        APPLICATION_JSON,
        APPLICATION_OCTET_STREAM,
    ...
    def get_all_glossaries(
        self, sort_by_attribute=DEFAULT_SORT, limit=DEFAULT_LIMIT, offset=DEFAULT_OFFSET
    ):
        query_params = {
        ...
        return self.client.call_api(
            GlossaryClient.GET_ALL_GLOSSARIES, list, query_params
        )
    ...
    def get_glossary_term(self, term_guid):
        return self.client.call_api(
            GlossaryClient.GET_GLOSSARY_TERM.format_path_with_params(term_guid),
            AtlanGlossaryTerm,
        )
    ...
    def get_glossary_terms(
        self,
        glossary_guid,
        sort_by_attribute=DEFAULT_SORT,
        limit=DEFAULT_LIMIT,
    ...
    def get_glossary_term_headers(
        self, glossary_guid, sort_by_attribute, limit, offset
    ):
        query_params = {
            "glossaryGuid": glossary_guid,
            GlossaryClient.LIMIT: limit,
    ...
    def get_glossary_category(self, category_guid):
        return self.client.call_api(
            GlossaryClient.GET_GLOSSARY_CATEGORY.format_path_with_params(category_guid),
            AtlanGlossaryCategory,
        )
    ...
    def get_glossary_category_headers(
        self, glossary_guid, sort_by_attribute, limit, offset
    ):
        query_params = {
            "glossaryGuid": glossary_guid,
    ...
    def get_related_terms(self, term_guid, sort_by_attribute, limit, offset):
        ...
        return self.client.call_api(
            GlossaryClient.GET_RELATED_TERMS.format_path({"term_guid": term_guid}),
            dict,
            query_params,
        )
    ...
    def create_glossary(self, glossary):
        return self.client.call_api(
            GlossaryClient.CREATE_GLOSSARY, AtlanGlossary, None, glossary
        )

    def create_glossary_term(self, glossary_term):
        return self.client.call_api(
            GlossaryClient.CREATE_GLOSSARY_TERM, AtlanGlossaryTerm, None, glossary_term
        )

    def create_glossary_terms(self, glossary_terms):
        return self.client.call_api(
            GlossaryClient.CREATE_GLOSSARY_TERMS, list, None, glossary_terms
        )

    def create_glossary_category(self, glossary_category):
        return self.client.call_api(
            GlossaryClient.CREATE_GLOSSARY_CATEGORY,
            AtlanGlossaryCategory,
            None,
            glossary_category,
        )
    ...
    def create_glossary_categories(self, glossary_categories):
        return self.client.call_api(
            GlossaryClient.CREATE_GLOSSARY_CATEGORIES, list, glossary_categories
        )
    ...
    def update_glossary_term_by_guid(self, term_guid, glossary_term):
        return self.client.call_api(
            GlossaryClient.UPDATE_GLOSSARY_TERM.format_path({"term_guid": term_guid}),
            AtlanGlossaryTerm,
            None,
            glossary_term,
        )
    ...
    def partial_update_term_by_guid(self, term_guid, attributes):
        return self.client.call_api(
            GlossaryClient.UPDATE_PARTIAL_TERM.format_path({"term_guid": term_guid}),
            AtlanGlossaryTerm,
            attributes,
        )
    ...
    def delete_glossary_term_by_guid(self, term_guid):
        return self.client.call_api(
            GlossaryClient.DELETE_TERM_BY_GUID.format_path({"term_guid": term_guid})
        )
    ...
    def get_entities_assigned_with_term(
        self, term_guid, sort_by_attribute, limit, offset
    ):
        query_params = {
            "termGuid": term_guid,
            GlossaryClient.LIMIT: limit,
