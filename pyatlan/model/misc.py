...
from pyatlan.utils import next_id, non_null


class AtlanBase(dict):
    ...
    def __setitem__(self, key, value):
        super(AtlanBase, self).__setitem__(key, value)
    ...
    def __delitem__(self, key):
        super(AtlanBase, self).__delitem__(key)
...
class AtlanBaseModelObject(AtlanBase):
