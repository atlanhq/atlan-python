...
class OpenLineageTransformation(AtlanObject):
    ...
    subtype: Optional[str] = Field(default=None, description="Subtype of the transformation")
    description: Optional[str] = Field(default=None, description="String representation of the transformation applied")
    masking: Optional[bool] = Field(default=None, description="Is the transformation masking the data or not")


class OpenLineageInputField(AtlanObject):
    namespace: Optional[str] = Field(default=None, description="Input dataset namespace")
