...
class ParsedQuery(AtlanObject):
    class DatabaseColumn(AtlanObject):
        id: Optional[str] = Field(
            None, description="Numeric identifier for the column."
        )
        name: Optional[str] = Field(
            None, description="Name of the column (unqualified)."
        )
        source: Optional[str] = Field(None, description="TBC")
    ...
    class RelationshipEndpoint(AtlanObject):
        ...
        column: Optional[str] = Field(
            None, description="Name of the column used by this end of the relationship."
        )
        ...
        parent_name: Optional[str] = Field(
            None, description="Name of the parent object in which the column exists."
        )

    class ParserError(AtlanObject):
        error_message: Optional[str] = Field(
            None, description="Description of the error."
        )
        error_type: Optional[str] = Field(None, description="Type of the error.")
        coordinates: Optional[List[Any]] = Field(None, description="TBC")

    class Relationship(AtlanObject):
        id: Optional[str] = Field(
            None, description="Numeric identifier for the relationship."
        )
        ...
        target: Optional[ParsedQuery.RelationshipEndpoint] = Field(
            None, description="TBC"
        )
    ...
    class DatabaseObject(AtlanObject):
        ...
        id: Optional[str] = Field(
            None, description="Numeric identifier for the object."
        )
        name: Optional[str] = Field(
            None, description="Name of the object (unqualified)."
        )
        type: Optional[str] = Field(None, description="Type of the object.")
        database: Optional[str] = Field(
            None, description="Name of the database the object exists within."
        )
        ...
        procedure_name: Optional[str] = Field(
            None, description="Name of the procedure (only for process objects)."
        )
    ...
    dbobjs: Optional[List[ParsedQuery.DatabaseObject]] = Field(
        None, description="All the database objects detected in the query."
    )
    relationships: Optional[List[ParsedQuery.Relationship]] = Field(
        None, description="All the relationship objects detected in the query."
    )
    errors: Optional[List[ParsedQuery.ParserError]] = Field(
        None, description="Any errors during parsing."
    )
...
class QueryParserRequest(AtlanObject):
    ...
    link_orphan_column_to_first_table: Optional[bool] = Field(None, description="TBC")
    show_join: Optional[bool] = Field(description="TBC")
    ignore_record_set: Optional[bool] = Field(None, description="TBC")
    ignore_coordinate: Optional[bool] = Field(None, description="TBC")
