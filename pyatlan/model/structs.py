...
class SourceTagAttachment(AtlanObject):
    ...
    source_tag_value: Optional[list[SourceTagAttachmentValue]] = Field(None, description='' )
...
class MCRuleComparison(AtlanObject):
    ...
    mc_rule_comparison_is_threshold_relative: Optional[bool] = Field(None, description='' )
