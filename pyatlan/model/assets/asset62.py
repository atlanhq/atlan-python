...
class ModeReport(Mode):
    ...
    class Attributes(Mode.Attributes):
        mode_collection_token: Optional[str] = Field(None, description='' , alias='modeCollectionToken')
        mode_report_published_at: Optional[datetime] = Field(None, description='' , alias='modeReportPublishedAt')
        mode_query_count: Optional[int] = Field(None, description='' , alias='modeQueryCount')
        mode_chart_count: Optional[int] = Field(None, description='' , alias='modeChartCount')
        mode_query_preview: Optional[str] = Field(None, description='' , alias='modeQueryPreview')
        mode_is_public: Optional[bool] = Field(None, description='' , alias='modeIsPublic')
        mode_is_shared: Optional[bool] = Field(None, description='' , alias='modeIsShared')
        mode_queries: Optional[list[ModeQuery]]= Field(None, description='',  alias='modeQueries') # relationship
        mode_collections: Optional[list[ModeCollection]]= Field(None, description='',  alias='modeCollections') # relationship
...
class ModeQuery(Mode):
    ...
    class Attributes(Mode.Attributes):
        mode_raw_query: Optional[str] = Field(None, description='' , alias='modeRawQuery')
        mode_report_import_count: Optional[int] = Field(None, description='' , alias='modeReportImportCount')
        mode_charts: Optional[list[ModeChart]]= Field(None, description='',  alias='modeCharts') # relationship
        mode_report: Optional[ModeReport]= Field(None, description='',  alias='modeReport') # relationship
...
class ModeChart(Mode):
    ...
    class Attributes(Mode.Attributes):
        mode_chart_type: Optional[str] = Field(None, description='' , alias='modeChartType')
        mode_query: Optional[ModeQuery]= Field(None, description='',  alias='modeQuery') # relationship
...
class ModeWorkspace(Mode):
    ...
    class Attributes(Mode.Attributes):
        mode_collection_count: Optional[int] = Field(None, description='' , alias='modeCollectionCount')
        mode_collections: Optional[list[ModeCollection]]= Field(None, description='',  alias='modeCollections') # relationship
...
class ModeCollection(Mode):
    ...
    class Attributes(Mode.Attributes):
        mode_collection_type: Optional[str] = Field(None, description='' , alias='modeCollectionType')
        mode_collection_state: Optional[str] = Field(None, description='' , alias='modeCollectionState')
        mode_workspace: Optional[ModeWorkspace]= Field(None, description='',  alias='modeWorkspace') # relationship
        mode_reports: Optional[list[ModeReport]]= Field(None, description='',  alias='modeReports') # relationship
