...
class AuthService(Asset, type_name='AuthService'):
    ...
    TBC
    """
    AUTH_SERVICE_POLICY_LAST_SYNC: ClassVar[NumericField] = NumericField("authServicePolicyLastSync", "authServicePolicyLastSync")
    """
    TBC
    """
    ...
    class Attributes(Asset.Attributes):
        auth_service_type: Optional[str] = Field(None, description='' , alias='authServiceType')
        tag_service: Optional[str] = Field(None, description='' , alias='tagService')
        auth_service_is_enabled: Optional[bool] = Field(None, description='' , alias='authServiceIsEnabled')
        auth_service_config: Optional[dict[str,str]] = Field(None, description='' , alias='authServiceConfig')
        auth_service_policy_last_sync: Optional[int] = Field(None, description='' , alias='authServicePolicyLastSync')
