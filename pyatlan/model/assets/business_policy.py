...
class BusinessPolicy(Asset, type_name="BusinessPolicy"):
    ...
    BUSINESS_POLICY_TYPE: ClassVar[KeywordField] = KeywordField("businessPolicyType", "businessPolicyType")
    """
    Type of business policy
    """
    BUSINESS_POLICY_LONG_DESCRIPTION: ClassVar[RelationField] = RelationField("businessPolicyLongDescription")
    """
    ...
    """
    BUSINESS_POLICY_VERSION: ClassVar[NumericField] = NumericField("businessPolicyVersion", "businessPolicyVersion")
    """
    ...
    """
    BUSINESS_POLICY_FILTER_DSL: ClassVar[TextField] = TextField("businessPolicyFilterDSL", "businessPolicyFilterDSL")
    """
    ...
    """
    BUSINESS_POLICY_RULES: ClassVar[KeywordField] = KeywordField("businessPolicyRules", "businessPolicyRules")
    """
    List of rules applied to this business policy.
    """

    EXCEPTIONS_FOR_BUSINESS_POLICY: ClassVar[RelationField] = RelationField("exceptionsForBusinessPolicy")
    """
    TBC
    """
    RELATED_BUSINESS_POLICIES: ClassVar[RelationField] = RelationField("relatedBusinessPolicies")
    """
    TBC
    """
    ...
    def business_policy_long_description(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.business_policy_long_description

    @business_policy_long_description.setter
    def business_policy_long_description(self, business_policy_long_description: Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.business_policy_long_description = business_policy_long_description

    @property
    def business_policy_valid_till(self) -> Optional[datetime]:
        return None if self.attributes is None else self.attributes.business_policy_valid_till

    @business_policy_valid_till.setter
    def business_policy_valid_till(self, business_policy_valid_till: Optional[datetime]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def business_policy_valid_from(self) -> Optional[datetime]:
        return None if self.attributes is None else self.attributes.business_policy_valid_from

    @business_policy_valid_from.setter
    def business_policy_valid_from(self, business_policy_valid_from: Optional[datetime]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def business_policy_version(self) -> Optional[int]:
        return None if self.attributes is None else self.attributes.business_policy_version
    ...
    def business_policy_review_period(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.business_policy_review_period

    @business_policy_review_period.setter
    def business_policy_review_period(self, business_policy_review_period: Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def business_policy_filter_d_s_l(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.business_policy_filter_d_s_l
    ...
    def business_policy_base_parent_guid(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.business_policy_base_parent_guid

    @business_policy_base_parent_guid.setter
    def business_policy_base_parent_guid(self, business_policy_base_parent_guid: Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.business_policy_base_parent_guid = business_policy_base_parent_guid

    @property
    def business_policy_selected_approval_w_f(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.business_policy_selected_approval_w_f

    @business_policy_selected_approval_w_f.setter
    def business_policy_selected_approval_w_f(self, business_policy_selected_approval_w_f: Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.business_policy_selected_approval_w_f = business_policy_selected_approval_w_f

    @property
    def business_policy_rules(self) -> Optional[List[BusinessPolicyRule]]:
        return None if self.attributes is None else self.attributes.business_policy_rules

    @business_policy_rules.setter
    def business_policy_rules(self, business_policy_rules: Optional[List[BusinessPolicyRule]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def exceptions_for_business_policy(self) -> Optional[List[BusinessPolicyException]]:
        return None if self.attributes is None else self.attributes.exceptions_for_business_policy

    @exceptions_for_business_policy.setter
    def exceptions_for_business_policy(self, exceptions_for_business_policy: Optional[List[BusinessPolicyException]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def related_business_policies(self) -> Optional[List[BusinessPolicy]]:
        return None if self.attributes is None else self.attributes.related_business_policies

    @related_business_policies.setter
    def related_business_policies(self, related_business_policies: Optional[List[BusinessPolicy]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    class Attributes(Asset.Attributes):
        ...
        business_policy_long_description: Optional[str] = Field(default=None, description="")
        business_policy_valid_till: Optional[datetime] = Field(default=None, description="")
        business_policy_valid_from: Optional[datetime] = Field(default=None, description="")
        business_policy_version: Optional[int] = Field(default=None, description="")
        business_policy_review_period: Optional[str] = Field(default=None, description="")
        business_policy_filter_d_s_l: Optional[str] = Field(default=None, description="")
        business_policy_base_parent_guid: Optional[str] = Field(default=None, description="")
        business_policy_selected_approval_w_f: Optional[str] = Field(default=None, description="")
        business_policy_rules: Optional[List[BusinessPolicyRule]] = Field(default=None, description="")
        exceptions_for_business_policy: Optional[List[BusinessPolicyException]] = Field(
            default=None, description=""
        )  # relationship
        related_business_policies: Optional[List[BusinessPolicy]] = Field(default=None, description="")  # relationship
