...
class RedashQuery(Redash):
    ...
    REDASH_QUERY_SQL: ClassVar[KeywordField] = KeywordField("redashQuerySQL", "redashQuerySQL")
    """
    SQL code of Redash Query
    """
    REDASH_QUERY_PARAMETERS: ClassVar[KeywordField] = KeywordField("redashQueryParameters", "redashQueryParameters")
    """
    Parameters of Redash Query
    """
    REDASH_QUERY_SCHEDULE: ClassVar[KeywordField] = KeywordField("redashQuerySchedule", "redashQuerySchedule")
    """
    Schedule of Redash Query
    """
    REDASH_QUERY_LAST_EXECUTION_RUNTIME: ClassVar[NumericField] = NumericField("redashQueryLastExecutionRuntime", "redashQueryLastExecutionRuntime")
    """
    Runtime of Redash Query
    """
    REDASH_QUERY_LAST_EXECUTED_AT: ClassVar[NumericField] = NumericField("redashQueryLastExecutedAt", "redashQueryLastExecutedAt")
    """
    Time when the Redash Query was last executed
    """
    REDASH_QUERY_SCHEDULE_HUMANIZED: ClassVar[KeywordTextField] = KeywordTextField("redashQueryScheduleHumanized", "redashQueryScheduleHumanized", "redashQueryScheduleHumanized.text")
    """
    ...
    def redash_query_parameters(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.redash_query_parameters
    ...
    def redash_query_schedule(self)->Optional[dict[str,str]]:
        return None if self.attributes is None else self.attributes.redash_query_schedule
    ...
    def redash_query_last_execution_runtime(self)->Optional[float]:
        return None if self.attributes is None else self.attributes.redash_query_last_execution_runtime

    @redash_query_last_execution_runtime.setter
    def redash_query_last_execution_runtime(self, redash_query_last_execution_runtime:Optional[float]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def redash_query_last_executed_at(self)->Optional[datetime]:
        return None if self.attributes is None else self.attributes.redash_query_last_executed_at

    @redash_query_last_executed_at.setter
    def redash_query_last_executed_at(self, redash_query_last_executed_at:Optional[datetime]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def redash_query_schedule_humanized(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.redash_query_schedule_humanized

    @redash_query_schedule_humanized.setter
    def redash_query_schedule_humanized(self, redash_query_schedule_humanized:Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.redash_query_schedule_humanized = redash_query_schedule_humanized
    @property
    def redash_visualizations(self)->Optional[list[RedashVisualization]]:
        return None if self.attributes is None else self.attributes.redash_visualizations

    @redash_visualizations.setter
    def redash_visualizations(self, redash_visualizations:Optional[list[RedashVisualization]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.redash_visualizations = redash_visualizations

    class Attributes(Redash.Attributes):
        redash_query_s_q_l: Optional[str] = Field(None, description='' , alias='redashQuerySQL')
        redash_query_parameters: Optional[str] = Field(None, description='' , alias='redashQueryParameters')
        redash_query_schedule: Optional[dict[str,str]] = Field(None, description='' , alias='redashQuerySchedule')
        redash_query_last_execution_runtime: Optional[float] = Field(None, description='' , alias='redashQueryLastExecutionRuntime')
        redash_query_last_executed_at: Optional[datetime] = Field(None, description='' , alias='redashQueryLastExecutedAt')
        redash_query_schedule_humanized: Optional[str] = Field(None, description='' , alias='redashQueryScheduleHumanized')
        redash_visualizations: Optional[list[RedashVisualization]]= Field(None, description='',  alias='redashVisualizations') # relationship
...
class RedashVisualization(Redash):
    ...
    REDASH_VISUALIZATION_TYPE: ClassVar[KeywordField] = KeywordField("redashVisualizationType", "redashVisualizationType")
    """
    Redash Visualization Type
    """
    REDASH_QUERY_NAME: ClassVar[KeywordTextField] = KeywordTextField("redashQueryName", "redashQueryName.keyword", "redashQueryName")
    """
    Redash Query from which visualization is created
    """
    REDASH_QUERY_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("redashQueryQualifiedName", "redashQueryQualifiedName", "redashQueryQualifiedName.text")
    """
    ...
    class Attributes(Redash.Attributes):
        redash_visualization_type: Optional[str] = Field(None, description='' , alias='redashVisualizationType')
        redash_query_name: Optional[str] = Field(None, description='' , alias='redashQueryName')
        redash_query_qualified_name: Optional[str] = Field(None, description='' , alias='redashQueryQualifiedName')
        redash_query: Optional[RedashQuery]= Field(None, description='',  alias='redashQuery') # relationship
