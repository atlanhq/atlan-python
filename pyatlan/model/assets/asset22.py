...
class MultiDimensionalDataset(Catalog):
    ...
    type_name: str = Field("MultiDimensionalDataset", allow_mutation=False)
    ...
    class Attributes(Catalog.Attributes):
        cube_name: Optional[str] = Field(None, description="", alias="cubeName")
        cube_qualified_name: Optional[str] = Field(
            None, description="", alias="cubeQualifiedName"
        )
        cube_dimension_name: Optional[str] = Field(
            None, description="", alias="cubeDimensionName"
        )
        cube_dimension_qualified_name: Optional[str] = Field(
            None, description="", alias="cubeDimensionQualifiedName"
        )
        cube_hierarchy_name: Optional[str] = Field(
            None, description="", alias="cubeHierarchyName"
        )
        cube_hierarchy_qualified_name: Optional[str] = Field(
            None, description="", alias="cubeHierarchyQualifiedName"
        )
