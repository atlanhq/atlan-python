...
class SigmaWorkbook(Sigma):
    ...
    class Attributes(Sigma.Attributes):
        sigma_page_count: Optional[int] = Field(None, description='' , alias='sigmaPageCount')
        sigma_pages: Optional[list[SigmaPage]]= Field(None, description='',  alias='sigmaPages') # relationship
...
class SigmaDataElementField(Sigma):
    ...
    SIGMA_DATA_ELEMENT_FIELD_IS_HIDDEN: ClassVar[BooleanField] = BooleanField("sigmaDataElementFieldIsHidden", "sigmaDataElementFieldIsHidden")
    """
    TBC
    """
    SIGMA_DATA_ELEMENT_FIELD_FORMULA: ClassVar[TextField] = TextField("sigmaDataElementFieldFormula", "sigmaDataElementFieldFormula")
    """
    TBC
    """
    ...
    class Attributes(Sigma.Attributes):
        sigma_data_element_field_is_hidden: Optional[bool] = Field(None, description='' , alias='sigmaDataElementFieldIsHidden')
        sigma_data_element_field_formula: Optional[str] = Field(None, description='' , alias='sigmaDataElementFieldFormula')
        sigma_data_element: Optional[SigmaDataElement]= Field(None, description='',  alias='sigmaDataElement') # relationship
...
class SigmaPage(Sigma):
    ...
    class Attributes(Sigma.Attributes):
        sigma_data_element_count: Optional[int] = Field(None, description='' , alias='sigmaDataElementCount')
        sigma_data_elements: Optional[list[SigmaDataElement]]= Field(None, description='',  alias='sigmaDataElements') # relationship
        sigma_workbook: Optional[SigmaWorkbook]= Field(None, description='',  alias='sigmaWorkbook') # relationship
...
class SigmaDataElement(Sigma):
    ...
    SIGMA_DATA_ELEMENT_QUERY: ClassVar[KeywordField] = KeywordField("sigmaDataElementQuery", "sigmaDataElementQuery")
    """
    TBC
    """
    ...
    TBC
    """
    SIGMA_DATA_ELEMENT_FIELD_COUNT: ClassVar[NumericField] = NumericField("sigmaDataElementFieldCount", "sigmaDataElementFieldCount")
    """
    TBC
    """
    ...
    class Attributes(Sigma.Attributes):
        sigma_data_element_query: Optional[str] = Field(None, description='' , alias='sigmaDataElementQuery')
        sigma_data_element_type: Optional[str] = Field(None, description='' , alias='sigmaDataElementType')
        sigma_data_element_field_count: Optional[int] = Field(None, description='' , alias='sigmaDataElementFieldCount')
        sigma_page: Optional[SigmaPage]= Field(None, description='',  alias='sigmaPage') # relationship
        sigma_data_element_fields: Optional[list[SigmaDataElementField]]= Field(None, description='',  alias='sigmaDataElementFields') # relationship
