...
class PresetChart(Preset):
    ...
    PRESET_CHART_DESCRIPTION_MARKDOWN: ClassVar[TextField] = TextField("presetChartDescriptionMarkdown", "presetChartDescriptionMarkdown")
    """
    TBC
    """
    ...
    class Attributes(Preset.Attributes):
        preset_chart_description_markdown: Optional[str] = Field(None, description='' , alias='presetChartDescriptionMarkdown')
        preset_chart_form_data: Optional[dict[str,str]] = Field(None, description='' , alias='presetChartFormData')
        preset_dashboard: Optional[PresetDashboard]= Field(None, description='',  alias='presetDashboard') # relationship
...
class PresetDataset(Preset):
    ...
    PRESET_DATASET_DATASOURCE_NAME: ClassVar[KeywordTextStemmedField] = KeywordTextStemmedField("presetDatasetDatasourceName", "presetDatasetDatasourceName.keyword", "presetDatasetDatasourceName", "presetDatasetDatasourceName.stemmed")
    """
    TBC
    """
    ...
    class Attributes(Preset.Attributes):
        preset_dataset_datasource_name: Optional[str] = Field(None, description='' , alias='presetDatasetDatasourceName')
        preset_dataset_id: Optional[int] = Field(None, description='' , alias='presetDatasetId')
        preset_dataset_type: Optional[str] = Field(None, description='' , alias='presetDatasetType')
        preset_dashboard: Optional[PresetDashboard]= Field(None, description='',  alias='presetDashboard') # relationship
...
class PresetDashboard(Preset):
    ...
    PRESET_DASHBOARD_CHANGED_BY_NAME: ClassVar[KeywordTextStemmedField] = KeywordTextStemmedField("presetDashboardChangedByName", "presetDashboardChangedByName.keyword", "presetDashboardChangedByName", "presetDashboardChangedByName.stemmed")
    """
    TBC
    """
    PRESET_DASHBOARD_CHANGED_BY_URL: ClassVar[KeywordField] = KeywordField("presetDashboardChangedByURL", "presetDashboardChangedByURL")
    """
    TBC
    """
    PRESET_DASHBOARD_IS_MANAGED_EXTERNALLY: ClassVar[BooleanField] = BooleanField("presetDashboardIsManagedExternally", "presetDashboardIsManagedExternally")
    """
    TBC
    """
    PRESET_DASHBOARD_IS_PUBLISHED: ClassVar[BooleanField] = BooleanField("presetDashboardIsPublished", "presetDashboardIsPublished")
    """
    TBC
    """
    PRESET_DASHBOARD_THUMBNAIL_URL: ClassVar[KeywordField] = KeywordField("presetDashboardThumbnailURL", "presetDashboardThumbnailURL")
    """
    TBC
    """
    PRESET_DASHBOARD_CHART_COUNT: ClassVar[NumericField] = NumericField("presetDashboardChartCount", "presetDashboardChartCount")
    """
    TBC
    """
    ...
    class Attributes(Preset.Attributes):
        preset_dashboard_changed_by_name: Optional[str] = Field(None, description='' , alias='presetDashboardChangedByName')
        preset_dashboard_changed_by_url: Optional[str] = Field(None, description='' , alias='presetDashboardChangedByURL')
        preset_dashboard_is_managed_externally: Optional[bool] = Field(None, description='' , alias='presetDashboardIsManagedExternally')
        preset_dashboard_is_published: Optional[bool] = Field(None, description='' , alias='presetDashboardIsPublished')
        preset_dashboard_thumbnail_url: Optional[str] = Field(None, description='' , alias='presetDashboardThumbnailURL')
        preset_dashboard_chart_count: Optional[int] = Field(None, description='' , alias='presetDashboardChartCount')
        preset_datasets: Optional[list[PresetDataset]]= Field(None, description='',  alias='presetDatasets') # relationship
        preset_charts: Optional[list[PresetChart]]= Field(None, description='',  alias='presetCharts') # relationship
        preset_workspace: Optional[PresetWorkspace]= Field(None, description='',  alias='presetWorkspace') # relationship
...
class PresetWorkspace(Preset):
    ...
    PRESET_WORKSPACE_PUBLIC_DASHBOARDS_ALLOWED: ClassVar[BooleanField] = BooleanField("presetWorkspacePublicDashboardsAllowed", "presetWorkspacePublicDashboardsAllowed")
    """
    TBC
    """
    PRESET_WORKSPACE_CLUSTER_ID: ClassVar[NumericField] = NumericField("presetWorkspaceClusterId", "presetWorkspaceClusterId")
    """
    TBC
    """
    PRESET_WORKSPACE_HOSTNAME: ClassVar[KeywordTextField] = KeywordTextField("presetWorkspaceHostname", "presetWorkspaceHostname", "presetWorkspaceHostname.text")
    """
    TBC
    """
    PRESET_WORKSPACE_IS_IN_MAINTENANCE_MODE: ClassVar[BooleanField] = BooleanField("presetWorkspaceIsInMaintenanceMode", "presetWorkspaceIsInMaintenanceMode")
    """
    TBC
    """
    PRESET_WORKSPACE_REGION: ClassVar[KeywordTextField] = KeywordTextField("presetWorkspaceRegion", "presetWorkspaceRegion", "presetWorkspaceRegion.text")
    """
    TBC
    """
    ...
    TBC
    """
    PRESET_WORKSPACE_DEPLOYMENT_ID: ClassVar[NumericField] = NumericField("presetWorkspaceDeploymentId", "presetWorkspaceDeploymentId")
    """
    TBC
    """
    PRESET_WORKSPACE_DASHBOARD_COUNT: ClassVar[NumericField] = NumericField("presetWorkspaceDashboardCount", "presetWorkspaceDashboardCount")
    """
    TBC
    """
    PRESET_WORKSPACE_DATASET_COUNT: ClassVar[NumericField] = NumericField("presetWorkspaceDatasetCount", "presetWorkspaceDatasetCount")
    """
    TBC
    """
    ...
    class Attributes(Preset.Attributes):
        preset_workspace_public_dashboards_allowed: Optional[bool] = Field(None, description='' , alias='presetWorkspacePublicDashboardsAllowed')
        preset_workspace_cluster_id: Optional[int] = Field(None, description='' , alias='presetWorkspaceClusterId')
        preset_workspace_hostname: Optional[str] = Field(None, description='' , alias='presetWorkspaceHostname')
        preset_workspace_is_in_maintenance_mode: Optional[bool] = Field(None, description='' , alias='presetWorkspaceIsInMaintenanceMode')
        preset_workspace_region: Optional[str] = Field(None, description='' , alias='presetWorkspaceRegion')
        preset_workspace_status: Optional[str] = Field(None, description='' , alias='presetWorkspaceStatus')
        preset_workspace_deployment_id: Optional[int] = Field(None, description='' , alias='presetWorkspaceDeploymentId')
        preset_workspace_dashboard_count: Optional[int] = Field(None, description='' , alias='presetWorkspaceDashboardCount')
        preset_workspace_dataset_count: Optional[int] = Field(None, description='' , alias='presetWorkspaceDatasetCount')
        preset_dashboards: Optional[list[PresetDashboard]]= Field(None, description='',  alias='presetDashboards') # relationship
