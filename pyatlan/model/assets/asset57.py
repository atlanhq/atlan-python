...
class DataStudioAsset(DataStudio):
    ...
    TBC
    """
    DATA_STUDIO_ASSET_TITLE: ClassVar[KeywordTextStemmedField] = KeywordTextStemmedField("dataStudioAssetTitle", "dataStudioAssetTitle.keyword", "dataStudioAssetTitle", "dataStudioAssetTitle.stemmed")
    """
    TBC
    """
    ...
    TBC
    """
    IS_TRASHED_DATA_STUDIO_ASSET: ClassVar[BooleanField] = BooleanField("isTrashedDataStudioAsset", "isTrashedDataStudioAsset")
    """
    TBC
    """
    ...
    class Attributes(DataStudio.Attributes):
        ...
        data_studio_asset_title: Optional[str] = Field(None, description='' , alias='dataStudioAssetTitle')
        data_studio_asset_owner: Optional[str] = Field(None, description='' , alias='dataStudioAssetOwner')
        is_trashed_data_studio_asset: Optional[bool] = Field(None, description='' , alias='isTrashedDataStudioAsset')
