...
class API(Catalog):
    ...
    TBC
    """
    API_SPEC_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("apiSpecQualifiedName", "apiSpecQualifiedName", "apiSpecQualifiedName.text")
    """
    TBC
    """
    ...
    class Attributes(Catalog.Attributes):
        ...
        api_spec_version: Optional[str] = Field(None, description='' , alias='apiSpecVersion')
        api_spec_name: Optional[str] = Field(None, description='' , alias='apiSpecName')
        api_spec_qualified_name: Optional[str] = Field(None, description='' , alias='apiSpecQualifiedName')
        api_external_docs: Optional[dict[str,str]] = Field(None, description='' , alias='apiExternalDocs')
        api_is_auth_optional: Optional[bool] = Field(None, description='' , alias='apiIsAuthOptional')
