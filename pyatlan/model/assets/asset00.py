...
class Referenceable(AtlanObject):
    ...
    class Attributes(AtlanObject):
        ...
        meanings: Optional[list[AtlasGlossaryTerm]] = Field(None, description='',  alias='meanings') # relationship
...
class Asset(Referenceable):
    ...
    TBC
    """
    USER_DESCRIPTION: ClassVar[KeywordTextField] = KeywordTextField("userDescription", "userDescription.keyword", "userDescription")
    """
    TBC
    """
    ...
    TBC
    """
    CERTIFICATE_STATUS: ClassVar[KeywordTextField] = KeywordTextField("certificateStatus", "certificateStatus", "certificateStatus.text")
    """
    TBC
    """
    CERTIFICATE_STATUS_MESSAGE: ClassVar[KeywordField] = KeywordField("certificateStatusMessage", "certificateStatusMessage")
    """
    TBC
    """
    ...
    TBC
    """
    ANNOUNCEMENT_TITLE: ClassVar[KeywordField] = KeywordField("announcementTitle", "announcementTitle")
    """
    TBC
    """
    ANNOUNCEMENT_MESSAGE: ClassVar[KeywordField] = KeywordField("announcementMessage", "announcementMessage")
    """
    TBC
    """
    ...
    TBC
    """
    CONNECTION_NAME: ClassVar[KeywordTextField] = KeywordTextField("connectionName", "connectionName", "connectionName.text")
    """
    TBC
    """
    CONNECTION_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("connectionQualifiedName", "connectionQualifiedName", "connectionQualifiedName.text")
    """
    TBC
    """
    ...
    TBC
    """
    POPULARITY_SCORE: ClassVar[NumericRankField] = NumericRankField("popularityScore", "popularityScore", "popularityScore.rank_feature")
    """
    TBC
    """
    ...
    """
    SOURCE_READ_RECENT_USER_LIST: ClassVar[KeywordField] = KeywordField("sourceReadRecentUserList", "sourceReadRecentUserList")
    """
    List of usernames of the most recent users who read the asset
    """
    SOURCE_READ_RECENT_USER_RECORD_LIST: ClassVar[KeywordField] = KeywordField("sourceReadRecentUserRecordList", "sourceReadRecentUserRecordList")
    """
    ...
    """
    SOURCE_READ_TOP_USER_RECORD_LIST: ClassVar[KeywordField] = KeywordField("sourceReadTopUserRecordList", "sourceReadTopUserRecordList")
    """
    List of usernames with extra insights for the top users who read the asset the most
    """
    SOURCE_READ_POPULAR_QUERY_RECORD_LIST: ClassVar[KeywordField] = KeywordField("sourceReadPopularQueryRecordList", "sourceReadPopularQueryRecordList")
    """
    List of the most popular queries that accessed this asset
    """
    SOURCE_READ_EXPENSIVE_QUERY_RECORD_LIST: ClassVar[KeywordField] = KeywordField("sourceReadExpensiveQueryRecordList", "sourceReadExpensiveQueryRecordList")
    """
    List of the most expensive queries that accessed this asset
    """
    SOURCE_READ_SLOW_QUERY_RECORD_LIST: ClassVar[KeywordField] = KeywordField("sourceReadSlowQueryRecordList", "sourceReadSlowQueryRecordList")
    """
    List of the slowest queries that accessed this asset
    """
    SOURCE_QUERY_COMPUTE_COST_LIST: ClassVar[KeywordField] = KeywordField("sourceQueryComputeCostList", "sourceQueryComputeCostList")
    """
    List of most expensive warehouse names
    """
    SOURCE_QUERY_COMPUTE_COST_RECORD_LIST: ClassVar[KeywordField] = KeywordField("sourceQueryComputeCostRecordList", "sourceQueryComputeCostRecordList")
    """
    List of most expensive warehouses with extra insights
    """
    DBT_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("dbtQualifiedName", "dbtQualifiedName", "dbtQualifiedName.text")
    """
    TBC
    """
    ASSET_DBT_ALIAS: ClassVar[KeywordTextField] = KeywordTextField("assetDbtAlias", "assetDbtAlias.keyword", "assetDbtAlias")
    """
    TBC
    """
    ASSET_DBT_META: ClassVar[KeywordField] = KeywordField("assetDbtMeta", "assetDbtMeta")
    """
    TBC
    """
    ASSET_DBT_UNIQUE_ID: ClassVar[KeywordTextField] = KeywordTextField("assetDbtUniqueId", "assetDbtUniqueId.keyword", "assetDbtUniqueId")
    """
    TBC
    """
    ASSET_DBT_ACCOUNT_NAME: ClassVar[KeywordTextField] = KeywordTextField("assetDbtAccountName", "assetDbtAccountName.keyword", "assetDbtAccountName")
    """
    TBC
    """
    ASSET_DBT_PROJECT_NAME: ClassVar[KeywordTextField] = KeywordTextField("assetDbtProjectName", "assetDbtProjectName.keyword", "assetDbtProjectName")
    """
    TBC
    """
    ASSET_DBT_PACKAGE_NAME: ClassVar[KeywordTextField] = KeywordTextField("assetDbtPackageName", "assetDbtPackageName.keyword", "assetDbtPackageName")
    """
    TBC
    """
    ASSET_DBT_JOB_NAME: ClassVar[KeywordTextField] = KeywordTextField("assetDbtJobName", "assetDbtJobName.keyword", "assetDbtJobName")
    """
    TBC
    """
    ...
    """
    ASSET_DBT_JOB_SCHEDULE_CRON_HUMANIZED: ClassVar[TextField] = TextField("assetDbtJobScheduleCronHumanized", "assetDbtJobScheduleCronHumanized")
    """
    TBC
    """
    ...
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_CREATED_AT: ClassVar[NumericField] = NumericField("assetDbtJobLastRunCreatedAt", "assetDbtJobLastRunCreatedAt")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_UPDATED_AT: ClassVar[NumericField] = NumericField("assetDbtJobLastRunUpdatedAt", "assetDbtJobLastRunUpdatedAt")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_DEQUED_AT: ClassVar[NumericField] = NumericField("assetDbtJobLastRunDequedAt", "assetDbtJobLastRunDequedAt")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_STARTED_AT: ClassVar[NumericField] = NumericField("assetDbtJobLastRunStartedAt", "assetDbtJobLastRunStartedAt")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_TOTAL_DURATION: ClassVar[KeywordField] = KeywordField("assetDbtJobLastRunTotalDuration", "assetDbtJobLastRunTotalDuration")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_TOTAL_DURATION_HUMANIZED: ClassVar[KeywordField] = KeywordField("assetDbtJobLastRunTotalDurationHumanized", "assetDbtJobLastRunTotalDurationHumanized")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_QUEUED_DURATION: ClassVar[KeywordField] = KeywordField("assetDbtJobLastRunQueuedDuration", "assetDbtJobLastRunQueuedDuration")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_QUEUED_DURATION_HUMANIZED: ClassVar[KeywordField] = KeywordField("assetDbtJobLastRunQueuedDurationHumanized", "assetDbtJobLastRunQueuedDurationHumanized")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_RUN_DURATION: ClassVar[KeywordField] = KeywordField("assetDbtJobLastRunRunDuration", "assetDbtJobLastRunRunDuration")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_RUN_DURATION_HUMANIZED: ClassVar[KeywordField] = KeywordField("assetDbtJobLastRunRunDurationHumanized", "assetDbtJobLastRunRunDurationHumanized")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_GIT_BRANCH: ClassVar[KeywordTextField] = KeywordTextField("assetDbtJobLastRunGitBranch", "assetDbtJobLastRunGitBranch", "assetDbtJobLastRunGitBranch.text")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_GIT_SHA: ClassVar[KeywordField] = KeywordField("assetDbtJobLastRunGitSha", "assetDbtJobLastRunGitSha")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_STATUS_MESSAGE: ClassVar[KeywordTextField] = KeywordTextField("assetDbtJobLastRunStatusMessage", "assetDbtJobLastRunStatusMessage.keyword", "assetDbtJobLastRunStatusMessage")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_OWNER_THREAD_ID: ClassVar[KeywordField] = KeywordField("assetDbtJobLastRunOwnerThreadId", "assetDbtJobLastRunOwnerThreadId")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_EXECUTED_BY_THREAD_ID: ClassVar[KeywordField] = KeywordField("assetDbtJobLastRunExecutedByThreadId", "assetDbtJobLastRunExecutedByThreadId")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_ARTIFACTS_SAVED: ClassVar[BooleanField] = BooleanField("assetDbtJobLastRunArtifactsSaved", "assetDbtJobLastRunArtifactsSaved")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_ARTIFACT_S3PATH: ClassVar[KeywordField] = KeywordField("assetDbtJobLastRunArtifactS3Path", "assetDbtJobLastRunArtifactS3Path")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_HAS_DOCS_GENERATED: ClassVar[BooleanField] = BooleanField("assetDbtJobLastRunHasDocsGenerated", "assetDbtJobLastRunHasDocsGenerated")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_HAS_SOURCES_GENERATED: ClassVar[BooleanField] = BooleanField("assetDbtJobLastRunHasSourcesGenerated", "assetDbtJobLastRunHasSourcesGenerated")
    """
    TBC
    """
    ASSET_DBT_JOB_LAST_RUN_NOTIFICATIONS_SENT: ClassVar[BooleanField] = BooleanField("assetDbtJobLastRunNotificationsSent", "assetDbtJobLastRunNotificationsSent")
    """
    TBC
    """
    ...
    TBC
    """
    ASSET_DBT_JOB_NEXT_RUN_HUMANIZED: ClassVar[KeywordTextField] = KeywordTextField("assetDbtJobNextRunHumanized", "assetDbtJobNextRunHumanized.keyword", "assetDbtJobNextRunHumanized")
    """
    TBC
    """
    ASSET_DBT_ENVIRONMENT_NAME: ClassVar[KeywordTextField] = KeywordTextField("assetDbtEnvironmentName", "assetDbtEnvironmentName.keyword", "assetDbtEnvironmentName")
    """
    TBC
    """
    ASSET_DBT_ENVIRONMENT_DBT_VERSION: ClassVar[KeywordField] = KeywordField("assetDbtEnvironmentDbtVersion", "assetDbtEnvironmentDbtVersion")
    """
    TBC
    """
    ...
    TBC
    """
    ASSET_DBT_SEMANTIC_LAYER_PROXY_URL: ClassVar[KeywordField] = KeywordField("assetDbtSemanticLayerProxyUrl", "assetDbtSemanticLayerProxyUrl")
    """
    TBC
    """
    ASSET_DBT_SOURCE_FRESHNESS_CRITERIA: ClassVar[KeywordField] = KeywordField("assetDbtSourceFreshnessCriteria", "assetDbtSourceFreshnessCriteria")
    """
    TBC
    """
    SAMPLE_DATA_URL: ClassVar[KeywordTextField] = KeywordTextField("sampleDataUrl", "sampleDataUrl", "sampleDataUrl.text")
    """
    TBC
    """
    ...
    TBC
    """
    ASSET_MC_INCIDENT_NAMES: ClassVar[KeywordTextField] = KeywordTextField("assetMcIncidentNames", "assetMcIncidentNames.keyword", "assetMcIncidentNames")
    """
    TBC
    """
    ASSET_MC_INCIDENT_QUALIFIED_NAMES: ClassVar[KeywordTextField] = KeywordTextField("assetMcIncidentQualifiedNames", "assetMcIncidentQualifiedNames", "assetMcIncidentQualifiedNames.text")
    """
    TBC
    """
    ASSET_MC_MONITOR_NAMES: ClassVar[KeywordTextField] = KeywordTextField("assetMcMonitorNames", "assetMcMonitorNames.keyword", "assetMcMonitorNames")
    """
    TBC
    """
    ASSET_MC_MONITOR_QUALIFIED_NAMES: ClassVar[KeywordTextField] = KeywordTextField("assetMcMonitorQualifiedNames", "assetMcMonitorQualifiedNames", "assetMcMonitorQualifiedNames.text")
    """
    TBC
    """
    ...
    """
    ASSET_MC_MONITOR_SCHEDULE_TYPES: ClassVar[KeywordField] = KeywordField("assetMcMonitorScheduleTypes", "assetMcMonitorScheduleTypes")
    """
    ...
    TBC
    """
    ASSET_MC_INCIDENT_SUB_TYPES: ClassVar[KeywordField] = KeywordField("assetMcIncidentSubTypes", "assetMcIncidentSubTypes")
    """
    TBC
    """
    ASSET_MC_INCIDENT_SEVERITIES: ClassVar[KeywordField] = KeywordField("assetMcIncidentSeverities", "assetMcIncidentSeverities")
    """
    TBC
    """
    ...
    Soda check count
    """
    ASSET_SODA_LAST_SYNC_RUN_AT: ClassVar[NumericField] = NumericField("assetSodaLastSyncRunAt", "assetSodaLastSyncRunAt")
    """
    TBC
    """
    ...
    TBC
    """
    ASSET_SODA_CHECK_STATUSES: ClassVar[KeywordField] = KeywordField("assetSodaCheckStatuses", "assetSodaCheckStatuses")
    """
    ...
    def source_read_recent_user_record_list(self, source_read_recent_user_record_list:Optional[list[PopularityInsights]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    @property
    def source_read_popular_query_record_list(self)->Optional[list[PopularityInsights]]:
    ...
    def source_read_popular_query_record_list(self, source_read_popular_query_record_list:Optional[list[PopularityInsights]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.source_read_popular_query_record_list = source_read_popular_query_record_list
    @property
    def source_read_expensive_query_record_list(self)->Optional[list[PopularityInsights]]:
    ...
    def source_read_expensive_query_record_list(self, source_read_expensive_query_record_list:Optional[list[PopularityInsights]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def source_read_slow_query_record_list(self, source_read_slow_query_record_list:Optional[list[PopularityInsights]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    @property
    def source_query_compute_cost_record_list(self)->Optional[list[PopularityInsights]]:
    ...
    def source_query_compute_cost_record_list(self, source_query_compute_cost_record_list:Optional[list[PopularityInsights]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def asset_dbt_job_last_run_total_duration_humanized(self, asset_dbt_job_last_run_total_duration_humanized:Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.asset_dbt_job_last_run_total_duration_humanized = asset_dbt_job_last_run_total_duration_humanized
    @property
    ...
    def asset_dbt_job_last_run_queued_duration_humanized(self, asset_dbt_job_last_run_queued_duration_humanized:Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.asset_dbt_job_last_run_queued_duration_humanized = asset_dbt_job_last_run_queued_duration_humanized
    @property
    ...
    def asset_dbt_job_last_run_run_duration_humanized(self, asset_dbt_job_last_run_run_duration_humanized:Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def asset_dbt_job_last_run_has_sources_generated(self, asset_dbt_job_last_run_has_sources_generated:Optional[bool]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    class Attributes(Referenceable.Attributes):
        ...
        user_description: Optional[str] = Field(None, description='' , alias='userDescription')
        tenant_id: Optional[str] = Field(None, description='' , alias='tenantId')
        certificate_status: Optional[CertificateStatus] = Field(None, description='' , alias='certificateStatus')
        certificate_status_message: Optional[str] = Field(None, description='' , alias='certificateStatusMessage')
        certificate_updated_by: Optional[str] = Field(None, description='' , alias='certificateUpdatedBy')
        certificate_updated_at: Optional[datetime] = Field(None, description='' , alias='certificateUpdatedAt')
        announcement_title: Optional[str] = Field(None, description='' , alias='announcementTitle')
        announcement_message: Optional[str] = Field(None, description='' , alias='announcementMessage')
        announcement_type: Optional[str] = Field(None, description='' , alias='announcementType')
        announcement_updated_at: Optional[datetime] = Field(None, description='' , alias='announcementUpdatedAt')
        announcement_updated_by: Optional[str] = Field(None, description='' , alias='announcementUpdatedBy')
        owner_users: Optional[set[str]] = Field(None, description='' , alias='ownerUsers')
        owner_groups: Optional[set[str]] = Field(None, description='' , alias='ownerGroups')
        admin_users: Optional[set[str]] = Field(None, description='' , alias='adminUsers')
        admin_groups: Optional[set[str]] = Field(None, description='' , alias='adminGroups')
        viewer_users: Optional[set[str]] = Field(None, description='' , alias='viewerUsers')
        viewer_groups: Optional[set[str]] = Field(None, description='' , alias='viewerGroups')
        connector_name: Optional[str] = Field(None, description='' , alias='connectorName')
        connection_name: Optional[str] = Field(None, description='' , alias='connectionName')
        connection_qualified_name: Optional[str] = Field(None, description='' , alias='connectionQualifiedName')
        has_lineage: Optional[bool] = Field(None, description='' , alias='__hasLineage')
        is_discoverable: Optional[bool] = Field(None, description='' , alias='isDiscoverable')
        ...
        popularity_score: Optional[float] = Field(None, description='' , alias='popularityScore')
        source_owners: Optional[str] = Field(None, description='' , alias='sourceOwners')
        source_created_by: Optional[str] = Field(None, description='' , alias='sourceCreatedBy')
        source_created_at: Optional[datetime] = Field(None, description='' , alias='sourceCreatedAt')
        source_updated_at: Optional[datetime] = Field(None, description='' , alias='sourceUpdatedAt')
        source_updated_by: Optional[str] = Field(None, description='' , alias='sourceUpdatedBy')
        source_url: Optional[str] = Field(None, description='' , alias='sourceURL')
        source_embed_url: Optional[str] = Field(None, description='' , alias='sourceEmbedURL')
        last_sync_workflow_name: Optional[str] = Field(None, description='' , alias='lastSyncWorkflowName')
        last_sync_run_at: Optional[datetime] = Field(None, description='' , alias='lastSyncRunAt')
        last_sync_run: Optional[str] = Field(None, description='' , alias='lastSyncRun')
        admin_roles: Optional[set[str]] = Field(None, description='' , alias='adminRoles')
        source_read_count: Optional[int] = Field(None, description='' , alias='sourceReadCount')
        source_read_user_count: Optional[int] = Field(None, description='' , alias='sourceReadUserCount')
        source_last_read_at: Optional[datetime] = Field(None, description='' , alias='sourceLastReadAt')
        last_row_changed_at: Optional[datetime] = Field(None, description='' , alias='lastRowChangedAt')
        source_total_cost: Optional[float] = Field(None, description='' , alias='sourceTotalCost')
        source_cost_unit: Optional[SourceCostUnitType] = Field(None, description='' , alias='sourceCostUnit')
        source_read_query_cost: Optional[float] = Field(None, description='' , alias='sourceReadQueryCost')
        source_read_recent_user_list: Optional[set[str]] = Field(None, description='' , alias='sourceReadRecentUserList')
        source_read_recent_user_record_list: Optional[list[PopularityInsights]] = Field(None, description='' , alias='sourceReadRecentUserRecordList')
        source_read_top_user_list: Optional[set[str]] = Field(None, description='' , alias='sourceReadTopUserList')
        source_read_top_user_record_list: Optional[list[PopularityInsights]] = Field(None, description='' , alias='sourceReadTopUserRecordList')
        source_read_popular_query_record_list: Optional[list[PopularityInsights]] = Field(None, description='' , alias='sourceReadPopularQueryRecordList')
        source_read_expensive_query_record_list: Optional[list[PopularityInsights]] = Field(None, description='' , alias='sourceReadExpensiveQueryRecordList')
        source_read_slow_query_record_list: Optional[list[PopularityInsights]] = Field(None, description='' , alias='sourceReadSlowQueryRecordList')
        source_query_compute_cost_list: Optional[set[str]] = Field(None, description='' , alias='sourceQueryComputeCostList')
        source_query_compute_cost_record_list: Optional[list[PopularityInsights]] = Field(None, description='' , alias='sourceQueryComputeCostRecordList')
        dbt_qualified_name: Optional[str] = Field(None, description='' , alias='dbtQualifiedName')
        asset_dbt_alias: Optional[str] = Field(None, description='' , alias='assetDbtAlias')
        asset_dbt_meta: Optional[str] = Field(None, description='' , alias='assetDbtMeta')
        asset_dbt_unique_id: Optional[str] = Field(None, description='' , alias='assetDbtUniqueId')
        asset_dbt_account_name: Optional[str] = Field(None, description='' , alias='assetDbtAccountName')
        asset_dbt_project_name: Optional[str] = Field(None, description='' , alias='assetDbtProjectName')
        asset_dbt_package_name: Optional[str] = Field(None, description='' , alias='assetDbtPackageName')
        asset_dbt_job_name: Optional[str] = Field(None, description='' , alias='assetDbtJobName')
        asset_dbt_job_schedule: Optional[str] = Field(None, description='' , alias='assetDbtJobSchedule')
        asset_dbt_job_status: Optional[str] = Field(None, description='' , alias='assetDbtJobStatus')
        asset_dbt_test_status: Optional[str] = Field(None, description='' , alias='assetDbtTestStatus')
        asset_dbt_job_schedule_cron_humanized: Optional[str] = Field(None, description='' , alias='assetDbtJobScheduleCronHumanized')
        asset_dbt_job_last_run: Optional[datetime] = Field(None, description='' , alias='assetDbtJobLastRun')
        asset_dbt_job_last_run_url: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunUrl')
        asset_dbt_job_last_run_created_at: Optional[datetime] = Field(None, description='' , alias='assetDbtJobLastRunCreatedAt')
        asset_dbt_job_last_run_updated_at: Optional[datetime] = Field(None, description='' , alias='assetDbtJobLastRunUpdatedAt')
        asset_dbt_job_last_run_dequed_at: Optional[datetime] = Field(None, description='' , alias='assetDbtJobLastRunDequedAt')
        asset_dbt_job_last_run_started_at: Optional[datetime] = Field(None, description='' , alias='assetDbtJobLastRunStartedAt')
        asset_dbt_job_last_run_total_duration: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunTotalDuration')
        asset_dbt_job_last_run_total_duration_humanized: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunTotalDurationHumanized')
        asset_dbt_job_last_run_queued_duration: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunQueuedDuration')
        asset_dbt_job_last_run_queued_duration_humanized: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunQueuedDurationHumanized')
        asset_dbt_job_last_run_run_duration: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunRunDuration')
        asset_dbt_job_last_run_run_duration_humanized: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunRunDurationHumanized')
        asset_dbt_job_last_run_git_branch: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunGitBranch')
        asset_dbt_job_last_run_git_sha: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunGitSha')
        asset_dbt_job_last_run_status_message: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunStatusMessage')
        asset_dbt_job_last_run_owner_thread_id: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunOwnerThreadId')
        asset_dbt_job_last_run_executed_by_thread_id: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunExecutedByThreadId')
        asset_dbt_job_last_run_artifacts_saved: Optional[bool] = Field(None, description='' , alias='assetDbtJobLastRunArtifactsSaved')
        asset_dbt_job_last_run_artifact_s3_path: Optional[str] = Field(None, description='' , alias='assetDbtJobLastRunArtifactS3Path')
        asset_dbt_job_last_run_has_docs_generated: Optional[bool] = Field(None, description='' , alias='assetDbtJobLastRunHasDocsGenerated')
        asset_dbt_job_last_run_has_sources_generated: Optional[bool] = Field(None, description='' , alias='assetDbtJobLastRunHasSourcesGenerated')
        asset_dbt_job_last_run_notifications_sent: Optional[bool] = Field(None, description='' , alias='assetDbtJobLastRunNotificationsSent')
        asset_dbt_job_next_run: Optional[datetime] = Field(None, description='' , alias='assetDbtJobNextRun')
        asset_dbt_job_next_run_humanized: Optional[str] = Field(None, description='' , alias='assetDbtJobNextRunHumanized')
        asset_dbt_environment_name: Optional[str] = Field(None, description='' , alias='assetDbtEnvironmentName')
        asset_dbt_environment_dbt_version: Optional[str] = Field(None, description='' , alias='assetDbtEnvironmentDbtVersion')
        asset_dbt_tags: Optional[set[str]] = Field(None, description='' , alias='assetDbtTags')
        asset_dbt_semantic_layer_proxy_url: Optional[str] = Field(None, description='' , alias='assetDbtSemanticLayerProxyUrl')
        asset_dbt_source_freshness_criteria: Optional[str] = Field(None, description='' , alias='assetDbtSourceFreshnessCriteria')
        sample_data_url: Optional[str] = Field(None, description='' , alias='sampleDataUrl')
        asset_tags: Optional[set[str]] = Field(None, description='' , alias='assetTags')
        asset_mc_incident_names: Optional[set[str]] = Field(None, description='' , alias='assetMcIncidentNames')
        asset_mc_incident_qualified_names: Optional[set[str]] = Field(None, description='' , alias='assetMcIncidentQualifiedNames')
        asset_mc_monitor_names: Optional[set[str]] = Field(None, description='' , alias='assetMcMonitorNames')
        asset_mc_monitor_qualified_names: Optional[set[str]] = Field(None, description='' , alias='assetMcMonitorQualifiedNames')
        asset_mc_monitor_statuses: Optional[set[str]] = Field(None, description='' , alias='assetMcMonitorStatuses')
        asset_mc_monitor_types: Optional[set[str]] = Field(None, description='' , alias='assetMcMonitorTypes')
        asset_mc_monitor_schedule_types: Optional[set[str]] = Field(None, description='' , alias='assetMcMonitorScheduleTypes')
        asset_mc_incident_types: Optional[set[str]] = Field(None, description='' , alias='assetMcIncidentTypes')
        asset_mc_incident_sub_types: Optional[set[str]] = Field(None, description='' , alias='assetMcIncidentSubTypes')
        asset_mc_incident_severities: Optional[set[str]] = Field(None, description='' , alias='assetMcIncidentSeverities')
        asset_mc_incident_states: Optional[set[str]] = Field(None, description='' , alias='assetMcIncidentStates')
        asset_mc_last_sync_run_at: Optional[datetime] = Field(None, description='' , alias='assetMcLastSyncRunAt')
        starred_by: Optional[set[str]] = Field(None, description='' , alias='starredBy')
        starred_details_list: Optional[list[StarredDetails]] = Field(None, description='' , alias='starredDetailsList')
        starred_count: Optional[int] = Field(None, description='' , alias='starredCount')
        asset_soda_d_q_status: Optional[str] = Field(None, description='' , alias='assetSodaDQStatus')
        asset_soda_check_count: Optional[int] = Field(None, description='' , alias='assetSodaCheckCount')
        asset_soda_last_sync_run_at: Optional[datetime] = Field(None, description='' , alias='assetSodaLastSyncRunAt')
        asset_soda_last_scan_at: Optional[datetime] = Field(None, description='' , alias='assetSodaLastScanAt')
        asset_soda_check_statuses: Optional[str] = Field(None, description='' , alias='assetSodaCheckStatuses')
        asset_soda_source_url: Optional[str] = Field(None, description='' , alias='assetSodaSourceURL')
        asset_icon: Optional[str] = Field(None, description='' , alias='assetIcon')
        schema_registry_subjects: Optional[list[SchemaRegistrySubject]]= Field(None, description='',  alias='schemaRegistrySubjects') # relationship
        mc_monitors: Optional[list[MCMonitor]]= Field(None, description='',  alias='mcMonitors') # relationship
        files: Optional[list[File]]= Field(None, description='',  alias='files') # relationship
        mc_incidents: Optional[list[MCIncident]]= Field(None, description='',  alias='mcIncidents') # relationship
        links: Optional[list[Link]]= Field(None, description='',  alias='links') # relationship
        metrics: Optional[list[Metric]]= Field(None, description='',  alias='metrics') # relationship
        readme: Optional[Readme]= Field(None, description='',  alias='readme') # relationship
        soda_checks: Optional[list[SodaCheck]]= Field(None, description='',  alias='sodaChecks') # relationship
        meanings: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='meanings') # relationship
...
class AtlasGlossaryCategory(Asset, type_name='AtlasGlossaryCategory'):
    ...
    SHORT_DESCRIPTION: ClassVar[KeywordField] = KeywordField("shortDescription", "shortDescription")
    """
    TBC
    """
    LONG_DESCRIPTION: ClassVar[KeywordField] = KeywordField("longDescription", "longDescription")
    """
    TBC
    """
    ...
    class Attributes(Asset.Attributes):
        short_description: Optional[str] = Field(None, description='' , alias='shortDescription')
        long_description: Optional[str] = Field(None, description='' , alias='longDescription')
        additional_attributes: Optional[dict[str,str]] = Field(None, description='' , alias='additionalAttributes')
        terms: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='terms') # relationship
        anchor: Optional[AtlasGlossary]= Field(None, description='',  alias='anchor') # relationship
        parent_category: Optional[AtlasGlossaryCategory]= Field(None, description='',  alias='parentCategory') # relationship
        children_categories: Optional[list[AtlasGlossaryCategory]]= Field(None, description='',  alias='childrenCategories') # relationship
...
class AtlasGlossary(Asset, type_name='AtlasGlossary'):
    ...
    class Attributes(Asset.Attributes):
        ...
        additional_attributes: Optional[dict[str,str]] = Field(None, description='' , alias='additionalAttributes')
        terms: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='terms') # relationship
        categories: Optional[list[AtlasGlossaryCategory]]= Field(None, description='',  alias='categories') # relationship
...
class AtlasGlossaryTerm(Asset, type_name='AtlasGlossaryTerm'):
    ...
    class Attributes(Asset.Attributes):
        ...
        usage: Optional[str] = Field(None, description='' , alias='usage')
        additional_attributes: Optional[dict[str,str]] = Field(None, description='' , alias='additionalAttributes')
        valid_values_for: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='validValuesFor') # relationship
        valid_values: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='validValues') # relationship
        see_also: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='seeAlso') # relationship
        is_a: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='isA') # relationship
        antonyms: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='antonyms') # relationship
        assigned_entities: Optional[list[Referenceable]]= Field(None, description='',  alias='assignedEntities') # relationship
        classifies: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='classifies') # relationship
        categories: Optional[list[AtlasGlossaryCategory]]= Field(None, description='',  alias='categories') # relationship
        preferred_to_terms: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='preferredToTerms') # relationship
        preferred_terms: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='preferredTerms') # relationship
        translation_terms: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='translationTerms') # relationship
        synonyms: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='synonyms') # relationship
        replaced_by: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='replacedBy') # relationship
        replacement_terms: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='replacementTerms') # relationship
        translated_terms: Optional[list[AtlasGlossaryTerm]]= Field(None, description='',  alias='translatedTerms') # relationship
        anchor: Optional[AtlasGlossary]= Field(None, description='',  alias='anchor') # relationship
...
class Process(Asset, type_name='Process'):
    ...
    class Attributes(Asset.Attributes):
        ...
        matillion_component: Optional[MatillionComponent]= Field(None, description='',  alias='matillionComponent') # relationship
        airflow_tasks: Optional[list[AirflowTask]]= Field(None, description='',  alias='airflowTasks') # relationship
        column_processes: Optional[list[ColumnProcess]]= Field(None, description='',  alias='columnProcesses') # relationship
...
class Namespace(Asset, type_name='Namespace'):
    ...
    class Attributes(Asset.Attributes):
        children_queries: Optional[list[Query]]= Field(None, description='',  alias='childrenQueries') # relationship
        children_folders: Optional[list[Folder]]= Field(None, description='',  alias='childrenFolders') # relationship
...
class Folder(Namespace):
    ...
    PARENT_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("parentQualifiedName", "parentQualifiedName", "parentQualifiedName.text")
    """
    TBC
    """
    COLLECTION_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("collectionQualifiedName", "collectionQualifiedName", "collectionQualifiedName.text")
    """
    TBC
    """
    ...
    class Attributes(Namespace.Attributes):
        parent_qualified_name: Optional[str] = Field(None, description='' , alias='parentQualifiedName')
        collection_qualified_name: Optional[str] = Field(None, description='' , alias='collectionQualifiedName')
        parent: Optional[Namespace]= Field(None, description='',  alias='parent') # relationship
...
class Catalog(Asset, type_name='Catalog'):
    ...
    class Attributes(Asset.Attributes):
        input_to_processes: Optional[list[Process]]= Field(None, description='',  alias='inputToProcesses') # relationship
        output_from_airflow_tasks: Optional[list[AirflowTask]]= Field(None, description='',  alias='outputFromAirflowTasks') # relationship
        input_to_airflow_tasks: Optional[list[AirflowTask]]= Field(None, description='',  alias='inputToAirflowTasks') # relationship
        output_from_processes: Optional[list[Process]]= Field(None, description='',  alias='outputFromProcesses') # relationship
...
class Tag(Catalog):
    ...
    """
    TAG_ALLOWED_VALUES: ClassVar[KeywordTextField] = KeywordTextField("tagAllowedValues", "tagAllowedValues", "tagAllowedValues.text")
    """
    Allowed values for the tag at source. De-normalised from sourceTagAttributed for ease of querying
    """
    MAPPED_CLASSIFICATION_NAME: ClassVar[KeywordField] = KeywordField("mappedClassificationName", "mappedClassificationName")
    """
    ...
    class Attributes(Catalog.Attributes):
        ...
        tag_attributes: Optional[list[SourceTagAttribute]] = Field(None, description='' , alias='tagAttributes')
        tag_allowed_values: Optional[set[str]] = Field(None, description='' , alias='tagAllowedValues')
        mapped_atlan_tag_name: Optional[str] = Field(None, description='' , alias='mappedClassificationName')
...
class ColumnProcess(Process):
    ...
    class Attributes(Process.Attributes):
        ...
        process: Optional[Process]= Field(None, description='',  alias='process') # relationship
...
class Airflow(Catalog):
    ...
    """
    AIRFLOW_RUN_OPEN_LINEAGE_VERSION: ClassVar[KeywordField] = KeywordField("airflowRunOpenLineageVersion", "airflowRunOpenLineageVersion")
    """
    ...
    End time of the run
    """
    AIRFLOW_RUN_OPEN_LINEAGE_STATE: ClassVar[KeywordField] = KeywordField("airflowRunOpenLineageState", "airflowRunOpenLineageState")
    """
    ...
    class Attributes(Catalog.Attributes):
        airflow_tags: Optional[set[str]] = Field(None, description='' , alias='airflowTags')
        airflow_run_version: Optional[str] = Field(None, description='' , alias='airflowRunVersion')
        airflow_run_open_lineage_version: Optional[str] = Field(None, description='' , alias='airflowRunOpenLineageVersion')
        airflow_run_name: Optional[str] = Field(None, description='' , alias='airflowRunName')
        airflow_run_type: Optional[str] = Field(None, description='' , alias='airflowRunType')
        airflow_run_start_time: Optional[datetime] = Field(None, description='' , alias='airflowRunStartTime')
        airflow_run_end_time: Optional[datetime] = Field(None, description='' , alias='airflowRunEndTime')
        airflow_run_open_lineage_state: Optional[OpenLineageRunState] = Field(None, description='' , alias='airflowRunOpenLineageState')
...
class AirflowDag(Airflow):
    ...
    TBC
    """
    AIRFLOW_DAG_SCHEDULE_DELTA: ClassVar[NumericField] = NumericField("airflowDagScheduleDelta", "airflowDagScheduleDelta")
    """
    ...
    class Attributes(Airflow.Attributes):
        airflow_dag_schedule: Optional[str] = Field(None, description='' , alias='airflowDagSchedule')
        airflow_dag_schedule_delta: Optional[int] = Field(None, description='' , alias='airflowDagScheduleDelta')
        airflow_tasks: Optional[list[AirflowTask]]= Field(None, description='',  alias='airflowTasks') # relationship
...
class AirflowTask(Airflow):
    ...
    AIRFLOW_TASK_OPERATOR_CLASS: ClassVar[KeywordTextField] = KeywordTextField("airflowTaskOperatorClass", "airflowTaskOperatorClass.keyword", "airflowTaskOperatorClass")
    """
    TBC
    """
    AIRFLOW_DAG_NAME: ClassVar[KeywordTextField] = KeywordTextField("airflowDagName", "airflowDagName.keyword", "airflowDagName")
    """
    TBC
    """
    AIRFLOW_DAG_QUALIFIED_NAME: ClassVar[KeywordField] = KeywordField("airflowDagQualifiedName", "airflowDagQualifiedName")
    """
    TBC
    """
    AIRFLOW_TASK_CONNECTION_ID: ClassVar[KeywordTextField] = KeywordTextField("airflowTaskConnectionId", "airflowTaskConnectionId.keyword", "airflowTaskConnectionId")
    """
    TBC
    """
    AIRFLOW_TASK_SQL: ClassVar[KeywordField] = KeywordField("airflowTaskSql", "airflowTaskSql")
    """
    TBC
    """
    ...
    """
    AIRFLOW_TASK_PRIORITY_WEIGHT: ClassVar[NumericField] = NumericField("airflowTaskPriorityWeight", "airflowTaskPriorityWeight")
    """
    ...
    class Attributes(Airflow.Attributes):
        airflow_task_operator_class: Optional[str] = Field(None, description='' , alias='airflowTaskOperatorClass')
        airflow_dag_name: Optional[str] = Field(None, description='' , alias='airflowDagName')
        airflow_dag_qualified_name: Optional[str] = Field(None, description='' , alias='airflowDagQualifiedName')
        airflow_task_connection_id: Optional[str] = Field(None, description='' , alias='airflowTaskConnectionId')
        airflow_task_sql: Optional[str] = Field(None, description='' , alias='airflowTaskSql')
        airflow_task_retry_number: Optional[int] = Field(None, description='' , alias='airflowTaskRetryNumber')
        airflow_task_pool: Optional[str] = Field(None, description='' , alias='airflowTaskPool')
        airflow_task_pool_slots: Optional[int] = Field(None, description='' , alias='airflowTaskPoolSlots')
        airflow_task_queue: Optional[str] = Field(None, description='' , alias='airflowTaskQueue')
        airflow_task_priority_weight: Optional[int] = Field(None, description='' , alias='airflowTaskPriorityWeight')
        airflow_task_trigger_rule: Optional[str] = Field(None, description='' , alias='airflowTaskTriggerRule')
        outputs: Optional[list[Catalog]]= Field(None, description='',  alias='outputs') # relationship
        process: Optional[Process]= Field(None, description='',  alias='process') # relationship
        inputs: Optional[list[Catalog]]= Field(None, description='',  alias='inputs') # relationship
        airflow_dag: Optional[AirflowDag]= Field(None, description='',  alias='airflowDag') # relationship
...
class Metric(DataQuality):
    ...
    class Attributes(DataQuality.Attributes):
        ...
        metric_filters: Optional[str] = Field(None, description='' , alias='metricFilters')
        metric_time_grains: Optional[set[str]] = Field(None, description='' , alias='metricTimeGrains')
        metric_timestamp_column: Optional[Column]= Field(None, description='',  alias='metricTimestampColumn') # relationship
        assets: Optional[list[Asset]]= Field(None, description='',  alias='assets') # relationship
        metric_dimension_columns: Optional[list[Column]]= Field(None, description='',  alias='metricDimensionColumns') # relationship
...
class Resource(Catalog):
    ...
    class Attributes(Catalog.Attributes):
        ...
        resource_metadata: Optional[dict[str,str]] = Field(None, description='' , alias='resourceMetadata')
...
class Readme(Resource):
    ...
    class Attributes(Resource.Attributes):
        see_also: Optional[list[Readme]]= Field(None, description='',  alias='seeAlso') # relationship
        asset: Optional[Asset]= Field(None, description='',  alias='asset') # relationship
...
class File(Resource):
    ...
    class Attributes(Resource.Attributes):
        ...
        file_assets: Optional[Asset]= Field(None, description='',  alias='fileAssets') # relationship
...
class Link(Resource):
    ...
    # @validate_arguments()
    def create(
        cls, *, asset: Asset, name: str, link: str
    ) -> Link:
        return Link(
            attributes=Link.Attributes.create(
                asset=asset, name=name, link=link
            )
        )
...
class SQL(Catalog):
    ...
    class Attributes(Catalog.Attributes):
        ...
        query_user_count: Optional[int] = Field(None, description='' , alias='queryUserCount')
        query_user_map: Optional[dict[str,int]] = Field(None, description='' , alias='queryUserMap')
        query_count_updated_at: Optional[datetime] = Field(None, description='' , alias='queryCountUpdatedAt')
        database_name: Optional[str] = Field(None, description='' , alias='databaseName')
        database_qualified_name: Optional[str] = Field(None, description='' , alias='databaseQualifiedName')
        schema_name: Optional[str] = Field(None, description='' , alias='schemaName')
        schema_qualified_name: Optional[str] = Field(None, description='' , alias='schemaQualifiedName')
        table_name: Optional[str] = Field(None, description='' , alias='tableName')
        table_qualified_name: Optional[str] = Field(None, description='' , alias='tableQualifiedName')
        view_name: Optional[str] = Field(None, description='' , alias='viewName')
        view_qualified_name: Optional[str] = Field(None, description='' , alias='viewQualifiedName')
        is_profiled: Optional[bool] = Field(None, description='' , alias='isProfiled')
        last_profiled_at: Optional[datetime] = Field(None, description='' , alias='lastProfiledAt')
        dbt_sources: Optional[list[DbtSource]]= Field(None, description='',  alias='dbtSources') # relationship
        sql_dbt_models: Optional[list[DbtModel]]= Field(None, description='',  alias='sqlDbtModels') # relationship
        sql_dbt_sources: Optional[list[DbtSource]]= Field(None, description='',  alias='sqlDBTSources') # relationship
        dbt_models: Optional[list[DbtModel]]= Field(None, description='',  alias='dbtModels') # relationship
        dbt_tests: Optional[list[DbtTest]]= Field(None, description='',  alias='dbtTests') # relationship
...
class Query(SQL):
    ...
    TBC
    """
    LONG_RAW_QUERY: ClassVar[KeywordField] = KeywordField("longRawQuery", "longRawQuery")
    """
    TBC
    """
    ...
    TBC
    """
    DEFAULT_SCHEMA_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("defaultSchemaQualifiedName", "defaultSchemaQualifiedName", "defaultSchemaQualifiedName.text")
    """
    TBC
    """
    DEFAULT_DATABASE_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("defaultDatabaseQualifiedName", "defaultDatabaseQualifiedName", "defaultDatabaseQualifiedName.text")
    """
    TBC
    """
    VARIABLES_SCHEMA_BASE64: ClassVar[KeywordField] = KeywordField("variablesSchemaBase64", "variablesSchemaBase64")
    """
    TBC
    """
    ...
    TBC
    """
    VISUAL_BUILDER_SCHEMA_BASE64: ClassVar[KeywordField] = KeywordField("visualBuilderSchemaBase64", "visualBuilderSchemaBase64")
    """
    TBC
    """
    ...
    class Attributes(SQL.Attributes):
        ...
        long_raw_query: Optional[str] = Field(None, description='' , alias='longRawQuery')
        raw_query_text: Optional[str] = Field(None, description='' , alias='rawQueryText')
        default_schema_qualified_name: Optional[str] = Field(None, description='' , alias='defaultSchemaQualifiedName')
        default_database_qualified_name: Optional[str] = Field(None, description='' , alias='defaultDatabaseQualifiedName')
        variables_schema_base64: Optional[str] = Field(None, description='' , alias='variablesSchemaBase64')
        is_private: Optional[bool] = Field(None, description='' , alias='isPrivate')
        is_sql_snippet: Optional[bool] = Field(None, description='' , alias='isSqlSnippet')
        parent_qualified_name: Optional[str] = Field(None, description='' , alias='parentQualifiedName')
        collection_qualified_name: Optional[str] = Field(None, description='' , alias='collectionQualifiedName')
        is_visual_query: Optional[bool] = Field(None, description='' , alias='isVisualQuery')
        visual_builder_schema_base64: Optional[str] = Field(None, description='' , alias='visualBuilderSchemaBase64')
        parent: Optional[Namespace]= Field(None, description='',  alias='parent') # relationship
        columns: Optional[list[Column]]= Field(None, description='',  alias='columns') # relationship
        tables: Optional[list[Table]]= Field(None, description='',  alias='tables') # relationship
        views: Optional[list[View]]= Field(None, description='',  alias='views') # relationship
...
class Schema(SQL):
    ...
    class Attributes(SQL.Attributes):
        ...
        snowflake_tags: Optional[list[SnowflakeTag]]= Field(None, description='',  alias='snowflakeTags') # relationship
        functions: Optional[list[Function]]= Field(None, description='',  alias='functions') # relationship
        tables: Optional[list[Table]]= Field(None, description='',  alias='tables') # relationship
        database: Optional[Database]= Field(None, description='',  alias='database') # relationship
        procedures: Optional[list[Procedure]]= Field(None, description='',  alias='procedures') # relationship
        views: Optional[list[View]]= Field(None, description='',  alias='views') # relationship
        materialised_views: Optional[list[MaterialisedView]]= Field(None, description='',  alias='materialisedViews') # relationship
        snowflake_dynamic_tables: Optional[list[SnowflakeDynamicTable]]= Field(None, description='',  alias='snowflakeDynamicTables') # relationship
        snowflake_pipes: Optional[list[SnowflakePipe]]= Field(None, description='',  alias='snowflakePipes') # relationship
        snowflake_streams: Optional[list[SnowflakeStream]]= Field(None, description='',  alias='snowflakeStreams') # relationship
...
class SnowflakePipe(SQL):
    ...
    TBC
    """
    SNOWFLAKE_PIPE_IS_AUTO_INGEST_ENABLED: ClassVar[BooleanField] = BooleanField("snowflakePipeIsAutoIngestEnabled", "snowflakePipeIsAutoIngestEnabled")
    """
    TBC
    """
    SNOWFLAKE_PIPE_NOTIFICATION_CHANNEL_NAME: ClassVar[KeywordTextField] = KeywordTextField("snowflakePipeNotificationChannelName", "snowflakePipeNotificationChannelName", "snowflakePipeNotificationChannelName.text")
    """
    TBC
    """
    ...
    class Attributes(SQL.Attributes):
        ...
        snowflake_pipe_is_auto_ingest_enabled: Optional[bool] = Field(None, description='' , alias='snowflakePipeIsAutoIngestEnabled')
        snowflake_pipe_notification_channel_name: Optional[str] = Field(None, description='' , alias='snowflakePipeNotificationChannelName')
        atlan_schema: Optional[Schema]= Field(None, description='',  alias='atlanSchema') # relationship
...
class View(SQL):
    ...
    def create(cls, *, name: str, schema_qualified_name: str)->View:
        ...
        attributes = View.Attributes.create(name=name, schema_qualified_name=schema_qualified_name)
        return cls(attributes=attributes)
    ...
    class Attributes(SQL.Attributes):
        ...
        is_query_preview: Optional[bool] = Field(None, description='' , alias='isQueryPreview')
        query_preview_config: Optional[dict[str,str]] = Field(None, description='' , alias='queryPreviewConfig')
        alias: Optional[str] = Field(None, description='' , alias='alias')
        is_temporary: Optional[bool] = Field(None, description='' , alias='isTemporary')
        definition: Optional[str] = Field(None, description='' , alias='definition')
        columns: Optional[list[Column]]= Field(None, description='',  alias='columns') # relationship
        queries: Optional[list[Query]]= Field(None, description='',  alias='queries') # relationship
        atlan_schema: Optional[Schema]= Field(None, description='',  alias='atlanSchema') # relationship
...
class MaterialisedView(SQL):
    ...
    def create(cls, *, name: str, schema_qualified_name: str)->MaterialisedView:
        validate_required_fields(["name", "schema_qualified_name"], [name, schema_qualified_name])
        attributes = MaterialisedView.Attributes.create(name=name, schema_qualified_name=schema_qualified_name)
        return cls(attributes=attributes)
    ...
    class Attributes(SQL.Attributes):
        ...
        refresh_method: Optional[str] = Field(None, description='' , alias='refreshMethod')
        staleness: Optional[str] = Field(None, description='' , alias='staleness')
        stale_since_date: Optional[datetime] = Field(None, description='' , alias='staleSinceDate')
        column_count: Optional[int] = Field(None, description='' , alias='columnCount')
        row_count: Optional[int] = Field(None, description='' , alias='rowCount')
        size_bytes: Optional[int] = Field(None, description='' , alias='sizeBytes')
        is_query_preview: Optional[bool] = Field(None, description='' , alias='isQueryPreview')
        ...
        @classmethod
        # @validate_arguments()
        def create(cls, *, name: str, schema_qualified_name: str) -> MaterialisedView.Attributes:
            if not name:
                raise ValueError("name cannot be blank")
            validate_required_fields(["schema_qualified_name"], [schema_qualified_name])
            fields = schema_qualified_name.split("/")
...
class Function(SQL):
    ...
    FUNCTION_DEFINITION: ClassVar[KeywordField] = KeywordField("functionDefinition", "functionDefinition")
    """
    ...
    class Attributes(SQL.Attributes):
        function_definition: Optional[str] = Field(None, description='' , alias='functionDefinition')
        function_return_type: Optional[str] = Field(None, description='' , alias='functionReturnType')
        function_arguments: Optional[set[str]] = Field(None, description='' , alias='functionArguments')
        function_language: Optional[str] = Field(None, description='' , alias='functionLanguage')
        function_type: Optional[str] = Field(None, description='' , alias='functionType')
        function_is_external: Optional[bool] = Field(None, description='' , alias='functionIsExternal')
        function_is_secure: Optional[bool] = Field(None, description='' , alias='functionIsSecure')
        function_is_memoizable: Optional[bool] = Field(None, description='' , alias='functionIsMemoizable')
        function_schema: Optional[Schema]= Field(None, description='',  alias='functionSchema') # relationship
...
class TablePartition(SQL):
    ...
    TBC
    """
    PARTITION_LIST: ClassVar[KeywordField] = KeywordField("partitionList", "partitionList")
    """
    TBC
    """
    ...
    class Attributes(SQL.Attributes):
        ...
        is_query_preview: Optional[bool] = Field(None, description='' , alias='isQueryPreview')
        query_preview_config: Optional[dict[str,str]] = Field(None, description='' , alias='queryPreviewConfig')
        external_location: Optional[str] = Field(None, description='' , alias='externalLocation')
        external_location_region: Optional[str] = Field(None, description='' , alias='externalLocationRegion')
        external_location_format: Optional[str] = Field(None, description='' , alias='externalLocationFormat')
        is_partitioned: Optional[bool] = Field(None, description='' , alias='isPartitioned')
        partition_strategy: Optional[str] = Field(None, description='' , alias='partitionStrategy')
        partition_count: Optional[int] = Field(None, description='' , alias='partitionCount')
        partition_list: Optional[str] = Field(None, description='' , alias='partitionList')
        child_table_partitions: Optional[list[TablePartition]]= Field(None, description='',  alias='childTablePartitions') # relationship
        columns: Optional[list[Column]]= Field(None, description='',  alias='columns') # relationship
        parent_table_partition: Optional[TablePartition]= Field(None, description='',  alias='parentTablePartition') # relationship
        parent_table: Optional[Table]= Field(None, description='',  alias='parentTable') # relationship
...
class Column(SQL):
    ...
    TBC
    """
    RAW_DATA_TYPE_DEFINITION: ClassVar[KeywordField] = KeywordField("rawDataTypeDefinition", "rawDataTypeDefinition")
    """
    TBC
    """
    ...
    TBC
    """
    PARENT_COLUMN_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("parentColumnQualifiedName", "parentColumnQualifiedName", "parentColumnQualifiedName.text")
    """
    TBC
    """
    PARENT_COLUMN_NAME: ClassVar[KeywordTextField] = KeywordTextField("parentColumnName", "parentColumnName.keyword", "parentColumnName")
    """
    TBC
    """
    COLUMN_DISTINCT_VALUES_COUNT: ClassVar[NumericField] = NumericField("columnDistinctValuesCount", "columnDistinctValuesCount")
    """
    TBC
    """
    COLUMN_DISTINCT_VALUES_COUNT_LONG: ClassVar[NumericField] = NumericField("columnDistinctValuesCountLong", "columnDistinctValuesCountLong")
    """
    TBC
    """
    ...
    TBC
    """
    COLUMN_STANDARD_DEVIATION: ClassVar[NumericField] = NumericField("columnStandardDeviation", "columnStandardDeviation")
    """
    TBC
    """
    COLUMN_UNIQUE_VALUES_COUNT: ClassVar[NumericField] = NumericField("columnUniqueValuesCount", "columnUniqueValuesCount")
    """
    TBC
    """
    COLUMN_UNIQUE_VALUES_COUNT_LONG: ClassVar[NumericField] = NumericField("columnUniqueValuesCountLong", "columnUniqueValuesCountLong")
    """
    TBC
    """
    ...
    TBC
    """
    COLUMN_DUPLICATE_VALUES_COUNT: ClassVar[NumericField] = NumericField("columnDuplicateValuesCount", "columnDuplicateValuesCount")
    """
    TBC
    """
    COLUMN_DUPLICATE_VALUES_COUNT_LONG: ClassVar[NumericField] = NumericField("columnDuplicateValuesCountLong", "columnDuplicateValuesCountLong")
    """
    TBC
    """
    COLUMN_MAXIMUM_STRING_LENGTH: ClassVar[NumericField] = NumericField("columnMaximumStringLength", "columnMaximumStringLength")
    """
    TBC
    """
    ...
    TBC
    """
    COLUMN_MINIMUM_STRING_LENGTH: ClassVar[NumericField] = NumericField("columnMinimumStringLength", "columnMinimumStringLength")
    """
    TBC
    """
    ...
    TBC
    """
    COLUMN_MISSING_VALUES_COUNT: ClassVar[NumericField] = NumericField("columnMissingValuesCount", "columnMissingValuesCount")
    """
    TBC
    """
    COLUMN_MISSING_VALUES_COUNT_LONG: ClassVar[NumericField] = NumericField("columnMissingValuesCountLong", "columnMissingValuesCountLong")
    """
    TBC
    """
    COLUMN_MISSING_VALUES_PERCENTAGE: ClassVar[NumericField] = NumericField("columnMissingValuesPercentage", "columnMissingValuesPercentage")
    """
    TBC
    """
    COLUMN_UNIQUENESS_PERCENTAGE: ClassVar[NumericField] = NumericField("columnUniquenessPercentage", "columnUniquenessPercentage")
    """
    TBC
    """
    ...
    class Attributes(SQL.Attributes):
        ...
        raw_data_type_definition: Optional[str] = Field(None, description='' , alias='rawDataTypeDefinition')
        order: Optional[int] = Field(None, description='' , alias='order')
        nested_column_count: Optional[int] = Field(None, description='' , alias='nestedColumnCount')
        is_partition: Optional[bool] = Field(None, description='' , alias='isPartition')
        partition_order: Optional[int] = Field(None, description='' , alias='partitionOrder')
        ...
        numeric_scale: Optional[float] = Field(None, description='' , alias='numericScale')
        max_length: Optional[int] = Field(None, description='' , alias='maxLength')
        validations: Optional[dict[str,str]] = Field(None, description='' , alias='validations')
        parent_column_qualified_name: Optional[str] = Field(None, description='' , alias='parentColumnQualifiedName')
        parent_column_name: Optional[str] = Field(None, description='' , alias='parentColumnName')
        column_distinct_values_count: Optional[int] = Field(None, description='' , alias='columnDistinctValuesCount')
        column_distinct_values_count_long: Optional[int] = Field(None, description='' , alias='columnDistinctValuesCountLong')
        column_histogram: Optional[Histogram] = Field(None, description='' , alias='columnHistogram')
        ...
        column_median: Optional[float] = Field(None, description='' , alias='columnMedian')
        column_standard_deviation: Optional[float] = Field(None, description='' , alias='columnStandardDeviation')
        column_unique_values_count: Optional[int] = Field(None, description='' , alias='columnUniqueValuesCount')
        column_unique_values_count_long: Optional[int] = Field(None, description='' , alias='columnUniqueValuesCountLong')
        column_average: Optional[float] = Field(None, description='' , alias='columnAverage')
        column_average_length: Optional[float] = Field(None, description='' , alias='columnAverageLength')
        column_duplicate_values_count: Optional[int] = Field(None, description='' , alias='columnDuplicateValuesCount')
        column_duplicate_values_count_long: Optional[int] = Field(None, description='' , alias='columnDuplicateValuesCountLong')
        column_maximum_string_length: Optional[int] = Field(None, description='' , alias='columnMaximumStringLength')
        column_maxs: Optional[set[str]] = Field(None, description='' , alias='columnMaxs')
        column_minimum_string_length: Optional[int] = Field(None, description='' , alias='columnMinimumStringLength')
        column_mins: Optional[set[str]] = Field(None, description='' , alias='columnMins')
        column_missing_values_count: Optional[int] = Field(None, description='' , alias='columnMissingValuesCount')
        column_missing_values_count_long: Optional[int] = Field(None, description='' , alias='columnMissingValuesCountLong')
        column_missing_values_percentage: Optional[float] = Field(None, description='' , alias='columnMissingValuesPercentage')
        column_uniqueness_percentage: Optional[float] = Field(None, description='' , alias='columnUniquenessPercentage')
        column_variance: Optional[float] = Field(None, description='' , alias='columnVariance')
        column_top_values: Optional[list[ColumnValueFrequencyMap]] = Field(None, description='' , alias='columnTopValues')
        column_depth_level: Optional[int] = Field(None, description='' , alias='columnDepthLevel')
        snowflake_dynamic_table: Optional[SnowflakeDynamicTable]= Field(None, description='',  alias='snowflakeDynamicTable') # relationship
        view: Optional[View]= Field(None, description='',  alias='view') # relationship
        nested_columns: Optional[list[Column]]= Field(None, description='',  alias='nestedColumns') # relationship
        data_quality_metric_dimensions: Optional[list[Metric]]= Field(None, description='',  alias='dataQualityMetricDimensions') # relationship
        dbt_model_columns: Optional[list[DbtModelColumn]]= Field(None, description='',  alias='dbtModelColumns') # relationship
        table: Optional[Table]= Field(None, description='',  alias='table') # relationship
        column_dbt_model_columns: Optional[list[DbtModelColumn]]= Field(None, description='',  alias='columnDbtModelColumns') # relationship
        materialised_view: Optional[MaterialisedView]= Field(None, description='',  alias='materialisedView') # relationship
        parent_column: Optional[Column]= Field(None, description='',  alias='parentColumn') # relationship
        queries: Optional[list[Query]]= Field(None, description='',  alias='queries') # relationship
        metric_timestamps: Optional[list[Metric]]= Field(None, description='',  alias='metricTimestamps') # relationship
        foreign_key_to: Optional[list[Column]]= Field(None, description='',  alias='foreignKeyTo') # relationship
        foreign_key_from: Optional[Column]= Field(None, description='',  alias='foreignKeyFrom') # relationship
        dbt_metrics: Optional[list[DbtMetric]]= Field(None, description='',  alias='dbtMetrics') # relationship
        table_partition: Optional[TablePartition]= Field(None, description='',  alias='tablePartition') # relationship
...
class SnowflakeStream(SQL):
    ...
    TBC
    """
    SNOWFLAKE_STREAM_SOURCE_TYPE: ClassVar[KeywordField] = KeywordField("snowflakeStreamSourceType", "snowflakeStreamSourceType")
    """
    TBC
    """
    ...
    TBC
    """
    SNOWFLAKE_STREAM_STALE_AFTER: ClassVar[NumericField] = NumericField("snowflakeStreamStaleAfter", "snowflakeStreamStaleAfter")
    """
    TBC
    """
    ...
    class Attributes(SQL.Attributes):
        snowflake_stream_type: Optional[str] = Field(None, description='' , alias='snowflakeStreamType')
        snowflake_stream_source_type: Optional[str] = Field(None, description='' , alias='snowflakeStreamSourceType')
        snowflake_stream_mode: Optional[str] = Field(None, description='' , alias='snowflakeStreamMode')
        snowflake_stream_is_stale: Optional[bool] = Field(None, description='' , alias='snowflakeStreamIsStale')
        snowflake_stream_stale_after: Optional[datetime] = Field(None, description='' , alias='snowflakeStreamStaleAfter')
        atlan_schema: Optional[Schema]= Field(None, description='',  alias='atlanSchema') # relationship
...
class Matillion(Catalog):
    ...
    MATILLION_VERSION: ClassVar[KeywordField] = KeywordField("matillionVersion", "matillionVersion")
    """
    ...
    class Attributes(Catalog.Attributes):
        matillion_version: Optional[str] = Field(None, description='' , alias='matillionVersion')
...
class MatillionGroup(Matillion):
    ...
    class Attributes(Matillion.Attributes):
        matillion_project_count: Optional[int] = Field(None, description='' , alias='matillionProjectCount')
        matillion_projects: Optional[list[MatillionProject]]= Field(None, description='',  alias='matillionProjects') # relationship
...
class MatillionJob(Matillion):
    ...
    """
    MATILLION_JOB_PATH: ClassVar[KeywordTextField] = KeywordTextField("matillionJobPath", "matillionJobPath", "matillionJobPath.text")
    """
    ...
    """  # noqa: E501
    MATILLION_JOB_COMPONENT_COUNT: ClassVar[NumericField] = NumericField("matillionJobComponentCount", "matillionJobComponentCount")
    """
    ...
    """
    MATILLION_PROJECT_NAME: ClassVar[KeywordTextField] = KeywordTextField("matillionProjectName", "matillionProjectName.keyword", "matillionProjectName")
    """
    Name of the matillion project to which the matillion job belongs
    """
    MATILLION_PROJECT_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("matillionProjectQualifiedName", "matillionProjectQualifiedName", "matillionProjectQualifiedName.text")
    """
    ...
    class Attributes(Matillion.Attributes):
        matillion_job_type: Optional[MatillionJobType] = Field(None, description='' , alias='matillionJobType')
        matillion_job_path: Optional[str] = Field(None, description='' , alias='matillionJobPath')
        matillion_job_component_count: Optional[int] = Field(None, description='' , alias='matillionJobComponentCount')
        matillion_job_schedule: Optional[str] = Field(None, description='' , alias='matillionJobSchedule')
        matillion_project_name: Optional[str] = Field(None, description='' , alias='matillionProjectName')
        matillion_project_qualified_name: Optional[str] = Field(None, description='' , alias='matillionProjectQualifiedName')
        matillion_project: Optional[MatillionProject]= Field(None, description='',  alias='matillionProject') # relationship
        matillion_components: Optional[list[MatillionComponent]]= Field(None, description='',  alias='matillionComponents') # relationship
...
class MatillionProject(Matillion):
    ...
    MATILLION_VERSIONS: ClassVar[KeywordField] = KeywordField("matillionVersions", "matillionVersions")
    """
    List of versions under a matillion project
    """
    MATILLION_ENVIRONMENTS: ClassVar[KeywordField] = KeywordField("matillionEnvironments", "matillionEnvironments")
    """
    List of environments under a matillion project
    """
    MATILLION_PROJECT_JOB_COUNT: ClassVar[NumericField] = NumericField("matillionProjectJobCount", "matillionProjectJobCount")
    """
    Count of jobs under a matillion project
    """
    MATILLION_GROUP_NAME: ClassVar[KeywordTextField] = KeywordTextField("matillionGroupName", "matillionGroupName.keyword", "matillionGroupName")
    """
    Name of the matillion group to which the matillion project belongs
    """
    MATILLION_GROUP_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("matillionGroupQualifiedName", "matillionGroupQualifiedName", "matillionGroupQualifiedName.text")
    """
    ...
    class Attributes(Matillion.Attributes):
        matillion_versions: Optional[set[str]] = Field(None, description='' , alias='matillionVersions')
        matillion_environments: Optional[set[str]] = Field(None, description='' , alias='matillionEnvironments')
        matillion_project_job_count: Optional[int] = Field(None, description='' , alias='matillionProjectJobCount')
        matillion_group_name: Optional[str] = Field(None, description='' , alias='matillionGroupName')
        matillion_group_qualified_name: Optional[str] = Field(None, description='' , alias='matillionGroupQualifiedName')
        matillion_jobs: Optional[list[MatillionJob]]= Field(None, description='',  alias='matillionJobs') # relationship
        matillion_group: Optional[MatillionGroup]= Field(None, description='',  alias='matillionGroup') # relationship
...
class MatillionComponent(Matillion):
    ...
    """
    MATILLION_COMPONENT_IMPLEMENTATION_ID: ClassVar[KeywordField] = KeywordField("matillionComponentImplementationId", "matillionComponentImplementationId")
    """
    Unique id which represents the type of a component in matillion
    """
    MATILLION_COMPONENT_LINKED_JOB: ClassVar[KeywordField] = KeywordField("matillionComponentLinkedJob", "matillionComponentLinkedJob")
    """
    Job details of the matillion job to which the matillion component internally links to
    """
    MATILLION_COMPONENT_LAST_RUN_STATUS: ClassVar[KeywordField] = KeywordField("matillionComponentLastRunStatus", "matillionComponentLastRunStatus")
    """
    The latest run status of a matillion component under a matillion job
    """
    MATILLION_COMPONENT_LAST_FIVE_RUN_STATUS: ClassVar[KeywordField] = KeywordField("matillionComponentLastFiveRunStatus", "matillionComponentLastFiveRunStatus")
    """
    The last five run status of a matillion component under a matillion job
    """
    MATILLION_COMPONENT_SQLS: ClassVar[KeywordField] = KeywordField("matillionComponentSqls", "matillionComponentSqls")
    """
    SQL Query involved with a matillion component
    """
    MATILLION_JOB_NAME: ClassVar[KeywordTextField] = KeywordTextField("matillionJobName", "matillionJobName.keyword", "matillionJobName")
    """
    Name of the matillion job to which the matillion component belongs
    """
    MATILLION_JOB_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("matillionJobQualifiedName", "matillionJobQualifiedName", "matillionJobQualifiedName.text")
    """
    ...
    class Attributes(Matillion.Attributes):
        matillion_component_id: Optional[str] = Field(None, description='' , alias='matillionComponentId')
        matillion_component_implementation_id: Optional[str] = Field(None, description='' , alias='matillionComponentImplementationId')
        matillion_component_linked_job: Optional[dict[str,str]] = Field(None, description='' , alias='matillionComponentLinkedJob')
        matillion_component_last_run_status: Optional[str] = Field(None, description='' , alias='matillionComponentLastRunStatus')
        matillion_component_last_five_run_status: Optional[str] = Field(None, description='' , alias='matillionComponentLastFiveRunStatus')
        matillion_component_sqls: Optional[set[str]] = Field(None, description='' , alias='matillionComponentSqls')
        matillion_job_name: Optional[str] = Field(None, description='' , alias='matillionJobName')
        matillion_job_qualified_name: Optional[str] = Field(None, description='' , alias='matillionJobQualifiedName')
        matillion_process: Optional[Process]= Field(None, description='',  alias='matillionProcess') # relationship
        matillion_job: Optional[MatillionJob]= Field(None, description='',  alias='matillionJob') # relationship
...
class Dbt(Catalog):
    ...
    TBC
    """
    DBT_ACCOUNT_NAME: ClassVar[KeywordTextField] = KeywordTextField("dbtAccountName", "dbtAccountName.keyword", "dbtAccountName")
    """
    TBC
    """
    DBT_PROJECT_NAME: ClassVar[KeywordTextField] = KeywordTextField("dbtProjectName", "dbtProjectName.keyword", "dbtProjectName")
    """
    TBC
    """
    DBT_PACKAGE_NAME: ClassVar[KeywordTextField] = KeywordTextField("dbtPackageName", "dbtPackageName.keyword", "dbtPackageName")
    """
    TBC
    """
    ...
    TBC
    """
    DBT_JOB_SCHEDULE: ClassVar[KeywordField] = KeywordField("dbtJobSchedule", "dbtJobSchedule")
    """
    TBC
    """
    ...
    TBC
    """
    DBT_JOB_SCHEDULE_CRON_HUMANIZED: ClassVar[KeywordTextField] = KeywordTextField("dbtJobScheduleCronHumanized", "dbtJobScheduleCronHumanized.keyword", "dbtJobScheduleCronHumanized")
    """
    TBC
    """
    ...
    TBC
    """
    DBT_JOB_NEXT_RUN_HUMANIZED: ClassVar[KeywordTextField] = KeywordTextField("dbtJobNextRunHumanized", "dbtJobNextRunHumanized.keyword", "dbtJobNextRunHumanized")
    """
    TBC
    """
    DBT_ENVIRONMENT_NAME: ClassVar[KeywordTextField] = KeywordTextField("dbtEnvironmentName", "dbtEnvironmentName.keyword", "dbtEnvironmentName")
    """
    TBC
    """
    DBT_ENVIRONMENT_DBT_VERSION: ClassVar[KeywordTextField] = KeywordTextField("dbtEnvironmentDbtVersion", "dbtEnvironmentDbtVersion.keyword", "dbtEnvironmentDbtVersion")
    """
    TBC
    """
    ...
    TBC
    """
    DBT_CONNECTION_CONTEXT: ClassVar[KeywordField] = KeywordField("dbtConnectionContext", "dbtConnectionContext")
    """
    TBC
    """
    DBT_SEMANTIC_LAYER_PROXY_URL: ClassVar[KeywordField] = KeywordField("dbtSemanticLayerProxyUrl", "dbtSemanticLayerProxyUrl")
    """
    TBC
    """
    ...
    class Attributes(Catalog.Attributes):
        ...
        dbt_account_name: Optional[str] = Field(None, description='' , alias='dbtAccountName')
        dbt_project_name: Optional[str] = Field(None, description='' , alias='dbtProjectName')
        dbt_package_name: Optional[str] = Field(None, description='' , alias='dbtPackageName')
        dbt_job_name: Optional[str] = Field(None, description='' , alias='dbtJobName')
        dbt_job_schedule: Optional[str] = Field(None, description='' , alias='dbtJobSchedule')
        dbt_job_status: Optional[str] = Field(None, description='' , alias='dbtJobStatus')
        dbt_job_schedule_cron_humanized: Optional[str] = Field(None, description='' , alias='dbtJobScheduleCronHumanized')
        dbt_job_last_run: Optional[datetime] = Field(None, description='' , alias='dbtJobLastRun')
        dbt_job_next_run: Optional[datetime] = Field(None, description='' , alias='dbtJobNextRun')
        dbt_job_next_run_humanized: Optional[str] = Field(None, description='' , alias='dbtJobNextRunHumanized')
        dbt_environment_name: Optional[str] = Field(None, description='' , alias='dbtEnvironmentName')
        dbt_environment_dbt_version: Optional[str] = Field(None, description='' , alias='dbtEnvironmentDbtVersion')
        dbt_tags: Optional[set[str]] = Field(None, description='' , alias='dbtTags')
        dbt_connection_context: Optional[str] = Field(None, description='' , alias='dbtConnectionContext')
        dbt_semantic_layer_proxy_url: Optional[str] = Field(None, description='' , alias='dbtSemanticLayerProxyUrl')
...
class DbtModelColumn(Dbt):
    ...
    DBT_MODEL_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("dbtModelQualifiedName", "dbtModelQualifiedName", "dbtModelQualifiedName.text")
    """
    TBC
    """
    DBT_MODEL_COLUMN_DATA_TYPE: ClassVar[KeywordField] = KeywordField("dbtModelColumnDataType", "dbtModelColumnDataType")
    """
    TBC
    """
    ...
    class Attributes(Dbt.Attributes):
        dbt_model_qualified_name: Optional[str] = Field(None, description='' , alias='dbtModelQualifiedName')
        dbt_model_column_data_type: Optional[str] = Field(None, description='' , alias='dbtModelColumnDataType')
        dbt_model_column_order: Optional[int] = Field(None, description='' , alias='dbtModelColumnOrder')
        sql_column: Optional[Column]= Field(None, description='',  alias='sqlColumn') # relationship
        dbt_model: Optional[DbtModel]= Field(None, description='',  alias='dbtModel') # relationship
        dbt_model_column_sql_columns: Optional[list[Column]]= Field(None, description='',  alias='dbtModelColumnSqlColumns') # relationship
        dbt_tests: Optional[list[DbtTest]]= Field(None, description='',  alias='dbtTests') # relationship
...
class DbtTest(Dbt):
    ...
    """
    DBT_TEST_ERROR: ClassVar[KeywordField] = KeywordField("dbtTestError", "dbtTestError")
    """
    The error message in the case of state being "error"
    """
    DBT_TEST_RAW_SQL: ClassVar[KeywordTextField] = KeywordTextField("dbtTestRawSQL", "dbtTestRawSQL", "dbtTestRawSQL.text")
    """
    The raw sql of a test
    """
    DBT_TEST_COMPILED_SQL: ClassVar[KeywordField] = KeywordField("dbtTestCompiledSQL", "dbtTestCompiledSQL")
    """
    The compiled sql of a test
    """
    DBT_TEST_RAW_CODE: ClassVar[KeywordTextField] = KeywordTextField("dbtTestRawCode", "dbtTestRawCode", "dbtTestRawCode.text")
    """
    The raw code of a test ( tests in dbt can be defined using python )
    """
    DBT_TEST_COMPILED_CODE: ClassVar[KeywordField] = KeywordField("dbtTestCompiledCode", "dbtTestCompiledCode")
    """
    The compiled code of a test ( tests in dbt can be defined using python )
    """
    DBT_TEST_LANGUAGE: ClassVar[KeywordField] = KeywordField("dbtTestLanguage", "dbtTestLanguage")
    """
    ...
    class Attributes(Dbt.Attributes):
        dbt_test_status: Optional[str] = Field(None, description='' , alias='dbtTestStatus')
        dbt_test_state: Optional[str] = Field(None, description='' , alias='dbtTestState')
        dbt_test_error: Optional[str] = Field(None, description='' , alias='dbtTestError')
        dbt_test_raw_s_q_l: Optional[str] = Field(None, description='' , alias='dbtTestRawSQL')
        dbt_test_compiled_s_q_l: Optional[str] = Field(None, description='' , alias='dbtTestCompiledSQL')
        dbt_test_raw_code: Optional[str] = Field(None, description='' , alias='dbtTestRawCode')
        dbt_test_compiled_code: Optional[str] = Field(None, description='' , alias='dbtTestCompiledCode')
        dbt_test_language: Optional[str] = Field(None, description='' , alias='dbtTestLanguage')
        dbt_sources: Optional[list[DbtSource]]= Field(None, description='',  alias='dbtSources') # relationship
        sql_assets: Optional[list[SQL]]= Field(None, description='',  alias='sqlAssets') # relationship
        dbt_models: Optional[list[DbtModel]]= Field(None, description='',  alias='dbtModels') # relationship
        dbt_model_columns: Optional[list[DbtModelColumn]]= Field(None, description='',  alias='dbtModelColumns') # relationship
...
class DbtModel(Dbt):
    ...
    TBC
    """
    DBT_COMPILED_SQL: ClassVar[KeywordField] = KeywordField("dbtCompiledSQL", "dbtCompiledSQL")
    """
    TBC
    """
    ...
    TBC
    """
    DBT_MATERIALIZATION_TYPE: ClassVar[KeywordField] = KeywordField("dbtMaterializationType", "dbtMaterializationType")
    """
    TBC
    """
    DBT_MODEL_COMPILE_STARTED_AT: ClassVar[NumericField] = NumericField("dbtModelCompileStartedAt", "dbtModelCompileStartedAt")
    """
    TBC
    """
    DBT_MODEL_COMPILE_COMPLETED_AT: ClassVar[NumericField] = NumericField("dbtModelCompileCompletedAt", "dbtModelCompileCompletedAt")
    """
    TBC
    """
    DBT_MODEL_EXECUTE_STARTED_AT: ClassVar[NumericField] = NumericField("dbtModelExecuteStartedAt", "dbtModelExecuteStartedAt")
    """
    TBC
    """
    DBT_MODEL_EXECUTE_COMPLETED_AT: ClassVar[NumericField] = NumericField("dbtModelExecuteCompletedAt", "dbtModelExecuteCompletedAt")
    """
    TBC
    """
    ...
    TBC
    """
    DBT_MODEL_RUN_GENERATED_AT: ClassVar[NumericField] = NumericField("dbtModelRunGeneratedAt", "dbtModelRunGeneratedAt")
    """
    TBC
    """
    DBT_MODEL_RUN_ELAPSED_TIME: ClassVar[NumericField] = NumericField("dbtModelRunElapsedTime", "dbtModelRunElapsedTime")
    """
    TBC
    """
    ...
    class Attributes(Dbt.Attributes):
        ...
        dbt_compiled_s_q_l: Optional[str] = Field(None, description='' , alias='dbtCompiledSQL')
        dbt_stats: Optional[str] = Field(None, description='' , alias='dbtStats')
        dbt_materialization_type: Optional[str] = Field(None, description='' , alias='dbtMaterializationType')
        dbt_model_compile_started_at: Optional[datetime] = Field(None, description='' , alias='dbtModelCompileStartedAt')
        dbt_model_compile_completed_at: Optional[datetime] = Field(None, description='' , alias='dbtModelCompileCompletedAt')
        dbt_model_execute_started_at: Optional[datetime] = Field(None, description='' , alias='dbtModelExecuteStartedAt')
        dbt_model_execute_completed_at: Optional[datetime] = Field(None, description='' , alias='dbtModelExecuteCompletedAt')
        dbt_model_execution_time: Optional[float] = Field(None, description='' , alias='dbtModelExecutionTime')
        dbt_model_run_generated_at: Optional[datetime] = Field(None, description='' , alias='dbtModelRunGeneratedAt')
        dbt_model_run_elapsed_time: Optional[float] = Field(None, description='' , alias='dbtModelRunElapsedTime')
        dbt_metrics: Optional[list[DbtMetric]]= Field(None, description='',  alias='dbtMetrics') # relationship
        dbt_tests: Optional[list[DbtTest]]= Field(None, description='',  alias='dbtTests') # relationship
        dbt_model_sql_assets: Optional[list[SQL]]= Field(None, description='',  alias='dbtModelSqlAssets') # relationship
        dbt_model_columns: Optional[list[DbtModelColumn]]= Field(None, description='',  alias='dbtModelColumns') # relationship
        sql_asset: Optional[SQL]= Field(None, description='',  alias='sqlAsset') # relationship
...
class DbtMetric(Dbt):
    ...
    class Attributes(Dbt.Attributes):
        dbt_metric_filters: Optional[list[DbtMetricFilter]] = Field(None, description='' , alias='dbtMetricFilters')
        dbt_alias: Optional[str] = Field(None, description='' , alias='dbtAlias')
        dbt_meta: Optional[str] = Field(None, description='' , alias='dbtMeta')
        dbt_unique_id: Optional[str] = Field(None, description='' , alias='dbtUniqueId')
        dbt_account_name: Optional[str] = Field(None, description='' , alias='dbtAccountName')
        ...
        assets: Optional[list[Asset]]= Field(None, description='',  alias='assets') # relationship
        metric_dimension_columns: Optional[list[Column]]= Field(None, description='',  alias='metricDimensionColumns') # relationship
        dbt_metric_filter_columns: Optional[list[Column]]= Field(None, description='',  alias='dbtMetricFilterColumns') # relationship
...
class DbtSource(Dbt):
    ...
    TBC
    """
    DBT_FRESHNESS_CRITERIA: ClassVar[KeywordField] = KeywordField("dbtFreshnessCriteria", "dbtFreshnessCriteria")
    """
    TBC
    """
    ...
    class Attributes(Dbt.Attributes):
        ...
        dbt_freshness_criteria: Optional[str] = Field(None, description='' , alias='dbtFreshnessCriteria')
        sql_assets: Optional[list[SQL]]= Field(None, description='',  alias='sqlAssets') # relationship
        dbt_tests: Optional[list[DbtTest]]= Field(None, description='',  alias='dbtTests') # relationship
        sql_asset: Optional[SQL]= Field(None, description='',  alias='sqlAsset') # relationship
...
class SchemaRegistry(Catalog):
    ...
    SCHEMA_REGISTRY_SCHEMA_TYPE: ClassVar[KeywordField] = KeywordField("schemaRegistrySchemaType", "schemaRegistrySchemaType")
    """
    ...
    class Attributes(Catalog.Attributes):
        schema_registry_schema_type: Optional[SchemaRegistrySchemaType] = Field(None, description='' , alias='schemaRegistrySchemaType')
        schema_registry_schema_id: Optional[str] = Field(None, description='' , alias='schemaRegistrySchemaId')
...
class SchemaRegistrySubject(SchemaRegistry):
    ...
    SCHEMA_REGISTRY_SUBJECT_BASE_NAME: ClassVar[KeywordField] = KeywordField("schemaRegistrySubjectBaseName", "schemaRegistrySubjectBaseName")
    """
    Base name of the subject (i.e. without -key, -value prefixes)
    """
    SCHEMA_REGISTRY_SUBJECT_IS_KEY_SCHEMA: ClassVar[BooleanField] = BooleanField("schemaRegistrySubjectIsKeySchema", "schemaRegistrySubjectIsKeySchema")
    """
    If the subject is a schema for the keys of the messages.
    """
    SCHEMA_REGISTRY_SUBJECT_SCHEMA_COMPATIBILITY: ClassVar[KeywordField] = KeywordField("schemaRegistrySubjectSchemaCompatibility", "schemaRegistrySubjectSchemaCompatibility")
    """
    Compatibility of the schema across versions.
    """
    SCHEMA_REGISTRY_SUBJECT_LATEST_SCHEMA_VERSION: ClassVar[KeywordField] = KeywordField("schemaRegistrySubjectLatestSchemaVersion", "schemaRegistrySubjectLatestSchemaVersion")
    """
    Latest schema version of the subject.
    """
    SCHEMA_REGISTRY_SUBJECT_LATEST_SCHEMA_DEFINITION: ClassVar[TextField] = TextField("schemaRegistrySubjectLatestSchemaDefinition", "schemaRegistrySubjectLatestSchemaDefinition")
    """
    Definition of the latest schema in the subject.
    """
    SCHEMA_REGISTRY_SUBJECT_GOVERNING_ASSET_QUALIFIED_NAMES: ClassVar[KeywordField] = KeywordField("schemaRegistrySubjectGoverningAssetQualifiedNames", "schemaRegistrySubjectGoverningAssetQualifiedNames")
    """
    ...
    @property
    def schema_registry_subject_schema_compatibility(self)->Optional[SchemaRegistrySchemaCompatibility]:
    ...
    def schema_registry_subject_schema_compatibility(self, schema_registry_subject_schema_compatibility:Optional[SchemaRegistrySchemaCompatibility]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def schema_registry_subject_latest_schema_version(self, schema_registry_subject_latest_schema_version:Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def schema_registry_subject_latest_schema_definition(self, schema_registry_subject_latest_schema_definition:Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.schema_registry_subject_latest_schema_definition = schema_registry_subject_latest_schema_definition
    @property
    def schema_registry_subject_governing_asset_qualified_names(self)->Optional[set[str]]:
        return None if self.attributes is None else self.attributes.schema_registry_subject_governing_asset_qualified_names

    @schema_registry_subject_governing_asset_qualified_names.setter
    def schema_registry_subject_governing_asset_qualified_names(self, schema_registry_subject_governing_asset_qualified_names:Optional[set[str]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.schema_registry_subject_governing_asset_qualified_names = schema_registry_subject_governing_asset_qualified_names
    @property
    def assets(self)->Optional[list[Asset]]:
        return None if self.attributes is None else self.attributes.assets
    ...
    class Attributes(SchemaRegistry.Attributes):
        schema_registry_subject_base_name: Optional[str] = Field(None, description='' , alias='schemaRegistrySubjectBaseName')
        schema_registry_subject_is_key_schema: Optional[bool] = Field(None, description='' , alias='schemaRegistrySubjectIsKeySchema')
        schema_registry_subject_schema_compatibility: Optional[SchemaRegistrySchemaCompatibility] = Field(None, description='' , alias='schemaRegistrySubjectSchemaCompatibility')
        schema_registry_subject_latest_schema_version: Optional[str] = Field(None, description='' , alias='schemaRegistrySubjectLatestSchemaVersion')
        schema_registry_subject_latest_schema_definition: Optional[str] = Field(None, description='' , alias='schemaRegistrySubjectLatestSchemaDefinition')
        schema_registry_subject_governing_asset_qualified_names: Optional[set[str]] = Field(None, description='' , alias='schemaRegistrySubjectGoverningAssetQualifiedNames')
        assets: Optional[list[Asset]]= Field(None, description='',  alias='assets') # relationship
...
class MonteCarlo(DataQuality):
    ...
    class Attributes(DataQuality.Attributes):
        ...
        mc_asset_qualified_names: Optional[set[str]] = Field(None, description='' , alias='mcAssetQualifiedNames')
...
class MCIncident(MonteCarlo):
    ...
    class Attributes(MonteCarlo.Attributes):
        mc_incident_id: Optional[str] = Field(None, description='' , alias='mcIncidentId')
        mc_incident_type: Optional[str] = Field(None, description='' , alias='mcIncidentType')
        mc_incident_sub_types: Optional[set[str]] = Field(None, description='' , alias='mcIncidentSubTypes')
        mc_incident_severity: Optional[str] = Field(None, description='' , alias='mcIncidentSeverity')
        mc_incident_state: Optional[str] = Field(None, description='' , alias='mcIncidentState')
        mc_incident_warehouse: Optional[str] = Field(None, description='' , alias='mcIncidentWarehouse')
        mc_monitor: Optional[MCMonitor]= Field(None, description='',  alias='mcMonitor') # relationship
        mc_incident_assets: Optional[list[Asset]]= Field(None, description='',  alias='mcIncidentAssets') # relationship
...
class MCMonitor(MonteCarlo):
    ...
    """
    MC_MONITOR_NAMESPACE: ClassVar[KeywordTextField] = KeywordTextField("mcMonitorNamespace", "mcMonitorNamespace.keyword", "mcMonitorNamespace")
    """
    Monitor namespace
    """
    ...
    TBC
    """
    MC_MONITOR_RULE_CUSTOM_SQL: ClassVar[KeywordField] = KeywordField("mcMonitorRuleCustomSql", "mcMonitorRuleCustomSql")
    """
    custom sql query
    """
    MC_MONITOR_RULE_SCHEDULE_CONFIG: ClassVar[KeywordField] = KeywordField("mcMonitorRuleScheduleConfig", "mcMonitorRuleScheduleConfig")
    """
    TBC
    """
    MC_MONITOR_RULE_SCHEDULE_CONFIG_HUMANIZED: ClassVar[TextField] = TextField("mcMonitorRuleScheduleConfigHumanized", "mcMonitorRuleScheduleConfigHumanized")
    """
    TBC
    """
    ...
    TBC
    """
    MC_MONITOR_RULE_NEXT_EXECUTION_TIME: ClassVar[NumericField] = NumericField("mcMonitorRuleNextExecutionTime", "mcMonitorRuleNextExecutionTime")
    """
    TBC
    """
    MC_MONITOR_RULE_PREVIOUS_EXECUTION_TIME: ClassVar[NumericField] = NumericField("mcMonitorRulePreviousExecutionTime", "mcMonitorRulePreviousExecutionTime")
    """
    TBC
    """
    MC_MONITOR_RULE_COMPARISONS: ClassVar[KeywordField] = KeywordField("mcMonitorRuleComparisons", "mcMonitorRuleComparisons")
    """
    TBC
    """
    MC_MONITOR_RULE_IS_SNOOZED: ClassVar[BooleanField] = BooleanField("mcMonitorRuleIsSnoozed", "mcMonitorRuleIsSnoozed")
    """
    TBC
    """
    ...
    class Attributes(MonteCarlo.Attributes):
        ...
        mc_monitor_status: Optional[str] = Field(None, description='' , alias='mcMonitorStatus')
        mc_monitor_type: Optional[str] = Field(None, description='' , alias='mcMonitorType')
        mc_monitor_warehouse: Optional[str] = Field(None, description='' , alias='mcMonitorWarehouse')
        mc_monitor_schedule_type: Optional[str] = Field(None, description='' , alias='mcMonitorScheduleType')
        mc_monitor_namespace: Optional[str] = Field(None, description='' , alias='mcMonitorNamespace')
        mc_monitor_rule_type: Optional[str] = Field(None, description='' , alias='mcMonitorRuleType')
        mc_monitor_rule_custom_sql: Optional[str] = Field(None, description='' , alias='mcMonitorRuleCustomSql')
        mc_monitor_rule_schedule_config: Optional[MCRuleSchedule] = Field(None, description='' , alias='mcMonitorRuleScheduleConfig')
        mc_monitor_rule_schedule_config_humanized: Optional[str] = Field(None, description='' , alias='mcMonitorRuleScheduleConfigHumanized')
        mc_monitor_alert_condition: Optional[str] = Field(None, description='' , alias='mcMonitorAlertCondition')
        mc_monitor_rule_next_execution_time: Optional[datetime] = Field(None, description='' , alias='mcMonitorRuleNextExecutionTime')
        mc_monitor_rule_previous_execution_time: Optional[datetime] = Field(None, description='' , alias='mcMonitorRulePreviousExecutionTime')
        mc_monitor_rule_comparisons: Optional[list[MCRuleComparison]] = Field(None, description='' , alias='mcMonitorRuleComparisons')
        mc_monitor_rule_is_snoozed: Optional[bool] = Field(None, description='' , alias='mcMonitorRuleIsSnoozed')
        mc_monitor_breach_rate: Optional[float] = Field(None, description='' , alias='mcMonitorBreachRate')
        mc_monitor_incident_count: Optional[int] = Field(None, description='' , alias='mcMonitorIncidentCount')
        mc_monitor_assets: Optional[list[Asset]]= Field(None, description='',  alias='mcMonitorAssets') # relationship
...
class SodaCheck(Soda):
    ...
    Check Id
    """
    SODA_CHECK_EVALUATION_STATUS: ClassVar[KeywordField] = KeywordField("sodaCheckEvaluationStatus", "sodaCheckEvaluationStatus")
    """
    Check status
    """
    SODA_CHECK_DEFINITION: ClassVar[KeywordField] = KeywordField("sodaCheckDefinition", "sodaCheckDefinition")
    """
    Check definition
    """
    ...
    class Attributes(Soda.Attributes):
        ...
        soda_check_evaluation_status: Optional[str] = Field(None, description='' , alias='sodaCheckEvaluationStatus')
        soda_check_definition: Optional[str] = Field(None, description='' , alias='sodaCheckDefinition')
        soda_check_last_scan_at: Optional[datetime] = Field(None, description='' , alias='sodaCheckLastScanAt')
        soda_check_incident_count: Optional[int] = Field(None, description='' , alias='sodaCheckIncidentCount')
        soda_check_columns: Optional[list[Column]]= Field(None, description='',  alias='sodaCheckColumns') # relationship
        soda_check_assets: Optional[list[Asset]]= Field(None, description='',  alias='sodaCheckAssets') # relationship
...
class Table(SQL):
    ...
    def create(cls, *, name: str, schema_qualified_name: str)->Table:
        validate_required_fields(["name", "schema_qualified_name"], [name, schema_qualified_name])
        attributes = Table.Attributes.create(name=name, schema_qualified_name=schema_qualified_name)
        return cls(attributes=attributes)
    ...
    class Attributes(SQL.Attributes):
        ...
        partition_count: Optional[int] = Field(None, description='' , alias='partitionCount')
        partition_list: Optional[str] = Field(None, description='' , alias='partitionList')
        partitions: Optional[list[TablePartition]]= Field(None, description='',  alias='partitions') # relationship
        columns: Optional[list[Column]]= Field(None, description='',  alias='columns') # relationship
        queries: Optional[list[Query]]= Field(None, description='',  alias='queries') # relationship
        facts: Optional[list[Table]]= Field(None, description='',  alias='facts') # relationship
        atlan_schema: Optional[Schema]= Field(None, description='',  alias='atlanSchema') # relationship
        dimensions: Optional[list[Table]]= Field(None, description='',  alias='dimensions') # relationship
...
class Database(SQL):
    ...
    class Attributes(SQL.Attributes):
        ...
        schemas: Optional[list[Schema]]= Field(None, description='',  alias='schemas') # relationship
