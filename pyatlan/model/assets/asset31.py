...
class AWS(Cloud):
    ...
    class Attributes(Cloud.Attributes):
        ...
        aws_account_id: Optional[str] = Field(None, description='' , alias='awsAccountId')
        aws_resource_id: Optional[str] = Field(None, description='' , alias='awsResourceId')
        aws_owner_name: Optional[str] = Field(None, description='' , alias='awsOwnerName')
