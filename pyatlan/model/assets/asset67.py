...
class LookerLook(Looker):
    ...
    TBC
    """
    SOURCE_CONTENT_METADATA_ID: ClassVar[NumericField] = NumericField("sourceContentMetadataId", "sourceContentMetadataId")
    """
    TBC
    """
    ...
    class Attributes(Looker.Attributes):
        ...
        source_user_id: Optional[int] = Field(None, description='' , alias='sourceUserId')
        source_view_count: Optional[int] = Field(None, description='' , alias='sourceViewCount')
        sourcelast_updater_id: Optional[int] = Field(None, description='' , alias='sourcelastUpdaterId')
        source_last_accessed_at: Optional[datetime] = Field(None, description='' , alias='sourceLastAccessedAt')
        source_last_viewed_at: Optional[datetime] = Field(None, description='' , alias='sourceLastViewedAt')
        source_content_metadata_id: Optional[int] = Field(None, description='' , alias='sourceContentMetadataId')
        source_query_id: Optional[int] = Field(None, description='' , alias='sourceQueryId')
        model_name: Optional[str] = Field(None, description='' , alias='modelName')
        query: Optional[LookerQuery]= Field(None, description='',  alias='query') # relationship
        folder: Optional[LookerFolder]= Field(None, description='',  alias='folder') # relationship
        tile: Optional[LookerTile]= Field(None, description='',  alias='tile') # relationship
        model: Optional[LookerModel]= Field(None, description='',  alias='model') # relationship
        dashboard: Optional[LookerDashboard]= Field(None, description='',  alias='dashboard') # relationship
...
class LookerDashboard(Looker):
    ...
    class Attributes(Looker.Attributes):
        ...
        source_last_accessed_at: Optional[datetime] = Field(None, description='' , alias='sourceLastAccessedAt')
        source_last_viewed_at: Optional[datetime] = Field(None, description='' , alias='sourceLastViewedAt')
        tiles: Optional[list[LookerTile]]= Field(None, description='',  alias='tiles') # relationship
        looks: Optional[list[LookerLook]]= Field(None, description='',  alias='looks') # relationship
        folder: Optional[LookerFolder]= Field(None, description='',  alias='folder') # relationship
...
class LookerFolder(Looker):
    ...
    class Attributes(Looker.Attributes):
        source_content_metadata_id: Optional[int] = Field(None, description='' , alias='sourceContentMetadataId')
        source_creator_id: Optional[int] = Field(None, description='' , alias='sourceCreatorId')
        source_child_count: Optional[int] = Field(None, description='' , alias='sourceChildCount')
        source_parent_i_d: Optional[int] = Field(None, description='' , alias='sourceParentID')
        looker_sub_folders: Optional[list[LookerFolder]]= Field(None, description='',  alias='lookerSubFolders') # relationship
        dashboards: Optional[list[LookerDashboard]]= Field(None, description='',  alias='dashboards') # relationship
        looks: Optional[list[LookerLook]]= Field(None, description='',  alias='looks') # relationship
        looker_parent_folder: Optional[LookerFolder]= Field(None, description='',  alias='lookerParentFolder') # relationship
...
class LookerTile(Looker):
    ...
    LOOKML_LINK_ID: ClassVar[KeywordField] = KeywordField("lookmlLinkId", "lookmlLinkId")
    """
    TBC
    """
    MERGE_RESULT_ID: ClassVar[KeywordField] = KeywordField("mergeResultId", "mergeResultId")
    """
    TBC
    """
    ...
    class Attributes(Looker.Attributes):
        lookml_link_id: Optional[str] = Field(None, description='' , alias='lookmlLinkId')
        merge_result_id: Optional[str] = Field(None, description='' , alias='mergeResultId')
        note_text: Optional[str] = Field(None, description='' , alias='noteText')
        query_i_d: Optional[int] = Field(None, description='' , alias='queryID')
        result_maker_i_d: Optional[int] = Field(None, description='' , alias='resultMakerID')
        ...
        query: Optional[LookerQuery]= Field(None, description='',  alias='query') # relationship
        look: Optional[LookerLook]= Field(None, description='',  alias='look') # relationship
        dashboard: Optional[LookerDashboard]= Field(None, description='',  alias='dashboard') # relationship
...
class LookerModel(Looker):
    ...
    class Attributes(Looker.Attributes):
        ...
        explores: Optional[list[LookerExplore]]= Field(None, description='',  alias='explores') # relationship
        project: Optional[LookerProject]= Field(None, description='',  alias='project') # relationship
        look: Optional[LookerLook]= Field(None, description='',  alias='look') # relationship
        queries: Optional[list[LookerQuery]]= Field(None, description='',  alias='queries') # relationship
        fields: Optional[list[LookerField]]= Field(None, description='',  alias='fields') # relationship
...
class LookerExplore(Looker):
    ...
    TBC
    """
    SOURCE_CONNECTION_NAME: ClassVar[KeywordField] = KeywordField("sourceConnectionName", "sourceConnectionName")
    """
    TBC
    """
    ...
    TBC
    """
    SQL_TABLE_NAME: ClassVar[KeywordField] = KeywordField("sqlTableName", "sqlTableName")
    """
    TBC
    """
    ...
    class Attributes(Looker.Attributes):
        project_name: Optional[str] = Field(None, description='' , alias='projectName')
        model_name: Optional[str] = Field(None, description='' , alias='modelName')
        source_connection_name: Optional[str] = Field(None, description='' , alias='sourceConnectionName')
        view_name: Optional[str] = Field(None, description='' , alias='viewName')
        sql_table_name: Optional[str] = Field(None, description='' , alias='sqlTableName')
        project: Optional[LookerProject]= Field(None, description='',  alias='project') # relationship
        model: Optional[LookerModel]= Field(None, description='',  alias='model') # relationship
        fields: Optional[list[LookerField]]= Field(None, description='',  alias='fields') # relationship
...
class LookerProject(Looker):
    ...
    class Attributes(Looker.Attributes):
        models: Optional[list[LookerModel]]= Field(None, description='',  alias='models') # relationship
        explores: Optional[list[LookerExplore]]= Field(None, description='',  alias='explores') # relationship
        fields: Optional[list[LookerField]]= Field(None, description='',  alias='fields') # relationship
        views: Optional[list[LookerView]]= Field(None, description='',  alias='views') # relationship
...
class LookerQuery(Looker):
    ...
    SOURCE_DEFINITION: ClassVar[KeywordField] = KeywordField("sourceDefinition", "sourceDefinition")
    """
    TBC
    """
    SOURCE_DEFINITION_DATABASE: ClassVar[KeywordField] = KeywordField("sourceDefinitionDatabase", "sourceDefinitionDatabase")
    """
    TBC
    """
    SOURCE_DEFINITION_SCHEMA: ClassVar[KeywordField] = KeywordField("sourceDefinitionSchema", "sourceDefinitionSchema")
    """
    TBC
    """
    ...
    class Attributes(Looker.Attributes):
        source_definition: Optional[str] = Field(None, description='' , alias='sourceDefinition')
        source_definition_database: Optional[str] = Field(None, description='' , alias='sourceDefinitionDatabase')
        source_definition_schema: Optional[str] = Field(None, description='' , alias='sourceDefinitionSchema')
...
class LookerField(Looker):
    ...
    TBC
    """
    LOOKER_EXPLORE_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("lookerExploreQualifiedName", "lookerExploreQualifiedName", "lookerExploreQualifiedName.text")
    """
    TBC
    """
    LOOKER_VIEW_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("lookerViewQualifiedName", "lookerViewQualifiedName", "lookerViewQualifiedName.text")
    """
    TBC
    """
    MODEL_NAME: ClassVar[KeywordField] = KeywordField("modelName", "modelName")
    ...
    class Attributes(Looker.Attributes):
        ...
        looker_view_qualified_name: Optional[str] = Field(None, description='' , alias='lookerViewQualifiedName')
        model_name: Optional[str] = Field(None, description='' , alias='modelName')
        source_definition: Optional[str] = Field(None, description='' , alias='sourceDefinition')
        looker_field_data_type: Optional[str] = Field(None, description='' , alias='lookerFieldDataType')
        looker_times_used: Optional[int] = Field(None, description='' , alias='lookerTimesUsed')
        explore: Optional[LookerExplore]= Field(None, description='',  alias='explore') # relationship
        project: Optional[LookerProject]= Field(None, description='',  alias='project') # relationship
        view: Optional[LookerView]= Field(None, description='',  alias='view') # relationship
        model: Optional[LookerModel]= Field(None, description='',  alias='model') # relationship
...
class LookerView(Looker):
    ...
    TBC
    """
    LOOKER_VIEW_FILE_PATH: ClassVar[KeywordField] = KeywordField("lookerViewFilePath", "lookerViewFilePath")
    """
    ...
    class Attributes(Looker.Attributes):
        project_name: Optional[str] = Field(None, description='' , alias='projectName')
        looker_view_file_path: Optional[str] = Field(None, description='' , alias='lookerViewFilePath')
        looker_view_file_name: Optional[str] = Field(None, description='' , alias='lookerViewFileName')
        project: Optional[LookerProject]= Field(None, description='',  alias='project') # relationship
        fields: Optional[list[LookerField]]= Field(None, description='',  alias='fields') # relationship
