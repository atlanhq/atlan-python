...
class PowerBIReport(PowerBI):
    ...
    WORKSPACE_QUALIFIED_NAME: ClassVar[KeywordField] = KeywordField("workspaceQualifiedName", "workspaceQualifiedName")
    """
    TBC
    """
    DATASET_QUALIFIED_NAME: ClassVar[KeywordField] = KeywordField("datasetQualifiedName", "datasetQualifiedName")
    """
    TBC
    """
    ...
    class Attributes(PowerBI.Attributes):
        workspace_qualified_name: Optional[str] = Field(None, description='' , alias='workspaceQualifiedName')
        dataset_qualified_name: Optional[str] = Field(None, description='' , alias='datasetQualifiedName')
        web_url: Optional[str] = Field(None, description='' , alias='webUrl')
        page_count: Optional[int] = Field(None, description='' , alias='pageCount')
        workspace: Optional[PowerBIWorkspace]= Field(None, description='',  alias='workspace') # relationship
        tiles: Optional[list[PowerBITile]]= Field(None, description='',  alias='tiles') # relationship
        pages: Optional[list[PowerBIPage]]= Field(None, description='',  alias='pages') # relationship
        dataset: Optional[PowerBIDataset]= Field(None, description='',  alias='dataset') # relationship
...
class PowerBIMeasure(PowerBI):
    ...
    TBC
    """
    POWER_BI_IS_EXTERNAL_MEASURE: ClassVar[BooleanField] = BooleanField("powerBIIsExternalMeasure", "powerBIIsExternalMeasure")
    """
    TBC
    """
    ...
    class Attributes(PowerBI.Attributes):
        workspace_qualified_name: Optional[str] = Field(None, description='' , alias='workspaceQualifiedName')
        dataset_qualified_name: Optional[str] = Field(None, description='' , alias='datasetQualifiedName')
        power_b_i_measure_expression: Optional[str] = Field(None, description='' , alias='powerBIMeasureExpression')
        power_b_i_is_external_measure: Optional[bool] = Field(None, description='' , alias='powerBIIsExternalMeasure')
        table: Optional[PowerBITable]= Field(None, description='',  alias='table') # relationship
...
class PowerBIColumn(PowerBI):
    ...
    TBC
    """
    POWER_BI_COLUMN_DATA_CATEGORY: ClassVar[KeywordField] = KeywordField("powerBIColumnDataCategory", "powerBIColumnDataCategory")
    """
    TBC
    """
    ...
    TBC
    """
    POWER_BI_COLUMN_SUMMARIZE_BY: ClassVar[KeywordField] = KeywordField("powerBIColumnSummarizeBy", "powerBIColumnSummarizeBy")
    """
    TBC
    """
    ...
    class Attributes(PowerBI.Attributes):
        workspace_qualified_name: Optional[str] = Field(None, description='' , alias='workspaceQualifiedName')
        dataset_qualified_name: Optional[str] = Field(None, description='' , alias='datasetQualifiedName')
        power_b_i_column_data_category: Optional[str] = Field(None, description='' , alias='powerBIColumnDataCategory')
        power_b_i_column_data_type: Optional[str] = Field(None, description='' , alias='powerBIColumnDataType')
        power_b_i_sort_by_column: Optional[str] = Field(None, description='' , alias='powerBISortByColumn')
        power_b_i_column_summarize_by: Optional[str] = Field(None, description='' , alias='powerBIColumnSummarizeBy')
        table: Optional[PowerBITable]= Field(None, description='',  alias='table') # relationship
...
class PowerBITable(PowerBI):
    ...
    TBC
    """
    POWER_BI_TABLE_SOURCE_EXPRESSIONS: ClassVar[KeywordField] = KeywordField("powerBITableSourceExpressions", "powerBITableSourceExpressions")
    """
    TBC
    """
    POWER_BI_TABLE_COLUMN_COUNT: ClassVar[NumericField] = NumericField("powerBITableColumnCount", "powerBITableColumnCount")
    """
    TBC
    """
    POWER_BI_TABLE_MEASURE_COUNT: ClassVar[NumericField] = NumericField("powerBITableMeasureCount", "powerBITableMeasureCount")
    """
    TBC
    """
    ...
    class Attributes(PowerBI.Attributes):
        workspace_qualified_name: Optional[str] = Field(None, description='' , alias='workspaceQualifiedName')
        dataset_qualified_name: Optional[str] = Field(None, description='' , alias='datasetQualifiedName')
        power_b_i_table_source_expressions: Optional[set[str]] = Field(None, description='' , alias='powerBITableSourceExpressions')
        power_b_i_table_column_count: Optional[int] = Field(None, description='' , alias='powerBITableColumnCount')
        power_b_i_table_measure_count: Optional[int] = Field(None, description='' , alias='powerBITableMeasureCount')
        columns: Optional[list[PowerBIColumn]]= Field(None, description='',  alias='columns') # relationship
        measures: Optional[list[PowerBIMeasure]]= Field(None, description='',  alias='measures') # relationship
        dataset: Optional[PowerBIDataset]= Field(None, description='',  alias='dataset') # relationship
...
class PowerBITile(PowerBI):
    ...
    TBC
    """
    DASHBOARD_QUALIFIED_NAME: ClassVar[KeywordField] = KeywordField("dashboardQualifiedName", "dashboardQualifiedName")
    """
    TBC
    """
    ...
    def dashboard_qualified_name(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.dashboard_qualified_name
    ...
    class Attributes(PowerBI.Attributes):
        workspace_qualified_name: Optional[str] = Field(None, description='' , alias='workspaceQualifiedName')
        dashboard_qualified_name: Optional[str] = Field(None, description='' , alias='dashboardQualifiedName')
        report: Optional[PowerBIReport]= Field(None, description='',  alias='report') # relationship
        dataset: Optional[PowerBIDataset]= Field(None, description='',  alias='dataset') # relationship
        dashboard: Optional[PowerBIDashboard]= Field(None, description='',  alias='dashboard') # relationship
...
class PowerBIDatasource(PowerBI):
    ...
    class Attributes(PowerBI.Attributes):
        connection_details: Optional[dict[str,str]] = Field(None, description='' , alias='connectionDetails')
        datasets: Optional[list[PowerBIDataset]]= Field(None, description='',  alias='datasets') # relationship
...
class PowerBIWorkspace(PowerBI):
    ...
    class Attributes(PowerBI.Attributes):
        ...
        dashboard_count: Optional[int] = Field(None, description='' , alias='dashboardCount')
        dataset_count: Optional[int] = Field(None, description='' , alias='datasetCount')
        dataflow_count: Optional[int] = Field(None, description='' , alias='dataflowCount')
        reports: Optional[list[PowerBIReport]]= Field(None, description='',  alias='reports') # relationship
        datasets: Optional[list[PowerBIDataset]]= Field(None, description='',  alias='datasets') # relationship
        dashboards: Optional[list[PowerBIDashboard]]= Field(None, description='',  alias='dashboards') # relationship
        dataflows: Optional[list[PowerBIDataflow]]= Field(None, description='',  alias='dataflows') # relationship
...
class PowerBIDataset(PowerBI):
    ...
    class Attributes(PowerBI.Attributes):
        ...
        dataflows: Optional[list[PowerBIDataflow]]= Field(None, description='',  alias='dataflows') # relationship
        tiles: Optional[list[PowerBITile]]= Field(None, description='',  alias='tiles') # relationship
        tables: Optional[list[PowerBITable]]= Field(None, description='',  alias='tables') # relationship
        datasources: Optional[list[PowerBIDatasource]]= Field(None, description='',  alias='datasources') # relationship
...
class PowerBIPage(PowerBI):
    ...
    TBC
    """
    REPORT_QUALIFIED_NAME: ClassVar[KeywordField] = KeywordField("reportQualifiedName", "reportQualifiedName")
    """
    TBC
    """
    ...
    class Attributes(PowerBI.Attributes):
        workspace_qualified_name: Optional[str] = Field(None, description='' , alias='workspaceQualifiedName')
        report_qualified_name: Optional[str] = Field(None, description='' , alias='reportQualifiedName')
        report: Optional[PowerBIReport]= Field(None, description='',  alias='report') # relationship
