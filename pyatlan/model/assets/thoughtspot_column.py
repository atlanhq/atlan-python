...
class ThoughtspotColumn(Thoughtspot):
    ...
    """
    THOUGHTSPOT_COLUMN_TYPE: ClassVar[KeywordField] = KeywordField("thoughtspotColumnType", "thoughtspotColumnType")
    """
    ...
    TBC
    """
    THOUGHTSPOT_WORKSHEET: ClassVar[RelationField] = RelationField("thoughtspotWorksheet")
    """
    TBC
    """
    ...
    def thoughtspot_table_qualified_name(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.thoughtspot_table_qualified_name

    @thoughtspot_table_qualified_name.setter
    def thoughtspot_table_qualified_name(self, thoughtspot_table_qualified_name: Optional[str]):
    ...
    def thoughtspot_view_qualified_name(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.thoughtspot_view_qualified_name

    @thoughtspot_view_qualified_name.setter
    def thoughtspot_view_qualified_name(self, thoughtspot_view_qualified_name: Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.thoughtspot_view_qualified_name = thoughtspot_view_qualified_name

    @property
    def thoughtspot_worksheet_qualified_name(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.thoughtspot_worksheet_qualified_name

    @thoughtspot_worksheet_qualified_name.setter
    def thoughtspot_worksheet_qualified_name(self, thoughtspot_worksheet_qualified_name: Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.thoughtspot_worksheet_qualified_name = thoughtspot_worksheet_qualified_name

    @property
    def thoughtspot_column_data_type(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.thoughtspot_column_data_type
    ...
    def thoughtspot_column_type(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.thoughtspot_column_type
    ...
    def thoughtspot_worksheet(self) -> Optional[ThoughtspotWorksheet]:
        return None if self.attributes is None else self.attributes.thoughtspot_worksheet
    ...
    class Attributes(Thoughtspot.Attributes):
        thoughtspot_table_qualified_name: Optional[str] = Field(default=None, description="")
        thoughtspot_view_qualified_name: Optional[str] = Field(default=None, description="")
        thoughtspot_worksheet_qualified_name: Optional[str] = Field(default=None, description="")
        thoughtspot_column_data_type: Optional[str] = Field(default=None, description="")
        thoughtspot_column_type: Optional[str] = Field(default=None, description="")
        thoughtspot_view: Optional[ThoughtspotView] = Field(default=None, description="")  # relationship
        thoughtspot_worksheet: Optional[ThoughtspotWorksheet] = Field(default=None, description="")  # relationship
        thoughtspot_table: Optional[ThoughtspotTable] = Field(default=None, description="")  # relationship
