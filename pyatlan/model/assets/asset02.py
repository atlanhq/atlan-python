...
class Connection(Asset, type_name='Connection'):
    ...
    TBC
    """
    CREDENTIAL_STRATEGY: ClassVar[KeywordField] = KeywordField("credentialStrategy", "credentialStrategy")
    """
    TBC
    """
    PREVIEW_CREDENTIAL_STRATEGY: ClassVar[KeywordField] = KeywordField("previewCredentialStrategy", "previewCredentialStrategy")
    """
    TBC
    """
    ...
    TBC
    """
    DEFAULT_CREDENTIAL_GUID: ClassVar[KeywordField] = KeywordField("defaultCredentialGuid", "defaultCredentialGuid")
    """
    TBC
    """
    CONNECTOR_ICON: ClassVar[KeywordField] = KeywordField("connectorIcon", "connectorIcon")
    """
    TBC
    """
    CONNECTOR_IMAGE: ClassVar[KeywordField] = KeywordField("connectorImage", "connectorImage")
    """
    TBC
    """
    ...
    TBC
    """
    IS_SAMPLE_DATA_PREVIEW_ENABLED: ClassVar[BooleanField] = BooleanField("isSampleDataPreviewEnabled", "isSampleDataPreviewEnabled")
    """
    TBC
    """
    POPULARITY_INSIGHTS_TIMEFRAME: ClassVar[NumericField] = NumericField("popularityInsightsTimeframe", "popularityInsightsTimeframe")
    """
    ...
    """
    CONNECTION_DBT_ENVIRONMENTS: ClassVar[KeywordField] = KeywordField("connectionDbtEnvironments", "connectionDbtEnvironments")
    """
    TBC
    """
    CONNECTION_SSO_CREDENTIAL_GUID: ClassVar[KeywordField] = KeywordField("connectionSSOCredentialGuid", "connectionSSOCredentialGuid")
    """
    TBC
    """
    ...
    class Attributes(Asset.Attributes):
        ...
        allow_query_preview: Optional[bool] = Field(None, description='' , alias='allowQueryPreview')
        ...
        credential_strategy: Optional[str] = Field(None, description='' , alias='credentialStrategy')
        preview_credential_strategy: Optional[str] = Field(None, description='' , alias='previewCredentialStrategy')
        policy_strategy: Optional[str] = Field(None, description='' , alias='policyStrategy')
        query_username_strategy: Optional[QueryUsernameStrategy] = Field(None, description='' , alias='queryUsernameStrategy')
        ...
        default_credential_guid: Optional[str] = Field(None, description='' , alias='defaultCredentialGuid')
        connector_icon: Optional[str] = Field(None, description='' , alias='connectorIcon')
        connector_image: Optional[str] = Field(None, description='' , alias='connectorImage')
        source_logo: Optional[str] = Field(None, description='' , alias='sourceLogo')
        is_sample_data_preview_enabled: Optional[bool] = Field(None, description='' , alias='isSampleDataPreviewEnabled')
        popularity_insights_timeframe: Optional[int] = Field(None, description='' , alias='popularityInsightsTimeframe')
        has_popularity_insights: Optional[bool] = Field(None, description='' , alias='hasPopularityInsights')
        connection_dbt_environments: Optional[set[str]] = Field(None, description='' , alias='connectionDbtEnvironments')
        connection_s_s_o_credential_guid: Optional[str] = Field(None, description='' , alias='connectionSSOCredentialGuid')
