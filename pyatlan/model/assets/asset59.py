...
class ADLSAccount(ADLS):
    ...
    @classmethod
    # @validate_arguments()
    def create(cls, *, name: str, connectionQualifiedName: str) -> ADLSAccount:
        validate_required_fields(
            ["name", "connectionQualifiedName"], [name, connectionQualifiedName]
        )
        attributes = ADLSAccount.Attributes.create(
            name=name, connectionQualifiedName=connectionQualifiedName
        )
    ...
    TBC
    """
    ADLS_ACCOUNT_RESOURCE_GROUP: ClassVar[KeywordTextField] = KeywordTextField("adlsAccountResourceGroup", "adlsAccountResourceGroup.keyword", "adlsAccountResourceGroup")
    """
    TBC
    """
    ADLS_ACCOUNT_SUBSCRIPTION: ClassVar[KeywordTextField] = KeywordTextField("adlsAccountSubscription", "adlsAccountSubscription.keyword", "adlsAccountSubscription")
    """
    TBC
    """
    ...
    TBC
    """
    ADLS_ACCOUNT_PROVISION_STATE: ClassVar[KeywordField] = KeywordField("adlsAccountProvisionState", "adlsAccountProvisionState")
    """
    TBC
    """
    ...
    class Attributes(ADLS.Attributes):
        ...
        adls_encryption_type: Optional[ADLSEncryptionTypes] = Field(None, description='' , alias='adlsEncryptionType')
        adls_account_resource_group: Optional[str] = Field(None, description='' , alias='adlsAccountResourceGroup')
        adls_account_subscription: Optional[str] = Field(None, description='' , alias='adlsAccountSubscription')
        adls_account_performance: Optional[ADLSPerformance] = Field(None, description='' , alias='adlsAccountPerformance')
        adls_account_replication: Optional[ADLSReplicationType] = Field(None, description='' , alias='adlsAccountReplication')
        adls_account_kind: Optional[ADLSStorageKind] = Field(None, description='' , alias='adlsAccountKind')
        adls_primary_disk_state: Optional[ADLSAccountStatus] = Field(None, description='' , alias='adlsPrimaryDiskState')
        adls_account_provision_state: Optional[ADLSProvisionState] = Field(None, description='' , alias='adlsAccountProvisionState')
        adls_account_access_tier: Optional[ADLSAccessTier] = Field(None, description='' , alias='adlsAccountAccessTier')
        adls_containers: Optional[list[ADLSContainer]]= Field(None, description='',  alias='adlsContainers') # relationship
...
class ADLSContainer(ADLS):
    ...
    ADLS_CONTAINER_URL: ClassVar[KeywordTextField] = KeywordTextField("adlsContainerUrl", "adlsContainerUrl.keyword", "adlsContainerUrl")
    """
    TBC
    """
    ADLS_CONTAINER_LEASE_STATE: ClassVar[KeywordField] = KeywordField("adlsContainerLeaseState", "adlsContainerLeaseState")
    """
    TBC
    """
    ADLS_CONTAINER_LEASE_STATUS: ClassVar[KeywordField] = KeywordField("adlsContainerLeaseStatus", "adlsContainerLeaseStatus")
    """
    TBC
    """
    ADLS_CONTAINER_ENCRYPTION_SCOPE: ClassVar[KeywordField] = KeywordField("adlsContainerEncryptionScope", "adlsContainerEncryptionScope")
    """
    TBC
    """
    ADLS_CONTAINER_VERSION_LEVEL_IMMUTABILITY_SUPPORT: ClassVar[BooleanField] = BooleanField("adlsContainerVersionLevelImmutabilitySupport", "adlsContainerVersionLevelImmutabilitySupport")
    """
    TBC
    """
    ...
    def adls_container_version_level_immutability_support(self, adls_container_version_level_immutability_support:Optional[bool]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.adls_container_version_level_immutability_support = adls_container_version_level_immutability_support
    @property
    ...
    class Attributes(ADLS.Attributes):
        adls_container_url: Optional[str] = Field(None, description='' , alias='adlsContainerUrl')
        adls_container_lease_state: Optional[ADLSLeaseState] = Field(None, description='' , alias='adlsContainerLeaseState')
        adls_container_lease_status: Optional[ADLSLeaseStatus] = Field(None, description='' , alias='adlsContainerLeaseStatus')
        adls_container_encryption_scope: Optional[str] = Field(None, description='' , alias='adlsContainerEncryptionScope')
        adls_container_version_level_immutability_support: Optional[bool] = Field(None, description='' , alias='adlsContainerVersionLevelImmutabilitySupport')
        adls_object_count: Optional[int] = Field(None, description='' , alias='adlsObjectCount')
        adls_objects: Optional[list[ADLSObject]]= Field(None, description='',  alias='adlsObjects') # relationship
        adls_account: Optional[ADLSAccount]= Field(None, description='',  alias='adlsAccount') # relationship
...
class ADLSObject(ADLS):
    ...
    ADLS_OBJECT_URL: ClassVar[KeywordTextField] = KeywordTextField("adlsObjectUrl", "adlsObjectUrl.keyword", "adlsObjectUrl")
    """
    TBC
    """
    ADLS_OBJECT_VERSION_ID: ClassVar[KeywordField] = KeywordField("adlsObjectVersionId", "adlsObjectVersionId")
    """
    TBC
    """
    ADLS_OBJECT_TYPE: ClassVar[KeywordField] = KeywordField("adlsObjectType", "adlsObjectType")
    """
    TBC
    """
    ADLS_OBJECT_SIZE: ClassVar[NumericField] = NumericField("adlsObjectSize", "adlsObjectSize")
    """
    TBC
    """
    ...
    TBC
    """
    ADLS_OBJECT_ACCESS_TIER_LAST_MODIFIED_TIME: ClassVar[NumericField] = NumericField("adlsObjectAccessTierLastModifiedTime", "adlsObjectAccessTierLastModifiedTime")
    """
    TBC
    """
    ADLS_OBJECT_ARCHIVE_STATUS: ClassVar[KeywordField] = KeywordField("adlsObjectArchiveStatus", "adlsObjectArchiveStatus")
    """
    TBC
    """
    ADLS_OBJECT_SERVER_ENCRYPTED: ClassVar[BooleanField] = BooleanField("adlsObjectServerEncrypted", "adlsObjectServerEncrypted")
    """
    TBC
    """
    ADLS_OBJECT_VERSION_LEVEL_IMMUTABILITY_SUPPORT: ClassVar[BooleanField] = BooleanField("adlsObjectVersionLevelImmutabilitySupport", "adlsObjectVersionLevelImmutabilitySupport")
    """
    TBC
    """
    ADLS_OBJECT_CACHE_CONTROL: ClassVar[TextField] = TextField("adlsObjectCacheControl", "adlsObjectCacheControl")
    """
    TBC
    """
    ADLS_OBJECT_CONTENT_TYPE: ClassVar[TextField] = TextField("adlsObjectContentType", "adlsObjectContentType")
    """
    TBC
    """
    ADLS_OBJECT_CONTENT_MD5HASH: ClassVar[KeywordField] = KeywordField("adlsObjectContentMD5Hash", "adlsObjectContentMD5Hash")
    """
    TBC
    """
    ADLS_OBJECT_CONTENT_LANGUAGE: ClassVar[KeywordTextField] = KeywordTextField("adlsObjectContentLanguage", "adlsObjectContentLanguage.keyword", "adlsObjectContentLanguage")
    """
    TBC
    """
    ADLS_OBJECT_LEASE_STATUS: ClassVar[KeywordField] = KeywordField("adlsObjectLeaseStatus", "adlsObjectLeaseStatus")
    """
    TBC
    """
    ADLS_OBJECT_LEASE_STATE: ClassVar[KeywordField] = KeywordField("adlsObjectLeaseState", "adlsObjectLeaseState")
    """
    TBC
    """
    ADLS_OBJECT_METADATA: ClassVar[KeywordField] = KeywordField("adlsObjectMetadata", "adlsObjectMetadata")
    """
    TBC
    """
    ADLS_CONTAINER_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("adlsContainerQualifiedName", "adlsContainerQualifiedName", "adlsContainerQualifiedName.text")
    """
    TBC
    """
    ...
    def adls_object_version_id(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.adls_object_version_id
    ...
    def adls_object_access_tier(self)->Optional[ADLSAccessTier]:
        return None if self.attributes is None else self.attributes.adls_object_access_tier
    ...
    def adls_object_access_tier_last_modified_time(self)->Optional[datetime]:
        return None if self.attributes is None else self.attributes.adls_object_access_tier_last_modified_time

    @adls_object_access_tier_last_modified_time.setter
    def adls_object_access_tier_last_modified_time(self, adls_object_access_tier_last_modified_time:Optional[datetime]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.adls_object_access_tier_last_modified_time = adls_object_access_tier_last_modified_time
    @property
    def adls_object_archive_status(self)->Optional[ADLSObjectArchiveStatus]:
        return None if self.attributes is None else self.attributes.adls_object_archive_status

    @adls_object_archive_status.setter
    def adls_object_archive_status(self, adls_object_archive_status:Optional[ADLSObjectArchiveStatus]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.adls_object_archive_status = adls_object_archive_status
    @property
    def adls_object_server_encrypted(self)->Optional[bool]:
        return None if self.attributes is None else self.attributes.adls_object_server_encrypted

    @adls_object_server_encrypted.setter
    def adls_object_server_encrypted(self, adls_object_server_encrypted:Optional[bool]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def adls_object_version_level_immutability_support(self)->Optional[bool]:
        return None if self.attributes is None else self.attributes.adls_object_version_level_immutability_support

    @adls_object_version_level_immutability_support.setter
    def adls_object_version_level_immutability_support(self, adls_object_version_level_immutability_support:Optional[bool]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.adls_object_version_level_immutability_support = adls_object_version_level_immutability_support
    @property
    def adls_object_cache_control(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.adls_object_cache_control
    ...
    def adls_object_content_type(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.adls_object_content_type
    ...
    def adls_object_content_m_d5_hash(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.adls_object_content_m_d5_hash

    @adls_object_content_m_d5_hash.setter
    def adls_object_content_m_d5_hash(self, adls_object_content_m_d5_hash:Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def adls_object_content_language(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.adls_object_content_language
    ...
    def adls_object_lease_status(self)->Optional[ADLSLeaseStatus]:
        return None if self.attributes is None else self.attributes.adls_object_lease_status

    @adls_object_lease_status.setter
    def adls_object_lease_status(self, adls_object_lease_status:Optional[ADLSLeaseStatus]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def adls_object_lease_state(self)->Optional[ADLSLeaseState]:
        return None if self.attributes is None else self.attributes.adls_object_lease_state
    ...
    def adls_container_qualified_name(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.adls_container_qualified_name

    @adls_container_qualified_name.setter
    def adls_container_qualified_name(self, adls_container_qualified_name:Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    class Attributes(ADLS.Attributes):
        adls_object_url: Optional[str] = Field(None, description='' , alias='adlsObjectUrl')
        adls_object_version_id: Optional[str] = Field(None, description='' , alias='adlsObjectVersionId')
        adls_object_type: Optional[ADLSObjectType] = Field(None, description='' , alias='adlsObjectType')
        adls_object_size: Optional[int] = Field(None, description='' , alias='adlsObjectSize')
        adls_object_access_tier: Optional[ADLSAccessTier] = Field(None, description='' , alias='adlsObjectAccessTier')
        adls_object_access_tier_last_modified_time: Optional[datetime] = Field(None, description='' , alias='adlsObjectAccessTierLastModifiedTime')
        adls_object_archive_status: Optional[ADLSObjectArchiveStatus] = Field(None, description='' , alias='adlsObjectArchiveStatus')
        adls_object_server_encrypted: Optional[bool] = Field(None, description='' , alias='adlsObjectServerEncrypted')
        adls_object_version_level_immutability_support: Optional[bool] = Field(None, description='' , alias='adlsObjectVersionLevelImmutabilitySupport')
        adls_object_cache_control: Optional[str] = Field(None, description='' , alias='adlsObjectCacheControl')
        adls_object_content_type: Optional[str] = Field(None, description='' , alias='adlsObjectContentType')
        adls_object_content_m_d5_hash: Optional[str] = Field(None, description='' , alias='adlsObjectContentMD5Hash')
        adls_object_content_language: Optional[str] = Field(None, description='' , alias='adlsObjectContentLanguage')
        adls_object_lease_status: Optional[ADLSLeaseStatus] = Field(None, description='' , alias='adlsObjectLeaseStatus')
        adls_object_lease_state: Optional[ADLSLeaseState] = Field(None, description='' , alias='adlsObjectLeaseState')
        adls_object_metadata: Optional[dict[str,str]] = Field(None, description='' , alias='adlsObjectMetadata')
        adls_container_qualified_name: Optional[str] = Field(None, description='' , alias='adlsContainerQualifiedName')
        adls_container: Optional[ADLSContainer]= Field(None, description='',  alias='adlsContainer') # relationship
