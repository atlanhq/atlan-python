...
class KafkaTopic(Kafka):
    ...
    TBC
    """
    KAFKA_TOPIC_COMPRESSION_TYPE: ClassVar[KeywordField] = KeywordField("kafkaTopicCompressionType", "kafkaTopicCompressionType")
    """
    TBC
    """
    KAFKA_TOPIC_REPLICATION_FACTOR: ClassVar[NumericField] = NumericField("kafkaTopicReplicationFactor", "kafkaTopicReplicationFactor")
    """
    TBC
    """
    ...
    TBC
    """
    KAFKA_TOPIC_RETENTION_TIME_IN_MS: ClassVar[NumericField] = NumericField("kafkaTopicRetentionTimeInMs", "kafkaTopicRetentionTimeInMs")
    """
    TBC
    """
    KAFKA_TOPIC_PARTITIONS_COUNT: ClassVar[NumericField] = NumericField("kafkaTopicPartitionsCount", "kafkaTopicPartitionsCount")
    """
    TBC
    """
    ...
    TBC
    """
    KAFKA_TOPIC_CLEANUP_POLICY: ClassVar[KeywordField] = KeywordField("kafkaTopicCleanupPolicy", "kafkaTopicCleanupPolicy")
    """
    TBC
    """
    ...
    class Attributes(Kafka.Attributes):
        kafka_topic_is_internal: Optional[bool] = Field(None, description='' , alias='kafkaTopicIsInternal')
        kafka_topic_compression_type: Optional[KafkaTopicCompressionType] = Field(None, description='' , alias='kafkaTopicCompressionType')
        kafka_topic_replication_factor: Optional[int] = Field(None, description='' , alias='kafkaTopicReplicationFactor')
        kafka_topic_segment_bytes: Optional[int] = Field(None, description='' , alias='kafkaTopicSegmentBytes')
        kafka_topic_retention_time_in_ms: Optional[int] = Field(None, description='' , alias='kafkaTopicRetentionTimeInMs')
        kafka_topic_partitions_count: Optional[int] = Field(None, description='' , alias='kafkaTopicPartitionsCount')
        kafka_topic_size_in_bytes: Optional[int] = Field(None, description='' , alias='kafkaTopicSizeInBytes')
        kafka_topic_record_count: Optional[int] = Field(None, description='' , alias='kafkaTopicRecordCount')
        kafka_topic_cleanup_policy: Optional[KafkaTopicCleanupPolicy] = Field(None, description='' , alias='kafkaTopicCleanupPolicy')
        kafka_consumer_groups: Optional[list[KafkaConsumerGroup]]= Field(None, description='',  alias='kafkaConsumerGroups') # relationship
...
class KafkaConsumerGroup(Kafka):
    ...
    KAFKA_CONSUMER_GROUP_TOPIC_CONSUMPTION_PROPERTIES: ClassVar[KeywordField] = KeywordField("kafkaConsumerGroupTopicConsumptionProperties", "kafkaConsumerGroupTopicConsumptionProperties")
    """
    TBC
    """
    KAFKA_CONSUMER_GROUP_MEMBER_COUNT: ClassVar[NumericField] = NumericField("kafkaConsumerGroupMemberCount", "kafkaConsumerGroupMemberCount")
    """
    TBC
    """
    ...
    TBC
    """
    KAFKA_TOPIC_QUALIFIED_NAMES: ClassVar[KeywordField] = KeywordField("kafkaTopicQualifiedNames", "kafkaTopicQualifiedNames")
    """
    TBC
    """
    ...
    _convenience_properties: ClassVar[list[str]] = [
        ...
        "kafka_topics",]
    @property
    def kafka_consumer_group_topic_consumption_properties(self)->Optional[list[KafkaTopicConsumption]]:
    ...
    def kafka_consumer_group_topic_consumption_properties(self, kafka_consumer_group_topic_consumption_properties:Optional[list[KafkaTopicConsumption]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.kafka_consumer_group_topic_consumption_properties = kafka_consumer_group_topic_consumption_properties
    @property
    ...
    class Attributes(Kafka.Attributes):
        kafka_consumer_group_topic_consumption_properties: Optional[list[KafkaTopicConsumption]] = Field(None, description='' , alias='kafkaConsumerGroupTopicConsumptionProperties')
        kafka_consumer_group_member_count: Optional[int] = Field(None, description='' , alias='kafkaConsumerGroupMemberCount')
        kafka_topic_names: Optional[set[str]] = Field(None, description='' , alias='kafkaTopicNames')
        kafka_topic_qualified_names: Optional[set[str]] = Field(None, description='' , alias='kafkaTopicQualifiedNames')
        kafka_topics: Optional[list[KafkaTopic]]= Field(None, description='',  alias='kafkaTopics') # relationship
