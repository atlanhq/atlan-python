...
class QuickSightFolder(QuickSight):
    ...
    """
    QUICK_SIGHT_FOLDER_HIERARCHY: ClassVar[KeywordField] = KeywordField("quickSightFolderHierarchy", "quickSightFolderHierarchy")
    """
    ...
    class Attributes(QuickSight.Attributes):
        quick_sight_folder_type: Optional[QuickSightFolderType] = Field(None, description='' , alias='quickSightFolderType')
        quick_sight_folder_hierarchy: Optional[list[dict[str,str]]] = Field(None, description='' , alias='quickSightFolderHierarchy')
        quick_sight_dashboards: Optional[list[QuickSightDashboard]]= Field(None, description='',  alias='quickSightDashboards') # relationship
        quick_sight_datasets: Optional[list[QuickSightDataset]]= Field(None, description='',  alias='quickSightDatasets') # relationship
        quick_sight_analyses: Optional[list[QuickSightAnalysis]]= Field(None, description='',  alias='quickSightAnalyses') # relationship
...
class QuickSightDashboardVisual(QuickSight):
    ...
    QUICK_SIGHT_DASHBOARD_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("quickSightDashboardQualifiedName", "quickSightDashboardQualifiedName", "quickSightDashboardQualifiedName.text")
    """
    TBC
    """
    ...
    class Attributes(QuickSight.Attributes):
        quick_sight_dashboard_qualified_name: Optional[str] = Field(None, description='' , alias='quickSightDashboardQualifiedName')
        quick_sight_dashboard: Optional[QuickSightDashboard]= Field(None, description='',  alias='quickSightDashboard') # relationship
...
class QuickSightAnalysisVisual(QuickSight):
    ...
    QUICK_SIGHT_ANALYSIS_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("quickSightAnalysisQualifiedName", "quickSightAnalysisQualifiedName", "quickSightAnalysisQualifiedName.text")
    """
    ...
    class Attributes(QuickSight.Attributes):
        quick_sight_analysis_qualified_name: Optional[str] = Field(None, description='' , alias='quickSightAnalysisQualifiedName')
        quick_sight_analysis: Optional[QuickSightAnalysis]= Field(None, description='',  alias='quickSightAnalysis') # relationship
...
class QuickSightDatasetField(QuickSight):
    ...
    QUICK_SIGHT_DATASET_FIELD_TYPE: ClassVar[KeywordField] = KeywordField("quickSightDatasetFieldType", "quickSightDatasetFieldType")
    """
    Datatype of column in the dataset
    """
    QUICK_SIGHT_DATASET_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("quickSightDatasetQualifiedName", "quickSightDatasetQualifiedName", "quickSightDatasetQualifiedName.text")
    """
    ...
    class Attributes(QuickSight.Attributes):
        quick_sight_dataset_field_type: Optional[QuickSightDatasetFieldType] = Field(None, description='' , alias='quickSightDatasetFieldType')
        quick_sight_dataset_qualified_name: Optional[str] = Field(None, description='' , alias='quickSightDatasetQualifiedName')
        quick_sight_dataset: Optional[QuickSightDataset]= Field(None, description='',  alias='quickSightDataset') # relationship
...
class QuickSightAnalysis(QuickSight):
    ...
    QUICK_SIGHT_ANALYSIS_STATUS: ClassVar[KeywordField] = KeywordField("quickSightAnalysisStatus", "quickSightAnalysisStatus")
    """
    Status of quicksight analysis
    """
    QUICK_SIGHT_ANALYSIS_CALCULATED_FIELDS: ClassVar[KeywordField] = KeywordField("quickSightAnalysisCalculatedFields", "quickSightAnalysisCalculatedFields")
    """
    Calculated fields of quicksight analysis 
    """
    QUICK_SIGHT_ANALYSIS_PARAMETER_DECLARATIONS: ClassVar[KeywordField] = KeywordField("quickSightAnalysisParameterDeclarations", "quickSightAnalysisParameterDeclarations")
    """
    parameters used for quicksight analysis 
    """
    QUICK_SIGHT_ANALYSIS_FILTER_GROUPS: ClassVar[KeywordField] = KeywordField("quickSightAnalysisFilterGroups", "quickSightAnalysisFilterGroups")
    """
    ...
    def quick_sight_analysis_parameter_declarations(self, quick_sight_analysis_parameter_declarations:Optional[set[str]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    class Attributes(QuickSight.Attributes):
        quick_sight_analysis_status: Optional[QuickSightAnalysisStatus] = Field(None, description='' , alias='quickSightAnalysisStatus')
        quick_sight_analysis_calculated_fields: Optional[set[str]] = Field(None, description='' , alias='quickSightAnalysisCalculatedFields')
        ...
        quick_sight_analysis_filter_groups: Optional[set[str]] = Field(None, description='' , alias='quickSightAnalysisFilterGroups')
        quick_sight_analysis_visuals: Optional[list[QuickSightAnalysisVisual]]= Field(None, description='',  alias='quickSightAnalysisVisuals') # relationship
        quick_sight_analysis_folders: Optional[list[QuickSightFolder]]= Field(None, description='',  alias='quickSightAnalysisFolders') # relationship
...
class QuickSightDashboard(QuickSight):
    ...
    QUICK_SIGHT_DASHBOARD_PUBLISHED_VERSION_NUMBER: ClassVar[NumericField] = NumericField("quickSightDashboardPublishedVersionNumber", "quickSightDashboardPublishedVersionNumber")
    """
    Version number of the dashboard published
    """
    QUICK_SIGHT_DASHBOARD_LAST_PUBLISHED_TIME: ClassVar[NumericField] = NumericField("quickSightDashboardLastPublishedTime", "quickSightDashboardLastPublishedTime")
    """
    ...
    def quick_sight_dashboard_published_version_number(self, quick_sight_dashboard_published_version_number:Optional[int]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    @property
    def quick_sight_dashboard_visuals(self)->Optional[list[QuickSightDashboardVisual]]:
    ...
    class Attributes(QuickSight.Attributes):
        quick_sight_dashboard_published_version_number: Optional[int] = Field(None, description='' , alias='quickSightDashboardPublishedVersionNumber')
        quick_sight_dashboard_last_published_time: Optional[datetime] = Field(None, description='' , alias='quickSightDashboardLastPublishedTime')
        quick_sight_dashboard_folders: Optional[list[QuickSightFolder]]= Field(None, description='',  alias='quickSightDashboardFolders') # relationship
        quick_sight_dashboard_visuals: Optional[list[QuickSightDashboardVisual]]= Field(None, description='',  alias='quickSightDashboardVisuals') # relationship
...
class QuickSightDataset(QuickSight):
    ...
    QUICK_SIGHT_DATASET_IMPORT_MODE: ClassVar[KeywordField] = KeywordField("quickSightDatasetImportMode", "quickSightDatasetImportMode")
    """
    Quicksight dataset importMode indicates a value that indicates whether you want to import the data into SPICE
    """
    QUICK_SIGHT_DATASET_COLUMN_COUNT: ClassVar[NumericField] = NumericField("quickSightDatasetColumnCount", "quickSightDatasetColumnCount")
    """
    ...
    TBC
    """
    QUICK_SIGHT_DATASET_FIELDS: ClassVar[RelationField] = RelationField("quickSightDatasetFields")
    """
    TBC
    """
    ...
    def quick_sight_dataset_import_mode(self)->Optional[QuickSightDatasetImportMode]:
        return None if self.attributes is None else self.attributes.quick_sight_dataset_import_mode

    @quick_sight_dataset_import_mode.setter
    def quick_sight_dataset_import_mode(self, quick_sight_dataset_import_mode:Optional[QuickSightDatasetImportMode]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.quick_sight_dataset_import_mode = quick_sight_dataset_import_mode
    @property
    def quick_sight_dataset_column_count(self)->Optional[int]:
        return None if self.attributes is None else self.attributes.quick_sight_dataset_column_count

    @quick_sight_dataset_column_count.setter
    def quick_sight_dataset_column_count(self, quick_sight_dataset_column_count:Optional[int]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def quick_sight_dataset_folders(self)->Optional[list[QuickSightFolder]]:
        return None if self.attributes is None else self.attributes.quick_sight_dataset_folders

    @quick_sight_dataset_folders.setter
    def quick_sight_dataset_folders(self, quick_sight_dataset_folders:Optional[list[QuickSightFolder]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def quick_sight_dataset_fields(self)->Optional[list[QuickSightDatasetField]]:
        return None if self.attributes is None else self.attributes.quick_sight_dataset_fields

    @quick_sight_dataset_fields.setter
    def quick_sight_dataset_fields(self, quick_sight_dataset_fields:Optional[list[QuickSightDatasetField]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.quick_sight_dataset_fields = quick_sight_dataset_fields

    class Attributes(QuickSight.Attributes):
        quick_sight_dataset_import_mode: Optional[QuickSightDatasetImportMode] = Field(None, description='' , alias='quickSightDatasetImportMode')
        quick_sight_dataset_column_count: Optional[int] = Field(None, description='' , alias='quickSightDatasetColumnCount')
        quick_sight_dataset_folders: Optional[list[QuickSightFolder]]= Field(None, description='',  alias='quickSightDatasetFolders') # relationship
        quick_sight_dataset_fields: Optional[list[QuickSightDatasetField]]= Field(None, description='',  alias='quickSightDatasetFields') # relationship
