...
class ThoughtspotLiveboard(Thoughtspot):
    ...
    class Attributes(Thoughtspot.Attributes):
        thoughtspot_dashlets: Optional[list[ThoughtspotDashlet]]= Field(None, description='',  alias='thoughtspotDashlets') # relationship
...
class ThoughtspotDashlet(Thoughtspot):
    ...
    THOUGHTSPOT_LIVEBOARD_NAME: ClassVar[KeywordTextField] = KeywordTextField("thoughtspotLiveboardName", "thoughtspotLiveboardName.keyword", "thoughtspotLiveboardName")
    """
    TBC
    """
    THOUGHTSPOT_LIVEBOARD_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("thoughtspotLiveboardQualifiedName", "thoughtspotLiveboardQualifiedName", "thoughtspotLiveboardQualifiedName.text")
    """
    TBC
    """
    ...
    class Attributes(Thoughtspot.Attributes):
        thoughtspot_liveboard_name: Optional[str] = Field(None, description='' , alias='thoughtspotLiveboardName')
        thoughtspot_liveboard_qualified_name: Optional[str] = Field(None, description='' , alias='thoughtspotLiveboardQualifiedName')
        thoughtspot_liveboard: Optional[ThoughtspotLiveboard]= Field(None, description='',  alias='thoughtspotLiveboard') # relationship
