...
class GCSObject(GCS):
    ...
    GCS_BUCKET_NAME: ClassVar[KeywordTextField] = KeywordTextField("gcsBucketName", "gcsBucketName.keyword", "gcsBucketName")
    """
    TBC
    """
    GCS_BUCKET_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("gcsBucketQualifiedName", "gcsBucketQualifiedName", "gcsBucketQualifiedName.text")
    """
    TBC
    """
    ...
    TBC
    """
    GCS_OBJECT_MEDIA_LINK: ClassVar[KeywordTextField] = KeywordTextField("gcsObjectMediaLink", "gcsObjectMediaLink", "gcsObjectMediaLink.text")
    """
    TBC
    """
    ...
    TBC
    """
    GCS_OBJECT_DATA_LAST_MODIFIED_TIME: ClassVar[NumericField] = NumericField("gcsObjectDataLastModifiedTime", "gcsObjectDataLastModifiedTime")
    """
    TBC
    """
    ...
    TBC
    """
    GCS_OBJECT_CONTENT_ENCODING: ClassVar[KeywordField] = KeywordField("gcsObjectContentEncoding", "gcsObjectContentEncoding")
    """
    TBC
    """
    GCS_OBJECT_CONTENT_DISPOSITION: ClassVar[KeywordField] = KeywordField("gcsObjectContentDisposition", "gcsObjectContentDisposition")
    """
    TBC
    """
    GCS_OBJECT_CONTENT_LANGUAGE: ClassVar[KeywordField] = KeywordField("gcsObjectContentLanguage", "gcsObjectContentLanguage")
    """
    TBC
    """
    GCS_OBJECT_RETENTION_EXPIRATION_DATE: ClassVar[NumericField] = NumericField("gcsObjectRetentionExpirationDate", "gcsObjectRetentionExpirationDate")
    """
    TBC
    """
    ...
    class Attributes(GCS.Attributes):
        gcs_bucket_name: Optional[str] = Field(None, description='' , alias='gcsBucketName')
        gcs_bucket_qualified_name: Optional[str] = Field(None, description='' , alias='gcsBucketQualifiedName')
        gcs_object_size: Optional[int] = Field(None, description='' , alias='gcsObjectSize')
        gcs_object_key: Optional[str] = Field(None, description='' , alias='gcsObjectKey')
        gcs_object_media_link: Optional[str] = Field(None, description='' , alias='gcsObjectMediaLink')
        gcs_object_hold_type: Optional[str] = Field(None, description='' , alias='gcsObjectHoldType')
        gcs_object_generation_id: Optional[int] = Field(None, description='' , alias='gcsObjectGenerationId')
        gcs_object_c_r_c32_c_hash: Optional[str] = Field(None, description='' , alias='gcsObjectCRC32CHash')
        gcs_object_m_d5_hash: Optional[str] = Field(None, description='' , alias='gcsObjectMD5Hash')
        gcs_object_data_last_modified_time: Optional[datetime] = Field(None, description='' , alias='gcsObjectDataLastModifiedTime')
        gcs_object_content_type: Optional[str] = Field(None, description='' , alias='gcsObjectContentType')
        gcs_object_content_encoding: Optional[str] = Field(None, description='' , alias='gcsObjectContentEncoding')
        gcs_object_content_disposition: Optional[str] = Field(None, description='' , alias='gcsObjectContentDisposition')
        gcs_object_content_language: Optional[str] = Field(None, description='' , alias='gcsObjectContentLanguage')
        gcs_object_retention_expiration_date: Optional[datetime] = Field(None, description='' , alias='gcsObjectRetentionExpirationDate')
        gcs_bucket: Optional[GCSBucket]= Field(None, description='',  alias='gcsBucket') # relationship
...
class GCSBucket(GCS):
    ...
    TBC
    """
    GCS_BUCKET_VERSIONING_ENABLED: ClassVar[BooleanField] = BooleanField("gcsBucketVersioningEnabled", "gcsBucketVersioningEnabled")
    """
    TBC
    """
    GCS_BUCKET_RETENTION_LOCKED: ClassVar[BooleanField] = BooleanField("gcsBucketRetentionLocked", "gcsBucketRetentionLocked")
    """
    TBC
    """
    GCS_BUCKET_RETENTION_PERIOD: ClassVar[NumericField] = NumericField("gcsBucketRetentionPeriod", "gcsBucketRetentionPeriod")
    """
    TBC
    """
    GCS_BUCKET_RETENTION_EFFECTIVE_TIME: ClassVar[NumericField] = NumericField("gcsBucketRetentionEffectiveTime", "gcsBucketRetentionEffectiveTime")
    """
    TBC
    """
    ...
    class Attributes(GCS.Attributes):
        gcs_object_count: Optional[int] = Field(None, description='' , alias='gcsObjectCount')
        gcs_bucket_versioning_enabled: Optional[bool] = Field(None, description='' , alias='gcsBucketVersioningEnabled')
        gcs_bucket_retention_locked: Optional[bool] = Field(None, description='' , alias='gcsBucketRetentionLocked')
        gcs_bucket_retention_period: Optional[int] = Field(None, description='' , alias='gcsBucketRetentionPeriod')
        gcs_bucket_retention_effective_time: Optional[datetime] = Field(None, description='' , alias='gcsBucketRetentionEffectiveTime')
        gcs_bucket_lifecycle_rules: Optional[str] = Field(None, description='' , alias='gcsBucketLifecycleRules')
        gcs_bucket_retention_policy: Optional[str] = Field(None, description='' , alias='gcsBucketRetentionPolicy')
        gcs_objects: Optional[list[GCSObject]]= Field(None, description='',  alias='gcsObjects') # relationship
