...
class ADLSObject(ADLS):
    ...
    def create(
        ...
        *,
        ...
        return cls.creator(name=name, adls_container_qualified_name=adls_container_qualified_name)
    ...
    class Attributes(ADLS.Attributes):
        ...
        adls_object_access_tier: Optional[ADLSAccessTier] = Field(default=None, description="")
        adls_object_access_tier_last_modified_time: Optional[datetime] = Field(default=None, description="")
        adls_object_archive_status: Optional[ADLSObjectArchiveStatus] = Field(default=None, description="")
        adls_object_server_encrypted: Optional[bool] = Field(default=None, description="")
        adls_object_version_level_immutability_support: Optional[bool] = Field(default=None, description="")
        ...
        adls_object_content_m_d5_hash: Optional[str] = Field(default=None, description="")
        adls_object_content_language: Optional[str] = Field(default=None, description="")
        adls_object_lease_status: Optional[ADLSLeaseStatus] = Field(default=None, description="")
        adls_object_lease_state: Optional[ADLSLeaseState] = Field(default=None, description="")
        adls_object_metadata: Optional[Dict[str, str]] = Field(default=None, description="")
        adls_container_qualified_name: Optional[str] = Field(default=None, description="")
        adls_container_name: Optional[str] = Field(default=None, description="")
        adls_container: Optional[ADLSContainer] = Field(default=None, description="")  # relationship
        ...
        def create(
            ...
            *,
            ...
            adls_account_qualified_name = adls_account_qualified_name or get_parent_qualified_name(
                adls_container_qualified_name
            )
            return ADLSObject.Attributes(
                ...
                adls_container=ADLSContainer.ref_by_qualified_name(adls_container_qualified_name),
                adls_account_qualified_name=adls_account_qualified_name,
