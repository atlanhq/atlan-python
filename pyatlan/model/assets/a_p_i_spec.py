...
class APISpec(API):
    ...
    def creator(cls, *, name: str, connection_qualified_name: str) -> APISpec:
        ...
        attributes = APISpec.Attributes.create(name=name, connection_qualified_name=connection_qualified_name)
    ...
    class Attributes(API.Attributes):
        api_spec_terms_of_service_url: Optional[str] = Field(default=None, description="")
        ...
        api_paths: Optional[List[APIPath]] = Field(default=None, description="")  # relationship

        @classmethod
        @init_guid
        def create(cls, *, name: str, connection_qualified_name: str) -> APISpec.Attributes:
            validate_required_fields(["name", "connection_qualified_name"], [name, connection_qualified_name])
