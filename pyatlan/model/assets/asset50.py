...
class Qlik(BI):
    ...
    """
    QLIK_SPACE_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("qlikSpaceQualifiedName", "qlikSpaceQualifiedName", "qlikSpaceQualifiedName.text")
    """
    ...
    """
    QLIK_APP_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("qlikAppQualifiedName", "qlikAppQualifiedName", "qlikAppQualifiedName.text")
    """
    ...
    class Attributes(BI.Attributes):
        ...
        qlik_space_qualified_name: Optional[str] = Field(None, description='' , alias='qlikSpaceQualifiedName')
        qlik_app_id: Optional[str] = Field(None, description='' , alias='qlikAppId')
        qlik_app_qualified_name: Optional[str] = Field(None, description='' , alias='qlikAppQualifiedName')
        qlik_owner_id: Optional[str] = Field(None, description='' , alias='qlikOwnerId')
        qlik_is_published: Optional[bool] = Field(None, description='' , alias='qlikIsPublished')
