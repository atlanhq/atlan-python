...
class ADLS(ObjectStore):
    ...
    ADLS_ACCOUNT_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("adlsAccountQualifiedName", "adlsAccountQualifiedName", "adlsAccountQualifiedName.text")
    """
    TBC
    """
    AZURE_RESOURCE_ID: ClassVar[KeywordTextField] = KeywordTextField("azureResourceId", "azureResourceId", "azureResourceId.text")
    """
    TBC
    """
    ...
    TBC
    """
    ADLS_ACCOUNT_SECONDARY_LOCATION: ClassVar[KeywordField] = KeywordField("adlsAccountSecondaryLocation", "adlsAccountSecondaryLocation")
    """
    TBC
    """
    ...
    def adls_account_qualified_name(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.adls_account_qualified_name
    ...
    class Attributes(ObjectStore.Attributes):
        adls_account_qualified_name: Optional[str] = Field(None, description='' , alias='adlsAccountQualifiedName')
        azure_resource_id: Optional[str] = Field(None, description='' , alias='azureResourceId')
        azure_location: Optional[str] = Field(None, description='' , alias='azureLocation')
        adls_account_secondary_location: Optional[str] = Field(None, description='' , alias='adlsAccountSecondaryLocation')
        azure_tags: Optional[list[AzureTag]] = Field(None, description='' , alias='azureTags')
