...
class AuthPolicy(Asset, type_name='AuthPolicy'):
    ...
    TBC
    """
    POLICY_RESOURCE_SIGNATURE: ClassVar[KeywordField] = KeywordField("policyResourceSignature", "policyResourceSignature")
    """
    TBC
    """
    ...
    class Attributes(Asset.Attributes):
        policy_type: Optional[AuthPolicyType] = Field(None, description='' , alias='policyType')
        policy_service_name: Optional[str] = Field(None, description='' , alias='policyServiceName')
        policy_category: Optional[str] = Field(None, description='' , alias='policyCategory')
        policy_sub_category: Optional[str] = Field(None, description='' , alias='policySubCategory')
        policy_users: Optional[set[str]] = Field(None, description='' , alias='policyUsers')
        policy_groups: Optional[set[str]] = Field(None, description='' , alias='policyGroups')
        policy_roles: Optional[set[str]] = Field(None, description='' , alias='policyRoles')
        policy_actions: Optional[set[str]] = Field(None, description='' , alias='policyActions')
        policy_resources: Optional[set[str]] = Field(None, description='' , alias='policyResources')
        policy_resource_category: Optional[str] = Field(None, description='' , alias='policyResourceCategory')
        policy_priority: Optional[int] = Field(None, description='' , alias='policyPriority')
        is_policy_enabled: Optional[bool] = Field(None, description='' , alias='isPolicyEnabled')
        policy_mask_type: Optional[str] = Field(None, description='' , alias='policyMaskType')
        policy_validity_schedule: Optional[list[AuthPolicyValiditySchedule]] = Field(None, description='' , alias='policyValiditySchedule')
        policy_resource_signature: Optional[str] = Field(None, description='' , alias='policyResourceSignature')
        policy_delegate_admin: Optional[bool] = Field(None, description='' , alias='policyDelegateAdmin')
        policy_conditions: Optional[list[AuthPolicyCondition]] = Field(None, description='' , alias='policyConditions')
        access_control: Optional[AccessControl]= Field(None, description='',  alias='accessControl') # relationship
...
class AccessControl(Asset, type_name='AccessControl'):
    ...
    TBC
    """
    DENY_CUSTOM_METADATA_GUIDS: ClassVar[KeywordField] = KeywordField("denyCustomMetadataGuids", "denyCustomMetadataGuids")
    """
    TBC
    """
    ...
    TBC
    """
    DENY_ASSET_FILTERS: ClassVar[KeywordField] = KeywordField("denyAssetFilters", "denyAssetFilters")
    """
    TBC
    """
    ...
    class Attributes(Asset.Attributes):
        is_access_control_enabled: Optional[bool] = Field(None, description='' , alias='isAccessControlEnabled')
        deny_custom_metadata_guids: Optional[set[str]] = Field(None, description='' , alias='denyCustomMetadataGuids')
        deny_asset_tabs: Optional[set[str]] = Field(None, description='' , alias='denyAssetTabs')
        deny_asset_filters: Optional[set[str]] = Field(None, description='' , alias='denyAssetFilters')
        channel_link: Optional[str] = Field(None, description='' , alias='channelLink')
        policies: Optional[list[AuthPolicy]]= Field(None, description='',  alias='policies') # relationship
