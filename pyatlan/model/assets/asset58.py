...
class S3Bucket(S3):
    ...
    TBC
    """
    S3BUCKET_VERSIONING_ENABLED: ClassVar[BooleanField] = BooleanField("s3BucketVersioningEnabled", "s3BucketVersioningEnabled")
    """
    TBC
    """
    ...
    class Attributes(S3.Attributes):
        s3_object_count: Optional[int] = Field(None, description='' , alias='s3ObjectCount')
        s3_bucket_versioning_enabled: Optional[bool] = Field(None, description='' , alias='s3BucketVersioningEnabled')
        objects: Optional[list[S3Object]]= Field(None, description='',  alias='objects') # relationship
...
class S3Object(S3):
    ...
    S3OBJECT_LAST_MODIFIED_TIME: ClassVar[NumericField] = NumericField("s3ObjectLastModifiedTime", "s3ObjectLastModifiedTime")
    """
    TBC
    """
    ...
    TBC
    """
    S3OBJECT_CONTENT_DISPOSITION: ClassVar[KeywordField] = KeywordField("s3ObjectContentDisposition", "s3ObjectContentDisposition")
    """
    TBC
    """
    ...
    class Attributes(S3.Attributes):
        s3_object_last_modified_time: Optional[datetime] = Field(None, description='' , alias='s3ObjectLastModifiedTime')
        s3_bucket_name: Optional[str] = Field(None, description='' , alias='s3BucketName')
        s3_bucket_qualified_name: Optional[str] = Field(None, description='' , alias='s3BucketQualifiedName')
        s3_object_size: Optional[int] = Field(None, description='' , alias='s3ObjectSize')
        s3_object_storage_class: Optional[str] = Field(None, description='' , alias='s3ObjectStorageClass')
        s3_object_key: Optional[str] = Field(None, description='' , alias='s3ObjectKey')
        s3_object_content_type: Optional[str] = Field(None, description='' , alias='s3ObjectContentType')
        s3_object_content_disposition: Optional[str] = Field(None, description='' , alias='s3ObjectContentDisposition')
        s3_object_version_id: Optional[str] = Field(None, description='' , alias='s3ObjectVersionId')
        bucket: Optional[S3Bucket]= Field(None, description='',  alias='bucket') # relationship
