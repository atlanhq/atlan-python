...
class Domo(BI):
    ...
    type_name: str = Field("Domo", allow_mutation=False)
    ...
    class Attributes(BI.Attributes):
        domo_id: Optional[str] = Field(None, description="", alias="domoId")
        domo_owner_id: Optional[str] = Field(None, description="", alias="domoOwnerId")
