...
class RedashDashboard(Redash):
    ...
    REDASH_DASHBOARD_WIDGET_COUNT: ClassVar[NumericField] = NumericField("redashDashboardWidgetCount", "redashDashboardWidgetCount")
    """
    ...
    class Attributes(Redash.Attributes):
        redash_dashboard_widget_count: Optional[int] = Field(None, description='' , alias='redashDashboardWidgetCount')
