...
class DbtMeasure(Dbt):
    ...
    def validate_type_name(cls, v):
        if v != "DbtMeasure":
            raise ValueError("must be DbtMeasure")
        return v

    def __setattr__(self, name, value):
        if name in DbtMeasure._convenience_properties:
    ...
    attributes: DbtMeasure.Attributes = Field(
        default_factory=lambda: DbtMeasure.Attributes(),
        description=(
