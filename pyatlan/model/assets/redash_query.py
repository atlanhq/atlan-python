...
class RedashQuery(Redash):
    ...
    REDASH_QUERY_SQL: ClassVar[TextField] = TextField("redashQuerySQL", "redashQuerySQL")
    """
    SQL code of this query.
    """
    REDASH_QUERY_PARAMETERS: ClassVar[TextField] = TextField("redashQueryParameters", "redashQueryParameters")
    """
    ...
    class Attributes(Redash.Attributes):
        ...
        redash_query_schedule: Optional[Dict[str, str]] = Field(default=None, description="")
        redash_query_last_execution_runtime: Optional[float] = Field(default=None, description="")
        redash_query_last_executed_at: Optional[datetime] = Field(default=None, description="")
        redash_query_schedule_humanized: Optional[str] = Field(default=None, description="")
        redash_visualizations: Optional[List[RedashVisualization]] = Field(default=None, description="")  # relationship
