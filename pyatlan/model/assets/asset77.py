...
class SalesforceObject(Salesforce):
    ...
    class Attributes(Salesforce.Attributes):
        ...
        lookup_fields: Optional[list[SalesforceField]]= Field(None, description='',  alias='lookupFields') # relationship
        organization: Optional[SalesforceOrganization]= Field(None, description='',  alias='organization') # relationship
        fields: Optional[list[SalesforceField]]= Field(None, description='',  alias='fields') # relationship
...
class SalesforceField(Salesforce):
    ...
    TBC
    """
    PICKLIST_VALUES: ClassVar[KeywordField] = KeywordField("picklistValues", "picklistValues")
    """
    picklistValues is a list of values from which a user can pick from while adding a record
    """
    IS_POLYMORPHIC_FOREIGN_KEY: ClassVar[BooleanField] = BooleanField("isPolymorphicForeignKey", "isPolymorphicForeignKey")
    """
    isPolymorphicForeignKey captures whether the field references to record of multiple objects
    """
    DEFAULT_VALUE_FORMULA: ClassVar[KeywordField] = KeywordField("defaultValueFormula", "defaultValueFormula")
    """
    TBC
    """
    ...
    class Attributes(Salesforce.Attributes):
        ...
        object_qualified_name: Optional[str] = Field(None, description='' , alias='objectQualifiedName')
        order: Optional[int] = Field(None, description='' , alias='order')
        inline_help_text: Optional[str] = Field(None, description='' , alias='inlineHelpText')
        is_calculated: Optional[bool] = Field(None, description='' , alias='isCalculated')
        formula: Optional[str] = Field(None, description='' , alias='formula')
        is_case_sensitive: Optional[bool] = Field(None, description='' , alias='isCaseSensitive')
        ...
        picklist_values: Optional[set[str]] = Field(None, description='' , alias='picklistValues')
        is_polymorphic_foreign_key: Optional[bool] = Field(None, description='' , alias='isPolymorphicForeignKey')
        default_value_formula: Optional[str] = Field(None, description='' , alias='defaultValueFormula')
        lookup_objects: Optional[list[SalesforceObject]]= Field(None, description='',  alias='lookupObjects') # relationship
        object: Optional[SalesforceObject]= Field(None, description='',  alias='object') # relationship
...
class SalesforceOrganization(Salesforce):
    ...
    class Attributes(Salesforce.Attributes):
        ...
        reports: Optional[list[SalesforceReport]]= Field(None, description='',  alias='reports') # relationship
        objects: Optional[list[SalesforceObject]]= Field(None, description='',  alias='objects') # relationship
        dashboards: Optional[list[SalesforceDashboard]]= Field(None, description='',  alias='dashboards') # relationship
...
class SalesforceDashboard(Salesforce):
    ...
    """
    DASHBOARD_TYPE: ClassVar[KeywordField] = KeywordField("dashboardType", "dashboardType")
    """
    ...
    class Attributes(Salesforce.Attributes):
        source_id: Optional[str] = Field(None, description='' , alias='sourceId')
        dashboard_type: Optional[str] = Field(None, description='' , alias='dashboardType')
...
class SalesforceReport(Salesforce):
    ...
    class Attributes(Salesforce.Attributes):
        source_id: Optional[str] = Field(None, description='' , alias='sourceId')
        report_type: Optional[dict[str,str]] = Field(None, description='' , alias='reportType')
