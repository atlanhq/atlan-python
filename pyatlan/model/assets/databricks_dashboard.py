...
from pyatlan.model.enums import DatabricksDashboardLifecycleState
...
class DatabricksDashboard(BI):
    """Description"""

    type_name: str = Field(default="DatabricksDashboard", allow_mutation=False)

    @validator("type_name")
    def validate_type_name(cls, v):
        if v != "DatabricksDashboard":
            raise ValueError("must be DatabricksDashboard")
        return v

    def __setattr__(self, name, value):
        if name in DatabricksDashboard._convenience_properties:
            return object.__setattr__(self, name, value)
        super().__setattr__(name, value)

    DATABRICKS_DASHBOARD_PATH: ClassVar[KeywordField] = KeywordField(
    ...
    """  # noqa: E501
    DATABRICKS_DASHBOARD_WORKSPACE_ID: ClassVar[KeywordField] = KeywordField(
        "databricksDashboardWorkspaceId", "databricksDashboardWorkspaceId"
    )
    """
    Identifier of the workspace containing the dashboard.
    """
    DATABRICKS_DASHBOARD_WAREHOUSE_ID: ClassVar[KeywordField] = KeywordField(
        "databricksDashboardWarehouseId", "databricksDashboardWarehouseId"
    )
    """
    Identifier of the SQL warehouse backing the dashboard.
    """
    DATABRICKS_DASHBOARD_ETAG: ClassVar[KeywordField] = KeywordField(
        "databricksDashboardEtag", "databricksDashboardEtag"
    )
    """
    Entity tag used as a change token for the dashboard.
    """
    DATABRICKS_DASHBOARD_IS_GENIE_SPACE_ENABLED: ClassVar[BooleanField] = BooleanField(
        "databricksDashboardIsGenieSpaceEnabled",
        "databricksDashboardIsGenieSpaceEnabled",
    )
    """
    Whether a Genie space is enabled for the dashboard.
    """
    DATABRICKS_DASHBOARD_LIFECYCLE_STATE: ClassVar[KeywordField] = KeywordField(
    ...
    _convenience_properties: ClassVar[List[str]] = [
        "databricks_dashboard_path",
        "databricks_dashboard_workspace_id",
        "databricks_dashboard_warehouse_id",
        "databricks_dashboard_etag",
        "databricks_dashboard_is_genie_space_enabled",
        "databricks_dashboard_lifecycle_state",
    ...
    @property
    def databricks_dashboard_path(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.databricks_dashboard_path
        )

    @databricks_dashboard_path.setter
    def databricks_dashboard_path(self, databricks_dashboard_path: Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.databricks_dashboard_path = databricks_dashboard_path

    @property
    def databricks_dashboard_workspace_id(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.databricks_dashboard_workspace_id
        )

    @databricks_dashboard_workspace_id.setter
    def databricks_dashboard_workspace_id(
        self, databricks_dashboard_workspace_id: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.databricks_dashboard_workspace_id = (
            databricks_dashboard_workspace_id
        )

    @property
    def databricks_dashboard_warehouse_id(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.databricks_dashboard_warehouse_id
        )

    @databricks_dashboard_warehouse_id.setter
    def databricks_dashboard_warehouse_id(
        self, databricks_dashboard_warehouse_id: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.databricks_dashboard_warehouse_id = (
            databricks_dashboard_warehouse_id
        )

    @property
    def databricks_dashboard_etag(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.databricks_dashboard_etag
        )

    @databricks_dashboard_etag.setter
    def databricks_dashboard_etag(self, databricks_dashboard_etag: Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.databricks_dashboard_etag = databricks_dashboard_etag

    @property
    def databricks_dashboard_is_genie_space_enabled(self) -> Optional[bool]:
        return (
            None
            if self.attributes is None
            else self.attributes.databricks_dashboard_is_genie_space_enabled
        )

    @databricks_dashboard_is_genie_space_enabled.setter
    def databricks_dashboard_is_genie_space_enabled(
        self, databricks_dashboard_is_genie_space_enabled: Optional[bool]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.databricks_dashboard_is_genie_space_enabled = (
            databricks_dashboard_is_genie_space_enabled
        )

    @property
    def databricks_dashboard_lifecycle_state(
        self,
    ) -> Optional[DatabricksDashboardLifecycleState]:
        return (
            None
            if self.attributes is None
            else self.attributes.databricks_dashboard_lifecycle_state
        )

    @databricks_dashboard_lifecycle_state.setter
    def databricks_dashboard_lifecycle_state(
        self,
        databricks_dashboard_lifecycle_state: Optional[
            DatabricksDashboardLifecycleState
        ],
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.databricks_dashboard_lifecycle_state = (
            databricks_dashboard_lifecycle_state
        )
    ...
    class Attributes(BI.Attributes):
        databricks_dashboard_path: Optional[str] = Field(default=None, description="")
        databricks_dashboard_workspace_id: Optional[str] = Field(
            default=None, description=""
        )
        databricks_dashboard_warehouse_id: Optional[str] = Field(
            default=None, description=""
        )
        databricks_dashboard_etag: Optional[str] = Field(default=None, description="")
        databricks_dashboard_is_genie_space_enabled: Optional[bool] = Field(
            default=None, description=""
        )
        databricks_dashboard_lifecycle_state: Optional[
            DatabricksDashboardLifecycleState
    ...
    attributes: DatabricksDashboard.Attributes = Field(
        default_factory=lambda: DatabricksDashboard.Attributes(),
        description=(
...
DatabricksDashboard.Attributes.update_forward_refs()
