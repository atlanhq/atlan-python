...
class DbtColumnProcess(Dbt):
    ...
    DBT_COLUMN_PROCESS_JOB_STATUS: ClassVar[KeywordField] = KeywordField("dbtColumnProcessJobStatus", "dbtColumnProcessJobStatus")
    """
    TBC
    """
    ...
    class Attributes(Dbt.Attributes):
        dbt_column_process_job_status: Optional[str] = Field(None, description='' , alias='dbtColumnProcessJobStatus')
