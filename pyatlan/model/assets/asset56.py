...
class APISpec(API):
    ...
    API_SPEC_TERMS_OF_SERVICE_URL: ClassVar[KeywordTextField] = KeywordTextField("apiSpecTermsOfServiceURL", "apiSpecTermsOfServiceURL", "apiSpecTermsOfServiceURL.text")
    """
    TBC
    """
    API_SPEC_CONTACT_EMAIL: ClassVar[KeywordTextField] = KeywordTextField("apiSpecContactEmail", "apiSpecContactEmail", "apiSpecContactEmail.text")
    """
    TBC
    """
    API_SPEC_CONTACT_NAME: ClassVar[KeywordTextField] = KeywordTextField("apiSpecContactName", "apiSpecContactName.keyword", "apiSpecContactName")
    """
    TBC
    """
    API_SPEC_CONTACT_URL: ClassVar[KeywordTextField] = KeywordTextField("apiSpecContactURL", "apiSpecContactURL", "apiSpecContactURL.text")
    """
    TBC
    """
    API_SPEC_LICENSE_NAME: ClassVar[KeywordTextField] = KeywordTextField("apiSpecLicenseName", "apiSpecLicenseName.keyword", "apiSpecLicenseName")
    """
    TBC
    """
    API_SPEC_LICENSE_URL: ClassVar[KeywordTextField] = KeywordTextField("apiSpecLicenseURL", "apiSpecLicenseURL", "apiSpecLicenseURL.text")
    """
    TBC
    """
    API_SPEC_CONTRACT_VERSION: ClassVar[KeywordField] = KeywordField("apiSpecContractVersion", "apiSpecContractVersion")
    """
    TBC
    """
    API_SPEC_SERVICE_ALIAS: ClassVar[KeywordTextField] = KeywordTextField("apiSpecServiceAlias", "apiSpecServiceAlias", "apiSpecServiceAlias.text")
    """
    TBC
    """
    ...
    def api_spec_terms_of_service_url(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.api_spec_terms_of_service_url

    @api_spec_terms_of_service_url.setter
    def api_spec_terms_of_service_url(self, api_spec_terms_of_service_url:Optional[str]):
    ...
    def api_spec_contact_email(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.api_spec_contact_email
    ...
    def api_spec_contact_name(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.api_spec_contact_name
    ...
    def api_spec_license_name(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.api_spec_license_name
    ...
    def api_spec_contract_version(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.api_spec_contract_version
    ...
    def api_spec_service_alias(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.api_spec_service_alias
    ...
    class Attributes(API.Attributes):
        api_spec_terms_of_service_url: Optional[str] = Field(None, description='' , alias='apiSpecTermsOfServiceURL')
        api_spec_contact_email: Optional[str] = Field(None, description='' , alias='apiSpecContactEmail')
        api_spec_contact_name: Optional[str] = Field(None, description='' , alias='apiSpecContactName')
        api_spec_contact_url: Optional[str] = Field(None, description='' , alias='apiSpecContactURL')
        api_spec_license_name: Optional[str] = Field(None, description='' , alias='apiSpecLicenseName')
        api_spec_license_url: Optional[str] = Field(None, description='' , alias='apiSpecLicenseURL')
        api_spec_contract_version: Optional[str] = Field(None, description='' , alias='apiSpecContractVersion')
        api_spec_service_alias: Optional[str] = Field(None, description='' , alias='apiSpecServiceAlias')
        api_paths: Optional[list[APIPath]]= Field(None, description='',  alias='apiPaths') # relationship
...
class APIPath(API):
    ...
    TBC
    """
    API_PATH_RAW_URI: ClassVar[KeywordTextField] = KeywordTextField("apiPathRawURI", "apiPathRawURI", "apiPathRawURI.text")
    """
    TBC
    """
    ...
    TBC
    """
    API_PATH_AVAILABLE_OPERATIONS: ClassVar[KeywordField] = KeywordField("apiPathAvailableOperations", "apiPathAvailableOperations")
    """
    TBC
    """
    API_PATH_AVAILABLE_RESPONSE_CODES: ClassVar[KeywordField] = KeywordField("apiPathAvailableResponseCodes", "apiPathAvailableResponseCodes")
    """
    TBC
    """
    API_PATH_IS_INGRESS_EXPOSED: ClassVar[BooleanField] = BooleanField("apiPathIsIngressExposed", "apiPathIsIngressExposed")
    """
    TBC
    """
    ...
    class Attributes(API.Attributes):
        api_path_summary: Optional[str] = Field(None, description='' , alias='apiPathSummary')
        api_path_raw_u_r_i: Optional[str] = Field(None, description='' , alias='apiPathRawURI')
        api_path_is_templated: Optional[bool] = Field(None, description='' , alias='apiPathIsTemplated')
        api_path_available_operations: Optional[set[str]] = Field(None, description='' , alias='apiPathAvailableOperations')
        api_path_available_response_codes: Optional[dict[str,str]] = Field(None, description='' , alias='apiPathAvailableResponseCodes')
        api_path_is_ingress_exposed: Optional[bool] = Field(None, description='' , alias='apiPathIsIngressExposed')
        api_spec: Optional[APISpec]= Field(None, description='',  alias='apiSpec') # relationship
