...
class MongoDBCollection(Table):
    ...
    MONGO_DB_COLLECTION_SUBTYPE: ClassVar[KeywordTextField] = KeywordTextField("mongoDBCollectionSubtype", "mongoDBCollectionSubtype", "mongoDBCollectionSubtype.text")
    """
    Subtype of a MongoDB collection (e.g. Capped, Time Series etc.)
    """
    MONGO_DB_COLLECTION_IS_CAPPED: ClassVar[BooleanField] = BooleanField("mongoDBCollectionIsCapped", "mongoDBCollectionIsCapped")
    """
    If the collection is a capped collection
    """
    MONGO_DB_COLLECTION_TIME_FIELD: ClassVar[KeywordField] = KeywordField("mongoDBCollectionTimeField", "mongoDBCollectionTimeField")
    """
    The name of the field which contains the date in each time series document
    """
    MONGO_DB_COLLECTION_TIME_GRANULARITY: ClassVar[KeywordField] = KeywordField("mongoDBCollectionTimeGranularity", "mongoDBCollectionTimeGranularity")
    """
    Set the granularity to the value that is the closest match to the time span between consecutive incoming measurements
    """  # noqa: E501
    MONGO_DB_COLLECTION_EXPIRE_AFTER_SECONDS: ClassVar[NumericField] = NumericField("mongoDBCollectionExpireAfterSeconds", "mongoDBCollectionExpireAfterSeconds")
    """
    Specifies the seconds after which documents in a time series collection or clustered collection expire
    """
    MONGO_DB_COLLECTION_MAXIMUM_DOCUMENT_COUNT: ClassVar[NumericField] = NumericField("mongoDBCollectionMaximumDocumentCount", "mongoDBCollectionMaximumDocumentCount")
    """
    The maximum number of documents allowed in the capped collection
    """
    MONGO_DB_COLLECTION_MAX_SIZE: ClassVar[NumericField] = NumericField("mongoDBCollectionMaxSize", "mongoDBCollectionMaxSize")
    """
    The maximum size allowed in the capped collection
    """
    MONGO_DB_COLLECTION_NUM_ORPHAN_DOCS: ClassVar[NumericField] = NumericField("mongoDBCollectionNumOrphanDocs", "mongoDBCollectionNumOrphanDocs")
    """
    The number of orphaned documents in the collection
    """
    MONGO_DB_COLLECTION_NUM_INDEXES: ClassVar[NumericField] = NumericField("mongoDBCollectionNumIndexes", "mongoDBCollectionNumIndexes")
    """
    The number of indexes on the collection
    """
    MONGO_DB_COLLECTION_TOTAL_INDEX_SIZE: ClassVar[NumericField] = NumericField("mongoDBCollectionTotalIndexSize", "mongoDBCollectionTotalIndexSize")
    """
    The total size of all indexes
    """
    MONGO_DB_COLLECTION_AVERAGE_OBJECT_SIZE: ClassVar[NumericField] = NumericField("mongoDBCollectionAverageObjectSize", "mongoDBCollectionAverageObjectSize")
    """
    The average size of an object in the collection
    """
    MONGO_DB_COLLECTION_SCHEMA_DEFINITION: ClassVar[TextField] = TextField("mongoDBCollectionSchemaDefinition", "mongoDBCollectionSchemaDefinition")
    """
    ...
    class Attributes(Table.Attributes):
        mongo_d_b_collection_subtype: Optional[str] = Field(None, description='' , alias='mongoDBCollectionSubtype')
        mongo_d_b_collection_is_capped: Optional[bool] = Field(None, description='' , alias='mongoDBCollectionIsCapped')
        mongo_d_b_collection_time_field: Optional[str] = Field(None, description='' , alias='mongoDBCollectionTimeField')
        mongo_d_b_collection_time_granularity: Optional[str] = Field(None, description='' , alias='mongoDBCollectionTimeGranularity')
        mongo_d_b_collection_expire_after_seconds: Optional[int] = Field(None, description='' , alias='mongoDBCollectionExpireAfterSeconds')
        mongo_d_b_collection_maximum_document_count: Optional[int] = Field(None, description='' , alias='mongoDBCollectionMaximumDocumentCount')
        mongo_d_b_collection_max_size: Optional[int] = Field(None, description='' , alias='mongoDBCollectionMaxSize')
        mongo_d_b_collection_num_orphan_docs: Optional[int] = Field(None, description='' , alias='mongoDBCollectionNumOrphanDocs')
        mongo_d_b_collection_num_indexes: Optional[int] = Field(None, description='' , alias='mongoDBCollectionNumIndexes')
        mongo_d_b_collection_total_index_size: Optional[int] = Field(None, description='' , alias='mongoDBCollectionTotalIndexSize')
        mongo_d_b_collection_average_object_size: Optional[int] = Field(None, description='' , alias='mongoDBCollectionAverageObjectSize')
        mongo_d_b_collection_schema_definition: Optional[str] = Field(None, description='' , alias='mongoDBCollectionSchemaDefinition')
        ...
        mongo_d_b_database: Optional[MongoDBDatabase]= Field(None, description='',  alias='mongoDBDatabase') # relationship
...
class MongoDBDatabase(Database):
    ...
    MONGO_DB_DATABASE_COLLECTION_COUNT: ClassVar[NumericField] = NumericField("mongoDBDatabaseCollectionCount", "mongoDBDatabaseCollectionCount")
    """
    ...
    class Attributes(Database.Attributes):
        mongo_d_b_database_collection_count: Optional[int] = Field(None, description='' , alias='mongoDBDatabaseCollectionCount')
        ...
        is_profiled: Optional[bool] = Field(None, description='' , alias='isProfiled')
        last_profiled_at: Optional[datetime] = Field(None, description='' , alias='lastProfiledAt')
        mongo_d_b_collections: Optional[list[MongoDBCollection]]= Field(None, description='',  alias='mongoDBCollections') # relationship
