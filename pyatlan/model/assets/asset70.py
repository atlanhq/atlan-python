...
class MetabaseQuestion(Metabase):
    ...
    TBC
    """
    METABASE_QUERY_TYPE: ClassVar[KeywordTextField] = KeywordTextField("metabaseQueryType", "metabaseQueryType", "metabaseQueryType.text")
    """
    TBC
    """
    METABASE_QUERY: ClassVar[KeywordTextField] = KeywordTextField("metabaseQuery", "metabaseQuery.keyword", "metabaseQuery")
    """
    TBC
    """
    ...
    class Attributes(Metabase.Attributes):
        metabase_dashboard_count: Optional[int] = Field(None, description='' , alias='metabaseDashboardCount')
        metabase_query_type: Optional[str] = Field(None, description='' , alias='metabaseQueryType')
        metabase_query: Optional[str] = Field(None, description='' , alias='metabaseQuery')
        metabase_dashboards: Optional[list[MetabaseDashboard]]= Field(None, description='',  alias='metabaseDashboards') # relationship
        metabase_collection: Optional[MetabaseCollection]= Field(None, description='',  alias='metabaseCollection') # relationship
...
class MetabaseCollection(Metabase):
    ...
    TBC
    """
    METABASE_NAMESPACE: ClassVar[KeywordTextField] = KeywordTextField("metabaseNamespace", "metabaseNamespace", "metabaseNamespace.text")
    """
    TBC
    """
    METABASE_IS_PERSONAL_COLLECTION: ClassVar[BooleanField] = BooleanField("metabaseIsPersonalCollection", "metabaseIsPersonalCollection")
    """
    TBC
    """
    ...
    class Attributes(Metabase.Attributes):
        ...
        metabase_color: Optional[str] = Field(None, description='' , alias='metabaseColor')
        metabase_namespace: Optional[str] = Field(None, description='' , alias='metabaseNamespace')
        metabase_is_personal_collection: Optional[bool] = Field(None, description='' , alias='metabaseIsPersonalCollection')
        metabase_dashboards: Optional[list[MetabaseDashboard]]= Field(None, description='',  alias='metabaseDashboards') # relationship
        metabase_questions: Optional[list[MetabaseQuestion]]= Field(None, description='',  alias='metabaseQuestions') # relationship
...
class MetabaseDashboard(Metabase):
    ...
    class Attributes(Metabase.Attributes):
        metabase_question_count: Optional[int] = Field(None, description='' , alias='metabaseQuestionCount')
        metabase_questions: Optional[list[MetabaseQuestion]]= Field(None, description='',  alias='metabaseQuestions') # relationship
        metabase_collection: Optional[MetabaseCollection]= Field(None, description='',  alias='metabaseCollection') # relationship
