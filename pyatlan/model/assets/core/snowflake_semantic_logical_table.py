...
class SnowflakeSemanticLogicalTable(SemanticEntity):
    """Description"""

    type_name: str = Field(
        default="SnowflakeSemanticLogicalTable", allow_mutation=False
    )

    @validator("type_name")
    def validate_type_name(cls, v):
        if v != "SnowflakeSemanticLogicalTable":
            raise ValueError("must be SnowflakeSemanticLogicalTable")
        return v

    def __setattr__(self, name, value):
        if name in SnowflakeSemanticLogicalTable._convenience_properties:
    ...
    """
    SNOWFLAKE_SEMANTIC_TABLE_PRIMARY_KEYS: ClassVar[KeywordField] = KeywordField(
    ...
    """
    SNOWFLAKE_SEMANTIC_TABLE_UNIQUE_KEYS: ClassVar[KeywordField] = KeywordField(
        "snowflakeSemanticTableUniqueKeys", "snowflakeSemanticTableUniqueKeys"
    )
    """
    Unique key columns for the logical table.
    """
    SNOWFLAKE_SEMANTIC_TABLE_DISTINCT_RANGES: ClassVar[KeywordField] = KeywordField(
    ...
    TBC
    """
    SNOWFLAKE_BASE_TABLE: ClassVar[RelationField] = RelationField("snowflakeBaseTable")
    """
    TBC
    """
    ...
    TBC
    """
    SNOWFLAKE_SEMANTIC_FACTS: ClassVar[RelationField] = RelationField(
    ...
    _convenience_properties: ClassVar[List[str]] = [
        ...
        "snowflake_semantic_table_primary_keys",
        "snowflake_semantic_table_unique_keys",
    ...
    @property
    def snowflake_semantic_table_primary_keys(self) -> Optional[Set[str]]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_semantic_table_primary_keys
        )

    @snowflake_semantic_table_primary_keys.setter
    def snowflake_semantic_table_primary_keys(
        self, snowflake_semantic_table_primary_keys: Optional[Set[str]]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_semantic_table_primary_keys = (
            snowflake_semantic_table_primary_keys
        )

    @property
    def snowflake_semantic_table_unique_keys(self) -> Optional[Set[str]]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_semantic_table_unique_keys
        )

    @snowflake_semantic_table_unique_keys.setter
    def snowflake_semantic_table_unique_keys(
        self, snowflake_semantic_table_unique_keys: Optional[Set[str]]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_semantic_table_unique_keys = (
            snowflake_semantic_table_unique_keys
        )

    @property
    def snowflake_semantic_table_distinct_ranges(self) -> Optional[Set[str]]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_semantic_table_distinct_ranges
        )

    @snowflake_semantic_table_distinct_ranges.setter
    def snowflake_semantic_table_distinct_ranges(
        self, snowflake_semantic_table_distinct_ranges: Optional[Set[str]]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_semantic_table_distinct_ranges = (
            snowflake_semantic_table_distinct_ranges
        )
    ...
    def snowflake_semantic_metrics(self) -> Optional[List[SnowflakeSemanticMetric]]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_semantic_metrics
        )

    @snowflake_semantic_metrics.setter
    def snowflake_semantic_metrics(
        self, snowflake_semantic_metrics: Optional[List[SnowflakeSemanticMetric]]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_semantic_metrics = snowflake_semantic_metrics
    ...
    def snowflake_base_table(self) -> Optional[SQL]:
        return None if self.attributes is None else self.attributes.snowflake_base_table

    @snowflake_base_table.setter
    def snowflake_base_table(self, snowflake_base_table: Optional[SQL]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    def snowflake_semantic_dimensions(
        ...
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_semantic_dimensions
        )

    @snowflake_semantic_dimensions.setter
    def snowflake_semantic_dimensions(
        self, snowflake_semantic_dimensions: Optional[List[SnowflakeSemanticDimension]]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_semantic_dimensions = snowflake_semantic_dimensions

    @property
    def snowflake_semantic_facts(self) -> Optional[List[SnowflakeSemanticFact]]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_semantic_facts
        )

    @snowflake_semantic_facts.setter
    def snowflake_semantic_facts(
        self, snowflake_semantic_facts: Optional[List[SnowflakeSemanticFact]]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_semantic_facts = snowflake_semantic_facts
    ...
    def snowflake_semantic_view(
        self, snowflake_semantic_view: Optional[SnowflakeSemanticView]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    class Attributes(SemanticEntity.Attributes):
        ...
        snowflake_semantic_table_primary_keys: Optional[Set[str]] = Field(
            default=None, description=""
        )
        snowflake_semantic_table_unique_keys: Optional[Set[str]] = Field(
            default=None, description=""
        )
        snowflake_semantic_table_distinct_ranges: Optional[Set[str]] = Field(
            default=None, description=""
        )
        ...
        snowflake_semantic_facts: Optional[List[SnowflakeSemanticFact]] = Field(
            default=None, description=""
        )  # relationship
    ...
    attributes: SnowflakeSemanticLogicalTable.Attributes = Field(
        default_factory=lambda: SnowflakeSemanticLogicalTable.Attributes(),
        description=(
...
from .snowflake_semantic_dimension import SnowflakeSemanticDimension  # noqa: E402, F401
