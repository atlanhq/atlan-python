...
class AdfDataset(ADF):
    ...
    ADF_DATASET_TYPE: ClassVar[KeywordField] = KeywordField("adfDatasetType", "adfDatasetType")
    """
    Defines the type of the dataset.
    """
    ADF_DATASET_ANNOTATIONS: ClassVar[TextField] = TextField("adfDatasetAnnotations", "adfDatasetAnnotations")
    """
    ...
    """
    ADF_DATASET_COLLECTION_NAME: ClassVar[TextField] = TextField("adfDatasetCollectionName", "adfDatasetCollectionName")
    """
    Defines the name collection in the cosmos dataset.
    """
    ADF_DATASET_STORAGE_TYPE: ClassVar[TextField] = TextField("adfDatasetStorageType", "adfDatasetStorageType")
    """
    Defines the storage type of storage file system dataset.
    """
    ADF_DATASET_FILE_NAME: ClassVar[TextField] = TextField("adfDatasetFileName", "adfDatasetFileName")
    """
    ...
    """
    ADF_DATASET_CONTAINER_NAME: ClassVar[TextField] = TextField("adfDatasetContainerName", "adfDatasetContainerName")
    """
    Defines the container or bucket name in the storage file system dataset.
    """
    ADF_DATASET_SCHEMA_NAME: ClassVar[TextField] = TextField("adfDatasetSchemaName", "adfDatasetSchemaName")
    """
    ...
    """
    ADF_DATASET_DATABASE_NAME: ClassVar[TextField] = TextField("adfDatasetDatabaseName", "adfDatasetDatabaseName")
    """
    ...
    def adf_dataset_annotations(self) -> Optional[Set[str]]:
        return None if self.attributes is None else self.attributes.adf_dataset_annotations
    ...
    def adf_dataset_linked_service(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.adf_dataset_linked_service
    ...
    def adf_dataset_collection_name(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.adf_dataset_collection_name
    ...
    def adf_dataset_storage_type(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.adf_dataset_storage_type
    ...
    def adf_dataset_file_name(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.adf_dataset_file_name
    ...
    def adf_dataset_file_folder_path(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.adf_dataset_file_folder_path
    ...
    def adf_dataset_container_name(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.adf_dataset_container_name
    ...
    def adf_dataset_schema_name(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.adf_dataset_schema_name
    ...
    def adf_dataset_table_name(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.adf_dataset_table_name
    ...
    def adf_dataset_database_name(self) -> Optional[str]:
        return None if self.attributes is None else self.attributes.adf_dataset_database_name
    ...
    class Attributes(ADF.Attributes):
        ...
        adf_dataset_annotations: Optional[Set[str]] = Field(default=None, description="")
        ...
        adf_dataset_file_folder_path: Optional[str] = Field(default=None, description="")
        ...
        adf_linkedservice: Optional[AdfLinkedservice] = Field(default=None, description="")  # relationship
