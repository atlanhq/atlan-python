...
class SnowflakeV1CortexAgent(Snowflake):
    """Description"""

    type_name: str = Field(default="SnowflakeV1CortexAgent", allow_mutation=False)

    @validator("type_name")
    def validate_type_name(cls, v):
        if v != "SnowflakeV1CortexAgent":
            raise ValueError("must be SnowflakeV1CortexAgent")
        return v

    def __setattr__(self, name, value):
        if name in SnowflakeV1CortexAgent._convenience_properties:
            return object.__setattr__(self, name, value)
        super().__setattr__(name, value)

    SNOWFLAKE_V1CORTEX_AGENT_ORCHESTRATION_MODEL: ClassVar[KeywordField] = KeywordField(
        "snowflakeV1CortexAgentOrchestrationModel",
        "snowflakeV1CortexAgentOrchestrationModel",
    )
    """
    Name of the LLM used by this agent for orchestration (for example, claude-3-5-sonnet, llama3.1-70b).
    """
    SNOWFLAKE_V1CORTEX_AGENT_RESPONSE_INSTRUCTIONS: ClassVar[KeywordField] = (
        KeywordField(
            "snowflakeV1CortexAgentResponseInstructions",
            "snowflakeV1CortexAgentResponseInstructions",
        )
    )
    """
    Instructions that govern how this agent formats and presents responses to end users.
    """
    SNOWFLAKE_V1CORTEX_AGENT_ORCHESTRATION_INSTRUCTIONS: ClassVar[KeywordField] = (
        KeywordField(
            "snowflakeV1CortexAgentOrchestrationInstructions",
            "snowflakeV1CortexAgentOrchestrationInstructions",
        )
    )
    """
    Instructions that govern how this agent plans, decomposes, and routes user questions across its tools.
    """
    SNOWFLAKE_V1CORTEX_AGENT_BUDGET_TIME_SECONDS: ClassVar[NumericField] = NumericField(
        "snowflakeV1CortexAgentBudgetTimeSeconds",
        "snowflakeV1CortexAgentBudgetTimeSeconds",
    )
    """
    Per-invocation wall-clock budget for this agent in seconds. Invocations exceeding this budget are terminated.
    """
    SNOWFLAKE_V1CORTEX_AGENT_BUDGET_TOKENS: ClassVar[NumericField] = NumericField(
        "snowflakeV1CortexAgentBudgetTokens", "snowflakeV1CortexAgentBudgetTokens"
    )
    """
    Per-invocation token budget for this agent. Invocations exceeding this budget are terminated.
    """
    SNOWFLAKE_V1CORTEX_AGENT_LAST_USED_AT: ClassVar[NumericField] = NumericField(
        "snowflakeV1CortexAgentLastUsedAt", "snowflakeV1CortexAgentLastUsedAt"
    )
    """
    Time (epoch) at which this agent was most recently invoked, in milliseconds.
    """
    SNOWFLAKE_V1CORTEX_AGENT_TOTAL_INVOCATION_COUNT: ClassVar[NumericField] = (
        NumericField(
            "snowflakeV1CortexAgentTotalInvocationCount",
            "snowflakeV1CortexAgentTotalInvocationCount",
        )
    )
    """
    Total number of invocations of this agent observed in Snowflake usage history.
    """
    SNOWFLAKE_V1CORTEX_AGENT_LAST_USED_BY: ClassVar[KeywordField] = KeywordField(
        "snowflakeV1CortexAgentLastUsedBy", "snowflakeV1CortexAgentLastUsedBy"
    )
    """
    Snowflake user who most recently invoked this agent.
    """
    ...
    TBC
    """
    SNOWFLAKE_CORTEX_AGENT_SKILLS: ClassVar[RelationField] = RelationField(
        "snowflakeCortexAgentSkills"
    )
    """
    TBC
    """
    SNOWFLAKE_CORTEX_AGENT_SCHEMA: ClassVar[RelationField] = RelationField(
        "snowflakeCortexAgentSchema"
    )
    """
    TBC
    """
    ...
    _convenience_properties: ClassVar[List[str]] = [
        "snowflake_v1_cortex_agent_orchestration_model",
        "snowflake_v1_cortex_agent_response_instructions",
        "snowflake_v1_cortex_agent_orchestration_instructions",
        "snowflake_v1_cortex_agent_budget_time_seconds",
        "snowflake_v1_cortex_agent_budget_tokens",
        "snowflake_v1_cortex_agent_last_used_at",
        "snowflake_v1_cortex_agent_total_invocation_count",
        "snowflake_v1_cortex_agent_last_used_by",
        "query_count",
        "query_user_count",
        "query_user_map",
        ...
        "snowflake_cortex_agent_skills",
        "snowflake_cortex_agent_schema",
    ]

    @property
    def snowflake_v1_cortex_agent_orchestration_model(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_orchestration_model
        )

    @snowflake_v1_cortex_agent_orchestration_model.setter
    def snowflake_v1_cortex_agent_orchestration_model(
        self, snowflake_v1_cortex_agent_orchestration_model: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_orchestration_model = (
            snowflake_v1_cortex_agent_orchestration_model
        )

    @property
    def snowflake_v1_cortex_agent_response_instructions(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_response_instructions
        )

    @snowflake_v1_cortex_agent_response_instructions.setter
    def snowflake_v1_cortex_agent_response_instructions(
        self, snowflake_v1_cortex_agent_response_instructions: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_response_instructions = (
            snowflake_v1_cortex_agent_response_instructions
        )

    @property
    def snowflake_v1_cortex_agent_orchestration_instructions(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_orchestration_instructions
        )

    @snowflake_v1_cortex_agent_orchestration_instructions.setter
    def snowflake_v1_cortex_agent_orchestration_instructions(
        self, snowflake_v1_cortex_agent_orchestration_instructions: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_orchestration_instructions = (
            snowflake_v1_cortex_agent_orchestration_instructions
        )

    @property
    def snowflake_v1_cortex_agent_budget_time_seconds(self) -> Optional[int]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_budget_time_seconds
        )

    @snowflake_v1_cortex_agent_budget_time_seconds.setter
    def snowflake_v1_cortex_agent_budget_time_seconds(
        self, snowflake_v1_cortex_agent_budget_time_seconds: Optional[int]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_budget_time_seconds = (
            snowflake_v1_cortex_agent_budget_time_seconds
        )

    @property
    def snowflake_v1_cortex_agent_budget_tokens(self) -> Optional[int]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_budget_tokens
        )

    @snowflake_v1_cortex_agent_budget_tokens.setter
    def snowflake_v1_cortex_agent_budget_tokens(
        self, snowflake_v1_cortex_agent_budget_tokens: Optional[int]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_budget_tokens = (
            snowflake_v1_cortex_agent_budget_tokens
        )

    @property
    def snowflake_v1_cortex_agent_last_used_at(self) -> Optional[datetime]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_last_used_at
        )

    @snowflake_v1_cortex_agent_last_used_at.setter
    def snowflake_v1_cortex_agent_last_used_at(
        self, snowflake_v1_cortex_agent_last_used_at: Optional[datetime]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_last_used_at = (
            snowflake_v1_cortex_agent_last_used_at
        )

    @property
    def snowflake_v1_cortex_agent_total_invocation_count(self) -> Optional[int]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_total_invocation_count
        )

    @snowflake_v1_cortex_agent_total_invocation_count.setter
    def snowflake_v1_cortex_agent_total_invocation_count(
        self, snowflake_v1_cortex_agent_total_invocation_count: Optional[int]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_total_invocation_count = (
            snowflake_v1_cortex_agent_total_invocation_count
        )

    @property
    def snowflake_v1_cortex_agent_last_used_by(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_last_used_by
        )

    @snowflake_v1_cortex_agent_last_used_by.setter
    def snowflake_v1_cortex_agent_last_used_by(
        self, snowflake_v1_cortex_agent_last_used_by: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_last_used_by = (
            snowflake_v1_cortex_agent_last_used_by
        )
    ...
    def snowflake_cortex_agent_tools(
        self,
    ) -> Optional[List[SnowflakeV1CortexAgentTool]]:
        return (
            None
            if self.attributes is None
    ...
    def snowflake_cortex_agent_tools(
        self, snowflake_cortex_agent_tools: Optional[List[SnowflakeV1CortexAgentTool]]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    @property
    def snowflake_cortex_agent_skills(
        self,
    ) -> Optional[List[SnowflakeV1CortexAgentSkill]]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_cortex_agent_skills
        )

    @snowflake_cortex_agent_skills.setter
    def snowflake_cortex_agent_skills(
        self, snowflake_cortex_agent_skills: Optional[List[SnowflakeV1CortexAgentSkill]]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_cortex_agent_skills = snowflake_cortex_agent_skills

    @property
    def snowflake_cortex_agent_schema(self) -> Optional[Schema]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_cortex_agent_schema
        )

    @snowflake_cortex_agent_schema.setter
    def snowflake_cortex_agent_schema(
        self, snowflake_cortex_agent_schema: Optional[Schema]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_cortex_agent_schema = snowflake_cortex_agent_schema

    class Attributes(Snowflake.Attributes):
        snowflake_v1_cortex_agent_orchestration_model: Optional[str] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_response_instructions: Optional[str] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_orchestration_instructions: Optional[str] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_budget_time_seconds: Optional[int] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_budget_tokens: Optional[int] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_last_used_at: Optional[datetime] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_total_invocation_count: Optional[int] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_last_used_by: Optional[str] = Field(
            default=None, description=""
        )
        ...
        snowflake_cortex_agent_tools: Optional[List[SnowflakeV1CortexAgentTool]] = (
            Field(default=None, description="")
        )  # relationship
        snowflake_cortex_agent_skills: Optional[List[SnowflakeV1CortexAgentSkill]] = (
            Field(default=None, description="")
        )  # relationship
        snowflake_cortex_agent_schema: Optional[Schema] = Field(
            default=None, description=""
        )  # relationship

    attributes: SnowflakeV1CortexAgent.Attributes = Field(
        default_factory=lambda: SnowflakeV1CortexAgent.Attributes(),
        description=(
...
from .snowflake_v1_cortex_agent_skill import (
    SnowflakeV1CortexAgentSkill,  # noqa: E402, F401
)
