...
class TablePartition(SQL):
    ...
    def updater(cls, *, name: str, qualified_name: str) -> TablePartition:
        """
        Builds the minimal object necessary to update a table partition.

        :param name: name of the table partition
        :param qualified_name: unique name of the table partition
        :returns: the minimal request necessary to update the table partition
        """
