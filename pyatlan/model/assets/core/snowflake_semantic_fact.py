...
class SnowflakeSemanticFact(Snowflake):
    """Description"""

    type_name: str = Field(default="SnowflakeSemanticFact", allow_mutation=False)

    @validator("type_name")
    def validate_type_name(cls, v):
        if v != "SnowflakeSemanticFact":
            raise ValueError("must be SnowflakeSemanticFact")
        return v

    def __setattr__(self, name, value):
        if name in SnowflakeSemanticFact._convenience_properties:
    ...
    attributes: SnowflakeSemanticFact.Attributes = Field(
        default_factory=lambda: SnowflakeSemanticFact.Attributes(),
        description=(
