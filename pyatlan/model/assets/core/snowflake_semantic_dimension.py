...
class SnowflakeSemanticDimension(SemanticDimension):
    """Description"""

    type_name: str = Field(default="SnowflakeSemanticDimension", allow_mutation=False)

    @validator("type_name")
    def validate_type_name(cls, v):
        if v != "SnowflakeSemanticDimension":
            raise ValueError("must be SnowflakeSemanticDimension")
        return v

    def __setattr__(self, name, value):
        if name in SnowflakeSemanticDimension._convenience_properties:
    ...
    class Attributes(SemanticDimension.Attributes):
    ...
    attributes: SnowflakeSemanticDimension.Attributes = Field(
        default_factory=lambda: SnowflakeSemanticDimension.Attributes(),
        description=(
