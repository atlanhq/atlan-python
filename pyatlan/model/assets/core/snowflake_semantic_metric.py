...
class SnowflakeSemanticMetric(Snowflake):
    """Description"""

    type_name: str = Field(default="SnowflakeSemanticMetric", allow_mutation=False)

    @validator("type_name")
    def validate_type_name(cls, v):
        if v != "SnowflakeSemanticMetric":
            raise ValueError("must be SnowflakeSemanticMetric")
        return v

    def __setattr__(self, name, value):
        if name in SnowflakeSemanticMetric._convenience_properties:
            return object.__setattr__(self, name, value)
        super().__setattr__(name, value)

    SNOWFLAKE_SEMANTIC_VIEW_QUALIFIED_NAME: ClassVar[KeywordField] = KeywordField(
    ...
    """
    SNOWFLAKE_SEMANTIC_VIEW_NAME: ClassVar[KeywordField] = KeywordField(
        "snowflakeSemanticViewName", "snowflakeSemanticViewName"
    )
    """
    Simple name of the semantic view in which this metric exists.
    """
    SNOWFLAKE_SEMANTIC_TABLE_QUALIFIED_NAME: ClassVar[KeywordField] = KeywordField(
    ...
    """
    SNOWFLAKE_SEMANTIC_TABLE_NAME: ClassVar[KeywordField] = KeywordField(
        "snowflakeSemanticTableName", "snowflakeSemanticTableName"
    )
    """
    Simple name of the logical table in which this metric exists.
    """
    SNOWFLAKE_METRIC_ADDITIVE_DIMENSIONS: ClassVar[KeywordField] = KeywordField(
    ...
    """
    SNOWFLAKE_METRIC_NON_ADDITIVE_DIMENSIONS: ClassVar[KeywordField] = KeywordField(
    ...
    """
    SNOWFLAKE_METRIC_USING_RELATIONSHIPS: ClassVar[KeywordField] = KeywordField(
    ...
    TBC
    """
    SNOWFLAKE_SEMANTIC_LOGICAL_TABLE: ClassVar[RelationField] = RelationField(
    ...
    _convenience_properties: ClassVar[List[str]] = [
        "snowflake_semantic_view_qualified_name",
        "snowflake_semantic_view_name",
        "snowflake_semantic_table_qualified_name",
        "snowflake_semantic_table_name",
        "snowflake_metric_additive_dimensions",
        "snowflake_metric_non_additive_dimensions",
        "snowflake_metric_using_relationships",
        "query_count",
        "query_user_count",
        "query_user_map",
    ...
    @property
    def snowflake_semantic_view_qualified_name(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_semantic_view_qualified_name
        )

    @snowflake_semantic_view_qualified_name.setter
    def snowflake_semantic_view_qualified_name(
        self, snowflake_semantic_view_qualified_name: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_semantic_view_qualified_name = (
            snowflake_semantic_view_qualified_name
        )

    @property
    def snowflake_semantic_view_name(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_semantic_view_name
        )

    @snowflake_semantic_view_name.setter
    def snowflake_semantic_view_name(self, snowflake_semantic_view_name: Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_semantic_view_name = snowflake_semantic_view_name

    @property
    def snowflake_semantic_table_qualified_name(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_semantic_table_qualified_name
        )

    @snowflake_semantic_table_qualified_name.setter
    def snowflake_semantic_table_qualified_name(
        self, snowflake_semantic_table_qualified_name: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_semantic_table_qualified_name = (
            snowflake_semantic_table_qualified_name
        )

    @property
    def snowflake_semantic_table_name(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_semantic_table_name
        )

    @snowflake_semantic_table_name.setter
    def snowflake_semantic_table_name(
        self, snowflake_semantic_table_name: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_semantic_table_name = snowflake_semantic_table_name

    @property
    def snowflake_metric_additive_dimensions(self) -> Optional[Set[str]]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_metric_additive_dimensions
        )

    @snowflake_metric_additive_dimensions.setter
    def snowflake_metric_additive_dimensions(
        self, snowflake_metric_additive_dimensions: Optional[Set[str]]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_metric_additive_dimensions = (
            snowflake_metric_additive_dimensions
        )

    @property
    def snowflake_metric_non_additive_dimensions(self) -> Optional[Set[str]]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_metric_non_additive_dimensions
        )

    @snowflake_metric_non_additive_dimensions.setter
    def snowflake_metric_non_additive_dimensions(
        self, snowflake_metric_non_additive_dimensions: Optional[Set[str]]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_metric_non_additive_dimensions = (
            snowflake_metric_non_additive_dimensions
        )

    @property
    def snowflake_metric_using_relationships(self) -> Optional[Set[str]]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_metric_using_relationships
        )

    @snowflake_metric_using_relationships.setter
    def snowflake_metric_using_relationships(
        self, snowflake_metric_using_relationships: Optional[Set[str]]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_metric_using_relationships = (
            snowflake_metric_using_relationships
        )
    ...
    @property
    def snowflake_semantic_logical_table(
        self,
    ) -> Optional[SnowflakeSemanticLogicalTable]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_semantic_logical_table
        )

    @snowflake_semantic_logical_table.setter
    def snowflake_semantic_logical_table(
        self, snowflake_semantic_logical_table: Optional[SnowflakeSemanticLogicalTable]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_semantic_logical_table = (
            snowflake_semantic_logical_table
        )
    ...
    class Attributes(Snowflake.Attributes):
        ...
        snowflake_semantic_view_name: Optional[str] = Field(
            default=None, description=""
        )
        snowflake_semantic_table_qualified_name: Optional[str] = Field(
            default=None, description=""
        )
        snowflake_semantic_table_name: Optional[str] = Field(
            default=None, description=""
        )
        snowflake_metric_additive_dimensions: Optional[Set[str]] = Field(
            default=None, description=""
        )
        snowflake_metric_non_additive_dimensions: Optional[Set[str]] = Field(
            default=None, description=""
        )
        snowflake_metric_using_relationships: Optional[Set[str]] = Field(
            default=None, description=""
        )
        ...
        snowflake_semantic_logical_table: Optional[SnowflakeSemanticLogicalTable] = (
            Field(default=None, description="")
        )  # relationship

    attributes: SnowflakeSemanticMetric.Attributes = Field(
        default_factory=lambda: SnowflakeSemanticMetric.Attributes(),
        description=(
