...
class SnowflakeV1CortexAgentSkill(Snowflake):
    """Description"""

    type_name: str = Field(default="SnowflakeV1CortexAgentSkill", allow_mutation=False)

    @validator("type_name")
    def validate_type_name(cls, v):
        if v != "SnowflakeV1CortexAgentSkill":
            raise ValueError("must be SnowflakeV1CortexAgentSkill")
        return v

    def __setattr__(self, name, value):
        if name in SnowflakeV1CortexAgentSkill._convenience_properties:
            return object.__setattr__(self, name, value)
        super().__setattr__(name, value)

    SNOWFLAKE_V1CORTEX_AGENT_SKILL_SKILL_SOURCE_TYPE: ClassVar[KeywordField] = (
        KeywordField(
            "snowflakeV1CortexAgentSkillSkillSourceType",
            "snowflakeV1CortexAgentSkillSkillSourceType",
        )
    )
    """
    Kind of skill source backing this artefact (for example, INLINE, STAGE_FILE, GIT).
    """
    SNOWFLAKE_V1CORTEX_AGENT_SKILL_SKILL_SOURCE_PATH: ClassVar[KeywordField] = (
        KeywordField(
            "snowflakeV1CortexAgentSkillSkillSourcePath",
            "snowflakeV1CortexAgentSkillSkillSourcePath",
        )
    )
    """
    Path to the skill source — stage URL, Git path, or inline marker.
    """
    SNOWFLAKE_V1CORTEX_AGENT_SKILL_SKILL_INSTRUCTIONS: ClassVar[KeywordField] = (
        KeywordField(
            "snowflakeV1CortexAgentSkillSkillInstructions",
            "snowflakeV1CortexAgentSkillSkillInstructions",
        )
    )
    """
    Inline instruction text for this skill, captured when the source is INLINE or small enough to materialise.
    """
    SNOWFLAKE_V1CORTEX_AGENT_SKILL_SKILL_SIZE_BYTES: ClassVar[NumericField] = (
        NumericField(
            "snowflakeV1CortexAgentSkillSkillSizeBytes",
            "snowflakeV1CortexAgentSkillSkillSizeBytes",
        )
    )
    """
    Size of the skill source in bytes.
    """
    SNOWFLAKE_V1CORTEX_AGENT_SKILL_SKILL_CHECKSUM: ClassVar[KeywordField] = (
        KeywordField(
            "snowflakeV1CortexAgentSkillSkillChecksum",
            "snowflakeV1CortexAgentSkillSkillChecksum",
        )
    )
    """
    Content checksum (for example, SHA-256) of the skill source, used to detect drift.
    """
    SNOWFLAKE_V1CORTEX_AGENT_SKILL_SKILL_LAST_MODIFIED_AT: ClassVar[NumericField] = (
        NumericField(
            "snowflakeV1CortexAgentSkillSkillLastModifiedAt",
            "snowflakeV1CortexAgentSkillSkillLastModifiedAt",
        )
    )
    """
    Time (epoch) at which the skill source was last modified, in milliseconds.
    """
    ...
    _convenience_properties: ClassVar[List[str]] = [
        "snowflake_v1_cortex_agent_skill_skill_source_type",
        "snowflake_v1_cortex_agent_skill_skill_source_path",
        "snowflake_v1_cortex_agent_skill_skill_instructions",
        "snowflake_v1_cortex_agent_skill_skill_size_bytes",
        "snowflake_v1_cortex_agent_skill_skill_checksum",
        "snowflake_v1_cortex_agent_skill_skill_last_modified_at",
        "query_count",
        "query_user_count",
        "query_user_map",
    ...
    @property
    def snowflake_v1_cortex_agent_skill_skill_source_type(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_skill_skill_source_type
        )

    @snowflake_v1_cortex_agent_skill_skill_source_type.setter
    def snowflake_v1_cortex_agent_skill_skill_source_type(
        self, snowflake_v1_cortex_agent_skill_skill_source_type: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_skill_skill_source_type = (
            snowflake_v1_cortex_agent_skill_skill_source_type
        )

    @property
    def snowflake_v1_cortex_agent_skill_skill_source_path(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_skill_skill_source_path
        )

    @snowflake_v1_cortex_agent_skill_skill_source_path.setter
    def snowflake_v1_cortex_agent_skill_skill_source_path(
        self, snowflake_v1_cortex_agent_skill_skill_source_path: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_skill_skill_source_path = (
            snowflake_v1_cortex_agent_skill_skill_source_path
        )

    @property
    def snowflake_v1_cortex_agent_skill_skill_instructions(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_skill_skill_instructions
        )

    @snowflake_v1_cortex_agent_skill_skill_instructions.setter
    def snowflake_v1_cortex_agent_skill_skill_instructions(
        self, snowflake_v1_cortex_agent_skill_skill_instructions: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_skill_skill_instructions = (
            snowflake_v1_cortex_agent_skill_skill_instructions
        )

    @property
    def snowflake_v1_cortex_agent_skill_skill_size_bytes(self) -> Optional[int]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_skill_skill_size_bytes
        )

    @snowflake_v1_cortex_agent_skill_skill_size_bytes.setter
    def snowflake_v1_cortex_agent_skill_skill_size_bytes(
        self, snowflake_v1_cortex_agent_skill_skill_size_bytes: Optional[int]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_skill_skill_size_bytes = (
            snowflake_v1_cortex_agent_skill_skill_size_bytes
        )

    @property
    def snowflake_v1_cortex_agent_skill_skill_checksum(self) -> Optional[str]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_skill_skill_checksum
        )

    @snowflake_v1_cortex_agent_skill_skill_checksum.setter
    def snowflake_v1_cortex_agent_skill_skill_checksum(
        self, snowflake_v1_cortex_agent_skill_skill_checksum: Optional[str]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_skill_skill_checksum = (
            snowflake_v1_cortex_agent_skill_skill_checksum
        )

    @property
    def snowflake_v1_cortex_agent_skill_skill_last_modified_at(
        self,
    ) -> Optional[datetime]:
        return (
            None
            if self.attributes is None
            else self.attributes.snowflake_v1_cortex_agent_skill_skill_last_modified_at
        )

    @snowflake_v1_cortex_agent_skill_skill_last_modified_at.setter
    def snowflake_v1_cortex_agent_skill_skill_last_modified_at(
        self, snowflake_v1_cortex_agent_skill_skill_last_modified_at: Optional[datetime]
    ):
        if self.attributes is None:
            self.attributes = self.Attributes()
        self.attributes.snowflake_v1_cortex_agent_skill_skill_last_modified_at = (
            snowflake_v1_cortex_agent_skill_skill_last_modified_at
        )
    ...
    class Attributes(Snowflake.Attributes):
        snowflake_v1_cortex_agent_skill_skill_source_type: Optional[str] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_skill_skill_source_path: Optional[str] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_skill_skill_instructions: Optional[str] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_skill_skill_size_bytes: Optional[int] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_skill_skill_checksum: Optional[str] = Field(
            default=None, description=""
        )
        snowflake_v1_cortex_agent_skill_skill_last_modified_at: Optional[datetime] = (
    ...
    attributes: SnowflakeV1CortexAgentSkill.Attributes = Field(
        default_factory=lambda: SnowflakeV1CortexAgentSkill.Attributes(),
        description=(
