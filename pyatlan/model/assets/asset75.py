...
class MicroStrategyReport(MicroStrategy):
    ...
    MICRO_STRATEGY_REPORT_TYPE: ClassVar[KeywordField] = KeywordField("microStrategyReportType", "microStrategyReportType")
    """
    ...
    def micro_strategy_report_type(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.micro_strategy_report_type
    ...
    class Attributes(MicroStrategy.Attributes):
        micro_strategy_report_type: Optional[str] = Field(None, description='' , alias='microStrategyReportType')
        micro_strategy_metrics: Optional[list[MicroStrategyMetric]]= Field(None, description='',  alias='microStrategyMetrics') # relationship
        micro_strategy_project: Optional[MicroStrategyProject]= Field(None, description='',  alias='microStrategyProject') # relationship
        micro_strategy_attributes: Optional[list[MicroStrategyAttribute]]= Field(None, description='',  alias='microStrategyAttributes') # relationship
...
class MicroStrategyProject(MicroStrategy):
    ...
    def micro_strategy_metrics(self, micro_strategy_metrics:Optional[list[MicroStrategyMetric]]):
        ...
        self.attributes.micro_strategy_metrics = micro_strategy_metrics
    @property
    def micro_strategy_visualizations(self)->Optional[list[MicroStrategyVisualization]]:
    ...
    class Attributes(MicroStrategy.Attributes):
        micro_strategy_reports: Optional[list[MicroStrategyReport]]= Field(None, description='',  alias='microStrategyReports') # relationship
        micro_strategy_facts: Optional[list[MicroStrategyFact]]= Field(None, description='',  alias='microStrategyFacts') # relationship
        micro_strategy_metrics: Optional[list[MicroStrategyMetric]]= Field(None, description='',  alias='microStrategyMetrics') # relationship
        micro_strategy_visualizations: Optional[list[MicroStrategyVisualization]]= Field(None, description='',  alias='microStrategyVisualizations') # relationship
        micro_strategy_documents: Optional[list[MicroStrategyDocument]]= Field(None, description='',  alias='microStrategyDocuments') # relationship
        micro_strategy_cubes: Optional[list[MicroStrategyCube]]= Field(None, description='',  alias='microStrategyCubes') # relationship
        micro_strategy_dossiers: Optional[list[MicroStrategyDossier]]= Field(None, description='',  alias='microStrategyDossiers') # relationship
        micro_strategy_attributes: Optional[list[MicroStrategyAttribute]]= Field(None, description='',  alias='microStrategyAttributes') # relationship
...
class MicroStrategyMetric(MicroStrategy):
    ...
    MICRO_STRATEGY_METRIC_EXPRESSION: ClassVar[KeywordField] = KeywordField("microStrategyMetricExpression", "microStrategyMetricExpression")
    """
    Metric expression text
    """
    MICRO_STRATEGY_ATTRIBUTE_QUALIFIED_NAMES: ClassVar[KeywordTextField] = KeywordTextField("microStrategyAttributeQualifiedNames", "microStrategyAttributeQualifiedNames", "microStrategyAttributeQualifiedNames.text")
    """
    Related attribute qualified name list
    """
    MICRO_STRATEGY_ATTRIBUTE_NAMES: ClassVar[KeywordTextField] = KeywordTextField("microStrategyAttributeNames", "microStrategyAttributeNames.keyword", "microStrategyAttributeNames")
    """
    Related attribute name list
    """
    MICRO_STRATEGY_FACT_QUALIFIED_NAMES: ClassVar[KeywordTextField] = KeywordTextField("microStrategyFactQualifiedNames", "microStrategyFactQualifiedNames", "microStrategyFactQualifiedNames.text")
    """
    Related fact qualified name list
    """
    MICRO_STRATEGY_FACT_NAMES: ClassVar[KeywordTextField] = KeywordTextField("microStrategyFactNames", "microStrategyFactNames.keyword", "microStrategyFactNames")
    """
    Related fact name list
    """
    MICRO_STRATEGY_METRIC_PARENT_QUALIFIED_NAMES: ClassVar[KeywordTextField] = KeywordTextField("microStrategyMetricParentQualifiedNames", "microStrategyMetricParentQualifiedNames", "microStrategyMetricParentQualifiedNames.text")
    """
    Related parent metric qualified name list
    """
    MICRO_STRATEGY_METRIC_PARENT_NAMES: ClassVar[KeywordTextField] = KeywordTextField("microStrategyMetricParentNames", "microStrategyMetricParentNames.keyword", "microStrategyMetricParentNames")
    """
    ...
    def micro_strategy_metric_parent_qualified_names(self, micro_strategy_metric_parent_qualified_names:Optional[set[str]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    class Attributes(MicroStrategy.Attributes):
        micro_strategy_metric_expression: Optional[str] = Field(None, description='' , alias='microStrategyMetricExpression')
        micro_strategy_attribute_qualified_names: Optional[set[str]] = Field(None, description='' , alias='microStrategyAttributeQualifiedNames')
        micro_strategy_attribute_names: Optional[set[str]] = Field(None, description='' , alias='microStrategyAttributeNames')
        micro_strategy_fact_qualified_names: Optional[set[str]] = Field(None, description='' , alias='microStrategyFactQualifiedNames')
        micro_strategy_fact_names: Optional[set[str]] = Field(None, description='' , alias='microStrategyFactNames')
        micro_strategy_metric_parent_qualified_names: Optional[set[str]] = Field(None, description='' , alias='microStrategyMetricParentQualifiedNames')
        micro_strategy_metric_parent_names: Optional[set[str]] = Field(None, description='' , alias='microStrategyMetricParentNames')
        micro_strategy_metric_parents: Optional[list[MicroStrategyMetric]]= Field(None, description='',  alias='microStrategyMetricParents') # relationship
        micro_strategy_facts: Optional[list[MicroStrategyFact]]= Field(None, description='',  alias='microStrategyFacts') # relationship
        micro_strategy_reports: Optional[list[MicroStrategyReport]]= Field(None, description='',  alias='microStrategyReports') # relationship
        micro_strategy_cubes: Optional[list[MicroStrategyCube]]= Field(None, description='',  alias='microStrategyCubes') # relationship
        micro_strategy_metric_children: Optional[list[MicroStrategyMetric]]= Field(None, description='',  alias='microStrategyMetricChildren') # relationship
        micro_strategy_project: Optional[MicroStrategyProject]= Field(None, description='',  alias='microStrategyProject') # relationship
        micro_strategy_attributes: Optional[list[MicroStrategyAttribute]]= Field(None, description='',  alias='microStrategyAttributes') # relationship
...
class MicroStrategyCube(MicroStrategy):
    ...
    """
    MICRO_STRATEGY_CUBE_QUERY: ClassVar[KeywordField] = KeywordField("microStrategyCubeQuery", "microStrategyCubeQuery")
    """
    ...
    class Attributes(MicroStrategy.Attributes):
        micro_strategy_cube_type: Optional[str] = Field(None, description='' , alias='microStrategyCubeType')
        micro_strategy_cube_query: Optional[str] = Field(None, description='' , alias='microStrategyCubeQuery')
        micro_strategy_metrics: Optional[list[MicroStrategyMetric]]= Field(None, description='',  alias='microStrategyMetrics') # relationship
        micro_strategy_project: Optional[MicroStrategyProject]= Field(None, description='',  alias='microStrategyProject') # relationship
        micro_strategy_attributes: Optional[list[MicroStrategyAttribute]]= Field(None, description='',  alias='microStrategyAttributes') # relationship
...
class MicroStrategyDossier(MicroStrategy):
    ...
    MICRO_STRATEGY_DOSSIER_CHAPTER_NAMES: ClassVar[KeywordField] = KeywordField("microStrategyDossierChapterNames", "microStrategyDossierChapterNames")
    """
    ...
    class Attributes(MicroStrategy.Attributes):
        micro_strategy_dossier_chapter_names: Optional[set[str]] = Field(None, description='' , alias='microStrategyDossierChapterNames')
        micro_strategy_visualizations: Optional[list[MicroStrategyVisualization]]= Field(None, description='',  alias='microStrategyVisualizations') # relationship
        micro_strategy_project: Optional[MicroStrategyProject]= Field(None, description='',  alias='microStrategyProject') # relationship
...
class MicroStrategyFact(MicroStrategy):
    ...
    MICRO_STRATEGY_FACT_EXPRESSIONS: ClassVar[KeywordField] = KeywordField("microStrategyFactExpressions", "microStrategyFactExpressions")
    """
    ...
    class Attributes(MicroStrategy.Attributes):
        micro_strategy_fact_expressions: Optional[set[str]] = Field(None, description='' , alias='microStrategyFactExpressions')
        micro_strategy_metrics: Optional[list[MicroStrategyMetric]]= Field(None, description='',  alias='microStrategyMetrics') # relationship
        micro_strategy_project: Optional[MicroStrategyProject]= Field(None, description='',  alias='microStrategyProject') # relationship
...
class MicroStrategyAttribute(MicroStrategy):
    ...
    MICRO_STRATEGY_ATTRIBUTE_FORMS: ClassVar[KeywordField] = KeywordField("microStrategyAttributeForms", "microStrategyAttributeForms")
    """
    ...
    def micro_strategy_attribute_forms(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.micro_strategy_attribute_forms

    @micro_strategy_attribute_forms.setter
    def micro_strategy_attribute_forms(self, micro_strategy_attribute_forms:Optional[str]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    class Attributes(MicroStrategy.Attributes):
        micro_strategy_attribute_forms: Optional[str] = Field(None, description='' , alias='microStrategyAttributeForms')
        micro_strategy_reports: Optional[list[MicroStrategyReport]]= Field(None, description='',  alias='microStrategyReports') # relationship
        micro_strategy_metrics: Optional[list[MicroStrategyMetric]]= Field(None, description='',  alias='microStrategyMetrics') # relationship
        micro_strategy_cubes: Optional[list[MicroStrategyCube]]= Field(None, description='',  alias='microStrategyCubes') # relationship
        micro_strategy_project: Optional[MicroStrategyProject]= Field(None, description='',  alias='microStrategyProject') # relationship
...
class MicroStrategyVisualization(MicroStrategy):
    ...
    MICRO_STRATEGY_VISUALIZATION_TYPE: ClassVar[KeywordField] = KeywordField("microStrategyVisualizationType", "microStrategyVisualizationType")
    """
    Visualization type name
    """
    MICRO_STRATEGY_DOSSIER_QUALIFIED_NAME: ClassVar[KeywordTextField] = KeywordTextField("microStrategyDossierQualifiedName", "microStrategyDossierQualifiedName", "microStrategyDossierQualifiedName.text")
    """
    Parent dossier qualified name
    """
    MICRO_STRATEGY_DOSSIER_NAME: ClassVar[KeywordTextField] = KeywordTextField("microStrategyDossierName", "microStrategyDossierName.keyword", "microStrategyDossierName")
    """
    Parent dossier name
    """
    ...
    class Attributes(MicroStrategy.Attributes):
        micro_strategy_visualization_type: Optional[str] = Field(None, description='' , alias='microStrategyVisualizationType')
        micro_strategy_dossier_qualified_name: Optional[str] = Field(None, description='' , alias='microStrategyDossierQualifiedName')
        micro_strategy_dossier_name: Optional[str] = Field(None, description='' , alias='microStrategyDossierName')
        micro_strategy_dossier: Optional[MicroStrategyDossier]= Field(None, description='',  alias='microStrategyDossier') # relationship
        micro_strategy_project: Optional[MicroStrategyProject]= Field(None, description='',  alias='microStrategyProject') # relationship
