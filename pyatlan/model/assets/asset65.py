...
class TableauWorkbook(Tableau):
    ...
    def top_level_project_name(self)->Optional[str]:
        return None if self.attributes is None else self.attributes.top_level_project_name
    ...
    class Attributes(Tableau.Attributes):
        ...
        top_level_project_name: Optional[str] = Field(None, description='' , alias='topLevelProjectName')
        ...
        dashboards: Optional[list[TableauDashboard]]= Field(None, description='',  alias='dashboards') # relationship
        worksheets: Optional[list[TableauWorksheet]]= Field(None, description='',  alias='worksheets') # relationship
        datasources: Optional[list[TableauDatasource]]= Field(None, description='',  alias='datasources') # relationship
...
class TableauDatasourceField(Tableau):
    ...
    TBC
    """
    WORKBOOK_QUALIFIED_NAME: ClassVar[KeywordField] = KeywordField("workbookQualifiedName", "workbookQualifiedName")
    """
    TBC
    """
    DATASOURCE_QUALIFIED_NAME: ClassVar[KeywordField] = KeywordField("datasourceQualifiedName", "datasourceQualifiedName")
    """
    TBC
    """
    PROJECT_HIERARCHY: ClassVar[KeywordField] = KeywordField("projectHierarchy", "projectHierarchy")
    ...
    TBC
    """
    FULLY_QUALIFIED_NAME: ClassVar[KeywordField] = KeywordField("fullyQualifiedName", "fullyQualifiedName")
    """
    TBC
    """
    TABLEAU_DATASOURCE_FIELD_DATA_CATEGORY: ClassVar[KeywordField] = KeywordField("tableauDatasourceFieldDataCategory", "tableauDatasourceFieldDataCategory")
    """
    TBC
    """
    TABLEAU_DATASOURCE_FIELD_ROLE: ClassVar[KeywordField] = KeywordField("tableauDatasourceFieldRole", "tableauDatasourceFieldRole")
    """
    TBC
    """
    TABLEAU_DATASOURCE_FIELD_DATA_TYPE: ClassVar[KeywordTextField] = KeywordTextField("tableauDatasourceFieldDataType", "tableauDatasourceFieldDataType", "tableauDatasourceFieldDataType.text")
    """
    TBC
    """
    ...
    TBC
    """
    TABLEAU_DATASOURCE_FIELD_FORMULA: ClassVar[KeywordField] = KeywordField("tableauDatasourceFieldFormula", "tableauDatasourceFieldFormula")
    """
    TBC
    """
    TABLEAU_DATASOURCE_FIELD_BIN_SIZE: ClassVar[KeywordField] = KeywordField("tableauDatasourceFieldBinSize", "tableauDatasourceFieldBinSize")
    """
    TBC
    """
    ...
    TBC
    """
    DATASOURCE_FIELD_TYPE: ClassVar[KeywordField] = KeywordField("datasourceFieldType", "datasourceFieldType")
    """
    TBC
    """
    ...
    class Attributes(Tableau.Attributes):
        ...
        project_qualified_name: Optional[str] = Field(None, description='' , alias='projectQualifiedName')
        top_level_project_qualified_name: Optional[str] = Field(None, description='' , alias='topLevelProjectQualifiedName')
        workbook_qualified_name: Optional[str] = Field(None, description='' , alias='workbookQualifiedName')
        datasource_qualified_name: Optional[str] = Field(None, description='' , alias='datasourceQualifiedName')
        project_hierarchy: Optional[list[dict[str,str]]] = Field(None, description='' , alias='projectHierarchy')
        fully_qualified_name: Optional[str] = Field(None, description='' , alias='fullyQualifiedName')
        tableau_datasource_field_data_category: Optional[str] = Field(None, description='' , alias='tableauDatasourceFieldDataCategory')
        tableau_datasource_field_role: Optional[str] = Field(None, description='' , alias='tableauDatasourceFieldRole')
        tableau_datasource_field_data_type: Optional[str] = Field(None, description='' , alias='tableauDatasourceFieldDataType')
        upstream_tables: Optional[list[dict[str,str]]] = Field(None, description='' , alias='upstreamTables')
        tableau_datasource_field_formula: Optional[str] = Field(None, description='' , alias='tableauDatasourceFieldFormula')
        tableau_datasource_field_bin_size: Optional[str] = Field(None, description='' , alias='tableauDatasourceFieldBinSize')
        upstream_columns: Optional[list[dict[str,str]]] = Field(None, description='' , alias='upstreamColumns')
        upstream_fields: Optional[list[dict[str,str]]] = Field(None, description='' , alias='upstreamFields')
        datasource_field_type: Optional[str] = Field(None, description='' , alias='datasourceFieldType')
        worksheets: Optional[list[TableauWorksheet]]= Field(None, description='',  alias='worksheets') # relationship
        datasource: Optional[TableauDatasource]= Field(None, description='',  alias='datasource') # relationship
...
class TableauCalculatedField(Tableau):
    ...
    TBC
    """
    TABLEAU_DATA_TYPE: ClassVar[KeywordTextField] = KeywordTextField("tableauDataType", "tableauDataType", "tableauDataType.text")
    """
    TBC
    """
    ...
    class Attributes(Tableau.Attributes):
        ...
        tableau_data_type: Optional[str] = Field(None, description='' , alias='tableauDataType')
...
class TableauProject(Tableau):
    ...
    class Attributes(Tableau.Attributes):
        site_qualified_name: Optional[str] = Field(None, description='' , alias='siteQualifiedName')
        top_level_project_qualified_name: Optional[str] = Field(None, description='' , alias='topLevelProjectQualifiedName')
        is_top_level_project: Optional[bool] = Field(None, description='' , alias='isTopLevelProject')
        project_hierarchy: Optional[list[dict[str,str]]] = Field(None, description='' , alias='projectHierarchy')
        parent_project: Optional[TableauProject]= Field(None, description='',  alias='parentProject') # relationship
        workbooks: Optional[list[TableauWorkbook]]= Field(None, description='',  alias='workbooks') # relationship
        site: Optional[TableauSite]= Field(None, description='',  alias='site') # relationship
        datasources: Optional[list[TableauDatasource]]= Field(None, description='',  alias='datasources') # relationship
        flows: Optional[list[TableauFlow]]= Field(None, description='',  alias='flows') # relationship
        child_projects: Optional[list[TableauProject]]= Field(None, description='',  alias='childProjects') # relationship
...
class TableauSite(Tableau):
    ...
    class Attributes(Tableau.Attributes):
        projects: Optional[list[TableauProject]]= Field(None, description='',  alias='projects') # relationship
...
class TableauDatasource(Tableau):
    ...
    TBC
    """
    CERTIFICATION_NOTE: ClassVar[KeywordField] = KeywordField("certificationNote", "certificationNote")
    """
    TBC
    """
    CERTIFIER_DISPLAY_NAME: ClassVar[KeywordField] = KeywordField("certifierDisplayName", "certifierDisplayName")
    """
    TBC
    """
    UPSTREAM_TABLES: ClassVar[KeywordField] = KeywordField("upstreamTables", "upstreamTables")
    ...
    def upstream_datasources(self, upstream_datasources:Optional[list[dict[str,str]]]):
        if self.attributes is None:
            self.attributes = self.Attributes()
    ...
    class Attributes(Tableau.Attributes):
        ...
        certifier: Optional[dict[str,str]] = Field(None, description='' , alias='certifier')
        certification_note: Optional[str] = Field(None, description='' , alias='certificationNote')
        certifier_display_name: Optional[str] = Field(None, description='' , alias='certifierDisplayName')
        upstream_tables: Optional[list[dict[str,str]]] = Field(None, description='' , alias='upstreamTables')
        upstream_datasources: Optional[list[dict[str,str]]] = Field(None, description='' , alias='upstreamDatasources')
        workbook: Optional[TableauWorkbook]= Field(None, description='',  alias='workbook') # relationship
        project: Optional[TableauProject]= Field(None, description='',  alias='project') # relationship
        fields: Optional[list[TableauDatasourceField]]= Field(None, description='',  alias='fields') # relationship
...
class TableauFlow(Tableau):
    ...
    class Attributes(Tableau.Attributes):
        ...
        top_level_project_qualified_name: Optional[str] = Field(None, description='' , alias='topLevelProjectQualifiedName')
        project_hierarchy: Optional[list[dict[str,str]]] = Field(None, description='' , alias='projectHierarchy')
        input_fields: Optional[list[dict[str,str]]] = Field(None, description='' , alias='inputFields')
        output_fields: Optional[list[dict[str,str]]] = Field(None, description='' , alias='outputFields')
        output_steps: Optional[list[dict[str,str]]] = Field(None, description='' , alias='outputSteps')
        project: Optional[TableauProject]= Field(None, description='',  alias='project') # relationship
...
class TableauWorksheet(Tableau):
    ...
    class Attributes(Tableau.Attributes):
        ...
        workbook_qualified_name: Optional[str] = Field(None, description='' , alias='workbookQualifiedName')
        workbook: Optional[TableauWorkbook]= Field(None, description='',  alias='workbook') # relationship
        datasource_fields: Optional[list[TableauDatasourceField]]= Field(None, description='',  alias='datasourceFields') # relationship
        calculated_fields: Optional[list[TableauCalculatedField]]= Field(None, description='',  alias='calculatedFields') # relationship
        dashboards: Optional[list[TableauDashboard]]= Field(None, description='',  alias='dashboards') # relationship
