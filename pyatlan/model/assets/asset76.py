...
class QlikApp(Qlik):
    ...
    class Attributes(Qlik.Attributes):
        qlik_has_section_access: Optional[bool] = Field(None, description='' , alias='qlikHasSectionAccess')
        qlik_origin_app_id: Optional[str] = Field(None, description='' , alias='qlikOriginAppId')
        qlik_is_encrypted: Optional[bool] = Field(None, description='' , alias='qlikIsEncrypted')
        qlik_is_direct_query_mode: Optional[bool] = Field(None, description='' , alias='qlikIsDirectQueryMode')
        qlik_app_static_byte_size: Optional[int] = Field(None, description='' , alias='qlikAppStaticByteSize')
        qlik_space: Optional[QlikSpace]= Field(None, description='',  alias='qlikSpace') # relationship
        qlik_sheets: Optional[list[QlikSheet]]= Field(None, description='',  alias='qlikSheets') # relationship
...
class QlikChart(Qlik):
    ...
    class Attributes(Qlik.Attributes):
        qlik_chart_subtitle: Optional[str] = Field(None, description='' , alias='qlikChartSubtitle')
        qlik_chart_footnote: Optional[str] = Field(None, description='' , alias='qlikChartFootnote')
        qlik_chart_orientation: Optional[str] = Field(None, description='' , alias='qlikChartOrientation')
        qlik_chart_type: Optional[str] = Field(None, description='' , alias='qlikChartType')
        qlik_sheet: Optional[QlikSheet]= Field(None, description='',  alias='qlikSheet') # relationship
...
class QlikDataset(Qlik):
    ...
    QLIK_DATASET_TECHNICAL_NAME: ClassVar[KeywordTextField] = KeywordTextField("qlikDatasetTechnicalName", "qlikDatasetTechnicalName.keyword", "qlikDatasetTechnicalName")
    """
    ...
    """
    QLIK_DATASET_URI: ClassVar[KeywordTextField] = KeywordTextField("qlikDatasetUri", "qlikDatasetUri", "qlikDatasetUri.text")
    """
    ...
    class Attributes(Qlik.Attributes):
        ...
        qlik_dataset_type: Optional[str] = Field(None, description='' , alias='qlikDatasetType')
        qlik_dataset_uri: Optional[str] = Field(None, description='' , alias='qlikDatasetUri')
        qlik_dataset_subtype: Optional[str] = Field(None, description='' , alias='qlikDatasetSubtype')
        qlik_space: Optional[QlikSpace]= Field(None, description='',  alias='qlikSpace') # relationship
...
class QlikSheet(Qlik):
    ...
    class Attributes(Qlik.Attributes):
        qlik_sheet_is_approved: Optional[bool] = Field(None, description='' , alias='qlikSheetIsApproved')
        qlik_app: Optional[QlikApp]= Field(None, description='',  alias='qlikApp') # relationship
        qlik_charts: Optional[list[QlikChart]]= Field(None, description='',  alias='qlikCharts') # relationship
...
class QlikSpace(Qlik):
    ...
    class Attributes(Qlik.Attributes):
        qlik_space_type: Optional[str] = Field(None, description='' , alias='qlikSpaceType')
        qlik_datasets: Optional[list[QlikDataset]]= Field(None, description='',  alias='qlikDatasets') # relationship
        qlik_apps: Optional[list[QlikApp]]= Field(None, description='',  alias='qlikApps') # relationship
