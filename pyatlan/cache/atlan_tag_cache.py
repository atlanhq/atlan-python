...
class AtlanTagCache:
    """
    Lazily-loaded cache for translating between Atlan-internal ID
    strings and human-readable names for Atlan tags.
    """
    ...
    def _refresh_cache(self) -> None:
        """
        Refreshes the cache of Atlan tags
        by requesting the full set of Atlan tags from Atlan.
        """
        with self.lock:
    ...
    def get_source_tags_attr_id(self, id: str) -> Optional[str]:
        ...
        containing source-synced tag attachment details
        """
