...
class Generator:
    ...
    def render_module(self, asset_info: AssetInfo, assets: list[AssetInfo]):
    ...
    def render_init(self, assets: list[AssetInfo]):
        ...
        content = template.render(
            {"asset_imports": imports, "forward_refs": forward_refs}
        )
...
if __name__ == "__main__":
    ...
    for asset_info in ModuleInfo.assets.values():
        generator.render_module(asset_info, ModuleInfo.assets.values())
