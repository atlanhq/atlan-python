...
CONNECTION_QUALIFIED_NAME = "default/datastudio/123456789"
QUALIFIED_NAME_REPORT = f"{CONNECTION_QUALIFIED_NAME}/{REPORT_NAME}"
QUALIFIED_NAME_SOURCE = f"{CONNECTION_QUALIFIED_NAME}/{SOURCE_NAME}"
