...
ADLS_ACCOUNT_QUALIFIED_NAME = f"{ADLS_QUALIFIED_NAME}"  # "default/adls/123456789/myaccount"
...
ANAPLAN_CONNECTION_QUALIFIED_NAME = "default/anaplan/123456789"
ANAPLAN_CONNECTOR_TYPE = "anaplan"
ANAPLAN_WORKSPACE_NAME = "anaplan-workspace"
ANAPLAN_WORKSPACE_QUALIFIED_NAME = f"{ANAPLAN_CONNECTION_QUALIFIED_NAME}/{ANAPLAN_WORKSPACE_NAME}"
ANAPLAN_APP_NAME = "anaplan-app"
ANAPLAN_APP_QUALIFIED_NAME = f"{ANAPLAN_CONNECTION_QUALIFIED_NAME}/{ANAPLAN_APP_NAME}"
ANAPLAN_PAGE_NAME = "anaplan-page"
ANAPLAN_PAGE_QUALIFIED_NAME = f"{ANAPLAN_APP_QUALIFIED_NAME}/{ANAPLAN_PAGE_NAME}"
ANAPLAN_MODEL_NAME = "anaplan-model"
ANAPLAN_MODEL_QUALIFIED_NAME = f"{ANAPLAN_WORKSPACE_QUALIFIED_NAME}/{ANAPLAN_MODEL_NAME}"
ANAPLAN_MODULE_NAME = "anaplan-module"
ANAPLAN_MODULE_QUALIFIED_NAME = f"{ANAPLAN_MODEL_QUALIFIED_NAME}/{ANAPLAN_MODULE_NAME}"
ANAPLAN_LIST_NAME = "anaplan-list"
ANAPLAN_LIST_QUALIFIED_NAME = f"{ANAPLAN_MODEL_QUALIFIED_NAME}/{ANAPLAN_LIST_NAME}"
ANAPLAN_SYSTEM_DIMENSION_NAME = "anaplan-system-dimension"
ANAPLAN_SYSTEM_DIMENSION_QUALIFIED_NAME = f"{ANAPLAN_CONNECTION_QUALIFIED_NAME}/{ANAPLAN_SYSTEM_DIMENSION_NAME}"
ANAPLAN_DIMENSION_NAME = "anaplan-list"
ANAPLAN_DIMENSION_QUALIFIED_NAME = f"{ANAPLAN_MODEL_QUALIFIED_NAME}/{ANAPLAN_DIMENSION_NAME}"
ANAPLAN_LINE_ITEM_NAME = "anaplan-lineitem"
ANAPLAN_LINE_ITEM_QUALIFIED_NAME = f"{ANAPLAN_MODULE_QUALIFIED_NAME}/{ANAPLAN_LINE_ITEM_NAME}"
ANAPLAN_VIEW_NAME = "anaplan-view"
ANAPLAN_VIEW_QUALIFIED_NAME = f"{ANAPLAN_MODULE_QUALIFIED_NAME}/{ANAPLAN_VIEW_NAME}"
...
API_PATH_QUALIFIED_NAME = f"{API_CONNECTION_QUALIFIED_NAME}/{API_SPEC_NAME}{API_PATH_RAW_URI}"
...
API_FIELD_PARENT_OBJECT_QUALIFIED_NAME = f"{API_CONNECTION_QUALIFIED_NAME}/{API_OBJECT_NAME}"
API_FIELD_PARENT_QUERY_QUALIFIED_NAME = f"{API_CONNECTION_QUALIFIED_NAME}/{API_QUERY_NAME}"
API_FIELD_REFERENCE_OBJECT_QN = f"{API_CONNECTION_QUALIFIED_NAME}/{API_OBJECT_REF_NAME}"
APPLICATION_NAME = "application"
APP_CONNECTOR_TYPE = "app"
APP_CONNECTION_QUALIFIED_NAME = "default/app/123456789"
APPLICATION_QUALIFIED_NAME = "default/app/123456789/application"
APPLICATION_FIELD_NAME = "field"
APPLICATION_FIELD_QUALIFIED_NAME = "default/app/123456789/application/field"
...
PRESET_WORKSPACE_QUALIFIED_NAME = f"{PRESET_CONNECTION_QUALIFIED_NAME}/{PRESET_WORKSPACE_NAME}"
...
PRESET_DATASET_QUALIFIED_NAME = f"{PRESET_DASHBOARD_QUALIFIED_NAME}/{PRESET_DATASET_NAME}"
...
DATA_PRODUCT_UNDER_SUB_DOMAIN_QUALIFIED_NAME = f"{DATA_SUB_DOMAIN_QUALIFIED_NAME}/product/{DATA_PRODUCT_NAME}"
...
CP_QUALIFIED_NAME_HASH = f"{CP_CONNECTION_QUALIFIED_NAME}/ecb5f77380c04710c979acfb8d3bba2f"
...
KAFKA_TOPIC_QUALIFIED_NAME = f"{KAFKA_CONNECTION_QUALIFIED_NAME}/topic/{KAFKA_TOPIC_NAME}"
...
KAFKA_CONSUMER_GROUP_QUALIFIED_NAME = f"{KAFKA_CONNECTION_QUALIFIED_NAME}/consumer-group/{KAFKA_CONSUMER_GROUP_NAME}"
...
EVENT_HUB_QUALIFIED_NAME = f"{EVENT_HUB_CONNECTION_QUALIFIED_NAME}/topic/{EVENT_HUB_NAME}"
...
EVENT_HUB_CONSUMER_GROUP_QUALIFIED_NAME = (
    f"{EVENT_HUB_CONNECTION_QUALIFIED_NAME}/consumer-group/{EVENT_HUB_NAME}/{EVENT_HUB_CONSUMER_GROUP_NAME}"
)
...
SUPERSET_DASHBOARD_QUALIFIED_NAME = f"{SUPERSET_CONNECTION_QUALIFIED_NAME}/{SUPERSET_DASHBOARD_NAME}"
SUPERSET_CHART_NAME = "ss-chart"
SUPERSET_CHART_QUALIFIED_NAME = f"{SUPERSET_DASHBOARD_QUALIFIED_NAME}/{SUPERSET_CHART_NAME}"
SUPERSET_DATASET_NAME = "ss-dataset"
SUPERSET_DATASET_QUALIFIED_NAME = f"{SUPERSET_DASHBOARD_QUALIFIED_NAME}/{SUPERSET_DATASET_NAME}"
...
CUSTOM_ENTITY_QUALIFIED_NAME = f"{CUSTOM_CONNECTION_QUALIFIED_NAME}/{CUSTOM_ENTITY_NAME}"
PROCEDURE_NAME = "test-procedure"
DATAVERSE_CONNECTION_QUALIFIED_NAME = "default/dataverse/123456789"
DATAVERSE_CONNECTOR_TYPE = "dataverse"
DATAVERSE_ENTITY_NAME = "dv-entity"
DATAVERSE_ENTITY_QUALIFIED_NAME = f"{DATAVERSE_CONNECTION_QUALIFIED_NAME}/{DATAVERSE_ENTITY_NAME}"
DATAVERSE_ATTRIBUTE_NAME = "dv-attribute"
DATAVERSE_ATTRIBUTE_QUALIFIED_NAME = f"{DATAVERSE_ENTITY_QUALIFIED_NAME}/{DATAVERSE_ATTRIBUTE_NAME}"
TABLE_PARTITION_NAME = "test-table-partition"
QUICK_SIGHT_NAME = "test-quick-sight-name"
QUICK_SIGHT_CONNECTION_QUALIFIED_NAME = "default/quicksight/123456789"
QUICK_SIGHT_ID = "0123456789"
QUICK_SIGHT_QUALIFIED_NAME = f"{QUICK_SIGHT_CONNECTION_QUALIFIED_NAME}/{QUICK_SIGHT_ID}"
QUICK_SIGHT_CONNECTOR_TYPE = "quicksight"
QUICK_SIGHT_FOLDER_SET = [
    f"{QUICK_SIGHT_CONNECTION_QUALIFIED_NAME}/1235663folder",
    f"{QUICK_SIGHT_CONNECTION_QUALIFIED_NAME}/1235663folder",
]
QUICK_SIGHT_ID_DATASET_FEILD = "23045523"
QUICK_SIGHT_DATASET_FIELD_QUALIFIED_NAME = f"{QUICK_SIGHT_QUALIFIED_NAME}/{QUICK_SIGHT_ID_DATASET_FEILD}"
QUICK_SIGHT_ID_ANALYSIS_VISUAL = "23045532"
QUICK_SIGHT_SHEET_ID = "1234"
QUICK_SIGHT_ANALYSIS_VISUAL_QUALIFIED_NAME = (
    f"{QUICK_SIGHT_QUALIFIED_NAME}/{QUICK_SIGHT_SHEET_ID}/{QUICK_SIGHT_ID_ANALYSIS_VISUAL}"
)
...
QUICK_SIGHT_DASHBOARD_VISUAL_QUALIFIED_NAME = (
    f"{QUICK_SIGHT_QUALIFIED_NAME}/{QUICK_SIGHT_SHEET_ID}/{QUICK_SIGHT_ID_DASHBOARD_VISUAL}"
)
