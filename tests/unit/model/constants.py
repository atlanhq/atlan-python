...
ALPHA_DQ_RULE_NAME = "MyAlphaDQRule"
ALPHA_DQ_RULE_QUALIFIED_NAME = (
    f"{TABLE_QUALIFIED_NAME}/rule/12345678-1234-4123-8123-123456789012"
)
ALPHA_DQ_RULE_TYPE_TABLE = "Row Count"
ALPHA_DQ_RULE_TYPE_COLUMN = "Blank Count"
ALPHA_DQ_RULE_DIMENSION = "completeness"
ALPHA_DQ_RULE_DIMENSION_UPDATED = "accuracy"
ALPHA_DQ_RULE_ALERT_PRIORITY = "NORMAL"
ALPHA_DQ_RULE_ALERT_PRIORITY_UPDATED = "URGENT"
ALPHA_DQ_RULE_STATUS = "ACTIVE"
ALPHA_DQ_RULE_STATUS_UPDATED = "SUSPENDED"
ALPHA_DQ_RULE_THRESHOLD_COMPARE_OPERATOR = "LTE"
ALPHA_DQ_RULE_THRESHOLD_COMPARE_OPERATOR_UPDATED = "GTE"
ALPHA_DQ_RULE_THRESHOLD_VALUE = 95
ALPHA_DQ_RULE_THRESHOLD_VALUE_UPDATED = 90
ALPHA_DQ_RULE_THRESHOLD_UNIT = "PERCENTAGE"
ALPHA_DQ_RULE_CUSTOM_SQL = "SELECT COUNT(*) FROM my_table WHERE column IS NOT NULL"
ALPHA_DQ_RULE_CUSTOM_SQL_UPDATED = "SELECT COUNT(*) FROM my_table WHERE column > 0"
ALPHA_DQ_RULE_DESCRIPTION = "Test data quality rule"
ALPHA_DQ_RULE_DESCRIPTION_UPDATED = "Updated test data quality rule"
ALPHA_DQ_TABLE_QUALIFIED_NAME = TABLE_QUALIFIED_NAME
ALPHA_DQ_COLUMN_QUALIFIED_NAME = TABLE_COLUMN_QUALIFIED_NAME
