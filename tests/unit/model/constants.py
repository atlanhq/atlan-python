...
ADLS_OBJECT_PREFIX = "/some/folder/structure"
...
ANAPLAN_WORKSPACE_QUALIFIED_NAME = (
    f"{ANAPLAN_CONNECTION_QUALIFIED_NAME}/{ANAPLAN_WORKSPACE_NAME}"
)
...
ANAPLAN_MODEL_QUALIFIED_NAME = (
    f"{ANAPLAN_WORKSPACE_QUALIFIED_NAME}/{ANAPLAN_MODEL_NAME}"
)
...
ANAPLAN_SYSTEM_DIMENSION_QUALIFIED_NAME = (
    f"{ANAPLAN_CONNECTION_QUALIFIED_NAME}/{ANAPLAN_SYSTEM_DIMENSION_NAME}"
)
...
ANAPLAN_LINE_ITEM_QUALIFIED_NAME = (
    f"{ANAPLAN_MODULE_QUALIFIED_NAME}/{ANAPLAN_LINE_ITEM_NAME}"
)
...
# Metabase
METABASE_CONNECTION_QUALIFIED_NAME = "default/metabase/123456789"
METABASE_CONNECTOR_TYPE = "metabase"
METABASE_ID = "42"
METABASE_COLLECTION_NAME = "mb-collection"
METABASE_COLLECTION_QUALIFIED_NAME = (
    f"{METABASE_CONNECTION_QUALIFIED_NAME}/collections/{METABASE_ID}"
)
METABASE_DASHBOARD_NAME = "mb-dashboard"
METABASE_DASHBOARD_QUALIFIED_NAME = (
    f"{METABASE_CONNECTION_QUALIFIED_NAME}/dashboards/{METABASE_ID}"
)
METABASE_QUESTION_NAME = "mb-question"
METABASE_QUESTION_QUALIFIED_NAME = (
    f"{METABASE_CONNECTION_QUALIFIED_NAME}/questions/{METABASE_ID}"
)
...
EVENT_HUB_CONSUMER_GROUP_QUALIFIED_NAME = f"{EVENT_HUB_CONNECTION_QUALIFIED_NAME}/consumer-group/{EVENT_HUB_NAME}/{EVENT_HUB_CONSUMER_GROUP_NAME}"

# DocumentDB constants
DOCUMENTDB_CONNECTOR_TYPE = "documentdb"
DOCUMENTDB_CONNECTION_QUALIFIED_NAME = "default/documentdb/123456789"
DOCUMENTDB_DATABASE_NAME = "my-documentdb"
DOCUMENTDB_DATABASE_QUALIFIED_NAME = (
    f"{DOCUMENTDB_CONNECTION_QUALIFIED_NAME}/{DOCUMENTDB_DATABASE_NAME}"
)
DOCUMENTDB_COLLECTION_NAME = "my-collection"
DOCUMENTDB_COLLECTION_QUALIFIED_NAME = (
    f"{DOCUMENTDB_DATABASE_QUALIFIED_NAME}/{DOCUMENTDB_COLLECTION_NAME}"
)
...
DATAVERSE_ENTITY_QUALIFIED_NAME = (
    f"{DATAVERSE_CONNECTION_QUALIFIED_NAME}/{DATAVERSE_ENTITY_NAME}"
)
DATAVERSE_ATTRIBUTE_NAME = "dv-attribute"
DATAVERSE_ATTRIBUTE_QUALIFIED_NAME = (
    f"{DATAVERSE_ENTITY_QUALIFIED_NAME}/{DATAVERSE_ATTRIBUTE_NAME}"
)
...
QUICK_SIGHT_DATASET_FIELD_QUALIFIED_NAME = (
    f"{QUICK_SIGHT_QUALIFIED_NAME}/{QUICK_SIGHT_ID_DATASET_FEILD}"
)
QUICK_SIGHT_ID_ANALYSIS_VISUAL = "23045532"
QUICK_SIGHT_SHEET_ID = "1234"
QUICK_SIGHT_ANALYSIS_VISUAL_QUALIFIED_NAME = f"{QUICK_SIGHT_QUALIFIED_NAME}/{QUICK_SIGHT_SHEET_ID}/{QUICK_SIGHT_ID_ANALYSIS_VISUAL}"
...
AI_MODEL_NAME = "test-model-ai"
AI_MODEL_VERSION = "1.0"
AI_MODEL_STATUS = "ACTIVE"
AI_MODEL_QUALIFIED_NAME = "default/ai/aiapplication/testModelAi"
AI_MODEL_STATUS_UPDATED = "INACTIVE"
DQ_RULE_NAME = "MyAlphaDQRule"
DQ_RULE_QUALIFIED_NAME = (
    f"{TABLE_QUALIFIED_NAME}/rule/12345678-1234-4123-8123-123456789012"
)
DQ_RULE_TYPE_TABLE = "Row Count"
DQ_RULE_TYPE_COLUMN = "Blank Count"
DQ_RULE_DIMENSION = "completeness"
DQ_RULE_DIMENSION_UPDATED = "accuracy"
DQ_RULE_ALERT_PRIORITY = "NORMAL"
DQ_RULE_ALERT_PRIORITY_UPDATED = "URGENT"
DQ_RULE_STATUS = "ACTIVE"
DQ_RULE_STATUS_UPDATED = "SUSPENDED"
DQ_RULE_THRESHOLD_COMPARE_OPERATOR = "LTE"
DQ_RULE_THRESHOLD_COMPARE_OPERATOR_UPDATED = "GTE"
DQ_RULE_THRESHOLD_VALUE = 95
DQ_RULE_THRESHOLD_VALUE_UPDATED = 90
DQ_RULE_THRESHOLD_UNIT = "PERCENTAGE"
DQ_RULE_CUSTOM_SQL = "SELECT COUNT(*) FROM my_table WHERE column IS NOT NULL"
DQ_RULE_CUSTOM_SQL_UPDATED = "SELECT COUNT(*) FROM my_table WHERE column > 0"
DQ_RULE_DESCRIPTION = "Test data quality rule"
