...
def test_create():
    sut = GCSBucket.create(name=GCS_BUCKET_NAME, connection_qualified_name=GCS_CONNECTION_QUALIFIED_NAME)
...
def test_create_for_modification():
    sut = GCSBucket.create_for_modification(qualified_name=GCS_QUALIFIED_NAME, name=GCS_BUCKET_NAME)
