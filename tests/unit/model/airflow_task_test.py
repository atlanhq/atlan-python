...
def test_creator_with_missing_parameters_raise_value_error(name: str, airflow_dag_qualified_name: str, message: str):
...
def test_updater():
    task = AirflowTask.updater(name=AIRFLOW_TASK_NAME, qualified_name=AIRFLOW_TASK_QUALIFIED_NAME)
...
def test_trim_to_required():
    task = AirflowTask.updater(name=AIRFLOW_TASK_NAME, qualified_name=AIRFLOW_TASK_QUALIFIED_NAME).trim_to_required()
