...
def test_create():
    sut = Database.create(name=DATABASE_NAME, connection_qualified_name=CONNECTION_QUALIFIED_NAME)
...
def test_create_for_modification():
    sut = Database.create_for_modification(qualified_name=DATABASE_QUALIFIED_NAME, name=DATABASE_NAME)
