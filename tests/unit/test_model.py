...
ATTRIBUTE_VALUES_BY_TYPE = {
    ...
    "Optional[AnaplanWorkspace]": AnaplanWorkspace(),
    "Optional[List[AnaplanApp]]": [AnaplanApp()],
    "Optional[List[AnaplanPage]]": [AnaplanPage()],
    "Optional[List[AnaplanModel]]": [AnaplanModel()],
    "Optional[List[AnaplanModule]]": [AnaplanModule()],
    "Optional[List[AnaplanLineItem]]": [AnaplanLineItem()],
    "Optional[List[AnaplanView]]": [AnaplanView()],
    "Optional[List[AnaplanList]]": [AnaplanList()],
    "Optional[List[AnaplanDimension]]": [AnaplanDimension()],
    ...
    "Optional[APIObject]": APIObject(),
    "Optional[APIQuery]": APIQuery(),
    "Optional[List[APIField]]": [APIField()],
    "Optional[Application]": Application(),
    "Optional[List[ApplicationField]]": [ApplicationField()],
