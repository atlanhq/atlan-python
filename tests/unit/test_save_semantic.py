...
# =============================================================================
# Test 5: get_semantic_flags returns correct flags
# =============================================================================
...
# =============================================================================
# Test 6: Split entities - APPEND/REMOVE goes to append_remove bucket
# =============================================================================
...
# =============================================================================
# Test 15: APPEND + REPLACE on different entities = 1 API call (both flags set)
# =============================================================================
def test_api_call_count_append_replace_different_entities(mock_asset_client):
    """Verify APPEND and REPLACE on different entities = 1 API call with both flags."""
    client, mock_call_api = mock_asset_client
...
# =============================================================================
# Test 17: APPEND + REPLACE + None semantic = 1 API call (all flags based on semantics)
# =============================================================================
def test_api_call_count_all_three_semantics(mock_asset_client):
    """Verify APPEND, REPLACE, and None semantics = 1 API call with appropriate flags."""
    client, mock_call_api = mock_asset_client
