...
def test_retrieve_data_studio_asset_data_source(
    ...
    b = client.asset.get_by_guid(
        data_studio_asset_data_source.guid, asset_type=DataStudioAsset, ignore_relationships=False
    )
    assert b
...
def test_restore_data_studio_asset_data_source(
    ...
    restored = client.asset.get_by_qualified_name(
        asset_type=DataStudioAsset,
        qualified_name=data_studio_asset_data_source.qualified_name, ignore_relationships=False
    )
    assert restored
